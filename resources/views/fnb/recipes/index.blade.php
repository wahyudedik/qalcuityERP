                ...
                <div class="bg-white rounded-lg shadow p-4 border border-gray-200 hover:shadow-md transition-shadow">
                    ...
                    <div class="space-y-1 text-sm mb-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-gray-700">{{ $recipe->preparation_time_minutes ?? '-' }} menit</span>
                        </div>
                        @if ($recipe->cooking_time_minutes)
                            <div class="flex justify-between">
                                <span class="text-gray-500">Waktu Masak:</span>
                                <span class="text-gray-700">{{ $recipe->cooking_time_minutes }} menit</span>
                            </div>
                        @endif
                    </div>
