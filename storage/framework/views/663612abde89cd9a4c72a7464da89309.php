...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Create Document Template')); ?> <?php $__env->endSlot(); ?>
                ...
                <form method="POST" action="<?php echo e(route('documents.templates.store')); ?>" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mb-2 text-xs text-gray-500">
                            Use <code class="px-1 py-0.5 bg-gray-100 rounded"><?php echo e(`{{variable_name); ?>`}}</code> for dynamic content
                        </div>
                        <textarea name="content" required rows="15" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 font-mono text-sm" placeholder="<h1><?php echo e(title); ?></h1>
...
..."></textarea>
                    ...
                    <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                        <a href="<?php echo e(route('documents.templates.index')); ?>" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
                            Cancel
                        </a>
