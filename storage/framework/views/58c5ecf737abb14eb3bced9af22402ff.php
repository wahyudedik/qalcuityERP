<div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5 h-full">
    <div class="flex items-start justify-between mb-4">
        <p class="text-xs font-medium text-gray-500 dark:text-slate-400 leading-tight">Omzet POS Hari Ini</p>
    ...
    <p class="text-2xl font-bold text-gray-900 dark:text-white">Rp <?php echo e(number_format($data['revenue'] ?? 0, 0, ',', '.')); ?></p>
    <p class="text-xs text-gray-400 dark:text-slate-500 mt-1"><?php echo e($data['count'] ?? 0); ?> transaksi · Avg Rp <?php echo e(number_format($data['avg_ticket'] ?? 0, 0, ',', '.')); ?></p>
</div>
