                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <div class="text-right">
                                <span
                                    class="text-sm font-bold text-gray-900">{{ number_format($species->total_weight, 1) }}
                                    kg</span>
                                <span
                                    class="text-xs text-gray-500 ml-2">({{ number_format($percentage, 1) }}%)</span>
                            </div>
                        </div>
            ...
            <div class="h-64 flex items-end gap-2 overflow-x-auto">
                ...
                @foreach ($analytics['weekly_revenue'] as $week)
                    ...
                    <div class="flex-1 min-w-[40px] flex flex-col items-center group">
                        ...
                        <span
                            class="text-[10px] text-gray-500 mt-1">W{{ substr($week->week, -2) }}</span>
                    </div>
                @endforeach
            </div>
        </div>
