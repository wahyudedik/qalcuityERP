...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('cost-centers.report')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 transition">
    ...
    <form method="GET" class="flex gap-3 flex-wrap">
        ...
        <a href="<?php echo e(route('cost-centers.index')); ?>" class="px-4 py-2 rounded-xl text-sm bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 transition">Reset</a>
        <?php endif; ?>
    </form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-4 py-3 font-mono text-blue-600 font-medium"><?php echo e($cc->code); ?></td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <span class="inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-medium bg-<?php echo e($c); ?>-100 text-<?php echo e($c); ?>-700 $c }}-500/20 $c }}-300">
                            <?php echo e($cc->typeLabel()); ?>

                        </span>
                    </td>
                    <td class="px-4 py-3 text-slate-500"><?php echo e($cc->parent?->name ?? '—'); ?></td>
                    <td class="px-4 py-3">
                        <?php if($cc->is_active): ?>
