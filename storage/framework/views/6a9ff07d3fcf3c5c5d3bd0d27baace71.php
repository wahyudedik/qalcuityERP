    ...
    <div class="py-4">
        <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-900"><?php echo e($patient->full_name); ?></h2>
                        <p class="text-sm text-gray-500">RM: <?php echo e($patient->medical_record_number); ?> |
                            NIK: <?php echo e($patient->nik ?? '-'); ?></p>
                    </div>
                </div>
                <div class="flex gap-2">
                    <a href="<?php echo e(route('healthcare.patients.edit', $patient)); ?>"
                        class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Edit</a>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-200">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900 mt-1"><?php echo e($patient->phone_primary ?? '-'); ?></p>
                </div>
                <div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 mb-6">
            ...
            <div id="content-visits" class="tab-content p-6">
                        ...
                        <?php $__currentLoopData = $patient->visits->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($visit->visit_status_label ?? $visit->visit_status ?? '-'); ?>
                ...
                <?php else: ?>
                    <p class="text-center text-gray-500 py-8">Belum ada riwayat kunjungan</p>
                <?php endif; ?>
            </div>
            ...
            <div id="content-emr" class="tab-content p-6 hidden">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Rekam Medis Elektronik</h3>
                    <?php if($patient->visits && $patient->visits->count() > 0): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-4 bg-gray-50 rounded-xl">
                        <p class="text-xs text-gray-500 mb-1">Alergi</p>
                        <p class="text-lg font-semibold text-gray-900">
                    ...
                    <div class="p-4 bg-gray-50 rounded-xl">
                        <p class="text-xs text-gray-500 mb-1">Asuransi</p>
                        <p class="text-lg font-semibold text-gray-900">
                            <?php echo e($patient->insurance_provider ?? '-'); ?></p>
                    </div>
                    <div class="p-4 bg-gray-50 rounded-xl">
                        <p class="text-xs text-gray-500 mb-1">No. Polis</p>
                        <p class="text-lg font-semibold text-gray-900">
            ...
            <div id="content-billing" class="tab-content p-6 hidden">
                ...
                <p class="text-center text-gray-500 py-8">Fitur tagihan akan ditampilkan di sini
                </p>
            </div>
        </div>
