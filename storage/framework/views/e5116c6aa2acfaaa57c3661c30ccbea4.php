...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($statTotal); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Aktif</p>
            <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($statActive); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Header</p>
            <p class="text-2xl font-bold text-purple-600 mt-1"><?php echo e($statHeader); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Detail</p>
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($statDetail); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200 col-span-2 sm:col-span-1">
            ...
            <p class="text-2xl font-bold text-gray-500 mt-1"><?php echo e($statTotal - $statActive); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 mb-4">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4">
            <form method="GET" class="flex flex-col sm:flex-row gap-2 flex-1">
                ...
                <select name="type" class="px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    ?>
                    <tr class="hover:bg-gray-50 <?php echo e($acc->is_header ? 'bg-gray-50/50' : ''); ?>">
                        <td class="px-4 py-3 font-mono text-xs font-semibold text-gray-700"><?php echo e($acc->code); ?></td>
                        <td class="px-4 py-3" style="padding-left: <?php echo e(($acc->level - 1) * 18 + 16); ?>px">
                            <div class="flex items-center gap-1.5">
                                ...
                                <?php endif; ?>
                                <span class="<?php echo e($acc->is_header ? 'font-semibold text-gray-900' : 'text-gray-700'); ?>"><?php echo e($acc->name); ?></span>
                            </div>
                        </td>
                        <td class="px-4 py-3 hidden sm:table-cell">
                            <span class="px-2 py-0.5 rounded-full text-xs <?php echo e($typeColor); ?>"><?php echo e($acc->getTypeLabel()); ?></span>
                        </td>
                        <td class="px-4 py-3 hidden md:table-cell text-xs text-gray-500 capitalize"><?php echo e($acc->normal_balance); ?></td>
                        <td class="px-4 py-3 text-center hidden lg:table-cell text-xs text-gray-500"><?php echo e($acc->level); ?></td>
                        <td class="px-4 py-3 hidden lg:table-cell font-mono text-xs text-gray-400"><?php echo e($acc->parent?->code ?? '—'); ?></td>
    ...
    <div id="modal-add-coa" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-xl max-h-[90vh] overflow-y-auto">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 sticky top-0 bg-white z-10">
                ...
                <button onclick="document.getElementById('modal-add-coa').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">✕</button>
            </div>
            <form method="POST" action="<?php echo e(route('accounting.coa.store')); ?>" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="level" required class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="add-is-header" class="text-sm text-gray-700">Akun header (tidak bisa diposting langsung)</label>
                </div>
                <div class="flex justify-end gap-3 pt-2">
                    <button type="button" onclick="document.getElementById('modal-add-coa').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Batal</button>
    ...
    <div id="modal-edit-coa" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            ...
            <form id="form-edit-coa" method="POST" class="p-6 space-y-4">
                ...
                <p class="text-xs text-gray-400">Kode, tipe, saldo normal, dan level tidak dapat diubah setelah dibuat.</p>
                <div class="flex justify-end gap-3 pt-2">
                    <button type="button" onclick="document.getElementById('modal-edit-coa').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Batal</button>
                    <button type="submit" class="px-4 py-2 text-sm bg-blue-600 text-white rounded-xl hover:bg-blue-700">Simpan</button>
                </div>
            </form>
        </div>
