        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    <td class="px-4 py-3 font-mono font-medium text-slate-800"><?php echo e($bp->number); ?></td>
                    <td class="px-4 py-3 text-slate-600"><?php echo e($bp->party?->name ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-500"><?php echo e($bp->payment_date->format('d/m/Y')); ?></td>
                    <td class="px-4 py-3 text-right font-medium text-slate-800">Rp <?php echo e(number_format($bp->total_amount, 0, ',', '.')); ?></td>
                    <td class="px-4 py-3 text-right text-slate-600">Rp <?php echo e(number_format($bp->applied_amount, 0, ',', '.')); ?></td>
                    ...
                    <td class="px-4 py-3 text-slate-500 capitalize"><?php echo e($bp->payment_method); ?></td>
                    <td class="px-4 py-3">
