...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Claim Asuransi Baru <?php $__env->endSlot(); ?>
    ...
    <div class="py-4">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('healthcare.insurance-claims.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            <label for="policy_number" class="block text-sm font-medium text-gray-700">Policy Number
                                *</label>
                            <input type="text" name="policy_number" required value="<?php echo e(old('policy_number')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Description of treatment..."><?php echo e(old('description')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="submitted_at"
                                value="<?php echo e(old('submitted_at', now()->format('Y-m-d'))); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\insurance-claims\create.blade.php ENDPATH**/ ?>