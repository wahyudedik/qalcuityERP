...
<?php $component->withAttributes([]); ?>
    ...
    <div class="sm:hidden mb-4">
        <a href="<?php echo e(route('super-admin.plans.index')); ?>" class="text-sm text-gray-500 dark:text-slate-400">← Kembali ke daftar paket</a>
    </div>
    ...
    <div class="max-w-2xl">
        <form method="POST"
            ...
            <?php if($errors->any()): ?>
            <div class="px-4 py-3 bg-red-50 dark:bg-red-500/20 border border-red-200 dark:border-red-500/30 text-red-700 dark:text-red-400 text-sm rounded-xl">
            ...
            <?php $cls = 'w-full px-3.5 py-2.5 text-sm border border-gray-200 dark:border-white/10 rounded-xl bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition'; ?>
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-2">Fitur Paket (centang yang tersedia)</label>
                <?php
                ...
                ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-1 max-h-64 overflow-y-auto border border-gray-200 dark:border-white/10 rounded-xl p-3 bg-gray-50 dark:bg-[#0f172a]">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer py-1 px-1 rounded hover:bg-gray-100 dark:hover:bg-white/5">
                        <input type="checkbox" name="features_list[]" value="<?php echo e($feat); ?>" <?php echo e(in_array($feat, $currentFeatures) ? 'checked' : ''); ?>

                            class="rounded border-gray-300 dark:border-white/20 text-blue-600 focus:ring-blue-500">
                        <span class="text-xs text-gray-700 dark:text-slate-300"><?php echo e($feat); ?></span>
                    </label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="flex items-end pb-2.5">
                    <label class="flex items-center gap-2.5 cursor-pointer">
                        ...
                        <span class="text-sm text-gray-700 dark:text-slate-300 font-medium">Paket aktif</span>
                    </label>
                </div>
            </div>

            <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-2 border-t border-gray-200 dark:border-white/10">
                <a href="<?php echo e(route('super-admin.plans.index')); ?>" class="w-full sm:w-auto text-center text-sm text-gray-600 dark:text-slate-400 px-4 py-2.5 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition">Batal</a>
