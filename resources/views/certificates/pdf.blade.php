...
<body>
    <div class="certificate">
        ...
        <div class="body">
            <div class="info-section">
                ...
                <div class="field">
                    ...
                    <div class="field-value sku">{{ $product->sku }}</div>
                </div>

                <div class="field">
                    <div class="field-label">Penerbit / Tenant</div>
                    <div class="field-value">{{ $tenant->name }}</div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="field-value">{{ $certificate->expires_at->translatedFormat('d F Y') }}</div>
                </div>
                @endif
            </div>
            ...
            <div class="qr-section">
                @if ($qrBase64)
                    <img src="{{ $qrBase64 }}" class="qr-image" alt="QR Code Verifikasi">
        ...
        <div class="footer">
            ...
            Certificate Hash: {{ substr($certificate->certificate_hash, 0, 16) }}...
        </div>
    </div>
</body>
</html>
