...
<?php $__env->startSection('content'); ?>
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-blue-600 mt-2"><?php echo e($stats['undo_actions']); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-yellow-600 mt-2"><?php echo e($stats['pending_conflicts']); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($stats['active_restore_points']); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-purple-600 mt-2">
                                <?php echo e($stats['error_stats']['resolution_rate']); ?>%</p>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <a href="<?php echo e(route('error-handling.backups.index')); ?>"
                ...
                <a href="<?php echo e(route('error-handling.conflicts.index')); ?>"
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($stats['pending_conflicts']); ?> pending</p>
                        </div>
                    </div>
                </a>

                <a href="<?php echo e(route('error-handling.action-log')); ?>"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900">
                                        <?php echo e($backup['backup_type_name'] ?? ucfirst($backup['backup_type'])); ?></p>
                                    <p class="text-sm text-gray-600">
                                        <?php echo e(\Carbon\Carbon::parse($backup['created_at'])->diffForHumans()); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-4">
                                <span
                                    class="px-3 py-1 rounded-full text-xs font-medium
                            <?php echo e($backup['status'] === 'completed'
                                ...
                                <span class="text-sm text-gray-600"><?php echo e($backup['records_count'] ?? 0); ?> records</span>
                            </div>
                        </div>
    ...
    <script>
        async function createBackup() {
            ...
            try {
                const response = await fetch('<?php echo e(route('error-handling.backups.create')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\error-handling\dashboard.blade.php ENDPATH**/ ?>