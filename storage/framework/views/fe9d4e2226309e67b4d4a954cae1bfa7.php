...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('New Surgery Schedule')); ?></h2>
     <?php $__env->endSlot(); ?>

    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('healthcare.surgeries.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            ...
                            <select name="surgeon_id" required
                                ...
                                <?php $__currentLoopData = $surgeons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surgeon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($surgeon->id); ?>"
                                        <?php echo e(old('surgeon_id') == $surgeon->id ? 'selected' : ''); ?>>
                                        <?php echo e($surgeon->name); ?> - <?php echo e($surgeon->specialization); ?>
                        ...
                        <div>
                            <label for="procedure_name" class="block text-sm font-medium text-gray-700">Procedure Name
                                *</label>
                            <input type="text" name="procedure_name" required value="<?php echo e(old('procedure_name')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        ...
                        <div>
                            <label for="operating_room" class="block text-sm font-medium text-gray-700">Operating Room
                                *</label>
                            <input type="text" name="operating_room" required value="<?php echo e(old('operating_room')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        ...
                        <div>
                            ...
                            <input type="number" name="estimated_duration" value="<?php echo e(old('estimated_duration')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="e.g., 120">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="pre_op_diagnosis" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Pre-operative diagnosis..."><?php echo e(old('pre_op_diagnosis')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Special requirements..."><?php echo e(old('notes')); ?></textarea>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\surgeries\create.blade.php ENDPATH**/ ?>