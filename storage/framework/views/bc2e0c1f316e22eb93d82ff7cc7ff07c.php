...
<?php $__env->startSection('title', 'Rate Plans'); ?>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y">
                        <?php $__empty_1 = true; $__currentLoopData = $ratePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div class="font-medium"><?php echo e($plan->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($plan->code); ?></div>
                                </td>
                                <td class="px-4 py-3"><?php echo e($plan->roomType?->name ?? 'N/A'); ?></td>
                                <td class="px-4 py-3 text-center font-medium">$<?php echo e(number_format($plan->base_rate, 2)); ?></td>
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="px-2 py-1 text-xs rounded 
                                <?php echo e($plan->type === 'standard' ? 'bg-gray-100 text-gray-700' : ''); ?>

                                <?php echo e($plan->type === 'non_refundable' ? 'bg-red-100 text-red-700' : ''); ?>

                                <?php echo e($plan->type === 'package' ? 'bg-blue-100 text-blue-700' : ''); ?>

                                <?php echo e($plan->type === 'corporate' ? 'bg-purple-100 text-purple-700' : ''); ?>

                                <?php echo e($plan->type === 'promotional' ? 'bg-green-100 text-green-700' : ''); ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $plan->type))); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center text-sm">
                                    <?php echo e($plan->min_stay); ?> / <?php echo e($plan->max_stay ?? '∞'); ?>

                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="px-2 py-1 text-xs rounded <?php echo e($plan->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'); ?>">
                                        <?php echo e($plan->is_active ? 'Active' : 'Inactive'); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <button onclick="editPlan(<?php echo e($plan->id); ?>)"
                                        class="text-blue-600 hover:text-blue-800 mr-2">Edit</button>
                                    <a href="<?php echo e(route('revenue.pricing-rules')); ?>?rate_plan=<?php echo e($plan->id); ?>"
    ...
    <div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-screen overflow-y-auto">
                ...
                <form action="<?php echo e(route('revenue.rate-plans.store')); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\revenue\rate-plans.blade.php ENDPATH**/ ?>