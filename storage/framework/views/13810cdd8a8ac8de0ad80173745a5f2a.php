...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex gap-2 mb-4">
        ...
        <?php $c = match($v) { 'fraud'=>'bg-red-600','warning'=>'bg-amber-600', default => '' }; ?>
        <a href="?severity=<?php echo e($v); ?>" class="px-3 py-1.5 text-xs rounded-xl <?php echo e(request('severity')===$v ? ($c ?: 'bg-blue-600') . ' text-white' : 'bg-white/5 border border-white/10 text-slate-300 hover:bg-white/10'); ?>"><?php echo e($l); ?></a>
    ...
    <div class="bg-[#1e293b] border border-white/10 rounded-2xl overflow-hidden">
                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/5 <?php echo e($log->severity === 'fraud' ? 'bg-red-500/5' : ''); ?>">
                        <td class="px-4 py-3 text-center">
                            <span class="px-2 py-0.5 rounded-full text-[10px] font-bold bg-<?php echo e($sc); ?>-500/20 text-<?php echo e($sc); ?>-400"><?php echo e($icon); ?> <?php echo e(strtoupper($log->severity)); ?></span>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center text-slate-500 text-xs"><?php echo e($log->created_at->format('d/m H:i')); ?></td>
                    </tr>
        ...
        <?php if($logs->hasPages()): ?><div class="px-4 py-3 border-t border-white/5"><?php echo e($logs->links()); ?></div><?php endif; ?>
    </div>
