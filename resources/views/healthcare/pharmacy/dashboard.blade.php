<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($statistics['total_items']) }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Stok Menipis</p>
            <p class="text-2xl font-bold text-amber-600 mt-1">{{ $statistics['low_stock'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Resep Pending</p>
            <p class="text-2xl font-bold text-blue-600 mt-1">{{ $statistics['pending_prescriptions'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Selesai Hari Ini</p>
            <p class="text-2xl font-bold text-green-600 mt-1">{{ $statistics['today_dispensed'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Terverifikasi</p>
            <p class="text-2xl font-bold text-purple-600 mt-1">{{ $statistics['verified_prescriptions'] }}</p>
        </div>
    </div>
