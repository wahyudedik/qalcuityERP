...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="lg:col-span-1 bg-white rounded-2xl border border-gray-200 p-6 flex flex-col items-center text-center">
            <p class="text-xs text-gray-400 uppercase tracking-wide mb-2"><?php echo e(now()->translatedFormat('l, d F Y')); ?></p>

            
            <p id="live-clock" class="text-4xl font-black text-gray-900 tabular-nums mb-4"><?php echo e(now()->format('H:i:s')); ?></p>

            <?php if($today): ?>
                <div class="w-full space-y-2 mb-5">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Clock In</span>
                        <span class="font-semibold text-green-600"><?php echo e($today->check_in ?? '—'); ?></span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500">Clock Out</span>
                        <span class="font-semibold <?php echo e($today->check_out ? 'text-blue-600' : 'text-gray-400'); ?>">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-semibold text-gray-900"><?php echo e($h); ?>j <?php echo e($m); ?>m</span>
                    </div>
                    <?php endif; ?>
                    <div class="flex justify-between text-sm">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center text-gray-700"><?php echo e($att->check_in ?? '—'); ?></td>
                        <td class="px-4 py-3 text-center text-gray-700"><?php echo e($att->check_out ?? '—'); ?></td>
                        <td class="px-4 py-3 text-center text-gray-500"><?php echo e($dur ?: '—'); ?></td>
