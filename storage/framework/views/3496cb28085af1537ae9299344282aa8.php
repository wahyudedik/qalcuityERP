            ...
            <form action="<?php echo e(route('healthcare.patient-satisfaction.store')); ?>" method="POST"
                ...
                <div>
                    ...
                    <select name="patient_visit_id" id="patient_visit_id" required
                        class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['patient_visit_id'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="overall_rating" id="overall_rating" required
                        class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['overall_rating'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
