...
<div class="md:hidden space-y-3" role="list" aria-label="Mobile card view">
    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm transition-all duration-200 hover:shadow-md touch-ripple"
                    ...
                    <div class="flex items-start justify-between gap-3">
                        ...
                        <?php if($type === 'tel' && $value): ?>
                            <a href="tel:<?php echo e($value); ?>"
                                class="text-sm text-blue-600 text-right break-words hover:underline">
                        ...
                        <?php elseif($type === 'badge' && $value): ?>
                            <span
                                class="px-2 py-0.5 rounded-full text-xs <?php echo e($field['badgeClass'] ?? 'bg-gray-100 text-gray-700'); ?>">
                                <?php echo e($displayValue); ?>

                            </span>
                        <?php elseif($type === 'boolean'): ?>
                            <span
                                class="text-sm <?php echo e($value ? 'text-green-600' : 'text-red-600'); ?>">
                        ...
                        <?php elseif($type === 'progress' && is_numeric($value)): ?>
                            <div class="flex-1">
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-sm text-gray-900"><?php echo e($displayValue); ?></span>
                                </div>
                        ...
                        <?php else: ?>
                            <span
                                class="text-sm text-gray-900 text-right break-words <?php echo e($valueClass); ?>">
                                <?php echo e($displayValue); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="text-center py-12">
            ...
            <p class="mt-4 text-sm text-gray-500"><?php echo e($emptyMessage); ?></p>
        </div>
    <?php endif; ?>
</div>
