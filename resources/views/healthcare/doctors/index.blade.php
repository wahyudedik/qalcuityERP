<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $statistics['total_doctors'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Dokter Aktif</p>
            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $statistics['active_doctors'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Tersedia Hari Ini</p>
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ $statistics['available_today'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Cuti</p>
            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1">{{ $statistics['on_leave'] }}</p>
        </div>
    </div>
                    ...
                    <div class="flex items-start justify-between gap-3 mb-3">
                        <div class="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="font-semibold text-gray-900 dark:text-white truncate">{{ $doctor->name }}
                                </p>
                                <p class="text-xs text-gray-500 dark:text-slate-400">{{ $doctor->email ?? '-' }}</p>
                            </div>
                        </div>
                        @if ($doctor->status === 'active')
                            <span
                    ...
                    <div class="grid grid-cols-2 gap-2 text-xs mb-3">
                        ...
                        @if ($doctor->str_number)
                            <div class="col-span-2">
                                ...
                                <p class="font-mono text-gray-700 dark:text-slate-300">{{ $doctor->str_number }}</p>
                            </div>
                        @endif
                        <div class="col-span-2">
