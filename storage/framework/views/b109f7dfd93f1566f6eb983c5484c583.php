    ...
    <div x-data="hotelSettings()" class="max-w-3xl mx-auto space-y-6">
        <form method="POST" action="<?php echo e(route('hotel.settings.update')); ?>" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-4">General
                    Settings</h3>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Hotel Name
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Check-in Time
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Check-out Time
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Timezone
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Currency
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Tax Rate (%)
                            *</label>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label for="tax_included" class="text-sm text-gray-700 dark:text-slate-300">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-4">Contact
                    Information</h3>

                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Phone</label>
                        <input type="text" name="phone" value="<?php echo e(old('phone', $settings->phone ?? '')); ?>"
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Email</label>
                        <input type="email" name="email" value="<?php echo e(old('email', $settings->email ?? '')); ?>"
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Website</label>
                        <input type="url" name="website" placeholder="https://"
                            value="<?php echo e(old('website', $settings->website ?? '')); ?>"
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Address</label>
                        <textarea name="address" rows="2"
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('address', $settings->address ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-4">Deposit
                    Settings</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between py-2">
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Deposit Required</p>
                            <p class="text-xs text-gray-500 dark:text-slate-400">Require deposit at check-in</p>
                        </div>
                    ...
                    <div x-show="depositRequired" class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-slate-400 text-sm">Rp</span>
                                    <input type="number" name="default_deposit_amount" min="0" step="10000"
                                        ...
                                        class="w-full pl-10 pr-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                            <div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start justify-between gap-4 py-2">
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Allow Overbooking</p>
                            <p class="text-xs text-gray-500 dark:text-slate-400">Allow reservations beyond available
                                capacity</p>
                        </div>
                    ...
                    <div class="flex items-start justify-between gap-4 py-2">
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">Auto-assign Room</p>
                            <p class="text-xs text-gray-500 dark:text-slate-400">Automatically assign available room at
                                check-in</p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer mt-0.5">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                <h3 class="text-sm font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-4">Policies
                </h3>

                <div class="space-y-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Cancellation
                            Policy</label>
                        <textarea name="cancellation_policy" rows="3"
                            placeholder="e.g., Free cancellation up to 24 hours before check-in..."
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('cancellation_policy', $settings->cancellation_policy ?? '')); ?></textarea>
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">Terms &
                            Conditions</label>
                        <textarea name="terms_conditions" rows="4" placeholder="Hotel terms and conditions..."
                            class="w-full px-3 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('terms_conditions', $settings->terms_conditions ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
