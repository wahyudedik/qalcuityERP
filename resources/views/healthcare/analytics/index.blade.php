<x-app-layout>
    <x-slot name="header">Analitik Healthcare</x-slot>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <a href="{{ route('healthcare.analytics.dashboard') }}"
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Dashboard Analitik</h3>
                            <p class="text-sm text-gray-500 mt-1">Overview semua metrik dan tren
                                utama</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('healthcare.analytics.kpi') }}"
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Dashboard KPI</h3>
                            <p class="text-sm text-gray-500 mt-1">Tracking key performance
                                indicators</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('healthcare.analytics.financial') }}"
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Analitik Finansial</h3>
                            <p class="text-sm text-gray-500 mt-1">Analisis pendapatan, pengeluaran,
                                dan koleksi</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <a href="{{ route('healthcare.analytics.bor') }}"
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Bed Occupancy Rate</h3>
                            <p class="text-sm text-gray-500 mt-1">Analisis BOR per bangsal dan tren
                            </p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('healthcare.analytics.alos') }}"
                    class="bg-white rounded-2xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-center gap-4">
                        <div
                        ...
                        <div>
                            <h3 class="font-semibold text-gray-900">Average Length of Stay</h3>
                            <p class="text-sm text-gray-500 mt-1">ALOS per bangsal dan diagnosa</p>
                        </div>
                    </div>
                </a> <a href="{{ route('healthcare.analytics.financial') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <a href="{{ route('healthcare.analytics.mortality') }}"
                    class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
                    <div class="flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <a href="{{ route('healthcare.analytics.infection') }}"
                    class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
                    <div class="flex items-center">
                ...
                <a href="{{ route('healthcare.analytics.satisfaction') }}"
                    class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
                    <div class="flex items-center">
