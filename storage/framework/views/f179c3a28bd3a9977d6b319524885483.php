    ...
    <div class="max-w-3xl space-y-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <div class="flex items-start justify-between mb-5 flex-wrap gap-3">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    ?>
                    <span
                        class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium <?php echo e($planColors[$tenant->plan] ?? 'bg-[#f8f8f8] text-gray-500'); ?>">
                    ...
                    <span
                        ...
                        <span
                            class="w-1.5 h-1.5 rounded-full <?php echo e($tenant->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                <div>
                    ...
                    <dd class="text-gray-900"><?php echo e($tenant->email); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-medium text-gray-400 uppercase tracking-wide mb-0.5">Telepon</dt>
                    <dd class="text-gray-900"><?php echo e($tenant->phone ?? '—'); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-medium text-gray-400 uppercase tracking-wide mb-0.5">Trial Berakhir</dt>
                    <dd class="<?php echo e($tenant->isTrialExpired() ? 'text-red-500 font-medium' : 'text-gray-900'); ?>">
                ...
                <div>
                    ...
                    <dd class="<?php echo e($tenant->isPlanExpired() ? 'text-red-500 font-medium' : 'text-gray-900'); ?>">
                ...
                <div>
                    ...
                    <dd class="text-gray-900"><?php echo e($tenant->subscriptionPlan?->name ?? ucfirst($tenant->plan)); ?></dd>
                </div>
                <div>
                    <dt class="text-xs font-medium text-gray-400 uppercase tracking-wide mb-0.5">Terdaftar</dt>
                    <dd class="text-gray-900"><?php echo e($tenant->created_at->format('d M Y, H:i')); ?></dd>
                </div>
            </dl>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-xs text-gray-400 mt-0.5">Ubah paket, pilih definisi paket, dan atur tanggal kedaluwarsa
                </p>
            </div>
            <form method="POST" action="<?php echo e(route('super-admin.tenants.update-plan', $tenant)); ?>"
                class="p-6 space-y-4">
                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="plan" required
                            class="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition bg-gray-50 text-gray-900">
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Definisi
                            Paket</label>
                        <select name="subscription_plan_id"
                            ...
                            <?php $__currentLoopData = $plans ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id); ?>"
                                    <?php echo e($tenant->subscription_plan_id == $p->id ? 'selected' : ''); ?>>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Trial
                            Berakhir</label>
                    ...
                    <div>
                        <label
                            class="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Langganan
                            Berakhir</label>
                ...
                <div class="flex flex-wrap gap-2 pt-1">
                    ...
                    <?php $__currentLoopData = [['label' => '+1 Bulan', 'days' => 30], ['label' => '+3 Bulan', 'days' => 90], ['label' => '+6 Bulan', 'days' => 180], ['label' => '+1 Tahun', 'days' => 365]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" onclick="setExpiry(<?php echo e($opt['days']); ?>)"
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                ...
                <span
                    class="text-xs bg-[#f8f8f8] text-gray-500 font-medium px-2.5 py-1 rounded-lg"><?php echo e($tenant->users->count()); ?></span>
            </div>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-3.5">
                                    <div class="flex items-center gap-2.5">
                                        <div
                                            class="w-7 h-7 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white text-xs font-bold shrink-0">
                                ...
                                <td class="px-6 py-3.5 text-sm text-gray-500 hidden sm:table-cell"><?php echo e($user->email); ?>

                                </td>
                                <td class="px-6 py-3.5">
                                    <span
                                        class="text-xs font-medium text-gray-500 capitalize"><?php echo e($user->role); ?></span>
                                </td>
                                <td class="px-6 py-3.5">
                                    <span
                                        class="inline-flex items-center gap-1.5 text-xs font-medium <?php echo e($user->is_active ? 'text-green-400' : 'text-red-400'); ?>">
                                        <span
                                            class="w-1.5 h-1.5 rounded-full <?php echo e($user->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/super-admin/tenants/show.blade.php ENDPATH**/ ?>