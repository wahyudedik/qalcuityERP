...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="{{ route('delivery-orders.index') }}" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                    ...
                    @if($selectedSo)
                        ...
                        @foreach($selectedSo->items as $i => $item)
                            ...
                            <div class="grid grid-cols-12 gap-2 items-center mb-2 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                                ...
                                <div class="col-span-6 text-sm text-slate-800 dark:text-white font-medium">{{ $item->product->name }}</div>
