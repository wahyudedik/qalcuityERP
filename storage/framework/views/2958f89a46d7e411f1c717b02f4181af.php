...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4">
        ...
        <button onclick="document.getElementById('modal-add').classList.remove('hidden')"
            class="px-4 py-2 text-sm bg-blue-600 text-white rounded-xl hover:bg-blue-700 whitespace-nowrap">+ Customer</button>
        <?php endif; ?>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e(!$c->is_active ? 'opacity-60' : ''); ?>">
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-500 dark:text-slate-400"><?php echo e($c->company ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e($c->phone ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden lg:table-cell text-gray-500 dark:text-slate-400"><?php echo e($c->email ?? '-'); ?></td>
                        ...
                        <td class="px-4 py-3 text-center hidden sm:table-cell">
                            <span class="px-2 py-0.5 rounded-full text-xs <?php echo e($c->is_active ? 'bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400' : 'bg-gray-100 text-gray-500 dark:bg-white/10 dark:text-slate-400'); ?>">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button onclick="openEdit(<?php echo e($c->id); ?>, <?php echo e(json_encode($c->name)); ?>, <?php echo e(json_encode($c->company ?? '')); ?>, <?php echo e(json_encode($c->phone ?? '')); ?>, <?php echo e(json_encode($c->email ?? '')); ?>, <?php echo e(json_encode($c->address ?? '')); ?>, <?php echo e(json_encode($c->npwp ?? '')); ?>, <?php echo e($c->credit_limit ?? 0); ?>, <?php echo e($c->is_active ? 'true' : 'false'); ?>)"
                                ...
                                <form method="POST" action="<?php echo e(route('customers.toggle', $c)); ?>">
                                    ...
                                    <button type="submit" class="p-1.5 rounded-lg text-gray-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-white/10" title="<?php echo e($c->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>">
                                        <?php if($c->is_active): ?>
            ...
            <form method="POST" action="<?php echo e(route('customers.store')); ?>" class="p-6 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="npwp" value="<?php echo e(old('npwp')); ?>" placeholder="00.000.000.0-000.000"
                            class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Credit Limit (Rp)</label>
                        <input type="number" name="credit_limit" value="<?php echo e(old('credit_limit', 0)); ?>" min="0" step="1000000"
                            class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
