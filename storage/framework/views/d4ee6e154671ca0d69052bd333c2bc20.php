...
<?php $__env->startSection('title', 'Log Eksekusi Workflow'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mt-2">Log Eksekusi</h1>
            ...
            <form method="GET" action="<?php echo e(route('automation.workflows.logs', $workflow)); ?>"
                ...
                <div>
                    ...
                    <select name="status" id="status"
                        ...
                        <option value="running" <?php echo e(request('status') === 'running' ? 'selected' : ''); ?>>Berjalan</option>
                    </select>
                </div>
                <div>
                    <label for="date_from" class="block text-sm font-medium text-gray-700">Dari
                        Tanggal</label>
                    <input type="date" name="date_from" id="date_from" value="<?php echo e(request('date_from')); ?>"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                </div>
                <div>
                    <label for="date_to" class="block text-sm font-medium text-gray-700">Sampai
                        Tanggal</label>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 cursor-pointer"
                                onclick="showLogDetails(<?php echo e($log->id); ?>)">
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($log->triggered_by); ?></td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-xs text-gray-400">
                                        <?php echo e($log->started_at->diffForHumans()); ?></div>
                                </td>
                                <td
                                ...
                                <td
                                    class="px-6 py-4 text-sm text-red-600 max-w-xs truncate hidden lg:table-cell">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-sm text-gray-500">
                                    Tidak ada log eksekusi yang sesuai filter
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Detail Eksekusi</h3>
    ...
    <script>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-500">Dipicu Oleh</label>
        ...
        ${log.error_message ? `
                <div>
                    <label class="block text-sm font-medium text-gray-500">Pesan Error</label>
        ...
        ${log.context_data ? `
                <div>
                    <label class="block text-sm font-medium text-gray-500">Data Konteks</label>
