    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div>
                    ...
                    <select id="rate-courier" class="w-full bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-blue-500">
            ...
            <button onclick="checkRate()" class="mt-4 px-4 py-2 bg-blue-600 text-gray-900 dark:text-white rounded-xl text-sm font-medium hover:bg-blue-500 transition">
                Cek Ongkir
            </button>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <input id="track-number" type="text" placeholder="Nomor resi..."
                    class="flex-1 bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-gray-900 dark:text-white placeholder-slate-600 focus:outline-none focus:border-blue-500">
                <button onclick="trackShipment()" class="px-4 py-2 bg-blue-600 text-gray-900 dark:text-white rounded-xl text-sm font-medium hover:bg-blue-500 transition">
                    Lacak
                </button>
            </div>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-white/10">
                <h2 class="font-semibold text-gray-900 dark:text-white">Daftar Pengiriman</h2>
            </div>
            ...
            <div class="px-6 py-4 border-t border-gray-200 dark:border-white/10">{{ $shipments->links() }}</div>
        </div>
    </div>
    ...
    async function checkRate() {
        ...
        el.innerHTML = '<div class="grid grid-cols-2 md:grid-cols-3 gap-2">' +
            data.map(r => `<div class="border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] rounded-xl p-3">
                <p class="font-medium text-sm text-gray-900 dark:text-white">${r.service}</p>
