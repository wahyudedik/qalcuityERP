        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">RM: {{ $patient->medical_record_number }} |
                            NIK: {{ $patient->nik ?? '-' }}</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-200">
                ...
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900 mt-1">{{ $patient->phone_primary ?? '-' }}</p>
                </div>
                <div>
                        ...
                        @foreach ($patient->visits->take(10) as $visit)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500">{{ $visit->visit_status_label ?? $visit->visit_status ?? '-' }}
                                    </p>
                                </div>
                            </div>
                        @endforeach
