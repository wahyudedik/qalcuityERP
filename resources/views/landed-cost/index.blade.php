<x-app-layout>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="{{ route('landed-cost.show', $lc) }}" class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50">Detail</a>
                                @if($lc->status !== 'posted')
        ...
        @if($landedCosts->hasPages())<div class="px-4 py-3 border-t border-gray-100">{{ $landedCosts->links() }}</div>@endif
    </div>
