...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Status Pasien</label>
                            <select name="status"
                                class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address_street" rows="3"
                                class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('address_street', $patient->address_street)); ?></textarea>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <textarea name="known_allergies" rows="2" placeholder="Contoh: Penisilin, Kacang, dll"
                                class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('known_allergies', is_array($patient->known_allergies) ? implode(', ', $patient->known_allergies) : $patient->known_allergies)); ?></textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="chronic_diseases" rows="3" placeholder="Contoh: Diabetes, Hipertensi, dll"
                                class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('chronic_diseases', is_array($patient->chronic_diseases) ? implode(', ', $patient->chronic_diseases) : $patient->chronic_diseases)); ?></textarea>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Obat yang Sedang Dikonsumsi</label>
                            <textarea name="current_medications" rows="2"
                                class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('current_medications', is_array($patient->current_medications) ? implode(', ', $patient->current_medications) : $patient->current_medications)); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Penyedia Asuransi</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">No. Polis</label>
