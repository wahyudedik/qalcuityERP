        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <form method="POST" action="{{ route('taxes.store') }}" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="rate" value="{{ old('rate') }}" placeholder="cth: 11"
                        ...
                        <div class="px-6 py-4 flex items-start gap-4">
                            <div class="flex-1">
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <span
                                        class="px-2 py-0.5 bg-white/10 text-gray-400 text-xs rounded-full font-mono">{{ $tax->code }}</span>
                                    <span
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    ...
                                    @if ($tax->account_code)
                                        &bull; Akun GL: <span class="font-mono">{{ $tax->account_code }}</span>
                                    @endif
                                </p>
                            </div>
