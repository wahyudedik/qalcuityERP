...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Izin Ekspor Aktif</p>
            <p class="text-2xl font-bold text-blue-600"><?php echo e($stats['active_permits'] ?? 0); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Sertifikat Kesehatan</p>
            <p class="text-2xl font-bold text-emerald-600"><?php echo e($stats['health_certificates'] ?? 0); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Deklarasi Bea Cukai</p>
            <p class="text-2xl font-bold text-purple-600"><?php echo e($stats['customs_declarations'] ?? 0); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Pengiriman Bulan Ini</p>
            <p class="text-2xl font-bold text-orange-600"><?php echo e($stats['shipments_this_month'] ?? 0); ?></p>
        </div>
    </div>

    
    <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10"
        ...
        <div x-show="tab === 'permits'" class="p-4">
            ...
            <?php if(empty($permits) || count($permits) === 0): ?>
                <div
                    ...
                    <p class="text-sm text-gray-500 dark:text-slate-400">Belum ada izin ekspor. Ajukan izin pertama
                        Anda.</p>
                </div>
            <?php else: ?>
                <div class="space-y-3">
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between mb-3">
                                ...
                                <div class="text-right">
                                    <p class="text-xs text-gray-500 dark:text-slate-400">Berlaku Sampai</p>
                                    <p
                                        class="text-sm font-medium <?php echo e($permit->isExpired() ? 'text-red-600' : 'text-gray-700 dark:text-slate-300'); ?>">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                <?php if($permit->destination_country): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($permit->destination_country); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($permit->commodity): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($permit->commodity); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($permit->quantity_kg): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e(number_format($permit->quantity_kg, 1)); ?>
                                ...
                                <?php if($permit->issuing_authority): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($permit->issuing_authority); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
        ...
        <div x-show="tab === 'certificates'" class="p-4">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-medium text-gray-700 dark:text-slate-300">Sertifikat Kesehatan Ikan</h3>
            ...
            <?php if(empty($certificates) || count($certificates) === 0): ?>
                <div
                    class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center">
                    <p class="text-4xl mb-3">🏥</p>
                    <p class="text-sm text-gray-500 dark:text-slate-400">Belum ada sertifikat kesehatan. Buat sertifikat
                        pertama Anda.</p>
                </div>
            <?php else: ?>
                <div class="space-y-3">
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">Issued:
                                        <?php echo e($cert->issued_date->format('d M Y')); ?></p>
                                </div>
                                <span
                                    class="text-xs px-2 py-1 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400">
                                    Valid
                                </span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                                <?php if($cert->veterinarian_name): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($cert->veterinarian_name); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($cert->species_tested): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($cert->species_tested); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($cert->test_results): ?>
                                    <div class="col-span-2 md:col-span-3">
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300"><?php echo e(Str::limit($cert->test_results, 200)); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div x-show="tab === 'customs'" class="p-4">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-medium text-gray-700 dark:text-slate-300">Deklarasi Bea Cukai</h3>
            ...
            <?php if(empty($customsDeclarations) || count($customsDeclarations) === 0): ?>
                <div
                    class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center">
                    <p class="text-4xl mb-3">🛃</p>
                    <p class="text-sm text-gray-500 dark:text-slate-400">Belum ada deklarasi bea cukai. Buat deklarasi
                        pertama Anda.</p>
                </div>
            <?php else: ?>
                <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                <?php if($declaration->hs_code): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($declaration->hs_code); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($declaration->declared_value_usd): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">$<?php echo e(number_format($declaration->declared_value_usd, 2)); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($declaration->weight_kg): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e(number_format($declaration->weight_kg, 1)); ?>
                                ...
                                <?php if($declaration->country_of_origin): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($declaration->country_of_origin); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div x-show="tab === 'shipments'" class="p-4">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-sm font-medium text-gray-700 dark:text-slate-300">Pengiriman Ekspor</h3>
            ...
            <?php if(empty($shipments) || count($shipments) === 0): ?>
                <div
                    class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center">
                    <p class="text-4xl mb-3">🚢</p>
                    <p class="text-sm text-gray-500 dark:text-slate-400">Belum ada pengiriman ekspor. Buat pengiriman
                        pertama Anda.</p>
                </div>
            <?php else: ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $shipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div
                            ...
                            <div class="flex items-start justify-between mb-3">
                                ...
                                <div class="text-right">
                                    <p class="text-xs text-gray-500 dark:text-slate-400">Estimasi Tiba</p>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                <?php if($shipment->carrier): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($shipment->carrier); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($shipment->tracking_number): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e($shipment->tracking_number); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($shipment->total_weight_kg): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium"><?php echo e(number_format($shipment->total_weight_kg, 1)); ?>
                                ...
                                <?php if($shipment->declared_value_usd): ?>
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">$<?php echo e(number_format($shipment->declared_value_usd, 2)); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <div
            ...
            <form method="POST" action="<?php echo e(route('fisheries.export.store-permit')); ?>" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Tipe Izin
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Negara Tujuan
                            *</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Komoditas
                            *</label>
                        <input type="text" name="commodity" required placeholder="Frozen Shrimp"
                            class="<?php echo e($cls); ?>">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Kuantitas (kg)
                            *</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Tanggal Berlaku
                            *</label>
                        <input type="date" name="valid_from" required class="<?php echo e($cls); ?>">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Kadaluarsa
                            *</label>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Otoritas
                        Penerbit</label>
