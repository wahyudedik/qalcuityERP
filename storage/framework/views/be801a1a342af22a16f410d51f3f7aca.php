...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('bulk-payments.index')); ?>" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                ...
                <div id="invoiceList" class="space-y-2">
                    <?php if($pendingInvoices->isNotEmpty()): ?>
                        ...
                        <div class="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-mono font-medium text-slate-800 dark:text-white"><?php echo e($inv->number); ?></p>
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-sm font-medium text-slate-800 dark:text-white">Rp <?php echo e(number_format($inv->remaining_amount, 0, ',', '.')); ?></p>
                            </div>
                            <div class="w-36">
