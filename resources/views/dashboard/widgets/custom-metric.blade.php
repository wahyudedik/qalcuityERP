...
<div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5 h-full flex flex-col">
    <div class="flex items-start justify-between mb-3">
        <p class="text-xs font-medium text-gray-500 dark:text-slate-400 leading-tight pr-2">{{ $title }}</p>
        @if ($canEdit && $customId)
    ...
    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-auto">{{ $display }}</p>
