                        ...
                        <div
                            ...
                            <div class="space-y-3">
                                <div
                                    ...
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white"><?php echo e($reservation->room->number); ?></span>
                                </div>
                                <div
                                    class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-slate-700">
                                    <span class="text-sm text-gray-600 dark:text-slate-400">Floor</span>
                                    <span
                                        class="font-semibold text-gray-900 dark:text-white"><?php echo e($reservation->room->floor); ?></span>
                                </div>
                                <div
                                    class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-slate-700">
                        ...
                        <div
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-gray-900 dark:text-white"><?php echo e($reservation->guest->name); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Check-in</span>
                                    <span
                                        class="text-gray-900 dark:text-white"><?php echo e($reservation->check_in_date->format('d M Y')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Check-out</span>
                                    <span
                                        class="text-gray-900 dark:text-white"><?php echo e($reservation->check_out_date->format('d M Y')); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-slate-400">Remaining</span>
                                    <span
                                        class="font-semibold text-blue-600 dark:text-blue-400"><?php echo e(now()->diffInDays($reservation->check_out_date)); ?>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-slate-400"><?php echo e($availableRooms->count()); ?>
                                                            ...
                                                            <div class="space-y-1 text-sm">
                                                                ...
                                                                <?php if($rateDiff != 0): ?>
                                                                    <div class="flex justify-between">
                                                                        ...
                                                                        <span
                                                                            class="font-medium <?php echo e($rateDiff > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-blue-600 dark:text-blue-400'); ?>">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            class="font-semibold <?php echo e($totalDiff > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-blue-600 dark:text-blue-400'); ?>">
