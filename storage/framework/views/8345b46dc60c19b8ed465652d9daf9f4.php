...
<?php $component->withAttributes([]); ?>
    ...
    <div x-data="syncLogs()" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Sync Logs</h1>
                <p class="text-sm text-gray-500">View channel synchronization history</p>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <span
                                        class="font-medium text-gray-900"><?php echo e($channelInfo[$log->channel] ?? ucfirst($log->channel)); ?></span>
                                </td>
    ...
    <div x-show="showModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50"
        ...
        <div class="bg-white rounded-2xl w-full max-w-2xl shadow-xl max-h-[90vh] overflow-hidden"
            @click.stop>
            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                <div x-show="selectedLog.request_data" class="mb-4">
                    <h4 class="text-xs font-medium text-gray-500 uppercase mb-2">Request Data</h4>
                    <pre class="bg-gray-50 p-4 rounded-xl text-xs overflow-x-auto text-gray-900"><code x-text="formatJson(selectedLog.request_data)"></code></pre>
                </div>
                <div x-show="selectedLog.response_data">
                    <h4 class="text-xs font-medium text-gray-500 uppercase mb-2">Response Data</h4>
                    <pre class="bg-gray-50 p-4 rounded-xl text-xs overflow-x-auto text-gray-900"><code x-text="formatJson(selectedLog.response_data)"></code></pre>
                </div>
            </div>
        </div>
    </div>
