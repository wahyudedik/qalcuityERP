                            ...
                            <div class="flex items-start justify-between mb-3">
                                <div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-xs px-2 py-0.5 rounded-full bg-{{ $color }}-100 text-{{ $color }}-700 dark:bg-{{ $color }}-500/20 dark:text-{{ $color }}-400">
                                ...
                                <div class="text-right">
                                    ...
                                    <p
                                        class="text-sm font-medium {{ $permit->isExpired() ? 'text-red-600' : 'text-gray-700 dark:text-slate-300' }}">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                @if ($permit->destination_country)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $permit->destination_country }}</span>
                                    </div>
                                @endif
                                @if ($permit->commodity)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $permit->commodity }}</span>
                                    </div>
                                @endif
                                @if ($permit->quantity_kg)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ number_format($permit->quantity_kg, 1) }}
                                            kg</span>
                                    </div>
                                @endif
                                @if ($permit->issuing_authority)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $permit->issuing_authority }}</span>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
                                @if ($cert->veterinarian_name)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $cert->veterinarian_name }}</span>
                                    </div>
                                @endif
                                @if ($cert->species_tested)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $cert->species_tested }}</span>
                                    </div>
                                @endif
                                @if ($cert->test_results)
                                    <div class="col-span-2 md:col-span-3">
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300">{{ Str::limit($cert->test_results, 200) }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                @if ($declaration->hs_code)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $declaration->hs_code }}</span>
                                    </div>
                                @endif
                                @if ($declaration->declared_value_usd)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">${{ number_format($declaration->declared_value_usd, 2) }}</span>
                                    </div>
                                @endif
                                @if ($declaration->weight_kg)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ number_format($declaration->weight_kg, 1) }}
                                            kg</span>
                                    </div>
                                @endif
                                @if ($declaration->country_of_origin)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $declaration->country_of_origin }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                @if ($shipment->carrier)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $shipment->carrier }}</span>
                                    </div>
                                @endif
                                @if ($shipment->tracking_number)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ $shipment->tracking_number }}</span>
                                    </div>
                                @endif
                                @if ($shipment->total_weight_kg)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">{{ number_format($shipment->total_weight_kg, 1) }}
                                            kg</span>
                                    </div>
                                @endif
                                @if ($shipment->declared_value_usd)
                                    <div>
                                        ...
                                        <span
                                            class="text-gray-700 dark:text-slate-300 font-medium">${{ number_format($shipment->declared_value_usd, 2) }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
