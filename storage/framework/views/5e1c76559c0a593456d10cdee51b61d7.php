...
<?php $__env->startSection('title', 'Material Deliveries'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex space-x-3">
                <a href="<?php echo e(route('construction.deliveries.delayed-report')); ?>"
                    class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700">
                    Delayed Report
                </a>
                <a href="<?php echo e(route('construction.deliveries.create')); ?>"
        ...
        <?php if($summary): ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
                    ...
                    <div class="text-2xl font-bold text-blue-700"><?php echo e($summary['total_deliveries']); ?></div>
                </div>
                <div class="bg-white rounded-lg shadow p-4 border-l-4 border-green-500">
                    <div class="text-sm text-gray-600">On-Time</div>
                    <div class="text-2xl font-bold text-green-700"><?php echo e($summary['on_time_deliveries']); ?></div>
                </div>
                <div class="bg-white rounded-lg shadow p-4 border-l-4 border-red-500">
                    <div class="text-sm text-gray-600">Delayed</div>
                    <div class="text-2xl font-bold text-red-700"><?php echo e($summary['delayed_deliveries']); ?></div>
                </div>
                <div class="bg-white rounded-lg shadow p-4 border-l-4 border-yellow-500">
                    <div class="text-sm text-gray-600">Pending</div>
                    <div class="text-2xl font-bold text-yellow-700"><?php echo e($summary['pending_deliveries']); ?></div>
                </div>
                <div class="bg-white rounded-lg shadow p-4 border-l-4 border-purple-500">
                    <div class="text-sm text-gray-600">Total Value</div>
                    <div class="text-xl font-bold text-purple-700">Rp
                        <?php echo e(number_format($summary['total_value'], 0, ',', '.')); ?></div>
                </div>
            </div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <?php $__currentLoopData = $summary['by_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-4 py-2 bg-gray-100 rounded-lg">
                                <span class="font-medium capitalize"><?php echo e(str_replace('_', ' ', $status)); ?></span>
                                <span class="text-gray-600 ml-2"><?php echo e($count); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $recentDeliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-4 whitespace-nowrap text-sm font-medium">
                                        <?php echo e($delivery->delivery_number); ?></td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($delivery->material_name); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($delivery->supplier_name); ?></div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center text-sm">
                                        <?php echo e($delivery->quantity_delivered); ?>/<?php echo e($delivery->quantity_ordered); ?>

                                        <?php echo e($delivery->unit); ?>

                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center text-sm">
                                        <?php echo e($delivery->expected_date?->format('d M Y')); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center text-sm">
                                        <?php echo e($delivery->actual_delivery_date?->format('d M Y H:i') ?? '-'); ?></td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center">
                                        ...
                                        <?php elseif($delivery->delivery_status === 'in_transit'): ?>
                                            <span
                                                ...
                                                Transit</span>
                                        <?php elseif($delivery->delivery_status === 'partial'): ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Partial</span>
                                        <?php else: ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 capitalize"><?php echo e(str_replace('_', ' ', $delivery->delivery_status)); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap text-center">
                                        <?php if($delivery->quality_check_status === 'passed'): ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Passed</span>
                                        <?php elseif($delivery->quality_check_status === 'failed'): ?>
                                            <span
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <a href="<?php echo e(route('construction.deliveries.show', $delivery)); ?>"
                ...
                <?php if($recentDeliveries instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                    <div class="px-6 py-4 border-t border-gray-200">
                        <?php echo e($recentDeliveries->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\construction\deliveries\index.blade.php ENDPATH**/ ?>