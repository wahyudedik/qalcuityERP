...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('hotel.reports.daily-operations') }}"
            ...
            <!-- Revenue Report -->
            <a href="{{ route('hotel.reports.revenue') }}"
            ...
            <!-- Occupancy Analytics -->
            <a href="{{ route('hotel.reports.occupancy') }}"
            ...
            <!-- Guest Analytics -->
            <a href="{{ route('hotel.reports.guest-analytics') }}"
            ...
            <!-- Staff Performance -->
            <a href="{{ route('hotel.reports.staff-performance') }}"
