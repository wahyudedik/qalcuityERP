        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600"><?php echo e(__('Detail paket internet')); ?></p>
                </div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm mt-1"><?php echo e(ucfirst($package->billing_cycle ?? 'monthly')); ?></p>
                                </div>
                                <?php if($package->is_active): ?>
                                    <span class="px-2 py-1 text-xs bg-green-500 rounded-full"><?php echo e(__('Aktif')); ?></span>
                                <?php else: ?>
                                    <span class="px-2 py-1 text-xs bg-gray-500 rounded-full"><?php echo e(__('Nonaktif')); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="mt-4">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-gray-900"><?php echo e($package->download_speed_mbps); ?> Mbps</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 text-sm"><?php echo e(__('Upload')); ?></span>
                                <span class="font-bold text-gray-900"><?php echo e($package->upload_speed_mbps); ?> Mbps</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600 text-sm"><?php echo e(__('Kuota')); ?></span>
                                <span class="font-bold text-gray-900">
                                    <?php if($package->isUnlimited()): ?>
                                        <span class="text-blue-600">∞ <?php echo e(__('Unlimited')); ?></span>
                                    <?php else: ?>
                            ...
                            <?php if($package->installation_fee > 0): ?>
                                <div class="flex justify-between">
                                    <span class="text-gray-600 text-sm"><?php echo e(__('Biaya Pasang')); ?></span>
                                    <span class="font-bold text-gray-900">Rp <?php echo e(number_format($package->installation_fee, 0, ',', '.')); ?></span>
                                </div>
                            <?php endif; ?>
                            <?php if($package->description): ?>
                                <div class="pt-4 border-t border-gray-200">
                                    <p class="text-sm text-gray-600"><?php echo e($package->description); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Pelanggan')); ?></th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Status')); ?></th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Mulai')); ?></th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('Aksi')); ?></th>
                                    </tr>
                                </thead>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $package->subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($sub->customer?->name ?? '-'); ?></div>
                                                <div class="text-xs text-gray-500"><?php echo e($sub->customer?->email ?? ''); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                                    <?php echo e($sub->status === 'active' ? 'bg-green-100 text-green-800' : ($sub->status === 'suspended' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
