    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e($workOrder->number); ?></h2>
                    <p class="text-sm text-gray-500"><?php echo e($workOrder->product->name); ?></p>
                </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e(number_format($workOrder->target_quantity, 0, ',', '.')); ?> <?php echo e($workOrder->unit); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e($workOrder->yieldRate() ?? '-'); ?>%</p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Biaya Material</p>
                    <p class="font-semibold text-gray-900">Rp <?php echo e(number_format($workOrder->material_cost, 0, ',', '.')); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Biaya Tenaga Kerja</p>
                    <p class="font-semibold text-gray-900">Rp <?php echo e(number_format($workOrder->labor_cost, 0, ',', '.')); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Overhead</p>
                    <p class="font-semibold text-gray-900">Rp <?php echo e(number_format($workOrder->overhead_cost, 0, ',', '.')); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Total Biaya</p>
                    <p class="font-semibold text-gray-900">Rp <?php echo e(number_format($workOrder->total_cost, 0, ',', '.')); ?></p>
                </div>
            </div>

            <?php if($workOrder->recipe): ?>
            <div class="mt-4 pt-4 border-t border-gray-100">
                <p class="text-xs font-medium text-gray-500 mb-2">Resep: <?php echo e($workOrder->recipe->name); ?> (batch <?php echo e($workOrder->recipe->batch_size); ?> <?php echo e($workOrder->recipe->batch_unit); ?>)</p>
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
                <p class="text-xs text-gray-500">
                    ...
                    <span class="ml-2 px-1.5 py-0.5 rounded text-xs <?php echo e($workOrder->journalEntry->status === 'posted' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'); ?>"><?php echo e($workOrder->journalEntry->status); ?></span>
                </p>
            </div>
            <?php endif; ?>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        ?>
                        <tr>
                            <td class="px-4 py-3 text-center font-mono text-xs text-gray-900"><?php echo e($op->sequence); ?></td>
                            <td class="px-4 py-3 text-gray-900"><?php echo e($op->name); ?></td>
                            <td class="px-4 py-3 text-gray-500"><?php echo e($op->workCenter->name ?? '-'); ?></td>
                            <td class="px-4 py-3 text-right text-gray-900"><?php echo e($op->estimated_hours); ?></td>
                            <td class="px-4 py-3 text-right text-gray-900"><?php echo e($op->actual_hours ?? '-'); ?></td>
                            <td class="px-4 py-3 text-center">
                                <span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($oc); ?>-100 text-<?php echo e($oc); ?>-700 $oc }}-500/20 $oc }}-400">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($out->created_at->format('d M Y H:i')); ?></td>
                            ...
                            <td class="px-4 py-3 text-right text-gray-900"><?php echo e($out->output_qty + 0); ?></td>
                            <td class="px-4 py-3 hidden sm:table-cell text-xs text-gray-500"><?php echo e($out->reject_reason ?? '-'); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
