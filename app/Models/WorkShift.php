...
class WorkShift extends Model
{
    ...
    public function schedules(): HasMany { return $this->hasMany(ShiftSchedule::class); }
    ...
    public function workMinutes(): int
    {
        ...
        if ($this->crosses_midnight) $end += 1440;
    ...
    public function calcOvertime(string $checkIn, string $checkOut): int
    {
        ...
        if ($this->crosses_midnight && $actualEnd < $scheduledEnd) $actualEnd += 1440;
