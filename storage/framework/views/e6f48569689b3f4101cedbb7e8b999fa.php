...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-gray-500 font-mono text-xs"><?php echo e($s->tracking_number ?? '—'); ?></td>
                            <td class="px-6 py-3 text-gray-700"><?php echo e($s->destination); ?></td>
                            <td class="px-6 py-3 text-right text-gray-500 hidden sm:table-cell"><?php echo e($s->weight); ?> kg</td>
                            ...
                            <td class="px-6 py-3 text-gray-400 hidden md:table-cell"><?php echo e($s->estimated_delivery?->format('d M Y') ?? '—'); ?></td>
                        </tr>
            ...
            <div class="px-6 py-4 border-t border-gray-200"><?php echo e($shipments->links()); ?></div>
        </div>
    </div>
