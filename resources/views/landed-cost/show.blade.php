        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @endphp
                    <span
                        class="px-3 py-1 rounded-full text-sm font-medium bg-{{ $sc }}-100 text-{{ $sc }}-700 dark:bg-{{ $sc }}-500/20 dark:text-{{ $sc }}-400">{{ $sl }}</span>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white">{{ $landedCost->date->format('d/m/Y') }}</p>
                </div>
                <div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        @foreach ($landedCost->allocations as $alloc)
                            <tr>
                                <td class="px-4 py-3 text-gray-900 dark:text-white">{{ $alloc->product->name ?? '-' }}
                                </td>
