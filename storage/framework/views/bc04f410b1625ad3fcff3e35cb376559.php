...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('New Triage Assessment')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('healthcare.triage.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                                    ...
                                    <select name="patient_visit_id" id="patient_visit_id" required
                                        ...
                                        <?php $__currentLoopData = $visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($visit->id); ?>"
                                                <?php echo e(old('patient_visit_id') == $visit->id ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <textarea name="chief_complaint" id="chief_complaint" required rows="3"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Describe the main reason for visit..."><?php echo e(old('chief_complaint')); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="priority_level" id="priority_level" required
                                    ...
                                    <option value="critical"
                                        <?php echo e(old('priority_level') === 'critical' ? 'selected' : ''); ?>>T1 - RED (Critical
                                        - Immediate)</option>
                                    <option value="emergency"
                                        <?php echo e(old('priority_level') === 'emergency' ? 'selected' : ''); ?>>T2 - ORANGE
                                    ...
                                    <option value="semi_urgent"
                                        <?php echo e(old('priority_level') === 'semi_urgent' ? 'selected' : ''); ?>>T4 - GREEN
                                        (Semi-Urgent - < 120 min)</option>
                                    <option value="non_urgent"
                                        <?php echo e(old('priority_level') === 'non_urgent' ? 'selected' : ''); ?>>T5 - BLUE
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div>
                                        ...
                                        <input type="number" name="blood_pressure_systolic"
                                            ...
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('blood_pressure_systolic')); ?>" placeholder="120">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="blood_pressure_diastolic"
                                            ...
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('blood_pressure_diastolic')); ?>" placeholder="80">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="heart_rate" id="heart_rate"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('heart_rate')); ?>" placeholder="72">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="temperature" id="temperature" step="0.1"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('temperature')); ?>" placeholder="36.5">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="respiratory_rate" id="respiratory_rate"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('respiratory_rate')); ?>" placeholder="16">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="oxygen_saturation" id="oxygen_saturation"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('oxygen_saturation')); ?>" placeholder="98">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="pain_score" id="pain_score" min="0"
                                            max="10"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('pain_score')); ?>" placeholder="0">
                                    </div>
                                    <div>
                                        ...
                                        <input type="number" name="gcs" id="gcs" min="3"
                                            max="15"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            value="<?php echo e(old('gcs')); ?>" placeholder="15">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="notes" id="notes" rows="3"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Any additional observations..."><?php echo e(old('notes')); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="assessment_time" id="assessment_time"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    value="<?php echo e(old('assessment_time', now()->format('Y-m-d\TH:i'))); ?>">
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\triage\create.blade.php ENDPATH**/ ?>