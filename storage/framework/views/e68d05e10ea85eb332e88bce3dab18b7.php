...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <span>⚓ Trip Detail - <?php echo e($trip->trip_number); ?></span>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($trip->trip_number); ?></h2>
                    <?php
                        $statusColors = [
                            'planned' => 'gray',
                            'departed' => 'blue',
        ...
        <?php if($trip->notes): ?>
            <div class="mt-4 pt-4 border-t border-gray-100 dark:border-white/5">
                <p class="text-sm text-gray-600 dark:text-slate-400"><?php echo e($trip->notes); ?></p>
            </div>
        <?php endif; ?>
    </div>
                        ...
                        <?php $__currentLoopData = $catches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-[#0f172a] transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($catch->grade): ?>
                                        <span
                                            class="px-2 py-1 text-xs rounded-full bg-<?php echo e($catch->grade->color ?? 'purple'); ?>-100 text-<?php echo e($catch->grade->color ?? 'purple'); ?>-700 dark:bg-<?php echo e($catch->grade->color ?? 'purple'); ?>-500/20 dark:text-<?php echo e($catch->grade->color ?? 'purple'); ?>-400">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                <?php $__currentLoopData = $trip->crew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="px-3 py-2 bg-gray-50 dark:bg-[#0f172a] rounded-lg">
                        ...
                        <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e(ucfirst($member->role ?? 'crew')); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
