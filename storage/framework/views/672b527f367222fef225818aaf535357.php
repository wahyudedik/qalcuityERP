...
<?php
// TASK 6.6: Modal dengan close X/backdrop/Escape, tidak overflow di mobile
$maxWidth = [
    'sm' => 'sm:max-w-sm',
    'md' => 'sm:max-w-md',
    'lg' => 'sm:max-w-lg',
...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white dark:bg-slate-800 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto max-h-[90vh] flex flex-col"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\components\modal.blade.php ENDPATH**/ ?>