...
<?php $__env->startSection('title', 'AI Optimization Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        async function fetchStats() {
            try {
                const response = await fetch('<?php echo e(route('chat.stats')); ?>');
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\ai\optimization-dashboard.blade.php ENDPATH**/ ?>