    ...
    <div class="h-screen flex flex-col" style="height: calc(100vh - 64px);">
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">{{ __('Network Maps') }}</h1>
                    <p class="text-xs text-gray-600">{{ $stats['devices_with_location'] }}
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2 text-sm">
                    <span class="flex items-center gap-1">
                        ...
                        <span class="text-gray-600">{{ __('Online') }}</span>
                    </span>
                    <span class="flex items-center gap-1">
                        <span class="w-3 h-3 rounded-full bg-red-500"></span>
                        <span class="text-gray-600">{{ __('Offline') }}</span>
                    </span>
                    <span class="flex items-center gap-1">
                        <span class="w-3 h-3 rounded-full bg-yellow-500"></span>
                        <span class="text-gray-600">{{ __('Maintenance') }}</span>
                    </span>
                </div>
            ...
            <div class="flex-1 relative">
                ...
                <div id="mapLoading"
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 font-medium">{{ __('Loading map...') }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        const popupContent = `
                            <div class="p-2" style="min-width: 250px;">
                                ...
                                <div class="space-y-1 text-sm">
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">{{ __('IP') }}:</span>
                                    ...
                                    ${device.location ? `
                                            ...
                                            ` : ''}
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">{{ __('Subscriptions') }}:</span>
                                        <span class="font-semibold">${device.subscriptions_count}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">{{ __('Users') }}:</span>
                                        <span class="font-semibold">${device.hotspot_users_count}</span>
                                    </div>
                                    ${device.last_seen_at ? `
                                                <div class="flex justify-between">
                                                    <span class="text-gray-600">{{ __('Last Seen') }}:</span>
