                ...
                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                        ...
                        <div class="flex-shrink-0">
                            <div class="w-20 h-20 bg-blue-100 rounded-xl flex flex-col items-center justify-center">
    ...
    @push('scripts')
        <script>
            async function cancelAppointment(id) {
                const confirmed = await Dialog.danger('Are you sure you want to cancel this appointment?');
                if (!confirmed) return;
