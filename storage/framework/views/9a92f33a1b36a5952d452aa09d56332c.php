        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['total_bookings']); ?></p>
                </div>
                <div
                                        ...
                                        <td class="px-6 py-4">
                                            <?php if($booking->departure_date): ?>
                                                <?php if($booking->departure_date->isPast()): ?>
                                                    <span
                                                        class="text-gray-500"><?php echo e($booking->departure_date->format('d M Y')); ?></span>
                                                <?php elseif($booking->departure_date->diffInDays(now()) <= 7): ?>
                                                    <span
                                                        class="text-orange-600 font-medium"><?php echo e($booking->departure_date->format('d M Y')); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="text-gray-700"><?php echo e($booking->departure_date->format('d M Y')); ?></span>
                                                <?php endif; ?>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex gap-2">
                                                ...
                                                <?php if($booking->status === 'pending'): ?>
                                                    <form
                                                        action="<?php echo e(route('tour-travel.bookings.confirm', $booking)); ?>"
                                                ...
                                                <?php if($booking->status === 'confirmed' || $booking->status === 'paid'): ?>
                                                    <form
                                                        action="<?php echo e(route('tour-travel.bookings.complete', $booking)); ?>"
                                                        method="POST" class="inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit"
