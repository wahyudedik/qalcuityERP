    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2 text-3xl font-bold text-red-600">{{ number_format($stats['avg_mortality_rate'], 2) }}%</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Avg FCR</div>
                <div class="mt-2 text-3xl font-bold text-blue-600">{{ number_format($stats['avg_fcr'], 2) }}</div>
            </div>
        </div>
                        ...
                        @forelse($performances as $perf)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if ($perf->health_status === 'healthy') bg-green-100 text-green-800
                                    @elseif($perf->health_status === 'sick') bg-red-100 text-red-800
