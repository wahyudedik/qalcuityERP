...
class Contract extends Model
{
    ...
    public function signedByUser(): BelongsTo { return $this->belongsTo(User::class, 'signed_by'); }
    public function billings(): HasMany { return $this->hasMany(ContractBilling::class); }
    public function slaLogs(): HasMany { return $this->hasMany(ContractSlaLog::class); }
