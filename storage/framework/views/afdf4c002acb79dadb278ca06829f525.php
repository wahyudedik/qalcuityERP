...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6 flex items-center gap-4">
        <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
            <span class="text-blue-600 font-bold text-lg"><?php echo e(strtoupper(substr($employee->name, 0, 1))); ?></span>
        </div>
        <div>
            <p class="font-semibold text-gray-900"><?php echo e($employee->name); ?></p>
            <p class="text-sm text-gray-500"><?php echo e($employee->position ?? '-'); ?> <?php echo e($employee->department ? '· '.$employee->department : ''); ?></p>
        </div>
        <div class="ml-auto text-right hidden sm:block">
            <p class="text-xs text-gray-400">NIK</p>
            <p class="text-sm font-medium text-gray-700"><?php echo e($employee->employee_id ?? '-'); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="<?php echo e(route('payroll.slip.show', $item)); ?>"
            ...
            <div class="flex items-start justify-between mb-4">
                <div>
                    <p class="text-xs text-gray-400 uppercase tracking-wide"><?php echo e($yr); ?></p>
                    <p class="text-lg font-bold text-gray-900 capitalize"><?php echo e($monthName ?: $period); ?></p>
                </div>
            ...
            <div class="space-y-1.5 text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-700">Rp <?php echo e(number_format($item->base_salary, 0, ',', '.')); ?></span>
                </div>
                <?php if($item->overtime_pay > 0): ?>
                <div class="flex justify-between">
                    <span class="text-gray-500">Lembur</span>
                    <span class="text-green-600">+Rp <?php echo e(number_format($item->overtime_pay, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                ...
                <div class="flex justify-between">
                    ...
                    <span class="text-red-500">-Rp <?php echo e(number_format($totalDeduct, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                <div class="flex justify-between pt-2 border-t border-gray-100 font-semibold">
                    <span class="text-gray-900">Take Home Pay</span>
                    <span class="text-blue-600">Rp <?php echo e(number_format($item->net_salary, 0, ',', '.')); ?></span>
                </div>
            </div>
