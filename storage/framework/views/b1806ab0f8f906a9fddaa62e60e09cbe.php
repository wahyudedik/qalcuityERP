    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('Customer Usage Portal')); ?></h1>
                    <p class="text-gray-600 mt-1"><?php echo e(__('Monitor & manage customer internet usage')); ?>
                                ...
                                <?php $__currentLoopData = $customer->telecomSubscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div
                                                    ...
                                                    <span
                                                        class="text-blue-600 font-bold"><?php echo e(substr($customer->name, 0, 1)); ?></span>
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <?php if($subscription->package->quota_bytes): ?>
                                                ...
                                                <div class="w-32">
                                                    <div class="flex justify-between text-xs mb-1">
                                                        <span
                                                            class="text-gray-900"><?php echo e(round($used / 1073741824, 2)); ?>

                                                            GB</span>
                                                        <span
                                                            class="text-gray-900"><?php echo e(round($total / 1073741824, 2)); ?>
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="text-xs text-gray-500"><?php echo e(__('Unlimited')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            <a href="<?php echo e(route('telecom.customers.show-usage', $customer)); ?>"
                                                class="text-blue-600 hover:text-blue-900"><?php echo e(__('View Details')); ?></a>
                                            ...
                                            <?php elseif($subscription->status === 'suspended'): ?>
                                                <form action="<?php echo e(route('telecom.customers.reactivate', $customer)); ?>"
                                                    ...
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit"
                                                        class="text-green-600 hover:text-green-900"><?php echo e(__('Reactivate')); ?></button>
                                                </form>
                                            <?php endif; ?>
