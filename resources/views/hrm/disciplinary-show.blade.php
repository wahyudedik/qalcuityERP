            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('hrm.disciplinary.show', $h) }}"
                        ...
                        <div class="min-w-0">
                            <p class="text-xs text-gray-700 truncate">{{ $h->violation_type }}</p>
                            <p class="text-xs text-gray-400">{{ $h->issued_date->format('d M Y') }}</p>
                        </div>
                    </a>
                    @endforeach
                </div>
        ...
        <div class="flex-1 min-w-0">
            <div id="print-area" class="bg-white rounded-2xl border border-gray-200 p-8 print:shadow-none print:border-none print:rounded-none print:p-6">
                ...
                <div class="text-center border-b-2 border-gray-800 pb-4 mb-6 print:border-gray-800">
                    ...
                    <p class="text-2xl font-black text-gray-900 mt-1">{{ $letter->levelLabel() }}</p>
                    <p class="text-sm text-gray-500 mt-1">No: {{ $letter->letter_number }}</p>
                </div>
                ...
                <div class="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-200">
                    ...
                    <p class="text-sm text-gray-700 whitespace-pre-line">{{ $letter->employee_response }}</p>
                </div>
                @endif
