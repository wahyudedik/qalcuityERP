...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Input Diagnosa - <?php echo e($visit->patient->full_name ?? 'Pasien'); ?> <?php $__env->endSlot(); ?>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-white/80">RM: <?php echo e($visit->patient->medical_record_number ?? '-'); ?> |
                        <?php echo e($visit->chief_complaint ?? 'Tidak ada keluhan'); ?></p>
                </div>
            </div>
        </div>

        <form action="<?php echo e(route('healthcare.emr.diagnoses.store', $visit)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\emr\diagnose.blade.php ENDPATH**/ ?>