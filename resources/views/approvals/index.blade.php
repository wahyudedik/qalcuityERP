                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-6 py-3 text-gray-500 dark:text-slate-400 hidden sm:table-cell">{{ $req->requester?->name }}</td>
                            <td class="px-6 py-3 text-gray-500 dark:text-slate-400 hidden md:table-cell">{{ $req->approver?->name ?? '-' }}</td>
                            <td class="px-6 py-3">
                                <span class="px-2 py-0.5 rounded-full text-xs font-medium
                            ...
                            <td class="px-6 py-3 text-gray-400 dark:text-slate-500 hidden sm:table-cell">{{ $req->responded_at?->format('d M Y H:i') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
