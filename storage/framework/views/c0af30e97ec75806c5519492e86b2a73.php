    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('Konsumen Teratas')); ?></h1>
                    <p class="mt-1 text-sm text-gray-600"><?php echo e(__('Identifikasi konsumen bandwidth tertinggi')); ?></p>
                </div>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-4 mb-6">
                <form method="GET" action="<?php echo e(route('telecom.reports.top-consumers')); ?>" class="flex flex-wrap gap-4 items-end">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('Metrik')); ?></label>
                        <select name="metric" class="rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('Jumlah')); ?></label>
                        <select name="limit" class="rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('Peringkat Konsumen Bandwidth')); ?></h2>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $report['consumers'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $consumer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-bold text-gray-500"><?php echo e($index + 1); ?></td>
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($consumer['customer_name'] ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($consumer['package_name'] ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-blue-600"><?php echo e(number_format(($consumer['total_download'] ?? 0) / 1073741824, 2)); ?> GB</td>
                                    <td class="px-6 py-4 text-sm text-green-600"><?php echo e(number_format(($consumer['total_upload'] ?? 0) / 1073741824, 2)); ?> GB</td>
                                    <td class="px-6 py-4 text-sm font-bold text-gray-900"><?php echo e(number_format((($consumer['total_download'] ?? 0) + ($consumer['total_upload'] ?? 0)) / 1073741824, 2)); ?> GB</td>
                                </tr>
