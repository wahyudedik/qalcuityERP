...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            ...
            <span><?php echo e($guest->name); ?> - Preferences</span>
            <?php
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <?php if(session('success')): ?>
            <div
                ...
                <p class="text-green-800 dark:text-green-200 text-sm"><?php echo e(session('success')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($guest->name); ?></h2>
                        <p class="text-sm text-gray-500 dark:text-slate-400"><?php echo e($guest->email ?? 'No email provided'); ?>

                        </p>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="text-xs text-gray-500 dark:text-slate-400">Loyalty Points:</span>
                            <span
                                class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e(number_format($guest->loyalty_points ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-start justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5">
                            <div class="flex-1">
                                <div class="flex items-center gap-2">
                                    <span
                                        class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e(ucwords(str_replace('_', ' ', $preference->preference_key))); ?></span>
