...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-3 gap-3 mb-4">
        <div class="bg-white rounded-2xl border border-gray-200 p-4 text-center">
            ...
            <p class="text-xs text-gray-500 mt-0.5">Total Customer</p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-4 text-center">
    ...
    <div
        class="hidden md:block bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 <?php echo e(!$c->is_active ? 'opacity-60' : ''); ?>">
                            <td class="px-4 py-3">
                                <p class="font-medium text-gray-900"><?php echo e($c->name); ?></p>
                                <?php if($c->npwp): ?>
                                    <p class="text-xs text-gray-400">NPWP: <?php echo e($c->npwp); ?></p>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="px-4 py-3 hidden lg:table-cell text-right text-gray-500">
                                <?php echo e($c->credit_limit ? 'Rp ' . number_format($c->credit_limit, 0, ',', '.') : '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-center hidden sm:table-cell">
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs <?php echo e($c->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                ...
                <div class="px-4 py-3 border-b border-gray-100 bg-gray-50">
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex-1 min-w-0">
                            <h3 class="text-base font-semibold text-gray-900 truncate"><?php echo e($c->name); ?></h3>
                            <?php if($c->company): ?>
                                <p class="text-sm text-gray-500 mt-0.5 truncate"><?php echo e($c->company); ?></p>
                            <?php endif; ?>
                        </div>
                        <span class="px-2.5 py-1 rounded-full text-xs font-medium whitespace-nowrap <?php echo e($c->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
                            <?php echo e($c->is_active ? 'Aktif' : 'Nonaktif'); ?>
                ...
                <div class="px-4 py-3 space-y-2.5">
                    ...
                    <div class="flex justify-between gap-3">
                        <span class="text-sm text-gray-500 shrink-0">NPWP</span>
                        <span class="text-sm text-gray-900 text-right"><?php echo e($c->npwp); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="flex justify-between gap-3">
                        <span class="text-sm text-gray-500 shrink-0">Telepon</span>
                        <?php if($c->phone): ?>
                            <a href="tel:<?php echo e($c->phone); ?>" class="text-sm text-gray-900 text-right hover:text-blue-600"><?php echo e($c->phone); ?></a>
                        <?php else: ?>
                    ...
                    <div class="flex justify-between gap-3">
                        ...
                        <?php if($c->email): ?>
                            <a href="mailto:<?php echo e($c->email); ?>" class="text-sm text-gray-900 text-right break-all hover:text-blue-600"><?php echo e($c->email); ?></a>
                        <?php else: ?>
                            <span class="text-sm text-gray-400">-</span>
                        <?php endif; ?>
                    </div>
                    <div class="flex justify-between gap-3">
                        <span class="text-sm text-gray-500 shrink-0">Credit Limit</span>
                    ...
                    <div class="flex justify-between gap-3">
                        ...
                        <span class="text-sm text-gray-900 text-right"><?php echo e($c->address); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <form method="POST" action="<?php echo e(route('customers.store')); ?>" class="p-6 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-600 mb-1">Nama <span
                    ...
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-600 mb-1">Credit Limit
                            (Rp)</label>
                        <input type="number" name="credit_limit" value="<?php echo e(old('credit_limit', 0)); ?>"
                            min="0" step="1000000"
                            class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p class="text-xs text-gray-400 mt-1">Isi 0 untuk tanpa batas kredit</p>
                    </div>
                </div>
            ...
            <form id="form-edit" method="POST" class="p-6 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-2 pt-4">
                        ...
                        <label for="e-active" class="text-sm text-gray-700">Customer Aktif</label>
                    </div>
                </div>
                <div class="flex justify-end gap-3 pt-2">
