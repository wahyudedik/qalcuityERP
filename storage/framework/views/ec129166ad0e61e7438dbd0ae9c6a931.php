        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <form method="POST" action="<?php echo e(route('taxes.store')); ?>" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="rate" value="<?php echo e(old('rate')); ?>" placeholder="cth: 11" step="0.01" min="0" max="100"
                        class="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-indigo-500" required>
                </div>
                    ...
                    <div class="px-6 py-4 flex items-start gap-4">
                        <div class="flex-1">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <span class="px-2 py-0.5 bg-white/10 text-gray-400 text-xs rounded-full font-mono"><?php echo e($tax->code); ?></span>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                ...
                                <?php if($tax->account_code): ?> &bull; Akun GL: <span class="font-mono"><?php echo e($tax->account_code); ?></span> <?php endif; ?>
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            ...
                            <form method="POST" action="<?php echo e(route('taxes.update', $tax)); ?>">
                                ...
                                <input type="hidden" name="is_withholding" value="<?php echo e($tax->is_withholding ? '1' : '0'); ?>">
                                <input type="hidden" name="account_code" value="<?php echo e($tax->account_code); ?>">
                                <input type="hidden" name="is_active" value="<?php echo e($tax->is_active ? '0' : '1'); ?>">
                                <button type="submit"
                            ...
                            <form method="POST" action="<?php echo e(route('taxes.destroy', $tax)); ?>" onsubmit="return confirm('Hapus tarif pajak <?php echo e($tax->name); ?>?')">
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\settings\taxes.blade.php ENDPATH**/ ?>