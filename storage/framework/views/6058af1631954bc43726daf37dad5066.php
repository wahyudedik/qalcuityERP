...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            CRM Pipeline
            <a href="<?php echo e(route('crm.index')); ?>" class="text-xs text-gray-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400">Tampilan Tabel →</a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Total Pipeline</p>
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1"><?php echo e($stageStats->sum('count')); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Nilai Pipeline</p>
            <p class="text-lg font-bold text-gray-900 dark:text-white mt-1">Rp <?php echo e(number_format($stageStats->sum('total_value')/1000000,1)); ?>jt</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Won Bulan Ini</p>
            <p class="text-lg font-bold text-green-600 dark:text-green-400 mt-1">Rp <?php echo e(number_format($wonThisMonth/1000000,1)); ?>jt</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
    ...
    <div class="flex items-center justify-between mb-4">
        <p class="text-sm text-gray-500 dark:text-slate-400">Drag kartu untuk pindah stage</p>
    ...
    <div class="overflow-x-auto pb-4">
        <div class="flex gap-4 min-w-max">
            ...
            <div class="w-64 flex flex-col"
                ...
                <div class="flex items-center justify-between px-3 py-2 rounded-xl bg-<?php echo e($sc); ?>-50 dark:bg-<?php echo e($sc); ?>-500/10 border border-<?php echo e($sc); ?>-200 dark:border-<?php echo e($sc); ?>-500/20 mb-3">
                    <div>
                        <p class="text-sm font-semibold text-<?php echo e($sc); ?>-700 dark:text-<?php echo e($sc); ?>-400"><?php echo e($stageLabels[$stage]); ?></p>
                        <?php if($stageTotal > 0): ?>
                        <p class="text-xs text-<?php echo e($sc); ?>-600 dark:text-<?php echo e($sc); ?>-500">Rp <?php echo e(number_format($stageTotal/1000000,1)); ?>jt</p>
                        <?php endif; ?>
                    </div>
                    <span class="w-6 h-6 flex items-center justify-center rounded-full bg-<?php echo e($sc); ?>-100 dark:bg-<?php echo e($sc); ?>-500/20 text-xs font-bold text-<?php echo e($sc); ?>-700 dark:text-<?php echo e($sc); ?>-400">
                ...
                <div class="flex flex-col gap-2 min-h-[200px]" id="col-<?php echo e($stage); ?>">
                    ...
                    <div class="lead-card bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-3 cursor-grab active:cursor-grabbing shadow-sm hover:shadow-md transition"
                         draggable="true"
                         data-id="<?php echo e($lead->id); ?>"
                         ondragstart="dragStart(event, <?php echo e($lead->id); ?>)">
                        <div class="flex items-start justify-between gap-1 mb-2">
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($lead->name); ?></p>
                                <?php if($lead->company): ?>
                                <p class="text-xs text-gray-500 dark:text-slate-400 truncate"><?php echo e($lead->company); ?></p>
                                <?php endif; ?>
                            </div>
                            <span class="shrink-0 text-xs font-medium text-<?php echo e($sc); ?>-600 dark:text-<?php echo e($sc); ?>-400"><?php echo e($lead->probability); ?>%</span>
                        </div>
                        <?php if($lead->estimated_value > 0): ?>
                        <p class="text-xs font-semibold text-blue-600 dark:text-blue-400 mb-1">Rp <?php echo e(number_format($lead->estimated_value,0,',','.')); ?></p>
                        <?php endif; ?>
                        <div class="flex items-center justify-between mt-2">
                            <span class="text-xs text-gray-400 dark:text-slate-500"><?php echo e($lead->last_contact_at?->diffForHumans() ?? 'Belum dihubungi'); ?></span>
                            <div class="flex gap-1">
                                <span id="kb-score-<?php echo e($lead->id); ?>" class="text-xs px-1.5 py-0.5 rounded-full bg-gray-100 dark:bg-white/10 text-gray-400 dark:text-slate-500"></span>
                                ...
                                <form method="POST" action="<?php echo e(route('crm.destroy', $lead)); ?>" onsubmit="return confirm('Hapus lead?')">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="p-1 rounded text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10">
            ...
            <div class="w-48 flex flex-col">
                ...
                <div class="flex flex-col gap-2 min-h-[100px]" id="col-<?php echo e($stage); ?>"
                    ...
                    <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 px-3 py-2 text-xs">
                        <p class="font-medium text-gray-900 dark:text-white truncate"><?php echo e($lead->name); ?></p>
                        <?php if($lead->estimated_value > 0): ?>
                        <p class="text-<?php echo e($sc); ?>-600 dark:text-<?php echo e($sc); ?>-400">Rp <?php echo e(number_format($lead->estimated_value/1000000,1)); ?>jt</p>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($stageLeads->count() > 5): ?>
                    <p class="text-xs text-center text-gray-400 dark:text-slate-500">+<?php echo e($stageLeads->count()-5); ?> lainnya</p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
