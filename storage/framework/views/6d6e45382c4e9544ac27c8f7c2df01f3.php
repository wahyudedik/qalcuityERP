...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Struktur Organisasi — Qalcuity ERP <?php $__env->endSlot(); ?>
    ...
    <script>
    const employees = <?php echo json_encode($nodes, 15, 512) ?>;
    ...
    function onEmployeeChange() {
        ...
        // Update form action
        document.getElementById('form-manager').action = '<?php echo e(url("hrm")); ?>/' + empId + '/manager';
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/hrm/orgchart.blade.php ENDPATH**/ ?>