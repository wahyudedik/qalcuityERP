...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Quality Control Dashboard <?php $__env->endSlot(); ?>
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $open_capas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div
                            ...
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($capa->defect_code); ?></p>
                            <p class="text-xs text-gray-600 mt-1"><?php echo e($capa->product?->name); ?></p>
