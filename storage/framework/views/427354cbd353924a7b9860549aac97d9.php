...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-2xl">
        ...
        <form method="POST" action="<?php echo e(route('writeoffs.store')); ?>" class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6 space-y-5">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="type" value="<?php echo e($type); ?>">

            <div class="p-3 rounded-xl <?php echo e($type === 'receivable' ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400' : 'bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-400'); ?> text-sm font-medium">
            ...
            <div class="flex justify-end gap-3 pt-2">
                <a href="<?php echo e(route('writeoffs.index')); ?>" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300">Batal</a>
