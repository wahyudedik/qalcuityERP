...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5 mb-6">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
                ...
                <p class="font-mono text-sm font-medium text-gray-900 dark:text-white mt-0.5"><?php echo e($asset->asset_code); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-500 dark:text-slate-400">Harga Perolehan</p>
                <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5">Rp <?php echo e(number_format($asset->purchase_price, 0, ',', '.')); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-500 dark:text-slate-400">Nilai Buku Saat Ini</p>
                <p class="text-sm font-medium text-blue-600 dark:text-blue-400 mt-0.5">Rp <?php echo e(number_format($asset->current_value, 0, ',', '.')); ?></p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5"><?php echo e($asset->purchase_date->format('d M Y')); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-500 dark:text-slate-400">Umur Ekonomis</p>
                <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5"><?php echo e($asset->useful_life_years); ?> tahun</p>
            </div>
            <div>
                <p class="text-xs text-gray-500 dark:text-slate-400">Depresiasi/Bulan</p>
                <p class="text-sm font-medium text-gray-900 dark:text-white mt-0.5">Rp <?php echo e(number_format($asset->monthlyDepreciation(), 0, ',', '.')); ?></p>
            </div>
            <div>
                ...
                <span class="inline-block mt-0.5 px-2 py-0.5 rounded-full text-xs bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 dark:bg-<?php echo e($sc); ?>-500/20 dark:text-<?php echo e($sc); ?>-400">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div>
            <h2 class="text-sm font-semibold text-gray-900 dark:text-white mb-3">Riwayat Depresiasi (<?php echo e($depreciations->count()); ?> periode)</h2>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                <td class="px-4 py-2.5 font-mono text-xs text-gray-700 dark:text-slate-300"><?php echo e($dep->period); ?></td>
                ...
                <div class="overflow-x-auto max-h-96 overflow-y-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                <td class="px-4 py-2.5 font-mono text-xs text-gray-500 dark:text-slate-400"><?php echo e($proj['period']); ?></td>
    ...
    <div class="mt-4">
        <a href="<?php echo e(route('assets.index')); ?>" class="text-sm text-gray-500 dark:text-slate-400 hover:text-blue-500">← Kembali ke Daftar Aset</a>
    </div>
