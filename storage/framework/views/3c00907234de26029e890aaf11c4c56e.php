                ...
                <div class="w-72 flex-shrink-0">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="px-2 py-0.5 text-xs font-medium bg-amber-200 dark:bg-amber-500/20 text-amber-800 dark:text-amber-300 rounded-full"><?php echo e($board['pending']->count()); ?></span>
                        </div>
                    </div>
                    <div
                ...
                <div class="w-72 flex-shrink-0">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="px-2 py-0.5 text-xs font-medium bg-blue-200 dark:bg-blue-500/20 text-blue-800 dark:text-blue-300 rounded-full"><?php echo e($board['in_progress']->count()); ?></span>
                        </div>
                    </div>
                    <div
                ...
                <div class="w-72 flex-shrink-0">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="px-2 py-0.5 text-xs font-medium bg-green-200 dark:bg-green-500/20 text-green-800 dark:text-green-300 rounded-full"><?php echo e($board['completed']->count()); ?></span>
                        </div>
                    </div>
                    <div
                ...
                <div class="w-72 flex-shrink-0">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="px-2 py-0.5 text-xs font-medium bg-gray-200 dark:bg-white/10 text-gray-700 dark:text-slate-300 rounded-full"><?php echo e($board['inspected']->count()); ?></span>
                        </div>
                    </div>
                    <div
