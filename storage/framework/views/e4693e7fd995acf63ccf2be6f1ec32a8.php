...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Laporan HPP (COGS) <?php $__env->endSlot(); ?>

    
    <div class="flex flex-wrap items-center justify-end gap-2 mb-4">
        <a href="<?php echo e(route('inventory.costing.valuation')); ?>" class="text-xs text-gray-500 hover:text-blue-500">← Valuasi Stok</a>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e(count($report['rows'])); ?></p>
            </div>
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-right text-gray-900"><?php echo e(number_format($row['qty_sold'], 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 text-right text-gray-700">Rp <?php echo e(number_format($row['avg_unit_cost'], 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 text-right font-semibold text-red-600">Rp <?php echo e(number_format($row['total_cogs'], 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 hidden md:table-cell">
                                <div class="flex items-center gap-2">
                                    <div class="flex-1 bg-gray-100 rounded-full h-1.5">
                                        <div class="bg-red-400 h-1.5 rounded-full" style="width: <?php echo e(min(100, $pct)); ?>%"></div>
                                    </div>
                                    <span class="text-xs text-gray-500 w-10 text-right"><?php echo e(number_format($pct, 1)); ?>%</span>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tfoot class="bg-gray-50 font-semibold text-sm">
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right text-red-600">Rp <?php echo e(number_format($report['total_cogs'], 0, ',', '.')); ?></td>
