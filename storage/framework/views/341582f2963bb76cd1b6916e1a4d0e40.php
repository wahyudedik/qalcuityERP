...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <a href="<?php echo e(route('consignment.index')); ?>" class="px-3 py-2 text-sm text-gray-500 hover:text-gray-700">← Konsinyasi</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-gray-900"><?php echo e($p->name); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-500 text-xs"><?php echo e($p->contact_person ?? '-'); ?> · <?php echo e($p->phone ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-900"><?php echo e($p->commission_pct); ?>%</td>
                        <td class="px-4 py-3 text-center text-gray-700"><?php echo e($p->shipments_count); ?></td>
        ...
        <?php if($partners->hasPages()): ?><div class="px-4 py-3 border-t border-gray-100"><?php echo e($partners->links()); ?></div><?php endif; ?>
    </div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            ...
            <form method="POST" action="<?php echo e(route('consignment.partners.store')); ?>" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2"><label class="block text-xs font-medium text-gray-600 mb-1">Nama Toko/Outlet *</label><input type="text" name="name" required class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Kontak</label><input type="text" name="contact_person" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Telepon</label><input type="text" name="phone" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Email</label><input type="email" name="email" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Komisi (%)</label><input type="number" name="commission_pct" min="0" max="100" step="0.01" value="10" class="<?php echo e($cls); ?>"></div>
                    <div class="col-span-2"><label class="block text-xs font-medium text-gray-600 mb-1">Alamat</label><input type="text" name="address" class="<?php echo e($cls); ?>"></div>
                </div>
