    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <dd class="mt-1 text-lg font-semibold text-gray-900 capitalize">{{ $workflow->trigger_type }}</dd>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $workflow->execution_count }}</dd>
            </div>
        </div>
        ...
        <div class="bg-white shadow sm:rounded-lg mb-8">
            <div class="px-4 py-5 sm:p-6 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Actions ({{ $actions->count() }})</h3>
                            ...
                            <div class="flex-1">
                                ...
                                @if ($action->condition)
                                    <p class="mt-1 text-xs text-gray-500">
                                        Condition: {{ $action->condition['field'] ?? '' }}
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-red-600">{{ Str::limit($log->error_message, 50) }}</td>
                            </tr>
                        @empty
                            <tr>
