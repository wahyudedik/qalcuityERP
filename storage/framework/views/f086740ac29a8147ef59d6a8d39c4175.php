    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(__('Internet Packages')); ?></h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e(__('Kelola paket internet dan pricing')); ?></p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Total Packages')); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Active')); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Inactive')); ?></p>
                            <p class="text-2xl font-bold text-red-600 dark:text-red-400"><?php echo e($stats['inactive']); ?></p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Unlimited')); ?></p>
                            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($stats['unlimited']); ?>
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <?php if($package->is_active): ?>
                                    <span
                                        class="px-2 py-1 text-xs bg-green-500 dark:bg-green-600 rounded-full"><?php echo e(__('Active')); ?></span>
                                <?php else: ?>
                                    <span
                                        class="px-2 py-1 text-xs bg-gray-500 dark:bg-gray-600 rounded-full"><?php echo e(__('Inactive')); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span
                                        class="font-bold text-gray-900 dark:text-white"><?php echo e($package->download_speed_mbps); ?>
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span
                                        class="font-bold text-gray-900 dark:text-white"><?php echo e($package->upload_speed_mbps); ?>
                            ...
                            <div class="mb-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600 dark:text-gray-400 text-sm"><?php echo e(__('Quota')); ?></span>
                            ...
                            <div class="mb-4">
                                <div class="flex items-baseline gap-1">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-400 text-sm">/<?php echo e(__('bulan')); ?></span>
                                </div>
                                <?php if($package->setup_fee > 0): ?>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e(__('Setup fee')); ?>: Rp
                            ...
                            <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
                                <span
                                    class="font-semibold text-gray-900 dark:text-white"><?php echo e($package->subscriptions_count); ?></span>
                            ...
                            <div class="flex gap-2">
                                ...
                                <form action="<?php echo e(route('telecom.packages.toggle-status', $package)); ?>" method="POST"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="w-full <?php echo e($package->is_active ? 'bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700' : 'bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700'); ?> text-white px-4 py-2 rounded-lg text-sm">
