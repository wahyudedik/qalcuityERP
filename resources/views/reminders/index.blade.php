    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <div class="divide-y divide-gray-100 dark:divide-white/5">
                ...
                <div class="px-6 py-4 flex flex-col sm:flex-row sm:items-center gap-4 {{ $isOverdue ? 'bg-amber-50 dark:bg-amber-500/5' : '' }}">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-900 dark:text-white text-sm {{ $reminder->status === 'done' ? 'line-through opacity-60' : '' }}">
                            {{ $reminder->title }}
                        </p>
                        @if($reminder->notes)
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">{{ $reminder->notes }}</p>
                        @endif
                        <div class="flex items-center gap-3 mt-1">
                            <span class="text-xs {{ $isOverdue ? 'text-amber-500 font-medium' : 'text-gray-400 dark:text-slate-500' }}">
