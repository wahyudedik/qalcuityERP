    ...
    <div class="min-h-screen bg-gray-950 pb-36">
        ...
        <div class="sticky top-0 z-20 bg-gray-900/95 backdrop-blur border-b border-white/10">
            <div class="px-4 py-3 flex items-center gap-3">
                <a href="<?php echo e(route('mobile.opname')); ?>"
                ...
                <div class="flex-1 min-w-0">
                    <h1 class="text-base font-bold text-white truncate"><?php echo e($s->number); ?></h1>
                    <p class="text-xs text-slate-400"><?php echo e($s->warehouse->name ?? '-'); ?> ·
                ...
                ?>
                <span
                    class="flex-shrink-0 px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($hbg); ?>"><?php echo e($hlbl); ?></span>
            </div>
            ...
            <div class="px-4 pb-3">
                <div class="flex justify-between text-xs mb-1.5">
                    ...
                    <span class="font-bold <?php echo e($progressPct === 100 ? 'text-emerald-400' : 'text-white'); ?>">
                        <?php echo e($countedItems); ?> / <?php echo e($totalItems); ?> item &nbsp;·&nbsp; <?php echo e($progressPct); ?>%
                    </span>
                </div>
                <div class="w-full h-3 bg-white/5 rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-all duration-700
                    <?php echo e($progressPct === 100 ? 'bg-emerald-500' : 'bg-blue-500'); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.barcode-scanner','data' => ['onScan' => 'onOpnameScan','buttonLabel' => 'Buka Kamera Scan','buttonClass' => 'w-full justify-center h-14 text-base rounded-2xl','inputPlaceholder' => 'Ketik SKU atau barcode produk...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['on-scan' => 'onOpnameScan','button-label' => 'Buka Kamera Scan','button-class' => 'w-full justify-center h-14 text-base rounded-2xl','input-placeholder' => 'Ketik SKU atau barcode produk...']); ?>
...
<?php endif; ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="item-card bg-[#1e293b] rounded-2xl border <?php echo e($cardBorder); ?> p-4 transition-all duration-200"
                    data-sku="<?php echo e($sku); ?>" data-barcode="<?php echo e($barcode); ?>"
                    data-counted="<?php echo e($isCounted ? 'true' : 'false'); ?>"
                    data-mismatch="<?php echo e($isMismatch ? 'true' : 'false'); ?>" x-data="{ qty: <?php echo e($initialQty); ?> }">

                    
                    <div class="flex items-start justify-between gap-2 mb-2">
                        <div class="flex-1 min-w-0">
                            <p class="text-base font-semibold text-white leading-snug"><?php echo e($productName); ?></p>
                            <div class="flex items-center flex-wrap gap-x-3 gap-y-0.5 mt-1">
                                <?php if($sku): ?>
                                    <span class="text-xs text-slate-400 font-mono">SKU: <?php echo e($sku); ?></span>
                                <?php endif; ?>
                                <span class="text-xs text-slate-400">Bin: <span
                                        class="font-mono text-slate-300"><?php echo e($binCode); ?></span></span>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between bg-white/5 rounded-xl px-3 py-2 mb-3">
                        ...
                        <span class="text-sm font-bold text-white"><?php echo e(number_format($systemQty, 0)); ?></span>
                        <?php if($diff !== null): ?>
                            <span
                                class="text-xs font-semibold ml-2 <?php echo e($diff > 0 ? 'text-green-400' : ($diff < 0 ? 'text-red-400' : 'text-gray-400')); ?>">
                    ...
                    <?php if(!$isCompleted): ?>
                        ...
                        <form method="POST" action="<?php echo e(route('mobile.opname.update', $item)); ?>"
                    ...
                    <?php else: ?>
                        ...
                        <div class="bg-white/5 rounded-xl px-3 py-3 text-center">
                            ...
                            <p
                                class="text-2xl font-bold <?php echo e($isMatch ? 'text-emerald-400' : ($isMismatch ? 'text-red-400' : 'text-slate-400')); ?>">
                                <?php echo e($actualQty !== null ? number_format($actualQty, 0) : '—'); ?>
    ...
    <?php if(!$isCompleted): ?>
        <div
            ...
            <form method="POST" action="<?php echo e(route('mobile.opname.complete', $s)); ?>"
                ...
                <button type="submit"
                    ...
                    Selesaikan Opname
                    <span class="text-sm font-normal opacity-75">(<?php echo e($progressPct); ?>% selesai)</span>
                </button>
            </form>
        </div>
    <?php else: ?>
    ...
    <?php echo $__env->make('mobile.partials.opname-batch-ui', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\mobile\opname-show.blade.php ENDPATH**/ ?>