    ...
    <form method="POST" action="{{ route('price-lists.store') }}" class="space-y-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="2" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                ...
                <label class="flex items-center gap-2 p-2 rounded-lg border border-gray-200 dark:border-white/10 cursor-pointer hover:bg-gray-50 dark:hover:bg-white/5">
                    ...
                    <span class="text-sm text-gray-700 dark:text-slate-300 truncate">{{ $c->name }}</span>
                </label>
                @endforeach
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('price-lists.index') }}" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300">Batal</a>
