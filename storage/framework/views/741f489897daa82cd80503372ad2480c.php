     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Telemedicine Consultations')); ?>

            </h2>
            <a href="<?php echo e(route('healthcare.telemedicine.create')); ?>"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $consultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consultation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e($consultation->consultation_id); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        <?php echo e($consultation->patient->name ?? 'N/A'); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($consultation->doctor->name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800"><?php echo e(ucfirst($consultation->consultation_type)); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($consultation->scheduled_at ? $consultation->scheduled_at->format('d/m/Y H:i') : '-'); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="<?php echo e(route('healthcare.telemedicine.show', $consultation)); ?>"
                                        class="text-blue-600 hover:text-blue-900 mr-3">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <?php if($consultation->status === 'scheduled'): ?>
                                        <a href="<?php echo e(route('healthcare.telemedicine.join', $consultation)); ?>"
                                            class="text-green-600 hover:text-green-900 mr-3" title="Join Call">
                                            <i class="fas fa-video"></i>
                                        </a>
                                    <?php endif; ?>
                                    <button onclick="deleteConsultation(<?php echo e($consultation->id); ?>)"
                                        class="text-red-600 hover:text-red-900">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <form id="delete-consultation-<?php echo e($consultation->id); ?>"
                                        action="<?php echo e(route('healthcare.telemedicine.destroy', $consultation)); ?>"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\telemedicine\index.blade.php ENDPATH**/ ?>