...
<body>
    ...
    <p>By accessing or using {{ config('app.name') }}, you agree to be bound by these Terms of Service and all applicable laws and regulations.</p>

    <h2>2. Use License</h2>
    <p>Permission is granted to temporarily use {{ config('app.name') }} for personal or business purposes. This is the grant of a license, not a transfer of title.</p>

    <h2>3. Subscription and Payment</h2>
    <p>Access to {{ config('app.name') }} requires a subscription. All fees are non-refundable unless otherwise stated in your subscription agreement.</p>
