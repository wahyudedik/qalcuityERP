...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Total Konsultasi</p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1"><?php echo e($statistics['scheduled'] ?? 0); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Berlangsung</p>
            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1"><?php echo e($statistics['in_progress'] ?? 0); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 dark:text-slate-400">Dokter:
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-300">
                            ...
                            <span><?php echo e($consultation->scheduled_at ? \Carbon\Carbon::parse($consultation->scheduled_at)->format('d M Y H:i') : '-'); ?></span>
                        </div>
                        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-300">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span><?php echo e($consultation->complaint ?? 'Konsultasi Umum'); ?></span>
                        </div>
                        <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-300">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center gap-2">
                        <?php if(
                            $consultation->status === 'in_progress' ||
                                ($consultation->status === 'scheduled' && \Carbon\Carbon::parse($consultation->scheduled_at)->isPast())): ?>
                        ...
                        <a href="<?php echo e(route('healthcare.telemedicine.consultations.show', $consultation)); ?>"
                            class="px-4 py-2.5 text-sm border border-gray-300 dark:border-white/10 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5">
                            Detail
                        </a>
                    </div>
                </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div
                class="col-span-full bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center">
                ...
                <p class="text-gray-500 dark:text-slate-400">Belum ada konsultasi</p>
            </div>
        <?php endif; ?>
    </div>
