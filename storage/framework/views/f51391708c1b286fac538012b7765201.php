...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500 mb-1">Trial</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500 mb-1">Past Due</p>
            <p class="text-2xl font-bold text-red-500"><?php echo e($stats['past_due']); ?></p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500 mb-1">Jatuh Tempo Hari Ini</p>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('subscription-billing.plans')); ?>"
                class="px-3 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Plans</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-gray-700"><?php echo e($s->customer->name ?? '-'); ?>
                            ...
                            <td
                                class="px-4 py-3 text-center hidden md:table-cell text-xs <?php echo e($s->next_billing_date->isPast() ? 'text-red-500 font-semibold' : 'text-gray-500'); ?>">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-1">
                                    <a href="<?php echo e(route('subscription-billing.show', $s)); ?>"
                                        class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600">Detail</a>
        ...
        <?php if($subscriptions->hasPages()): ?>
            <div class="px-4 py-3 border-t border-gray-100"><?php echo e($subscriptions->links()); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div id="modal-add" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Buat Subscription</h3>
            ...
            <form method="POST" action="<?php echo e(route('subscription-billing.store')); ?>" class="p-6 space-y-4">
                ...
                <div><label class="block text-xs font-medium text-gray-600 mb-1">Plan *</label>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Mulai
                            *</label><input type="date" name="start_date" required value="<?php echo e(date('Y-m-d')); ?>"
                            class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Diskon
                            (%)</label><input type="number" name="discount_pct" min="0" max="100"
                            step="0.01" value="0" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Harga
                    ...
                    <div class="flex items-end"><label class="flex items-center gap-2 cursor-pointer"><input
                                ...
                                class="text-sm text-gray-700">Auto Renew</span></label></div>
                </div>
