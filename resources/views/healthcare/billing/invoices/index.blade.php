<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-4 mb-6">
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($statistics['total_invoices']) }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Belum Bayar</p>
            <p class="text-2xl font-bold text-red-600 mt-1">{{ $statistics['unpaid_invoices'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Sebagian</p>
            <p class="text-2xl font-bold text-amber-600 mt-1">{{ $statistics['partial_invoices'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Lunas Hari Ini</p>
            <p class="text-2xl font-bold text-green-600 mt-1">{{ $statistics['paid_today'] }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($invoices ?? [] as $invoice)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <span
                                    class="font-mono text-sm font-bold text-blue-600">{{ $invoice->invoice_number ?? '-' }}</span>
                            </td>
                            <td class="px-4 py-3">
