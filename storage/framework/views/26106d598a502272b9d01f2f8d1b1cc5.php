    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e($stats['active_batches']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Total Compost</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e(number_format($stats['total_compost_kg'])); ?> kg</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Avg Quality Score</div>
                <div class="mt-2 text-3xl font-bold text-purple-600"><?php echo e(number_format($stats['avg_quality_score'], 1)); ?>/10</div>
            </div>
        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e($batch->batch_code); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($batch->start_date->format('d M Y')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($batch->initial_weight_kg)); ?> kg</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    <?php if($batch->status === 'active'): ?> bg-blue-100 text-blue-800
                                    <?php elseif($batch->status === 'curing'): ?> bg-yellow-100 text-yellow-800
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($batch->quality_score ? number_format($batch->quality_score, 1) . '/10' : 'N/A'); ?></td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\livestock\waste\composting.blade.php ENDPATH**/ ?>