<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('suppliers.index') }}" class="px-3 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Supplier</a>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 font-mono text-xs font-medium text-gray-900">{{ $po->number }}</td>
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-700">{{ $po->supplier->name ?? '-' }}</td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500">{{ $po->warehouse->name ?? '-' }}</td>
                        <td class="px-4 py-3 text-right font-medium text-gray-900">Rp {{ number_format($po->total,0,',','.') }}</td>
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell text-xs text-gray-500">{{ $po->date->format('d M Y') }}</td>
                        <td class="px-4 py-3 text-center">
