...
<?php $__env->startSection('title', 'Setup ' . $integration->name); ?>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-white shadow">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Setup <?php echo e($integration->name); ?></h1>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <form action="<?php echo e(route('integrations.update', $integration)); ?>" method="POST" class="p-6 space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name"
                                    value="<?php echo e(old('name', $integration->name)); ?>"
                            ...
                            <div>
                                ...
                                <select name="sync_frequency" id="sync_frequency"
                                    ...
                                    <option value="realtime"
                                        <?php echo e($integration->sync_frequency === 'realtime' ? 'selected' : ''); ?>>Real-time (every
                                        5 minutes)</option>
                                    <option value="hourly"
                                        <?php echo e($integration->sync_frequency === 'hourly' ? 'selected' : ''); ?>>Hourly</option>
                                    <option value="daily" <?php echo e($integration->sync_frequency === 'daily' ? 'selected' : ''); ?>>
                                        Daily</option>
                                    <option value="weekly"
                                        <?php echo e($integration->sync_frequency === 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($integration->slug === 'shopify'): ?>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="shop_domain" id="shop_domain"
                                        value="<?php echo e(old('shop_domain', $integration->getConfigValue('shop_domain'))); ?>"
                    ...
                    <?php if($integration->slug === 'woocommerce'): ?>
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="url" name="store_url" id="store_url"
                                        value="<?php echo e(old('store_url', $integration->getConfigValue('store_url'))); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="password" name="consumer_key" id="consumer_key"
                                        value="<?php echo e(old('consumer_key', $integration->getConfigValue('consumer_key'))); ?>"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="consumer_secret" id="consumer_secret"
                                        value="<?php echo e(old('consumer_secret')); ?>"
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="mt-1 text-sm text-yellow-700">
                                                ...
                                                <code
                                                    class="bg-yellow-100 px-1 rounded"><?php echo e(config('app.url')); ?>/api/integrations/webhooks/woocommerce</code>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php if(!in_array($integration->slug, ['shopify', 'woocommerce'])): ?>
                        <div class="border-t border-gray-200 pt-6">
            ...
            <div class="mt-8 bg-white shadow rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <?php elseif($integration->slug === 'woocommerce'): ?>
                        <div class="space-y-4">
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <span
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\integrations\setup.blade.php ENDPATH**/ ?>