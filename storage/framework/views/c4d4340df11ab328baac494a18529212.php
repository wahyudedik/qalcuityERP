    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1"><?php echo e(number_format($stats['total'])); ?>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Critical (24h)</p>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Not Notified</p>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 max-w-md">
                                    ...
                                    <?php if($errorLog->isRepeated()): ?>
                                        <span
                                            class="text-xs text-yellow-600">(<?php echo e($errorLog->occurrence_count); ?>x)</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php else: ?>
                                        <span class="text-xs text-orange-600">Unresolved</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="<?php echo e(route('admin.error-logs.show', $errorLog)); ?>"
                                        class="text-blue-600 hover:text-blue-900 min-h-[44px] min-w-[44px] inline-flex items-center justify-center">
                                        View Details
                                    </a>
                                </td>
                            </tr>
