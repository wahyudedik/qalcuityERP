...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="px-4 py-3 flex items-center space-x-3 touch-target active:bg-gray-50">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="font-medium text-gray-900 truncate">Invoice
                                #INV-<?php echo e(str_pad($i, 4, '0', STR_PAD_LEFT)); ?></p>
                            <p class="text-sm text-gray-600">Rp <?php echo e(number_format(rand(100000, 5000000), 0, ',', '.')); ?></p>
                        </div>
                        <span class="text-xs text-gray-500"><?php echo e($i); ?> jam lalu</span>
                    </div>
    ...
    <nav class="bottom-nav">
        <a href="<?php echo e(route('dashboard')); ?>" class="bottom-nav-item active">
        ...
        <a href="<?php echo e(route('pos.index')); ?>" class="bottom-nav-item">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
        ...
        <a href="<?php echo e(route('inventory.index')); ?>" class="bottom-nav-item">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
        ...
        <a href="<?php echo e(route('reports.index')); ?>" class="bottom-nav-item">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/mobile-gestures.js')); ?>"></script>
    <script src="<?php echo e(asset('js/camera-scanner.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\mobile\optimized-dashboard.blade.php ENDPATH**/ ?>