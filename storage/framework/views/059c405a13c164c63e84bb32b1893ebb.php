...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($statistics['today']); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Terjadwal</p>
            <p class="text-2xl font-bold text-purple-600 mt-1"><?php echo e($statistics['scheduled']); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Selesai</p>
            <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($statistics['completed']); ?></p>
        </div>
    </div>
