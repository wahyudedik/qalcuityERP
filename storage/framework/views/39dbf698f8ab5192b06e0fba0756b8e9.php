...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800"><?php echo e($device->name); ?></h1>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-2xl font-bold text-gray-900"><?php echo e($status['today_scans'] ?? 0); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-gray-900 font-medium"><?php echo e($device->device_id); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-600">Vendor</label>
                    <p class="text-gray-900 font-medium"><?php echo e(ucfirst($device->vendor)); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-600">Model</label>
                    <p class="text-gray-900 font-medium"><?php echo e($device->model ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-600">Protokol</label>
                    <p class="text-gray-900 font-medium"><?php echo e(strtoupper($device->protocol)); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-600">IP Address</label>
                    <p class="text-gray-900 font-medium"><?php echo e($device->ip_address ?? '-'); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-600">Port</label>
                    <p class="text-gray-900 font-medium"><?php echo e($device->port); ?></p>
                </div>
                <div>
            ...
            <?php if($device->notes): ?>
                <div class="mt-4 pt-4 border-t border-gray-200">
                    ...
                    <p class="text-gray-900 mt-1"><?php echo e($device->notes); ?></p>
                </div>
            <?php endif; ?>
        </div>
