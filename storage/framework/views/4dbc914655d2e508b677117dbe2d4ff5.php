...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between mb-5">
        <a href="<?php echo e(route('projects.show', $project)); ?>" class="text-sm text-blue-500 hover:text-blue-600">← Kembali ke
            Proyek</a>
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('projects.rab.export', $project)); ?>"
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-lg font-bold text-blue-600 dark:text-blue-400">Rp
                <?php echo e(number_format($summary['total_rab'], 0, ',', '.')); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Realisasi</p>
            <p
                class="text-lg font-bold <?php echo e($summary['total_actual'] > $summary['total_rab'] ? 'text-red-500' : 'text-emerald-600 dark:text-emerald-400'); ?>">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p
                class="text-lg font-bold <?php echo e($variance < 0 ? 'text-red-500' : 'text-emerald-600 dark:text-emerald-400'); ?>">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($summary['item_count']); ?> <span
            ...
            <div class="flex flex-wrap gap-3">
                <?php $__currentLoopData = $byCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 dark:bg-white/5 text-xs">
                        <span
                            class="font-medium text-gray-700 dark:text-slate-300 capitalize"><?php echo e($cat->cat); ?></span>
                    ...
                    <?php if($tree->isNotEmpty()): ?>
                        <tr class="bg-gray-50 dark:bg-white/5 font-bold">
                            ...
                            <td class="px-4 py-3 text-right text-blue-600 dark:text-blue-400">Rp
                                <?php echo e(number_format($summary['total_rab'], 0, ',', '.')); ?></td>
                            <td
                                class="px-4 py-3 text-right <?php echo e($summary['total_actual'] > $summary['total_rab'] ? 'text-red-500' : 'text-emerald-600 dark:text-emerald-400'); ?>">
                                Rp <?php echo e(number_format($summary['total_actual'], 0, ',', '.')); ?>
                    ...
                    <select name="parent_id"
                        ...
                        <?php $__currentLoopData = \App\Models\RabItem::where('project_id', $project->id)->where('type', 'group')->orderBy('sort_order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($g->id); ?>">
                                <?php echo e($g->code ? $g->code . ' — ' : ''); ?><?php echo e($g->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div id="item-fields">
    ...
    <div id="importModal"
        ...
        <div
            ...
            <form method="POST" action="<?php echo e(route('projects.rab.import', $project)); ?>" enctype="multipart/form-data"
                class="space-y-4">
                <?php echo csrf_field(); ?>
