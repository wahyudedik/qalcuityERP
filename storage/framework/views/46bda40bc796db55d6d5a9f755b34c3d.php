...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        <a href="<?php echo e(route('contracts.index')); ?>" class="px-3 py-2 text-sm text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-white">← Daftar Kontrak</a>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3 text-gray-900 dark:text-white"><?php echo e($t->name); ?></td>
                        <td class="px-4 py-3 text-center text-xs text-gray-500 dark:text-slate-400"><?php echo e(['service'=>'Jasa','lease'=>'Sewa','supply'=>'Supply','maintenance'=>'Maintenance','subscription'=>'Langganan'][$t->category] ?? $t->category); ?></td>
                        <td class="px-4 py-3 text-center">
                            <?php if($t->is_active): ?><span class="px-2 py-0.5 rounded-full text-xs bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400">Aktif</span>
        ...
        <?php if($templates->hasPages()): ?><div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($templates->links()); ?></div><?php endif; ?>
    </div>
    ...
    <div id="modal-add-tpl" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl w-full max-w-lg shadow-xl">
            ...
            <form method="POST" action="<?php echo e(route('contracts.templates.store')); ?>" class="p-6 space-y-4">
                ...
                <div><label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Nama *</label><input type="text" name="name" required placeholder="Template Kontrak Sewa" class="<?php echo e($cls); ?>"></div>
                ...
                <div><label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Body Template</label><textarea name="body_template" rows="4" placeholder="Isi template kontrak... Gunakan {customer_name}, {start_date}, {end_date}, {value}" class="<?php echo e($cls); ?>"></textarea></div>
                <div><label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Default Terms</label><textarea name="default_terms" rows="3" class="<?php echo e($cls); ?>"></textarea></div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/contracts/templates.blade.php ENDPATH**/ ?>