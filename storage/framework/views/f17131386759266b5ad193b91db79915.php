...
<?php $component->withAttributes([]); ?>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 mb-2">Today's Orders</h3>
                    <p class="text-3xl font-bold text-blue-600"><?php echo e($stats['today_orders'] ?? 0); ?></p>
                </div>

                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 mb-2">Pending Orders</h3>
                    <p class="text-3xl font-bold text-orange-600">
                        <?php echo e($stats['pending_orders'] ?? 0); ?></p>
                </div>

                <div class="bg-white rounded-2xl border border-gray-200 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 mb-2">Today's Revenue</h3>
                    <p class="text-3xl font-bold text-green-600">Rp
                        <?php echo e(number_format($stats['today_revenue'] ?? 0, 0, ',', '.')); ?></p>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <span
                                            ...
                                            <?php echo e(str_replace('_', ' ', ucfirst($order->order_type))); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($order->guest?->full_name ?? 'Walk-in'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?php echo e(route('hotel.fb.restaurant.orders.show', $order->id)); ?>"
            ...
            <div class="mt-6 flex gap-4">
                ...
                <a href="<?php echo e(route('hotel.fb.menus.index')); ?>"
    ...
    <div id="modal-new-order" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('hotel.fb.restaurant.orders.store')); ?>" method="POST" id="new-order-form">
                <?php echo csrf_field(); ?>
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Table Number
                            (Optional)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Special
                            Instructions</label>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\fb\restaurant\index.blade.php ENDPATH**/ ?>