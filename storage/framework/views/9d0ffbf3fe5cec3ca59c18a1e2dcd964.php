...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Manajemen Supplies Medis <?php $__env->endSlot(); ?>
        ...
        <div class="p-4">
            <form method="GET" class="flex flex-col lg:flex-row gap-3">
                ...
                <select name="category"
                    ...
                    <option value="consumables" <?php if(request('category') === 'consumables'): echo 'selected'; endif; ?>>Consumables</option>
                    <option value="medications" <?php if(request('category') === 'medications'): echo 'selected'; endif; ?>>Medications</option>
                ...
                <select name="stock_status"
                    ...
                    <option value="critical" <?php if(request('stock_status') === 'critical'): echo 'selected'; endif; ?>>Critical</option>
                </select>
                <button type="submit"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\healthcare-inventory\supplies.blade.php ENDPATH**/ ?>