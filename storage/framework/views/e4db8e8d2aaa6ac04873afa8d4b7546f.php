                    ...
                    <?php if(isset($registry[$key])): ?>
                        ...
                        <label
                            ...
                            <input type="checkbox"
                                ...
                                <?php echo e(collect($userWidgets)->where('key', $key)->where('visible', true)->isNotEmpty() ? 'checked' : ''); ?>>
                            <div
                                class="w-8 h-8 rounded-lg <?php echo e($meta['icon_bg']); ?> flex items-center justify-center shrink-0">
                                <svg class="w-4 h-4 <?php echo e($meta['icon_color']); ?>" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($meta['title']); ?></p>
                                <p class="text-xs text-gray-400 dark:text-slate-500">
                                    <?php echo e(match ((int) $meta['cols']) {1 => 'Kecil',2 => 'Sedang',4 => 'Lebar penuh',default => ''}); ?>
