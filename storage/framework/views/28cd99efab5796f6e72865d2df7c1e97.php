            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="text-sm font-semibold text-green-600 dark:text-green-400"><?php echo e($stats['rooms']['clean'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Dirty</span>
                        <span
                            class="text-sm font-semibold text-orange-600 dark:text-orange-400"><?php echo e($stats['rooms']['dirty'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Inspected</span>
                        <span
                            class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e($stats['rooms']['inspected'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Out of Order</span>
                        <span
                            class="text-sm font-semibold text-red-600 dark:text-red-400"><?php echo e($stats['rooms']['out_of_order'] ?? 0); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="text-sm font-semibold text-orange-600 dark:text-orange-400"><?php echo e($stats['tasks']['pending'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">In Progress</span>
                        <span
                            class="text-sm font-semibold text-blue-600 dark:text-blue-400"><?php echo e($stats['tasks']['in_progress'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Completed Today</span>
                        <span
                            class="text-sm font-semibold text-green-600 dark:text-green-400"><?php echo e($stats['tasks']['completed_today'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Overdue</span>
                        <span
                            class="text-sm font-semibold text-red-600 dark:text-red-400"><?php echo e($stats['tasks']['overdue'] ?? 0); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Pending</span>
                        <span
                            class="text-sm font-semibold text-orange-600 dark:text-orange-400"><?php echo e($stats['maintenance']['pending'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Urgent</span>
                        <span
                            class="text-sm font-semibold text-red-600 dark:text-red-400"><?php echo e($stats['maintenance']['urgent'] ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-600 dark:text-slate-400">Overdue</span>
                        <span
                            class="text-sm font-semibold text-red-600 dark:text-red-400"><?php echo e($stats['maintenance']['overdue'] ?? 0); ?></span>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                        <?php $__empty_1 = true; $__currentLoopData = $pendingTasks->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-4 py-3 text-sm text-gray-900 dark:text-white"><?php echo e($task->room?->number); ?>
