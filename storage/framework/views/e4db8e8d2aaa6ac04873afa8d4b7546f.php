            ...
            <div class="rounded-xl border <?php echo e($aBorder); ?> p-3.5 flex items-start gap-3" id="anomaly-<?php echo e($anomaly->id); ?>">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-0.5">
                        <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($anomaly->title); ?></p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
            ...
            <div class="space-y-0">
                ...
                <div class="flex items-center justify-between py-2.5 border-b border-white/5 last:border-0">
                    <div>
                        <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($item->product->name); ?></p>
