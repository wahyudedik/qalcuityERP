...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 dark:text-slate-400 mt-0.5"><?php echo e(now()->translatedFormat('l, d F Y')); ?> · Platform
            Overview</p>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 mb-6">
        <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div
                ...
                <p class="text-base sm:text-xl font-bold text-gray-900 dark:text-white truncate"><?php echo e($card['value']); ?>

                </p>
                <p class="text-[10px] sm:text-xs text-gray-400 dark:text-slate-500 mt-1 truncate"><?php echo e($card['sub']); ?>
                    ...
                    <?php $__currentLoopData = $planDist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-sm text-gray-700 dark:text-slate-300"><?php echo e($planLabels[$plan] ?? ucfirst($plan)); ?></span>
                            </div>
                            <span
                                class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($count); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex items-center gap-3 min-w-0">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-gray-400 dark:text-slate-500">
                                    <?php echo e($tenant->admins->first()?->email ?? $tenant->slug); ?></p>
                            </div>
                        </div>
                        <div class="text-right shrink-0 ml-3">
                            <p class="text-xs font-semibold <?php echo e($urgency); ?>"><?php echo e($expiryDate?->format('d M Y')); ?>
                            ...
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <p class="text-sm font-medium text-gray-900 dark:text-white truncate">
                                        <?php echo e($tenant->name); ?></p>
                                    <p class="text-xs text-gray-400 dark:text-slate-500">
                                        <?php echo e($tenant->created_at->format('d M Y')); ?></p>
                                </div>
                            </div>
                            <span
                            ...
                            <div class="flex items-center gap-3">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between mb-1">
                                        <span
                                            class="text-xs font-medium text-gray-700 dark:text-slate-300 truncate"><?php echo e($log->tenant?->name ?? 'Tenant #' . $log->tenant_id); ?></span>
                                        <span
                                            class="text-xs text-gray-400 dark:text-slate-500 shrink-0 ml-2"><?php echo e(number_format($log->total)); ?>
            ...
            requestAnimationFrame(() => setTimeout(() => {
                ...
                new Chart(document.getElementById('growthChart'), {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: 'Tenant Baru',
                            data: <?php echo json_encode(array_column($growthChart, 'count')); ?>,
                ...
                <?php if(!empty($planDist)): ?>
                    new Chart(document.getElementById('planChart'), {
                        ...
                        data: {
                            ...
                            datasets: [{
                                data: <?php echo json_encode($planChartData); ?>,
                                backgroundColor: <?php echo json_encode($planChartColors); ?>,
                                borderWidth: 0,
                                hoverOffset: 4
                            }]
                        },
