...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Riwayat Transaksi <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $pc = ($payment->status ?? 'pending') === 'confirmed' ? 'green' : (($payment->status ?? '') === 'failed' ? 'red' : 'amber'); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-gray-900">
                                <?php echo e($payment->payment_date?->format('d/m/Y') ?? $payment->created_at?->format('d/m/Y')); ?>

                            </td>
                            <td class="px-4 py-3 hidden sm:table-cell text-gray-700">
                                <?php echo e(ucfirst(str_replace('_', ' ', $payment->payment_method ?? '-'))); ?></td>
                            <td class="px-4 py-3 text-right font-medium text-gray-900">Rp
                                <?php echo e(number_format($payment->amount ?? 0, 0, ',', '.')); ?></td>
        ...
        <?php if($payments->hasPages()): ?>
            <div class="px-4 py-3 border-t border-gray-100"><?php echo e($payments->links()); ?></div>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\customer-portal\transactions\index.blade.php ENDPATH**/ ?>