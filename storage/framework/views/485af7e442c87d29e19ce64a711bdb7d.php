    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(__('Voucher Management')); ?></h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Total Vouchers')); ?></p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($stats['total'])); ?>

                    </p>
                </div>
                <div
                    class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 border-l-4 border-green-500">
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Unused')); ?></p>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Used')); ?></p>
                ...
                <div
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Expired')); ?></p>
                    <p class="text-2xl font-bold text-red-600 dark:text-red-400"><?php echo e(number_format($stats['expired'])); ?>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 mb-6">
                <form method="GET" action="<?php echo e(route('telecom.vouchers.index')); ?>"
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Status')); ?></label>
                        <select name="status"
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Batch Number')); ?></label>
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Package')); ?></label>
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Search Code')); ?></label>
            ...
            <?php if($vouchers->count() > 0): ?>
                <div class="mb-4 flex justify-between items-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Showing')); ?>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $vouchers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voucher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($voucher->batch_number ?? '-'); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <?php if($voucher->isExpired()): ?>
                                            <span
                                                class="text-xs text-red-600 dark:text-red-400 font-semibold"><?php echo e(__('EXPIRED')); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-white">
