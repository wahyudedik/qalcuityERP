...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Picking Detail <?php $__env->endSlot(); ?>
    ...
    <div class="mob-pick-show">
        ...
        <div class="mob-topbar">
            <a href="<?php echo e(route('mobile.picking')); ?>" class="mob-back-btn">←</a>
            <div class="mob-topbar-info">
                <div class="mob-topbar-title"><?php echo e($pickingList->number); ?></div>
                <div class="mob-topbar-sub"><?php echo e($pickingList->warehouse->name ?? '-'); ?></div>
            </div>
        ...
        <?php if(session('success')): ?>
            <div class="mob-flash mob-flash-success">✓ <?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if(session('error')): ?>
            <div class="mob-flash mob-flash-error">✕ <?php echo e(session('error')); ?></div>
        <?php endif; ?>
        ...
        <div class="mob-progress-section">
            <div class="mob-progress-row">
                ...
                <span class="mob-progress-count"><?php echo e($pickedCount); ?> / <?php echo e($totalCount); ?> item</span>
            </div>
            <div class="mob-progress-track">
                <div class="mob-progress-fill <?php echo e($allDone ? 'done' : ''); ?>" style="width:<?php echo e($progressPct); ?>%"></div>
            </div>
        </div>
        ...
        <div class="mob-scanner-section">
            ...
            <div class="mob-scanner-box">
                <?php if (isset($component)) { $__componentOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.barcode-scanner','data' => ['onScan' => 'onPickScan','buttonLabel' => 'Scan Barcode Produk']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('barcode-scanner'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['on-scan' => 'onPickScan','button-label' => 'Scan Barcode Produk']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf)): ?>
<?php $attributes = $__attributesOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf; ?>
<?php unset($__attributesOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf)): ?>
<?php $component = $__componentOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf; ?>
<?php unset($__componentOriginal9dd6d12390a68f9f1ca2bdbf2f7374bf); ?>
<?php endif; ?>
            </div>
        ...
        <div class="mob-items-section">
            <div class="mob-items-label">Daftar Item (<?php echo e($totalCount); ?>)</div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="mob-item-card <?php echo e($isDone ? 'done-card' : ''); ?>" id="item-card-<?php echo e($item->id); ?>"
                    data-barcode="<?php echo e($item->product->barcode ?? ''); ?>" data-sku="<?php echo e($item->product->sku ?? ''); ?>">

                    <div class="mob-item-top">
                        <div class="mob-item-name"><?php echo e($item->product->name ?? 'Produk Tidak Diketahui'); ?></div>
                        <span class="mob-item-badge <?php echo e($badgeClass); ?>"><?php echo e($badgeLabel); ?></span>
                    </div>

                    <div class="mob-item-meta">
                        <span class="mob-item-meta-chip">SKU <span><?php echo e($sku); ?></span></span>
                        <?php if($item->bin): ?>
                            <span class="mob-item-meta-chip">🗃 Bin <span><?php echo e($item->bin->code); ?></span></span>
                        <?php endif; ?>
                        <span class="mob-item-meta-chip">Diminta
                            <span><?php echo e(number_format($item->quantity_requested, 0)); ?></span></span>
                        <?php if($item->quantity_picked > 0): ?>
                            <span class="mob-item-meta-chip">Diambil
                                <span><?php echo e(number_format($item->quantity_picked, 0)); ?></span></span>
                        <?php endif; ?>
                    </div>

                    <?php if($isDone): ?>
                        <div class="mob-item-done-mark">
                            ✓ Selesai diambil: <?php echo e(number_format($item->quantity_picked, 0)); ?> unit
                        </div>
                    <?php else: ?>
                        <form method="POST" action="<?php echo e(route('mobile.picking.confirm', $item->id)); ?>"
                            class="mob-item-form" id="form-item-<?php echo e($item->id); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mob-qty-stepper">
                                <button type="button" class="mob-stepper-btn"
                                    onclick="stepQty('qty-<?php echo e($item->id); ?>', -1)">−</button>
                                <input type="number" id="qty-<?php echo e($item->id); ?>" name="quantity_picked"
    ...
    <div class="mob-bottom-bar">
        <?php if($allDone): ?>
            <a href="<?php echo e(route('mobile.picking')); ?>" class="mob-finish-btn active-btn">
                ✅ Picking Selesai — Kembali ke List
            </a>
        <?php else: ?>
            <button type="button" class="mob-finish-btn <?php echo e($pickedCount > 0 ? 'active-btn' : 'disabled-btn'); ?>"
                onclick="if(<?php echo e($pickedCount > 0 ? 'true' : 'false'); ?>) window.location='<?php echo e(route('mobile.picking')); ?>'">
                🛒 Selesai Picking (<?php echo e($pickedCount); ?>/<?php echo e($totalCount); ?>)
            </button>
        <?php endif; ?>
    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\mobile\picking-show.blade.php ENDPATH**/ ?>