    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg shadow p-4 border-l-4 border-yellow-500">
                ...
                <div class="text-2xl font-bold text-yellow-700 dark:text-yellow-300"><?php echo e($stats['pending'] ?? 0); ?></div>
            </div>
            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg shadow p-4 border-l-4 border-blue-500">
                ...
                <div class="text-2xl font-bold text-blue-700 dark:text-blue-300"><?php echo e($stats['preparing'] ?? 0); ?></div>
            </div>
            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg shadow p-4 border-l-4 border-green-500">
                ...
                <div class="text-2xl font-bold text-green-700 dark:text-green-300"><?php echo e($stats['ready'] ?? 0); ?></div>
            </div>
            <div class="bg-red-50 dark:bg-red-900/20 rounded-lg shadow p-4 border-l-4 border-red-500">
                ...
                <div class="text-2xl font-bold text-red-700 dark:text-red-300"><?php echo e($stats['overdue'] ?? 0); ?></div>
            </div>
            <div class="bg-purple-50 dark:bg-purple-900/20 rounded-lg shadow p-4 border-l-4 border-purple-500">
                ...
                <div class="text-2xl font-bold text-purple-700 dark:text-purple-300"><?php echo e(round($stats['avg_prep_time'] ?? 0)); ?>m</div>
            </div>
        </div>
        ...
        <div class="mb-6 flex flex-wrap gap-2">
            <?php $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('fnb.kds.index', ['station' => $s === 'all' ? null : $s])); ?>"
                    class="px-4 py-2 rounded-lg text-sm font-medium transition-colors <?php echo e(($station ?? 'all') === $s ? 'bg-blue-600 text-white' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700'); ?>">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden <?php echo e($ticket->isOverdue() ? 'border-4 border-red-500' : 'border border-gray-200 dark:border-gray-700'); ?>"
                    data-ticket-id="<?php echo e($ticket->id); ?>">
                    <!-- Header -->
                    <div
                        class="p-4 <?php echo e($ticket->priority === 'vip' ? 'bg-purple-100 dark:bg-purple-900/30' : ($ticket->priority === 'rush' ? 'bg-red-100 dark:bg-red-900/30' : 'bg-gray-50 dark:bg-gray-700')); ?>">
                        <div class="flex justify-between items-start">
                            <div>
                                <div class="text-lg font-bold text-gray-900 dark:text-gray-100"><?php echo e($ticket->ticket_number); ?></div>
                                <div class="text-xs text-gray-600 dark:text-gray-400">Pesanan #<?php echo e($ticket->fb_order_id); ?></div>
                            </div>
                            <span
                                class="px-2 py-1 text-xs rounded-full <?php echo e($ticket->status === 'pending' ? 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-300' : 'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300'); ?>">
                    ...
                    <div class="p-4">
                        <div class="space-y-2">
                            <?php $__currentLoopData = $ticket->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-start">
                                    <div>
                                        <div class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($item->quantity); ?>x <?php echo e($item->menuItem?->name ?? $item->item_name ?? 'Item tidak diketahui'); ?></div>
                                        <?php if($item->special_instructions): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400 italic"><?php echo e($item->special_instructions); ?></div>
                                        <?php endif; ?>
                        ...
                        <?php if($ticket->started_at): ?>
                            <div class="mt-3 flex items-center text-sm">
                                ...
                                <span class="<?php echo e($ticket->isOverdue() ? 'text-red-600 dark:text-red-400 font-bold' : 'text-gray-600 dark:text-gray-400'); ?>">
