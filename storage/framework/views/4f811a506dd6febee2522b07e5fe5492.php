...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Buat Sales Order <?php $__env->endSlot(); ?>

    <div class="max-w-4xl mx-auto">
        <form method="POST" action="<?php echo e(route('sales.store')); ?>" id="so-form">
            <?php echo csrf_field(); ?>
    ...
    (function() {
        let idx = 1;
        const products = <?php echo json_encode($productsJs); ?>;

        const AI_PRICE_URL = "<?php echo e(route('sales.ai.price-suggest')); ?>";
        const AI_DESC_URL  = "<?php echo e(route('sales.ai.item-description')); ?>";
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\sales\create.blade.php ENDPATH**/ ?>