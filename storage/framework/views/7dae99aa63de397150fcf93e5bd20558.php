...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e($report['supplier']->name); ?> - Performance Report <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900"><?php echo e($report['supplier']->name); ?></h2>
                <p class="text-sm text-gray-500 mt-1"><?php echo e($report['supplier']->code ?? ''); ?> |
            ...
            <div class="text-right">
                <span
                    class="inline-block px-4 py-2 text-2xl font-bold rounded-full bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-700 $color }}-500/20 $color }}-400">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-100">
            ...
            <div>
                ...
                <p
                    class="text-lg font-medium <?php echo e($report['trend'] === 'improving' ? 'text-green-600' : ($report['trend'] === 'declining' ? 'text-red-600' : 'text-yellow-600')); ?>">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($report['total_incidents']); ?></p>
            </div>
            <div>
                <p class="text-xs text-gray-500">Scorecards</p>
                <p class="text-2xl font-bold text-gray-900"><?php echo e(count($report['scorecards'])); ?></p>
            </div>
        </div>
    </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $report['scorecards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scorecard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        class="px-2 py-1 text-xs font-bold rounded-full bg-<?php echo e($ratingColors[$scorecard->rating] ?? 'gray'); ?>-100 text-<?php echo e($ratingColors[$scorecard->rating] ?? 'gray'); ?>-700 $ratingColors[$scorecard->rating] ?? 'gray' }}-500/20 $ratingColors[$scorecard->rating] ?? 'gray' }}-400">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <span
                                        class="px-2 py-0.5 text-xs rounded-full bg-<?php echo e($incident->severity_color); ?>-100 text-<?php echo e($incident->severity_color); ?>-700 $incident->severity_color }}-500/20 $incident->severity_color }}-400">
                                        <?php echo e(ucfirst($incident->severity)); ?>

                                    </span>
                                    <span
                                        class="text-xs text-gray-500"><?php echo e($incident->incident_type); ?></span>
                                </div>
                            ...
                            <span
                                class="px-2 py-1 text-xs rounded-full <?php echo e($incident->status === 'resolved' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
