...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('analytics.scheduled-reports') }}"
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <form method="GET" action="{{ route('analytics.advanced') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div>
                    ...
                    <select name="module"
                        ...
                        <option value="sales" {{ $module == 'sales' ? 'selected' : '' }}>Sales</option>
                        ...
                        <option value="crm" {{ $module == 'crm' ? 'selected' : '' }}>CRM</option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        Rp {{ number_format($kpis['revenue']['daily'], 0, ',', '.') }}
                    </div>
                    <div class="mt-2 text-sm {{ $kpis['revenue']['growth'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        <i class="fas fa-{{ $kpis['revenue']['growth'] >= 0 ? 'arrow-up' : 'arrow-down' }}"></i>
                        {{ number_format(abs($kpis['revenue']['growth']), 1) }}% vs previous period
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        Rp {{ number_format($kpis['revenue']['weekly'], 0, ',', '.') }}
                    </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        Rp {{ number_format($kpis['revenue']['monthly'], 0, ',', '.') }}
                    </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-indigo-500">
                    ...
                    <div
                        class="text-2xl font-bold {{ $kpis['revenue']['growth'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        {{ number_format($kpis['revenue']['growth'], 1) }}%
                    </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        {{ number_format($kpis['orders']['total']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
                    ...
                    <div class="text-2xl font-bold text-green-600">
                        {{ number_format($kpis['orders']['completed']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        {{ number_format($kpis['orders']['conversion_rate'], 1) }}%
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-orange-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        Rp {{ number_format($kpis['orders']['avg_value'], 0, ',', '.') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        {{ number_format($kpis['inventory']['total_products']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="text-2xl font-bold text-green-600">
                        {{ number_format($kpis['inventory']['in_stock']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="text-2xl font-bold text-yellow-600">
                        {{ number_format($kpis['inventory']['low_stock']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="text-2xl font-bold text-red-600">
                        {{ number_format($kpis['inventory']['out_of_stock']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        {{ number_format($kpis['inventory']['turnover_rate'], 2) }}x
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
                    ...
                    <div class="text-2xl font-bold text-gray-900">
                        {{ number_format($kpis['customers']['total']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-green-500">
                    ...
                    <div class="text-2xl font-bold text-green-600">
                        +{{ number_format($kpis['customers']['new_this_month']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-purple-500">
                    ...
                    <div class="text-2xl font-bold text-purple-600">
                        {{ number_format($kpis['customers']['active']) }}
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6 border-l-4 border-indigo-500">
                    ...
                    <div class="text-2xl font-bold text-indigo-600">
                        {{ number_format($kpis['customers']['retention_rate'], 1) }}%
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    @foreach ($topMetrics['top_products'] as $index => $item)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <div class="font-semibold text-gray-900">Rp
                                    {{ number_format($item->total_revenue, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    @foreach ($topMetrics['top_customers'] as $index => $customer)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center gap-3">
                                <span class="text-lg font-bold text-gray-400">#{{ $index + 1 }}</span>
                                <div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3">
                    @foreach ($topMetrics['top_categories'] as $index => $category)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center gap-3">
                                <span class="text-lg font-bold text-gray-400">#{{ $index + 1 }}</span>
                                <div>
                                    <div class="font-medium text-gray-900">{{ $category->category ?? 'Uncategorized' }}
                                    </div>
                                    <div class="text-sm text-gray-500">{{ number_format($category->sales_count) }} sales
                                    </div>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="font-semibold text-gray-900">Rp
                                    {{ number_format($category->total_revenue, 0, ',', '.') }}</div>
                            </div>
                        </div>
                    @endforeach
                </div>
