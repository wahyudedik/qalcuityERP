        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900">{{ number_format($farmPlot->area_size, 1) }} {{ $farmPlot->area_unit }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900">{{ $farmPlot->costPerUnit() ? 'Rp '.number_format($farmPlot->costPerUnit(), 0, ',', '.') : '-' }}</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="font-semibold text-gray-900">Riwayat Aktivitas ({{ $farmPlot->activities->count() }})</h3>
