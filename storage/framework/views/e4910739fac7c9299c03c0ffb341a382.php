...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-wrap gap-2 mb-5">
        <a href="<?php echo e(route('hrm.recruitment.applications', $posting)); ?>"
           class="px-3 py-1.5 text-xs rounded-xl border <?php echo e(!request('stage') ? 'bg-blue-600 text-white border-blue-600' : 'border-gray-200 dark:border-white/10 text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5'); ?>">
        ...
        <a href="<?php echo e(route('hrm.recruitment.applications', [$posting, 'stage' => $key])); ?>"
           class="px-3 py-1.5 text-xs rounded-xl border <?php echo e(request('stage') === $key ? 'bg-blue-600 text-white border-blue-600' : 'border-gray-200 dark:border-white/10 text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5'); ?>">
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($app->applicant_name); ?></p>
                            <?php if($app->notes): ?><p class="text-xs text-gray-400 dark:text-slate-500 truncate max-w-[180px]"><?php echo e($app->notes); ?></p><?php endif; ?>
                        </td>
                        ...
                        <td class="px-4 py-3 hidden md:table-cell text-xs text-gray-500 dark:text-slate-400">
                            ...
                            <?php else: ?><span class="text-gray-300 dark:text-slate-600">—</span><?php endif; ?>
                        </td>
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($apps->links()); ?></div>
        <?php endif; ?>
    </div>
