...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-3">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2 mb-1">
                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($ob->employee->name); ?></p>
                ...
                <div class="flex items-center gap-4 shrink-0">
                    <div class="text-right">
                        ...
                        <div class="w-32 h-2 bg-gray-200 dark:bg-white/10 rounded-full mt-1">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-12 text-center">
            <p class="text-gray-400 dark:text-slate-500 text-sm">Belum ada onboarding aktif.</p>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div id="modal-start-onboarding" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/10">
                <h3 class="font-semibold text-gray-900 dark:text-white">Mulai Onboarding</h3>
                <button onclick="document.getElementById('modal-start-onboarding').classList.add('hidden')" class="text-gray-400 hover:text-gray-600 dark:hover:text-white">✕</button>
            </div>
            <form method="POST" action="<?php echo e(route('hrm.onboarding.start')); ?>" class="p-6 space-y-4">
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="document.getElementById('modal-start-onboarding').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300">Batal</button>
