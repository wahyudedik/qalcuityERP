        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-4 py-3 text-slate-600"><?php echo e($return->supplier->name ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-500 font-mono text-xs"><?php echo e($return->purchaseOrder->number ?? '-'); ?></td>
