...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-3 gap-3 mb-4">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4 text-center">
            ...
            <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5">Total Supplier</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4 text-center">
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e(!$sup->is_active ? 'opacity-60' : ''); ?>">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($sup->name); ?></p>
                            <?php if($sup->npwp): ?>
                            <p class="text-xs text-gray-400 dark:text-slate-500">NPWP: <?php echo e($sup->npwp); ?></p>
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-500 dark:text-slate-400"><?php echo e($sup->company ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e($sup->phone ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden lg:table-cell text-gray-500 dark:text-slate-400"><?php echo e($sup->email ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden lg:table-cell text-gray-500 dark:text-slate-400">
                            <?php if($sup->bank_name): ?>
                                ...
                                <p class="text-xs text-gray-400 dark:text-slate-500"><?php echo e($sup->bank_account); ?></p>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-3 text-center hidden sm:table-cell">
                            <span class="px-2 py-0.5 rounded-full text-xs <?php echo e($sup->is_active ? 'bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400' : 'bg-gray-100 text-gray-500 dark:bg-white/10 dark:text-slate-400'); ?>">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <form method="POST" action="<?php echo e(route('suppliers.toggle', $sup)); ?>">
                                    ...
                                    <button type="submit" class="p-1.5 rounded-lg text-gray-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-white/10"
                                ...
                                <form method="POST" action="<?php echo e(route('suppliers.destroy', $sup)); ?>"
                                    ...
                                    <button type="submit" class="p-1.5 rounded-lg text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10" title="Hapus">
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($suppliers->links()); ?></div>
        <?php endif; ?>
    </div>
            ...
            <form method="POST" action="<?php echo e(route('suppliers.store')); ?>" class="p-6 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-600 dark:text-slate-400 mb-1">Nama <span class="text-red-400">*</span></label>
                    ...
                    <div class="col-span-2 pt-1">
                        <p class="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-2">Info Bank</p>
                    </div>
                    <div>
            ...
            <form id="form-edit" method="POST" class="p-6 space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="col-span-2 flex items-center gap-2">
                        ...
                        <label for="e-active" class="text-sm text-gray-700 dark:text-slate-300">Supplier Aktif</label>
                    </div>
                </div>
                <div class="flex justify-end gap-3 pt-2">
