        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">{{ __('Create Internet Package') }}
                        </h1>
                ...
                <form action="{{ route('telecom.packages.store') }}" method="POST" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="download_speed_mbps" id="download_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('download_speed_mbps') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="upload_speed_mbps" id="upload_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('upload_speed_mbps') border-red-300 @enderror">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 sm:text-sm">Mbps</span>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="inline-flex items-center">
                                ...
                                <span
                                    class="ml-2 text-sm text-gray-700">{{ __('Unlimited') }}</span>
                            </label>
                            <label class="inline-flex items-center">
                                ...
                                <span class="ml-2 text-sm text-gray-700">{{ __('Limited') }}</span>
                            </label>
                        </div>
                        ...
                        <div id="quota_input" class="mt-3 {{ old('quota_type') === 'limited' ? '' : 'hidden' }}">
                            <div class="relative mt-1 rounded-md shadow-sm max-w-xs">
                                <input type="number" name="quota_gb" id="quota_gb" min="1" max="10000"
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-12 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('quota_gb') border-red-300 @enderror">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('description') border-red-300 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="features" id="features" rows="4"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('features') border-red-300 @enderror">{{ old('features') }}</textarea>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_active"
                                class="font-medium text-gray-700">{{ __('Activate Package') }}</label>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('Package Preview') }}
                        </h3>
                        <div
