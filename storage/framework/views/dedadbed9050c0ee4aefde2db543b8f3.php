...
<div class="container">
    ...
    <div class="body">
        <p class="greeting">Yth. <strong><?php echo e($invoice->customer->name); ?></strong>,</p>
        <p style="font-size:13px;line-height:1.6;color:#6b7280">
            Bersama email ini kami lampirkan invoice dari <strong><?php echo e($tenantName); ?></strong>.
        ...
        <div class="invoice-box">
            <div class="row">
                ...
                <span class="value"><?php echo e($invoice->number); ?></span>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <span class="value"><?php echo e($invoice->due_date?->format('d M Y') ?? '-'); ?></span>
            </div>
            <div class="row">
                ...
                <span class="value">
                    ...
                    ?>
                    <span class="status-badge <?php echo e($cls); ?>"><?php echo e($lbl); ?></span>
                </span>
            </div>
            <div class="row total">
                <span class="label">Total Tagihan</span>
                <span class="value">Rp <?php echo e(number_format($invoice->total_amount, 0, ',', '.')); ?></span>
            </div>
            <?php if($invoice->remaining_amount < $invoice->total_amount): ?>
            <div class="row">
                <span class="label">Sisa Tagihan</span>
                <span class="value" style="color:#dc2626">Rp <?php echo e(number_format($invoice->remaining_amount, 0, ',', '.')); ?></span>
            </div>
            <?php endif; ?>
        </div>

        <?php if($invoice->notes): ?>
        <p class="note"><strong>Catatan:</strong> <?php echo e($invoice->notes); ?></p>
        <?php endif; ?>
    ...
    <div class="footer">
        Email ini dikirim otomatis oleh <strong>Qalcuity ERP</strong> &nbsp;·&nbsp; <?php echo e(now()->format('d M Y')); ?>

    </div>
</div>
</body>
</html>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\invoices\email.blade.php ENDPATH**/ ?>