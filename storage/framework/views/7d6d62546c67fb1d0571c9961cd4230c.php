...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Laporan — Qalcuity ERP <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> Export Laporan <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-4xl space-y-4">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
            <div class="flex items-center gap-4 mb-4">
                <div class="w-11 h-11 rounded-2xl <?php echo e($r['bg']); ?> flex items-center justify-center shrink-0">
                    <svg class="w-5 h-5 <?php echo e($r['ic']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="<?php echo e($r['icon']); ?>"/>
                    </svg>
                </div>
                <div>
                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($r['label']); ?></p>
                    <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5"><?php echo e($r['desc']); ?></p>
                </div>
            </div>

            <div class="flex flex-wrap items-end gap-3" id="form-<?php echo e($r['key']); ?>">
                <?php if($r['date']): ?>
                <div class="w-full sm:w-auto">
                    <label class="block text-xs font-medium text-gray-500 dark:text-slate-400 mb-1.5">Dari Tanggal</label>
                    <input type="date" name="start_date" value="<?php echo e(now()->startOfMonth()->format('Y-m-d')); ?>"
                ...
                <div class="w-full sm:w-auto">
                    ...
                    <input type="date" name="end_date" value="<?php echo e(now()->format('Y-m-d')); ?>"
                        class="w-full sm:w-auto px-3 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                </div>
                <?php endif; ?>
                ...
                <div class="flex gap-2 ml-auto">
                    <?php if($r['excel']): ?>
                    <button onclick="exportReport('<?php echo e($r['key']); ?>', 'excel')"
                    ...
                    <?php endif; ?>
                    <?php if($r['pdf']): ?>
                    <button onclick="exportReport('<?php echo e($r['key']); ?>', 'pdf')"
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
            ...
            <div class="flex flex-wrap items-end gap-3" id="form-balance-sheet">
                <div class="w-full sm:w-auto">
                    ...
                    <input type="date" name="as_of" value="<?php echo e(now()->format('Y-m-d')); ?>"
                        class="w-full sm:w-auto px-3 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                </div>
                <div class="flex gap-2 ml-auto">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
            ...
            <div class="flex flex-wrap items-end gap-3" id="form-budget">
                <div class="w-full sm:w-auto">
                    ...
                    <input type="month" name="period" value="<?php echo e(now()->format('Y-m')); ?>"
                        class="w-full sm:w-auto px-3 py-2 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                </div>
                <div class="flex gap-2 ml-auto">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('reports.aging.excel')); ?>"
    ...
    <script>
    const reportRoutes = {
        sales:        { excel: '<?php echo e(route("reports.sales.excel")); ?>',        pdf: '<?php echo e(route("reports.sales.pdf")); ?>' },
        finance:      { excel: '<?php echo e(route("reports.finance.excel")); ?>',      pdf: '<?php echo e(route("reports.finance.pdf")); ?>' },
        'profit-loss':{ excel: '<?php echo e(route("reports.income-statement.excel")); ?>', pdf: '<?php echo e(route("reports.profit-loss.pdf")); ?>' },
        inventory:    { excel: '<?php echo e(route("reports.inventory.excel")); ?>',    pdf: '<?php echo e(route("reports.inventory.pdf")); ?>' },
        receivables:  { excel: '<?php echo e(route("reports.receivables.excel")); ?>',  pdf: '<?php echo e(route("reports.receivables.pdf")); ?>' },
        hrm:          { excel: '<?php echo e(route("reports.hrm.excel")); ?>',          pdf: '<?php echo e(route("reports.hrm.pdf")); ?>' },
    };
    ...
    function exportBalanceSheet(format) {
        ...
        const urls  = { excel: '<?php echo e(route("reports.balance-sheet.excel")); ?>', pdf: '<?php echo e(route("reports.balance-sheet.pdf")); ?>' };
    ...
    function exportCashFlow(format) {
        ...
        const start = form.querySelector('[name="start_date"]')?.value ?? '';
        const end   = form.querySelector('[name="end_date"]')?.value ?? '';
        const urls  = { excel: '<?php echo e(route("reports.cash-flow.excel")); ?>', pdf: '<?php echo e(route("reports.cash-flow.pdf")); ?>' };
    ...
    function exportBudget(format) {
        ...
        const urls   = { excel: '<?php echo e(route("reports.budget.excel")); ?>', pdf: '<?php echo e(route("reports.budget.pdf")); ?>' };
    ...
    function exportPayroll() {
        ...
        const period = form.querySelector('[name="period"]')?.value ?? '';
        window.location.href = '<?php echo e(route("reports.payroll.excel")); ?>?period=' + period;
    }
    </script>
    <?php $__env->stopPush(); ?>
...
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/reports/index.blade.php ENDPATH**/ ?>