...
<?php $__env->startSection('title', 'Create Daily Site Report'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="<?php echo e(route('construction.reports.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="project_id" required
                            ...
                            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($project->id); ?>"><?php echo e($project->name); ?> (<?php echo e($project->number); ?>)</option>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Report Date <span
                                class="text-red-500">*</span></label>
                        <input type="date" name="report_date" value="<?php echo e(date('Y-m-d')); ?>" required
                            class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="<?php echo e(route('construction.reports.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\construction\reports\create.blade.php ENDPATH**/ ?>