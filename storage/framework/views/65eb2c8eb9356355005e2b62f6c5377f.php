    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <p class="font-medium text-gray-900"><?php echo e($lp->customer->name); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($lp->customer->phone ?? $lp->customer->email ?? ''); ?></p>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span class="px-2 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($tc); ?>-100 text-<?php echo e($tc); ?>-700 $tc }}-500/20 $tc }}-400">
                                        <?php echo e($lp->tier); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-right font-semibold text-gray-900"><?php echo e(number_format($lp->total_points)); ?></td>
                                <td class="px-4 py-3 text-right hidden md:table-cell text-gray-500"><?php echo e(number_format($lp->lifetime_points)); ?></td>
                                <?php if($program): ?>
                ...
                <div class="px-4 py-3 border-t border-gray-100"><?php echo e($points->links()); ?></div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-medium text-gray-900"><?php echo e($tier->name); ?></span>
                        </div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            ...
            <form method="POST" action="<?php echo e(route('loyalty.add-points')); ?>" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <?php if($program): ?><p class="text-xs text-gray-400 mt-1">Poin otomatis: Rp 100 = 1 poin</p><?php endif; ?>
                </div>
                <div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            ...
            <form method="POST" action="<?php echo e(route('loyalty.redeem')); ?>" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="points" min="<?php echo e($program?->min_redeem_points ?? 100); ?>" required class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <?php if($program): ?><p class="text-xs text-gray-400 mt-1">Min. <?php echo e($program->min_redeem_points); ?> poin · 1 poin = Rp <?php echo e(number_format($program->idr_per_point,0,',','.')); ?></p><?php endif; ?>
                </div>
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">Referensi</label>
