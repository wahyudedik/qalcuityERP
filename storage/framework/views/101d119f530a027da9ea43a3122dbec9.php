        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                    <td class="px-4 py-3 font-mono font-medium text-slate-800 dark:text-white"><?php echo e($dp->number); ?></td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-slate-600 dark:text-slate-300"><?php echo e($dp->party?->name ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-500 dark:text-slate-400"><?php echo e($dp->payment_date->format('d/m/Y')); ?></td>
                    <td class="px-4 py-3 text-right font-medium text-slate-800 dark:text-white">Rp <?php echo e(number_format($dp->amount, 0, ',', '.')); ?></td>
                    <td class="px-4 py-3 text-right text-slate-600 dark:text-slate-300">Rp <?php echo e(number_format($dp->remaining_amount, 0, ',', '.')); ?></td>
                    <td class="px-4 py-3">
