...
<?php $__env->startSection('title', 'New BPOM Registration'); ?>

<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-6">
            <a href="<?php echo e(route('cosmetic.registrations.index')); ?>" class="text-blue-600 hover:text-blue-900 mb-2 inline-block">
        ...
        <form method="POST" action="<?php echo e(route('cosmetic.registrations.store')); ?>">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <select name="formula_id"
                                ...
                                <?php $__currentLoopData = $formulas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formula): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($formula->id); ?>"
                                        <?php echo e(old('formula_id') == $formula->id ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <input type="text" name="registration_number" value="<?php echo e(old('registration_number')); ?>"
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['registration_number'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="product_name" value="<?php echo e(old('product_name')); ?>" required
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['product_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="product_category" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['product_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="skincare" <?php echo e(old('product_category') == 'skincare' ? 'selected' : ''); ?>>
                                    Skincare</option>
                                <option value="haircare" <?php echo e(old('product_category') == 'haircare' ? 'selected' : ''); ?>>
                                    Haircare</option>
                                <option value="makeup" <?php echo e(old('product_category') == 'makeup' ? 'selected' : ''); ?>>Makeup
                                </option>
                                <option value="fragrance" <?php echo e(old('product_category') == 'fragrance' ? 'selected' : ''); ?>>
                                    Fragrance</option>
                                <option value="personal_care"
                                    <?php echo e(old('product_category') == 'personal_care' ? 'selected' : ''); ?>>Personal Care
                                </option>
                                <option value="baby_care" <?php echo e(old('product_category') == 'baby_care' ? 'selected' : ''); ?>>
                                    Baby Care</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="registration_type" required
                                ...
                                <option value="notification"
                                    <?php echo e(old('registration_type') == 'notification' ? 'selected' : ''); ?>>Notification
                                </option>
                                <option value="certification"
                                    <?php echo e(old('registration_type') == 'certification' ? 'selected' : ''); ?>>Certification
                                </option>
                            </select>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="notes" rows="4"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                            placeholder="Additional notes, BPOM comments, etc."><?php echo e(old('notes')); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\registrations\create.blade.php ENDPATH**/ ?>