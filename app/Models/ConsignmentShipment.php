...
class ConsignmentShipment extends Model
{
    ...
    public function items(): HasMany { return $this->hasMany(ConsignmentShipmentItem::class); }
    public function salesReports(): HasMany { return $this->hasMany(ConsignmentSalesReport::class); }
