...
<?php $__env->startSection('title', 'Analisis Penyebab Pemborosan'); ?>
<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Analisis Penyebab Pemborosan</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Identifikasi penyebab utama pemborosan bahan</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                    Penyebab Pemborosan (<?php echo e($daysBack); ?> hari terakhir)
                </h2>
            </div>
            <?php if(empty($reasons) || count($reasons) === 0): ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Jenis Pemborosan</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Jumlah Kejadian</th>
                            ...
                            <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">
                                        <?php echo e($wasteTypeLabels[$type] ?? ($type ?: 'Tidak diketahui')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-red-600 dark:text-red-400">
                                        Rp <?php echo e(number_format($cost, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div class="w-24 bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                                <div class="bg-red-500 h-2 rounded-full" style="width: <?php echo e($pct); ?>%"></div>
                                            </div>
                                            <span class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($pct); ?>%</span>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\fnb\waste\reasons.blade.php ENDPATH**/ ?>