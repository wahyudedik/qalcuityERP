    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 text-center">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$emoji, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white/5 border border-white/10 rounded-2xl p-5 text-left">
                    <span class="text-2xl"><?php echo e($emoji); ?></span>
                    <h4 class="font-bold text-white text-sm mt-3 mb-1"><?php echo e($title); ?></h4>
                    <p class="text-xs text-slate-400 leading-relaxed"><?php echo e($desc); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
