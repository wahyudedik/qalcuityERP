        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('Version History')); ?> - <?php echo e($document->title); ?>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Versions</p>
                    <p class="text-3xl font-semibold text-gray-900 dark:text-white mt-2">
                        <?php echo e($history['total_versions']); ?></p>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Avg File Size</p>
                    <p class="text-3xl font-semibold text-gray-900 dark:text-white mt-2">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Version Timeline</h3>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('documents.versions.store', $document)); ?>"
                        enctype="multipart/form-data" class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                        <?php echo csrf_field(); ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Change
                                    Summary *</label>
                    ...
                    <?php if($history['total_versions'] > 1): ?>
                        <div
                            ...
                            <h4 class="text-sm font-medium text-yellow-800 dark:text-yellow-200 mb-2">⚠️ Rollback to
                                Previous Version</h4>
                            <form method="POST"
                                ...
                                <label class="inline-flex items-center">
                                    ...
                                    <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">I confirm I want to
