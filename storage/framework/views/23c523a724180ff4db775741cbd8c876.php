...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $receipts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-center">
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs <?php echo e($gr->status === 'confirmed' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
        ...
        <?php if($receipts->hasPages()): ?>
            <div class="px-4 py-3 border-t border-gray-100"><?php echo e($receipts->links()); ?></div>
        <?php endif; ?>
    </div>
