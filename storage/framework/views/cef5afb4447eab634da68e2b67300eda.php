...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 📋 Mix Design Version History - <?php echo e($mixDesign->grade); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div>
                        ...
                        <div class="text-xl font-bold text-gray-900"><?php echo e($mixDesign->grade); ?></div>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <h3 class="font-semibold text-gray-900 mb-6">📜 Version Timeline</h3>
                ...
                <div class="space-y-6">
                    <?php $__currentLoopData = $versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            class="relative pl-8 border-l-2 <?php echo e($index === 0 ? 'border-blue-500' : 'border-gray-300'); ?>">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-lg text-gray-900">
                                            ...
                                            <?php if($version->isApproved()): ?>
                                                <span
                                                    class="ml-2 px-2 py-1 rounded-full text-xs bg-green-100 text-green-700">✓
                                                    Approved</span>
                                            <?php else: ?>
                                                <span
                                                    class="ml-2 px-2 py-1 rounded-full text-xs bg-yellow-100 text-yellow-700">⏳
                                                    Pending</span>
                                            <?php endif; ?>
                                        </h4>
                                ...
                                <div
                                    ...
                                    <div class="text-xs text-blue-600 font-semibold mb-1">CHANGE
                                        REASON:</div>
                                    <p class="text-sm text-gray-700"><?php echo e($version->change_reason); ?>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                            ...
                                            <?php if(is_array($changes) && !isset($changes['message'])): ?>
                                                <?php $__currentLoopData = $changes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div
                                                        class="flex items-center justify-between p-2 bg-white rounded text-sm">
                                                        <span
                                                            class="text-gray-600"><?php echo e(str_replace('_', ' ', ucfirst($field))); ?></span>
