            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 flex flex-col sm:flex-row sm:items-start gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-900 text-sm"><?php echo e($req->workflow?->name ?? 'Permintaan Persetujuan'); ?></p>
                        <p class="text-xs text-gray-500 mt-0.5">
                            Diminta oleh <span class="font-medium text-gray-700"><?php echo e($req->requester?->name); ?></span>
                        ...
                        <?php endif; ?>
                        <?php if($req->notes): ?>
                        <p class="text-xs text-gray-400 mt-1 italic"><?php echo e($req->notes); ?></p>
                        <?php endif; ?>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-3 font-medium text-gray-900"><?php echo e($req->workflow?->name ?? '-'); ?></td>
                            <td class="px-6 py-3 text-gray-500 hidden sm:table-cell"><?php echo e($req->requester?->name); ?></td>
                            <td class="px-6 py-3 text-gray-500 hidden md:table-cell"><?php echo e($req->approver?->name ?? '-'); ?></td>
                            <td class="px-6 py-3">
                                <span class="px-2 py-0.5 rounded-full text-xs font-medium
                            ...
                            <td class="px-6 py-3 text-gray-400 hidden sm:table-cell"><?php echo e($req->responded_at?->format('d M Y H:i')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
