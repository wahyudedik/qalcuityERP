    ...
    <div class="space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">Rp <?php echo e(number_format($lastMonth, 0, ',', '.')); ?></p>
            </div>
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                ...
                <?php $__currentLoopData = $topCategories->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between text-xs mb-1">
                        <span class="text-gray-600 dark:text-slate-400"><?php echo e($tc->category->name ?? 'Lainnya'); ?></span>
                        <span class="font-medium text-gray-900 dark:text-white">Rp <?php echo e(number_format($tc->total, 0, ',', '.')); ?></span>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="lg:col-span-2 space-y-4">
                ...
                <form method="GET" class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4 flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('expenses.categories')); ?>" class="px-4 py-2 bg-gray-100 dark:bg-white/10 text-gray-700 dark:text-white rounded-xl text-sm hover:bg-gray-200 dark:hover:bg-white/20 transition">Kategori</a>
                </form>
                ...
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
                    ...
                    <?php else: ?>
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                                    <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition">
                                            <td class="px-4 py-3 text-xs text-gray-500 dark:text-slate-400"><?php echo e($exp->date->format('d/m/Y')); ?></td>
                                            <td class="px-4 py-3">
                                            ...
                                            <td class="px-4 py-3 text-xs text-gray-500 dark:text-slate-400 capitalize"><?php echo e($exp->payment_method); ?></td>
                                            <td class="px-4 py-3">
                        ...
                        <?php if($expenses->hasPages()): ?>
                            <div class="px-6 py-4 border-t border-gray-100 dark:border-white/5"><?php echo e($expenses->links()); ?></div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
