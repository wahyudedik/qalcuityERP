...
<?php $__env->startSection('title', 'QRIS Payment - ' . $transaction->transaction_number); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
                <div class="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4">
                    <div class="flex items-center justify-between text-white">
                        ...
                        <div class="text-right">
                            ...
                            <p class="font-mono font-semibold"><?php echo e($transaction->transaction_number); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-8 text-center border-b border-gray-100">
                    ...
                    <p class="text-4xl font-bold text-gray-900">Rp <?php echo e(number_format($transaction->amount, 0, ',', '.')); ?>

                    </p>

                    <?php if($transaction->salesOrder): ?>
                        <p class="text-xs text-gray-400 mt-2">Order #<?php echo e($transaction->salesOrder->order_number); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 mb-6">
                ...
                <div class="flex flex-col items-center">
                    <div class="bg-white p-4 rounded-xl border-2 border-purple-100 shadow-inner mb-4">
                        <?php if($transaction->qr_image_url): ?>
                            <img src="<?php echo e($transaction->qr_image_url); ?>" alt="QRIS Code" class="w-64 h-64 object-contain"
                                id="qr-code-image">
                        <?php else: ?>
    ...
    <script>
        function qrisPayment() {
            return {
                timeLeft: <?php echo e($transaction->expired_at->diffInSeconds(now()) ?? 900); ?>,
                checking: false,
                isCompleted: false,
                ...
                async checkStatus(silent = false) {
                    ...
                    try {
                        const response = await fetch(
                            `/api/payment/status?transaction_number=<?php echo e($transaction->transaction_number); ?>`, {
                                headers: {
                ...
                async printReceipt() {
                    try {
                        const response = await fetch(`/api/pos/print/receipt/<?php echo e($transaction->sales_order_id); ?>`, {
                            method: 'POST',
                            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\pos\payment-qris.blade.php ENDPATH**/ ?>