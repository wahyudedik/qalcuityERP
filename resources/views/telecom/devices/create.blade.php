    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('Tambah Network Device') }}</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('Daftarkan router atau network device baru') }}
                </p>
            </div>
            ...
            <form action="{{ route('telecom.devices.store') }}" method="POST"
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="password"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Password') }}
                                *</label>
