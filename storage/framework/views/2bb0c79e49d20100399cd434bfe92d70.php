...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Stock Movement - Tambah Transaksi <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            ...
            <form method="POST" action="<?php echo e(route('inventory.movements.store')); ?>" id="movement-form">
                <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function loadProducts() {
            fetch(`/api/products?tenant_id=<?php echo e(auth()->user()->tenant_id); ?>`)
                .then(res => res.json())
                .then(data => {
        ...
        function loadProductStock() {
            ...
            fetch(`<?php echo e(route('inventory.movements.stock')); ?>?product_id=${productId}&warehouse_id=${warehouseId}`)
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\inventory\movements\create.blade.php ENDPATH**/ ?>