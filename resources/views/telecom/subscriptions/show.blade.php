                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-medium text-gray-900">{{ $subscription->customer?->name ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase">{{ __('Paket') }}</p>
                                <p class="mt-1 text-sm font-medium text-gray-900">{{ $subscription->package?->name ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase">{{ __('Perangkat') }}</p>
                                <p class="mt-1 text-sm font-medium text-gray-900">{{ $subscription->device?->name ?? '-' }}</p>
                            </div>
                            <div>
                            ...
                            @if ($subscription->hotspot_username)
                                <div>
                                    ...
                                    <p class="mt-1 text-sm font-mono text-gray-900">{{ $subscription->hotspot_username }}</p>
                                </div>
                            @endif
                        ...
                        @if ($quotaBytes > 0)
                            <div class="mb-4">
                                <div class="flex justify-between text-sm mb-2">
                                    <span class="text-gray-600">{{ __('Terpakai') }}: {{ round($usedBytes / 1073741824, 2) }} GB</span>
