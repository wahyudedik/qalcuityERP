...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('HL7 Message Details')); ?> -
                #<?php echo e($message->id); ?></h2>
            <a href="<?php echo e(route('healthcare.hl7.index')); ?>"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <dl class="space-y-4">
                        <div>
                            ...
                            <dd class="mt-1 text-lg font-semibold text-gray-900 font-mono">#<?php echo e($message->id); ?></dd>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1"><span
                                    class="px-2 py-1 text-sm font-semibold rounded-full bg-indigo-100 text-indigo-800"><?php echo e($message->message_type); ?></span>
                            </dd>
                        </div>
                        <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <dl class="space-y-4">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900"><?php echo e($message->receiving_app ?? 'N/A'); ?></dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Created At</dt>
                            <dd class="mt-1 text-sm text-gray-900"><?php echo e($message->created_at->format('d/m/Y H:i:s')); ?>
                        ...
                        <?php if($message->sent_at): ?>
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($message->sent_at->format('d/m/Y H:i:s')); ?>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900"><?php echo e($message->retry_count); ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6">
                ...
                <pre id="messageContent" class="text-xs bg-gray-50 p-4 rounded overflow-x-auto font-mono whitespace-pre-wrap"><?php echo e($message->message_content); ?></pre>
            </div>
            ...
            <?php if($message->error_message): ?>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6 border-2 border-red-200">
                    ...
                    <pre class="text-sm bg-red-50 p-4 rounded overflow-x-auto text-red-800"><?php echo e($message->error_message); ?></pre>
                </div>
            <?php endif; ?>
    ...
    <script>
        ...
        function retryMessage() {
            if (confirm('Retry sending this message?')) {
                fetch('<?php echo e(route('healthcare.hl7.retry', $message)); ?>', {
                        method: 'POST',
                        headers: {
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\hl7\show.blade.php ENDPATH**/ ?>