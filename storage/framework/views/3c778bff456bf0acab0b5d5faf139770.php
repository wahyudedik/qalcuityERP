        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <p class="font-bold text-gray-900 text-lg"><?php echo e($livestockHerd->name); ?></p>
            ...
            <?php if($totalFeed > 0): ?>
                <div class="bg-white rounded-2xl border border-gray-200 p-5">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div
                            class="p-3 rounded-xl <?php echo e($fcr && $fcr <= 1.8 ? 'bg-green-50' : ($fcr && $fcr <= 2.2 ? 'bg-amber-50' : 'bg-gray-50')); ?>">
                            <p class="text-xs text-gray-500">FCR</p>
                            <p
                                class="text-2xl font-black <?php echo e($fcr && $fcr <= 1.8 ? 'text-green-600' : ($fcr && $fcr <= 2.2 ? 'text-amber-600' : 'text-gray-900')); ?>">
                                <?php echo e($fcr ?? '-'); ?></p>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $livestockHerd->feedLogs->take(14); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 text-gray-700"><?php echo e($fl->feed_type); ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $livestockHerd->vaccinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="<?php echo e($overdue ? 'bg-red-50/50' : ''); ?>">
                    ...
                    <?php $__currentLoopData = $livestockHerd->healthRecords->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="px-5 py-3">
                            <div class="flex items-center gap-2 mb-1">
                                <span
                                    class="text-xs px-2 py-0.5 rounded-full bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 $sc }}-500/20 $sc }}-400"><?php echo e(ucfirst($hr->severity)); ?></span>
                                <span
                                    class="text-sm font-medium text-gray-900"><?php echo e($hr->condition); ?></span>
    ...
    <div id="movementModal"
        ...
        <div
            ...
            <p class="text-xs text-gray-400 mb-4">Populasi saat ini: <span
                    class="font-bold text-gray-900"><?php echo e($livestockHerd->current_count); ?> ekor</span>
            </p>
