...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Supplier Performance <?php $__env->endSlot(); ?>
        ...
        <div class="flex items-center gap-2">
            <form method="GET" id="period-form">
                <select name="period" onchange="document.getElementById('period-form').submit()"
                    ...
                    <option value="365" <?php echo e($period == 365 ? 'selected' : ''); ?>>1 Tahun</option>
                </select>
            </form>
        </div>
        <a href="<?php echo e(route('supplier-performance.evaluate')); ?>"
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($totalSuppliers); ?></p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e(number_format($avgScore ?? 0, 1)); ?></p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-lg font-bold text-green-600 dark:text-green-400 truncate"><?php echo e($topGrade?->name ?? '-'); ?></p>
            <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">Grade: <?php echo e($topGrade?->performance['current_grade'] ?? 'N/A'); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400 mb-1">Periode Evaluasi</p>
            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400"><?php echo e($period); ?> Hari</p>
            <p class="text-xs text-gray-400 dark:text-slate-500 mt-1"><?php echo e($period); ?> hari terakhir</p>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    <?php $__empty_1 = true; $__currentLoopData = $rankings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ranking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            <td class="px-4 py-3">
                                <?php if($index < 3): ?>
                                    <span class="inline-flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold
                                        <?php echo e($index === 0 ? 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400' : ''); ?>

                                        <?php echo e($index === 1 ? 'bg-gray-100 text-gray-600 dark:bg-white/10 dark:text-slate-300' : ''); ?>

                                        <?php echo e($index === 2 ? 'bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400' : ''); ?>">
                                        <?php echo e($index + 1); ?>

                                    </span>
                                <?php else: ?>
                                    <span class="text-xs text-gray-400 dark:text-slate-500 font-medium pl-1">#<?php echo e($index + 1); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-3">
                                <a href="<?php echo e(route('supplier-performance.detail', $ranking['supplier_id'])); ?>"
                                    class="font-medium text-blue-600 dark:text-blue-400 hover:underline">
                                    <?php echo e($ranking['supplier_name']); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                ?>
                                <span class="px-2 py-0.5 rounded-full text-xs font-bold <?php echo e($gc); ?>"><?php echo e($ranking['grade']); ?></span>
                            </td>
                            <td class="px-4 py-3 text-right font-bold text-gray-900 dark:text-white"><?php echo e(number_format($ranking['avg_score'], 1)); ?></td>
                            <td class="px-4 py-3 text-right hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e(number_format($ranking['avg_delivery'], 1)); ?></td>
                            <td class="px-4 py-3 text-right hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e(number_format($ranking['avg_quality'], 1)); ?></td>
                            <td class="px-4 py-3 text-right hidden lg:table-cell text-gray-500 dark:text-slate-400"><?php echo e(number_format($ranking['avg_cost'], 1)); ?></td>
                            <td class="px-4 py-3 text-right hidden lg:table-cell">
                                <span class="<?php echo e($ranking['on_time_rate'] >= 90 ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'); ?> font-medium">
                                    <?php echo e($ranking['on_time_rate']); ?>%
                                </span>
                            </td>
                            <td class="px-4 py-3 text-right hidden lg:table-cell text-gray-500 dark:text-slate-400"><?php echo e($ranking['evaluation_count']); ?></td>
                            <td class="px-4 py-3 text-center">
                                <a href="<?php echo e(route('supplier-performance.detail', $ranking['supplier_id'])); ?>"
            ...
            <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="border border-gray-200 dark:border-white/10 rounded-xl p-4 hover:border-blue-300 dark:hover:border-blue-500/40 transition-colors">
                    <div class="flex items-start justify-between gap-2 mb-3">
                        <div class="min-w-0">
                            <h4 class="font-semibold text-gray-900 dark:text-white text-sm truncate"><?php echo e($supplier->name); ?></h4>
                            <p class="text-xs text-gray-400 dark:text-slate-500 truncate"><?php echo e($supplier->company ?? '-'); ?></p>
                        </div>
                        <span class="px-2 py-0.5 rounded-full text-xs font-bold shrink-0 <?php echo e($gc2); ?>"><?php echo e($grade); ?></span>
                    </div>
                    ...
                    <?php if($hasData): ?>
                        <div class="space-y-1.5 text-xs">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($supplier->performance['avg_overall_score'], 1)); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-slate-400">Tepat Waktu</span>
                                <span class="<?php echo e($supplier->performance['on_time_delivery_rate'] >= 90 ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'); ?> font-medium">
                                    <?php echo e($supplier->performance['on_time_delivery_rate']); ?>%
                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-slate-400">Kualitas</span>
                                <span class="text-gray-700 dark:text-slate-300"><?php echo e(number_format($supplier->performance['avg_quality_rate'], 1)); ?>%</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-slate-400">Total PO</span>
                                <span class="text-gray-700 dark:text-slate-300"><?php echo e($supplier->performance['total_pos']); ?></span>
                            </div>
                            <div class="flex justify-between items-center pt-1.5 border-t border-gray-100 dark:border-white/5">
                                ...
                                <span class="inline-flex items-center gap-1 text-xs font-medium
                                    <?php echo e($trend === 'improving' ? 'text-green-600 dark:text-green-400' : ($trend === 'declining' ? 'text-red-500 dark:text-red-400' : 'text-gray-500 dark:text-slate-400')); ?>">
                    ...
                    <div class="mt-3 pt-3 border-t border-gray-100 dark:border-white/5">
                        <a href="<?php echo e(route('supplier-performance.detail', $supplier->id)); ?>"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\procurement\supplier-performance.blade.php ENDPATH**/ ?>