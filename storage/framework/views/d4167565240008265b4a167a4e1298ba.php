...
<body class="font-[Inter,sans-serif] bg-white text-gray-900 antialiased">
    ...
    <footer class="bg-white border-t border-gray-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="<?php echo e(route('login')); ?>"
                                class="text-gray-500 hover:text-gray-900 transition">Masuk</a></li>
                        <li><a href="<?php echo e(route('register')); ?>"
                                class="text-gray-500 hover:text-gray-900 transition">Daftar Gratis</a></li>
                        <li>
                            <a href="https://wa.me/6281654932383" target="_blank" rel="noopener"
            ...
            <div
                class="border-t border-gray-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400">
