                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($stat['name']); ?></h3>
                                <span
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-md font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($stat['total_quantity'])); ?></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Transactions</span>
                                    <span
                                        class="text-md font-semibold text-gray-900 dark:text-white"><?php echo e($stat['transaction_count']); ?></span>
                                </div>
                                <div
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $salesTrend->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-sm text-gray-600 dark:text-gray-400 w-24"><?php echo e($sale->date); ?></span>
