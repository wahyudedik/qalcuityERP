...
<?php $component->withAttributes([]); ?>
    ...
    <div class="space-y-4">
        ...
        <?php $po = $m['po']; ?>
        <div class="bg-white rounded-2xl border <?php echo e($m['status'] === 'matched' ? 'border-green-200' : ($m['status'] === 'partial' ? 'border-amber-200' : 'border-red-200')); ?> overflow-hidden">
            
            <div class="flex flex-col sm:flex-row sm:items-center justify-between px-5 py-4 border-b border-gray-100">
                <div>
                    <div class="flex items-center gap-2">
                        <p class="font-mono text-sm font-semibold text-gray-900"><?php echo e($po->number); ?></p>
                        <?php
            ...
            <div class="grid grid-cols-3 divide-x divide-gray-100">
                ...
                <div class="px-5 py-4">
                    ...
                    <p class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($m['po_total'], 0, ',', '.')); ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e(number_format($m['po_qty'], 0)); ?> unit dipesan</p>
                ...
                <div class="px-5 py-4">
                    ...
                    <p class="text-lg font-bold <?php echo e($m['gr_match'] ? 'text-green-600' : 'text-red-500'); ?>">
                        <?php echo e(number_format($m['gr_qty'], 0)); ?> unit diterima
                    </p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($po->goodsReceipts->count()); ?> GR</p>
                    <div class="mt-3 space-y-1">
                ...
                <div class="px-5 py-4">
                    ...
                    <p class="text-lg font-bold <?php echo e($m['inv_match'] ? 'text-green-600' : 'text-red-500'); ?>">
