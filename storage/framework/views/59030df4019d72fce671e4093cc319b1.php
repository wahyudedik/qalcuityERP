...
<?php $__env->startSection('title', 'Variant Attributes'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $attributes->where('attribute_type', 'shade'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($attr->attribute_name); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($attr->usage_count); ?> variants</div>
                                    </div>
                                </div>
                                <form method="POST" action="<?php echo e(route('cosmetic.variants.attributes.destroy', $attr->id)); ?>"
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $attributes->where('attribute_type', 'size'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($attr->attribute_name); ?></div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $attributes->where('attribute_type', 'fragrance'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($attr->attribute_name); ?></div>
                                ...
                                <form method="POST"
                                    action="<?php echo e(route('cosmetic.variants.attributes.destroy', $attr->id)); ?>"
                                    onsubmit="return confirm('Delete this attribute?')">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="text-red-600 hover:text-red-900">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $attributes->where('attribute_type', 'packaging'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <div>
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($attr->attribute_name); ?></div>
    ...
    <div id="add-attribute-modal"
        ...
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-lg bg-white">
            ...
            <form method="POST" action="<?php echo e(route('cosmetic.variants.attributes.store')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\variants\attributes.blade.php ENDPATH**/ ?>