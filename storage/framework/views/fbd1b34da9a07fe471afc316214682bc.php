...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="text-center text-sm text-gray-500">
            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 font-semibold hover:underline">← Kembali ke login</a>
        </p>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>