...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('suppliers.index')); ?>" class="px-3 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">Supplier</a>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3 font-mono text-xs font-medium text-gray-900 dark:text-white"><?php echo e($po->number); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-700 dark:text-slate-300"><?php echo e($po->supplier->name ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e($po->warehouse->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right font-medium text-gray-900 dark:text-white">Rp <?php echo e(number_format($po->total,0,',','.')); ?></td>
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell text-xs text-gray-500 dark:text-slate-400"><?php echo e($po->date->format('d M Y')); ?></td>
                        <td class="px-4 py-3 text-center">
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($orders->links()); ?></div>
        <?php endif; ?>
    </div>
