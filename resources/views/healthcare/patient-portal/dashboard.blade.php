    ...
    @else
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $statistics['total_visits'] ?? 0 }}
                </p>
            </div>
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
                    ...
                    @forelse($appointments as $appointment)
                        <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-white/5 rounded-xl">
                            <div
                                ...
                                <span
                                    class="text-lg font-bold text-blue-600 dark:text-blue-400">{{ $appointment->appointment_date->format('d') }}</span>
                            </div>
