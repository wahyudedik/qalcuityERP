...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <a href="<?php echo e(route('cosmetic.distribution.index')); ?>"
                class="bg-white rounded-lg shadow p-4 hover:shadow-md transition <?php echo e(request()->routeIs('cosmetic.distribution.index') ? 'ring-2 ring-blue-500' : ''); ?>">
            ...
            <a href="<?php echo e(route('cosmetic.distribution.pricing')); ?>"
                class="bg-white rounded-lg shadow p-4 hover:shadow-md transition <?php echo e(request()->routeIs('cosmetic.distribution.pricing') ? 'ring-2 ring-blue-500' : ''); ?>">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('cosmetic.distribution.inventory')); ?>"
                class="bg-white rounded-lg shadow p-4 hover:shadow-md transition <?php echo e(request()->routeIs('cosmetic.distribution.inventory') ? 'ring-2 ring-blue-500' : ''); ?>">
                <div class="flex items-center">
            ...
            <a href="<?php echo e(route('cosmetic.distribution.performance')); ?>"
                class="bg-white rounded-lg shadow p-4 hover:shadow-md transition <?php echo e(request()->routeIs('cosmetic.distribution.performance') ? 'ring-2 ring-blue-500' : ''); ?>">
                <div class="flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-gray-900"><?php echo e($stats['total_channels']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Active Channels</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e($stats['active_channels']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Retail</div>
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e($stats['retail_channels']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Online</div>
                <div class="mt-2 text-3xl font-bold text-purple-600"><?php echo e($stats['online_channels']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Distributors</div>
                <div class="mt-2 text-3xl font-bold text-orange-600"><?php echo e($stats['distributor_channels']); ?></div>
            </div>
        </div>

        <!-- Filters -->
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <form method="GET" action="<?php echo e(route('cosmetic.distribution.index')); ?>" class="flex gap-4">
                <div class="flex-1">
                    <select name="type"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                        <option value="">All Channel Types</option>
                        <option value="retail" <?php echo e(request('type') == 'retail' ? 'selected' : ''); ?>>Retail Store</option>
                        <option value="online_marketplace" <?php echo e(request('type') == 'online_marketplace' ? 'selected' : ''); ?>>
                            Online Marketplace</option>
                        <option value="distributor" <?php echo e(request('type') == 'distributor' ? 'selected' : ''); ?>>Distributor
                        </option>
                        <option value="reseller_mlm" <?php echo e(request('type') == 'reseller_mlm' ? 'selected' : ''); ?>>Reseller/MLM
                        </option>
                    </select>
                </div>
                <button type="submit"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $channels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($channel->channel_code); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <div class="font-medium"><?php echo e($channel->channel_name); ?></div>
                                <?php if($channel->description): ?>
                                    <div class="text-xs text-gray-500"><?php echo e(Str::limit($channel->description, 50)); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full
                                    <?php echo e($channel->channel_type === 'retail'
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php if($channel->contact_person): ?>
                                    <div class="font-medium"><?php echo e($channel->contact_person); ?></div>
                                    <?php if($channel->contact_email): ?>
                                        <div class="text-xs"><?php echo e($channel->contact_email); ?></div>
                                    <?php endif; ?>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(number_format($channel->commission_rate, 2)); ?>%</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(number_format($channel->discount_rate, 2)); ?>%</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e($channel->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <span class="text-gray-500" title="Pricing: <?php echo e($channel->pricing_count); ?>">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </span>
                                    <span class="text-gray-500" title="Inventory: <?php echo e($channel->inventory_count); ?>">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                        </svg>
    ...
    <div id="addChannelModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
            ...
            <form method="POST" action="<?php echo e(route('cosmetic.distribution.channels.store')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\distribution\index.blade.php ENDPATH**/ ?>