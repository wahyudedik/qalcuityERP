                ...
                <div class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <div class="px-5 py-4 flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($c->label); ?></p>
                            <p class="text-xs text-gray-400 dark:text-slate-500 font-mono mt-0.5"><?php echo e($c->key); ?></p>
                        </div>
