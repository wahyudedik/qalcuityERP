<x-app-layout>
    <x-slot name="header">IoT Device Management</x-slot>

    {{-- Toolbar --}}
    <div class="flex flex-wrap items-center justify-end gap-2 mb-4">
        <a href="{{ route('iot.devices.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2">{{ $devices->total() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 mt-2">{{ $devices->where('is_connected', true)->count() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-yellow-600 mt-2">{{ $devices->where('is_active', true)->where('is_connected', false)->count() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-600 mt-2">{{ $devices->where('is_active', false)->count() }}</p>
                        </div>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-xs text-gray-500 font-mono">{{ $device->device_id }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                    ...
                                    <span class="text-sm text-gray-700">{{ \App\Models\IotDevice::deviceTypes()[$device->device_type] ?? $device->device_type }}</span>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="{{ route('iot.devices.show', $device) }}" class="inline-flex items-center px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-blue-800 border border-blue-200 rounded-lg hover:bg-blue-50 transition">
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <a href="{{ route('iot.devices.create') }}" class="text-blue-600 hover:text-blue-800 font-medium">Tambah sekarang</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
