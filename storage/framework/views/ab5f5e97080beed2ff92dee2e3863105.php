        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <div class="flex items-start gap-6 mb-6">
                    ...
                    <div class="flex-1">
                        <h2 class="text-xl font-bold text-gray-900"><?php echo e($guest->name); ?></h2>
                        <p class="text-sm text-gray-500"><?php echo e($guest->guest_code); ?></p>
                        <div class="flex flex-wrap gap-3 mt-2">
                            <?php if($guest->email): ?>
                                <a href="mailto:<?php echo e($guest->email); ?>"
                                    class="text-sm text-blue-600 hover:underline"><?php echo e($guest->email); ?></a>
                            <?php endif; ?>
                            <?php if($guest->phone): ?>
                                <a href="tel:<?php echo e($guest->phone); ?>"
                                    class="text-sm text-gray-600"><?php echo e($guest->phone); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($guest->id_number ?? '—'); ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900"><?php echo e($guest->nationality ?? '—'); ?></p>
                    </div>
                </div>
                ...
                <?php if($guest->notes): ?>
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        ...
                        <p class="text-gray-700 text-sm whitespace-pre-line"><?php echo e($guest->notes); ?>
            ...
            <div
                ...
                <?php if($reservations->hasPages()): ?>
                    <div class="px-4 py-3 border-t border-gray-100"><?php echo e($reservations->links()); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="text-2xl font-bold text-gray-900"><?php echo e($guest->total_stays ?? 0); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($guest->vip_level && $guest->vip_level !== 'regular' ? $vipColor : 'bg-gray-100 text-gray-500'); ?>">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="text-gray-700"><?php echo e($guest->created_at->format('d M Y, H:i')); ?></span>
                    </div>
                    <?php if($guest->updated_at != $guest->created_at): ?>
                        <div class="flex items-center justify-between">
                            <span class="text-gray-500">Last Updated</span>
                            <span
                                class="text-gray-700"><?php echo e($guest->updated_at->format('d M Y, H:i')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="address" rows="2"
                            class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e($guest->address); ?></textarea>
                    </div>
                    <div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notes" rows="2"
                            class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e($guest->notes); ?></textarea>
                    </div>
                </div>
