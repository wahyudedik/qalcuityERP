    ...
    <?php else: ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-2xl p-4 border border-gray-200">
                ...
                <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($upcomingAppointments); ?></p>
            </div>
            <div class="bg-white rounded-2xl p-4 border border-gray-200">
                <p class="text-xs text-gray-500">Today</p>
                <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($todayAppointments); ?></p>
            </div>
            <div class="bg-white rounded-2xl p-4 border border-gray-200">
                <p class="text-xs text-gray-500">Completed</p>
                <p class="text-2xl font-bold text-gray-600 mt-1"><?php echo e($completedAppointments); ?></p>
            </div>
            <div class="bg-white rounded-2xl p-4 border border-gray-200">
                <p class="text-xs text-gray-500">Cancelled</p>
                <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e($cancelledAppointments); ?></p>
            </div>
        </div>
