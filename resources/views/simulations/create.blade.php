<x-app-layout>
    <x-slot name="header">Buat Simulasi Baru</x-slot>
    ...
    <div class="py-6 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('simulations.store') }}" x-data="simForm()" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Simulasi</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tipe Skenario</label>
            ...
            <div x-show="type === 'price_increase'" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <h3 class="font-medium text-gray-900">Parameter Kenaikan Harga</h3>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Kenaikan Harga (%)</label>
                        <input type="number" name="parameters[price_change_pct]" value="{{ old('parameters.price_change_pct', 10) }}"
                               min="1" max="100" step="0.5"
                               class="w-full rounded-lg border-gray-300 text-sm">
                    </div>
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Periode Historis (hari)</label>
            ...
            <div x-show="type === 'new_branch'" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <h3 class="font-medium text-gray-900">Parameter Cabang Baru</h3>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Biaya Tetap/Bulan (Rp)</label>
                        <input type="number" name="parameters[fixed_cost_monthly]" value="{{ old('parameters.fixed_cost_monthly', 10000000) }}"
                               min="0" step="500000"
                               class="w-full rounded-lg border-gray-300 text-sm">
                    </div>
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Proyeksi Omzet/Bulan (Rp)</label>
                    ...
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Periode Proyeksi (bulan)</label>
            ...
            <div x-show="type === 'stock_out'" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <h3 class="font-medium text-gray-900">Parameter Simulasi Stok Habis</h3>
                <div>
                    <label class="block text-sm text-gray-600 mb-1">Periode Simulasi (hari)</label>
            ...
            <div x-show="type === 'cost_reduction'" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <h3 class="font-medium text-gray-900">Parameter Efisiensi Biaya</h3>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Pengurangan Biaya (%)</label>
            ...
            <div x-show="type === 'demand_change'" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                <h3 class="font-medium text-gray-900">Parameter Perubahan Demand</h3>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-gray-600 mb-1">Perubahan Demand (%) — negatif = turun</label>
