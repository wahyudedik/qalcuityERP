...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Total PR</p>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-4">
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="<?php echo e(route('purchasing.requisitions')); ?>" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Reset</a>
        </form>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <p class="font-mono text-xs font-semibold text-gray-900"><?php echo e($pr->number); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($pr->created_at->format('d M Y')); ?></p>
                        </td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-700"><?php echo e($pr->requester->name); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500"><?php echo e($pr->department ?? '—'); ?></td>
                    ...
                    <tr><td colspan="7" class="px-4 py-12 text-center text-gray-400">Belum ada Purchase Requisition.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        <?php if($requisitions->hasPages()): ?>
        <div class="px-4 py-3 border-t border-gray-100"><?php echo e($requisitions->links()); ?></div>
        <?php endif; ?>
    </div>
    ...
    <div id="modal-add-pr" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-2xl shadow-xl max-h-[90vh] overflow-y-auto">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 sticky top-0 bg-white">
                <h3 class="font-semibold text-gray-900">Buat Purchase Requisition</h3>
            ...
            <form method="POST" action="<?php echo e(route('purchasing.requisitions.store')); ?>" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="department" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Tanggal Dibutuhkan</label>
                        <input type="date" name="required_date" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900">
                    </div>
                    <div class="col-span-2">
                        <label class="block text-xs font-medium text-gray-600 mb-1">Tujuan / Keperluan</label>
                        <textarea name="purpose" rows="2" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 resize-none"></textarea>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        <p class="text-xs font-semibold text-gray-600 uppercase tracking-wide">Item yang Diminta</p>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    <button type="button" onclick="document.getElementById('modal-add-pr').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</button>
    ...
    <div id="modal-approve-pr" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Proses PR</h3>
            ...
            <form id="form-approve-pr" method="POST" class="p-6 space-y-4">
                ...
                <p id="approve-pr-num" class="text-sm font-medium text-gray-700"></p>
                <div>
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="document.getElementById('modal-approve-pr').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</button>
    ...
    <div id="modal-convert-pr" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Konversi PR ke PO</h3>
            ...
            <form id="form-convert-pr" method="POST" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <p id="convert-pr-num" class="text-sm font-medium text-gray-700"></p>
                <div>
                ...
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="document.getElementById('modal-convert-pr').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</button>
    ...
    function addPrItem() {
        ...
        div.innerHTML = `
            <div class="col-span-5"><input type="text" name="items[${i}][description]" placeholder="Deskripsi item *" required class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900"></div>
            <div class="col-span-2"><input type="number" name="items[${i}][quantity]" placeholder="Qty" min="0.01" step="0.01" required class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900"></div>
            ...
            <div class="col-span-2"><input type="number" name="items[${i}][estimated_price]" placeholder="Est. Harga" min="0" step="1000" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900"></div>
