    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalHours, 1)); ?> <span class="text-sm font-normal text-gray-400">jam</span></p>
            </div>
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                <p class="text-xs text-gray-500 dark:text-slate-400 mb-1">Total Biaya (filter)</p>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">Rp <?php echo e(number_format($totalCost, 0, ',', '.')); ?></p>
            </div>
        </div>
        ...
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="<?php echo e(route('timesheets.index')); ?>" class="px-4 py-2 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-slate-300 text-sm font-medium rounded-xl hover:bg-gray-100 dark:hover:bg-white/5 transition">Reset</a>
            <?php endif; ?>
        </form>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            <td class="px-6 py-3 text-gray-500 dark:text-slate-400 whitespace-nowrap"><?php echo e($ts->date->format('d M Y')); ?></td>
                            <td class="px-6 py-3 font-medium text-gray-900 dark:text-white"><?php echo e($ts->project?->name ?? '-'); ?></td>
                            <td class="px-6 py-3 text-gray-500 dark:text-slate-400 hidden sm:table-cell"><?php echo e($ts->user?->name ?? '-'); ?></td>
                            <td class="px-6 py-3 text-gray-600 dark:text-slate-300 max-w-xs truncate"><?php echo e($ts->description); ?></td>
                            <td class="px-6 py-3 text-right font-medium text-gray-900 dark:text-white"><?php echo e(number_format($ts->hours, 1)); ?></td>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/timesheets/index.blade.php ENDPATH**/ ?>