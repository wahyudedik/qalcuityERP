    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2 text-3xl font-bold text-blue-600">{{ $stats['pregnant_count'] }}</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Upcoming Births</div>
                <div class="mt-2 text-3xl font-bold text-yellow-600">{{ $stats['upcoming_births'] }}</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Success Rate</div>
                <div class="mt-2 text-3xl font-bold text-green-600">{{ $stats['success_rate'] }}%</div>
            </div>
        </div>
                        ...
                        @forelse($records as $record)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if ($record->status === 'pregnant') bg-blue-100 text-blue-800
                                    @elseif($record->status === 'born') bg-green-100 text-green-800
