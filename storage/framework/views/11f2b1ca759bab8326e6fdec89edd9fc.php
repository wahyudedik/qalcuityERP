...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-xl font-bold text-gray-900"><?php echo e(number_format($stats['total_sold'])); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <a href="<?php echo e(route('farm.livestock.show', $herd)); ?>" class="block bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-emerald-300 transition">
            <div class="px-5 py-4">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-2">
                        <span class="text-lg"><?php echo e(explode(' ', \App\Models\LivestockHerd::ANIMAL_TYPES[$herd->animal_type] ?? '🐾')[0]); ?></span>
                        <span class="font-bold text-gray-900"><?php echo e($herd->code); ?></span>
                        <span class="text-xs px-2 py-0.5 rounded-full <?php echo e($herd->status === 'active' ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500'); ?>"><?php echo e(ucfirst($herd->status)); ?></span>
                    </div>
                    <span class="text-2xl font-black text-gray-900"><?php echo e(number_format($herd->current_count)); ?></span>
                </div>
                <p class="text-sm text-gray-500"><?php echo e($herd->name); ?></p>
                <div class="grid grid-cols-3 gap-2 mt-3 text-xs">
                    <div><span class="text-gray-400">Awal:</span> <span class="text-gray-700"><?php echo e($herd->initial_count); ?></span></div>
                    ...
                    <div><span class="text-gray-400">Umur:</span> <span class="text-gray-700"><?php echo e($herd->ageDays() ?? '-'); ?> hari</span></div>
                </div>
                <?php if($herd->plot): ?>
