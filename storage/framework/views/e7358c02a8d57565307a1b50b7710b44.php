...
<?php $component->withAttributes(['title' => 'Linen Inventory']); ?>
     <?php $__env->slot('header', null, []); ?> Linen Inventory <?php $__env->endSlot(); ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600"><?php echo e($item->item_code); ?></p>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($item->category); ?>
