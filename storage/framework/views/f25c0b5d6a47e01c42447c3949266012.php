        ...
        <div class="flex-1">
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100 dark:border-white/10 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('inventory.index')); ?>" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">← Kembali ke Produk</a>
                </div>
                <div class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <div class="px-5 py-4 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-slate-400">Kode: <?php echo e($wh->code); ?> <?php if($wh->address): ?> · <?php echo e($wh->address); ?><?php endif; ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($wh->productStocks->sum('quantity'))); ?></p>
