    ...
    <div class="flex flex-col lg:flex-row gap-5">
        ...
        <div class="lg:w-64 shrink-0 space-y-4">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4">
                <p class="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-3">Riwayat SP — <?php echo e($letter->employee->name); ?></p>
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('hrm.disciplinary.show', $h)); ?>"
                        class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e($h->id === $letter->id ? 'bg-blue-50 dark:bg-blue-500/10' : ''); ?>">
                        <span class="px-1.5 py-0.5 rounded text-xs font-bold <?php echo e($h->levelColor()); ?>"><?php echo e($h->levelLabel()); ?></span>
                        <div class="min-w-0">
                            <p class="text-xs text-gray-700 dark:text-slate-300 truncate"><?php echo e($h->violation_type); ?></p>
                            <p class="text-xs text-gray-400 dark:text-slate-500"><?php echo e($h->issued_date->format('d M Y')); ?></p>
                        </div>
                    </a>
        ...
        <div class="flex-1 min-w-0">
            <div id="print-area" class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-8 print:shadow-none print:border-none print:rounded-none print:p-6">
                ...
                <div class="text-center border-b-2 border-gray-800 dark:border-white/30 pb-4 mb-6 print:border-gray-800">
                    ...
                    <p class="text-2xl font-black text-gray-900 dark:text-white mt-1"><?php echo e($letter->levelLabel()); ?></p>
                    <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">No: <?php echo e($letter->letter_number); ?></p>
                </div>
                ...
                <div class="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10">
                    ...
                    <p class="text-sm text-gray-700 dark:text-slate-300 whitespace-pre-line"><?php echo e($letter->employee_response); ?></p>
                </div>
                <?php endif; ?>
