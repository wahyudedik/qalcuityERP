...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Strategic Sourcing Analytics <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($dashboard['active_opportunities']); ?>

            </p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500">RFQs This Month</p>
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($dashboard['rfqs_this_month']); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($dashboard['avg_response_time']); ?>h</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500">Completion Rate</p>
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($dashboard['completion_rate']); ?>%</p>
        </div>
    </div>
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="font-medium text-gray-900"><?php echo e($opportunity->title); ?></h4>
                                    <?php
                                        $priorityColors = [
                                            'low' => 'gray',
                                            'medium' => 'blue',
                                    ...
                                    ?>
                                    <span
                                        class="px-2 py-0.5 text-xs rounded-full bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-700 $color }}-500/20 $color }}-400">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="font-medium text-gray-900 ml-1"><?php echo e(ucfirst(str_replace('_', ' ', $opportunity->status))); ?></span>
                                    </div>
                                    <?php if($opportunity->target_completion_date): ?>
                                        <div>
                                            <span class="text-gray-500">Target:</span>
                                            <span
                                                class="font-medium text-gray-900 ml-1"><?php echo e($opportunity->target_completion_date->format('d M Y')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
