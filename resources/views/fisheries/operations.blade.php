                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3">
                                <span
                                    class="text-lg font-bold text-gray-900 dark:text-white">{{ $trip->trip_number }}</span>
                                <span
                    ...
                    <div class="px-5 py-4">
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            @if ($trip->fishing_zone)
                                <div>
                                    ...
                                    <span
                                        class="text-gray-700 dark:text-slate-300 font-medium">{{ $trip->fishing_zone->name ?? $trip->fishing_zone }}</span>
                                </div>
                            @endif
                            @if ($trip->expected_return)
                                <div>
                                    ...
                                    <span
                                        class="text-gray-700 dark:text-slate-300 font-medium">{{ $trip->expected_return->format('d M Y, H:i') }}</span>
                                </div>
                            @endif
                            <div>
                        ...
                        @if ($trip->crew_count > 0)
                            <div class="mt-3 pt-3 border-t border-gray-100 dark:border-white/5">
                                ...
                                <span class="text-sm text-gray-700 dark:text-slate-300 ml-1">{{ $trip->crew_count }}
                                    orang</span>
                            </div>
                        @endif
