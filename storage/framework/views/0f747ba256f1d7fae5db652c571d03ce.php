        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    <?php echo e(__('QC Inspections')); ?>

                </h2>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Quality control inspection records</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Total Inspections</p>
                            <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($stats['total']); ?></p>
                        </div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $inspections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inspection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-medium text-blue-600 dark:text-blue-400"><?php echo e($inspection->inspection_number); ?></span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($inspection->grade): ?>
                                            ...
                                            <?php echo e($inspection->grade == 'A' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : ''); ?>

                                            <?php echo e($inspection->grade == 'B' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' : ''); ?>

                                            <?php echo e($inspection->grade == 'C' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300' : ''); ?>

                                            <?php echo e($inspection->grade == 'D' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300' : ''); ?>

                                            <?php echo e($inspection->grade == 'F' ? 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300' : ''); ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <?php echo e($inspection->status_color == 'gray' ? 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300' : ''); ?>">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="9" class="px-6 py-12 text-center">
                                        <i
                                            class="fas fa-clipboard-list text-6xl text-gray-300 dark:text-gray-600 mb-4"></i>
                                        <p class="text-gray-500 dark:text-gray-400">No QC inspections found</p>
                                        <a href="<?php echo e(route('qc.inspections.create')); ?>"
