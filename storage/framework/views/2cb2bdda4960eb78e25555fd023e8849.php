        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow">
                    ...
                    <div
                        class="mt-2 flex items-center text-sm <?php echo e($dashboard['financial_kpis']['revenue']['trend'] === 'up' ? 'text-green-600' : 'text-red-600'); ?>">
                        <span><?php echo e($dashboard['financial_kpis']['revenue']['trend'] === 'up' ? '↑' : '↓'); ?></span>
                        <span class="ml-1"><?php echo e(abs($dashboard['financial_kpis']['revenue']['growth'])); ?>% vs
                            previous</span>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow">
                    ...
                    <p
                        class="text-3xl font-bold <?php echo e($dashboard['financial_kpis']['cash_flow'] >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-right">
                                ...
                                <p
                                    ...
                                    <?php echo e($dashboard['operational_kpis']['orders']['growth']); ?>% growth
                                </p>
                            </div>
                        </div>
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-right">
                                ...
                                <p
                                    ...
                                    <?php echo e($dashboard['customer_kpis']['new_customers']['growth']); ?>% growth
                                </p>
                            </div>
                        </div>
                        <div class="flex justify-between items-center">
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\analytics\executive-dashboard.blade.php ENDPATH**/ ?>