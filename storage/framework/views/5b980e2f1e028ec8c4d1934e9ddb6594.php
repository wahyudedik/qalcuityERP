        ...
        <?php $__empty_1 = true; $__currentLoopData = $groupBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo e($group->group_name); ?></h3>
                        <p class="text-xs text-gray-500 dark:text-slate-400 mt-1"><?php echo e($group->group_code); ?></p>
                    </div>
                    <?php
                        $statusColors = [
                ...
                <div class="space-y-3 mb-4">
                    <div class="flex items-center gap-2 text-sm">
                        ...
                        <span class="text-gray-600 dark:text-slate-300"><?php echo e(ucfirst($group->type)); ?> Group</span>
                    </div>
