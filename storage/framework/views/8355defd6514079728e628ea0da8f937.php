...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($totalQueues); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Menunggu</p>
            <p class="text-2xl font-bold text-amber-600 mt-1"><?php echo e($waitingQueues); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Dipanggil</p>
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($inProgressQueues); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Selesai</p>
            <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($completedQueues); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Dilewati</p>
            <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e($skippedQueues); ?></p>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-100" id="queue-table-body">
                    <?php $__empty_1 = true; $__currentLoopData = $queues ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 queue-row"
                            ...
                            <td class="px-4 py-3">
                                <span
                                    class="text-xl font-black text-blue-600"><?php echo e($queue->queue_number); ?></span>
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 hidden lg:table-cell">
                                <p class="text-gray-900"><?php echo e($queue->counter ?? '-'); ?></p>
                            </td>
