<x-app-layout>
    <x-slot name="header">📋 Mix Design Version History - {{ $mixDesign->grade }}</x-slot>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div>
                        ...
                        <div class="text-xl font-bold text-gray-900">{{ $mixDesign->grade }}</div>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="space-y-6">
                    @foreach ($versions as $index => $version)
                        <div
                            class="relative pl-8 border-l-2 {{ $index === 0 ? 'border-blue-500' : 'border-gray-300' }}">
                            {{-- Version Badge --}}
                                            ...
                                            @if (is_array($changes) && !isset($changes['message']))
                                                @foreach ($changes as $field => $change)
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-gray-600">{{ str_replace('_', ' ', ucfirst($field)) }}</span>
