    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-gray-900"><?php echo e($stats['total_batches']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">In Progress</div>
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e($stats['in_progress']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">QC Pending</div>
                <div class="mt-2 text-3xl font-bold text-yellow-600"><?php echo e($stats['qc_pending']); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Released</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e($stats['released']); ?></div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4 mb-6">
            <form method="GET" action="<?php echo e(route('cosmetic.batches.index')); ?>" class="flex gap-4">
                ...
                <select name="status" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    ...
                    <option value="qc_pending" <?php echo e(request('status') == 'qc_pending' ? 'selected' : ''); ?>>QC Pending</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/cosmetic/batches/index.blade.php ENDPATH**/ ?>