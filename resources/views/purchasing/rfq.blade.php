        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between px-5 py-4 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    <div>
                        <p class="font-mono text-sm font-semibold text-gray-900">{{ $rfq->number }}</p>
                ...
                <div class="flex items-center gap-2 mt-3 sm:mt-0">
                    <span class="text-xs text-gray-500">{{ $rfq->responses->count() }} penawaran</span>
                    @if($rfq->status === 'open')
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="{{ $resp->is_selected ? 'bg-green-50' : 'hover:bg-gray-50' }}">
