                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="dietary_requirements" rows="3"
                            ...
                            class="w-full px-3 py-2.5 text-sm rounded-lg border border-gray-300 bg-gray-50 text-gray-900 focus:ring-2 focus:ring-blue-500"><?php echo e(old('dietary_requirements', $form->dietary_requirements ?? '')); ?></textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="special_requests" rows="3" placeholder="Any special requests or notes for your stay..."
                            class="w-full px-3 py-2.5 text-sm rounded-lg border border-gray-300 bg-gray-50 text-gray-900 focus:ring-2 focus:ring-blue-500"><?php echo e(old('special_requests', is_array($form->special_requests ?? null) ? implode("\n", $form->special_requests) : $form->special_requests ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
