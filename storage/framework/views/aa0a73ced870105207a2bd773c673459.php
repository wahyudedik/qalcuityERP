...
<div class="p-6 space-y-8 max-w-4xl">
    ...
    <div class="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-700">
        ...
        <div class="flex items-center gap-2">
            <code class="flex-1 text-xs bg-white dark:bg-black/30 border border-amber-200 dark:border-amber-700 rounded-lg px-3 py-2 font-mono text-amber-900 dark:text-amber-200 break-all"><?php echo e(session('new_token')); ?></code>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
        ...
        <code class="text-xs text-blue-700 dark:text-blue-400 font-mono"><?php echo e(url('/api/v1')); ?></code>
        ...
        <div class="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs text-blue-700 dark:text-blue-400">
            ...
            <code class="bg-blue-100 dark:bg-blue-900/40 px-2 py-1 rounded"><?php echo e($ep); ?></code>
    ...
    <div class="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100 dark:divide-white/5">
            ...
            <div class="px-5 py-4 flex items-center justify-between gap-4">
                <div class="min-w-0">
                    <div class="flex items-center gap-2">
                        <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($token->name); ?></p>
        ...
        <div class="divide-y divide-gray-100 dark:divide-white/5">
            ...
            <div class="px-5 py-4">
                <div class="flex items-start justify-between gap-4">
                    <div class="min-w-0">
                        <div class="flex items-center gap-2">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($wh->name); ?></p>
                            <span class="text-xs px-2 py-0.5 rounded-full <?php echo e($wh->is_active ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400' : 'bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-slate-400'); ?>">
                                <?php echo e($wh->is_active ? 'Aktif' : 'Nonaktif'); ?>

                            </span>
                        </div>
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5 truncate max-w-xs"><?php echo e($wh->url); ?></p>
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">Events: <?php echo e(implode(', ', $wh->events ?? [])); ?></p>
                        <div class="flex items-center gap-3 mt-0.5">
                            <?php if($wh->last_triggered_at): ?>
                            <p class="text-xs text-gray-400 dark:text-slate-500">Terakhir: <?php echo e($wh->last_triggered_at->diffForHumans()); ?></p>
                            <?php endif; ?>
                        ...
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">
                            Secret: <code class="bg-gray-100 dark:bg-white/5 px-1 rounded text-[10px]"><?php echo e(Str::mask($wh->secret, '*', 4)); ?></code>
                        </p>
                    </div>
                    <div class="flex items-center gap-2 shrink-0">
        ...
        <form method="POST" action="<?php echo e(route('api-settings.webhooks.store')); ?>" class="space-y-4">
            ...
            <div>
                ...
                <div class="space-y-3 max-h-64 overflow-y-auto">
                    ...
                    <div>
                        <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-slate-500 mb-1"><?php echo e($group); ?></p>
                        <div class="space-y-1">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="events[]" value="<?php echo e($ev); ?>"
                                       class="rounded border-gray-300 dark:border-white/20 text-blue-600">
                                <span class="text-sm text-gray-700 dark:text-slate-300 font-mono text-xs"><?php echo e($ev); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
