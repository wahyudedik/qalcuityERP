                ...
                <?php $__empty_1 = true; $__currentLoopData = $lowStockItemsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 bg-amber-50 rounded-xl border border-amber-200">
                        <div class="flex items-center justify-between mb-2">
                            <div>
                                <p class="font-bold text-gray-900"><?php echo e($item->item_name); ?></p>
                            ...
                            <span class="px-2 py-1 text-xs font-bold bg-amber-500 text-white rounded-lg">
                                <?php echo e($item->stock_quantity); ?> <?php echo e($item->unit_of_measure ?? ''); ?>
                        ...
                        <?php if($item->minimum_stock > 0): ?>
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-amber-500 h-2 rounded-full"
                                    style="width: <?php echo e(min(100, ($item->stock_quantity / $item->minimum_stock) * 100)); ?>%">
                                </div>
                            </div>
                            <p class="text-xs text-gray-500 mt-1">Minimum: <?php echo e($item->minimum_stock); ?>

                                <?php echo e($item->unit_of_measure ?? ''); ?></p>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
