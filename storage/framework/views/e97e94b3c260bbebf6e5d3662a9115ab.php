                ...
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <?php else: ?>
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    <?php $__currentLoopData = $transfers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50 transition">
                                            ...
                                            <td class="px-4 py-3 text-gray-700"><?php echo e($t->product->name ?? '-'); ?></td>
                                            <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($t->warehouse->name ?? '-'); ?></td>
                                            <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($t->toWarehouse->name ?? '-'); ?></td>
                                            <td class="px-4 py-3 text-right font-medium text-gray-900"><?php echo e($t->quantity); ?></td>
                                            <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($t->user->name ?? '-'); ?></td>
                                            <td class="px-4 py-3 text-xs text-gray-500"><?php echo e($t->created_at->format('d/m/Y H:i')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                        ...
                        <?php if($transfers->hasPages()): ?>
                            <div class="px-6 py-4 border-t border-gray-100"><?php echo e($transfers->links()); ?></div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/inventory/transfers.blade.php ENDPATH**/ ?>