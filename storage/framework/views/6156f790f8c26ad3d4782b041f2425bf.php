            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-700"><?php echo e($r->employee->name ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell text-xs text-gray-500"><?php echo e($r->categoryLabel()); ?></td>
