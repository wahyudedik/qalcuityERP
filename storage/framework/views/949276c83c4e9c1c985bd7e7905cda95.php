                        ...
                        <div class="px-6 py-4 flex items-center gap-4">
                            <div class="flex-1">
                                <div class="flex items-center gap-2">
                                    <span class="font-medium text-gray-900 text-sm"><?php echo e($cat->name); ?></span>
                                    <span class="font-mono text-xs px-2 py-0.5 bg-gray-100 text-gray-500 rounded-full"><?php echo e($cat->code); ?></span>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">
                                    ...
                                    &bull; <span class="font-mono text-blue-500">GL: <?php echo e($cat->coa_account_code); ?></span>
                                    <?php else: ?>
