...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total_harvests']); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
            ...
            <p class="text-xl font-bold text-gray-900 dark:text-white">Rp <?php echo e(number_format($stats['total_cost'], 0, ',', '.')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4 mb-6">
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <div class="px-3 py-2 rounded-lg bg-gray-50 dark:bg-white/5 text-xs">
                <span class="font-bold text-gray-700 dark:text-slate-300"><?php echo e($pp->code); ?></span>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition">
                        ...
                        <td class="px-4 py-3 font-medium text-gray-900 dark:text-white"><?php echo e($log->plot?->code); ?></td>
                        <td class="px-4 py-3 text-gray-600 dark:text-slate-300"><?php echo e($log->crop_name); ?></td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <span class="inline-block text-[10px] px-1.5 py-0.5 rounded bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 mr-1"><?php echo e($g->grade); ?>: <?php echo e(number_format($g->quantity, 0)); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
