...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('delivery-orders.index')); ?>" class="text-slate-400 hover:text-slate-600">
                    ...
                    <?php if($selectedSo): ?>
                        ...
                        <?php $__currentLoopData = $selectedSo->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="grid grid-cols-12 gap-2 items-center mb-2 p-3 bg-slate-50 rounded-lg">
                                ...
                                <div class="col-span-6 text-sm text-slate-800 font-medium"><?php echo e($item->product->name); ?></div>
