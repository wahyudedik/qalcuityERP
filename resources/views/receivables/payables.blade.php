<x-app-layout>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <a href="{{ route('receivables.index') }}" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50 text-center">
            ← Piutang (Receivables)
        </a>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 {{ $overdue ? 'bg-red-50/50' : '' }}">
                        ...
                        <td class="px-4 py-3 text-right text-gray-900">Rp {{ number_format($pay->total_amount, 0, ',', '.') }}</td>
        ...
        <div class="px-4 py-3 border-t border-gray-100">{{ $payables->links() }}</div>
        @endif
    </div>
