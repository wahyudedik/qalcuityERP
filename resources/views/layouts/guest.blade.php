...
<div class="min-h-full flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 xl:w-3/5 flex-col justify-between p-12 relative overflow-hidden bg-[#0a0f1e]">
        ...
        <div class="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-violet-600/10 rounded-full blur-[80px] -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div class="relative z-10 space-y-8">
            ...
            <div class="grid grid-cols-2 gap-3 max-w-sm">
                ...
                <div class="flex items-center gap-2.5 text-sm text-slate-200">
                    <div class="w-5 h-5 rounded-full bg-blue-500/25 border border-blue-500/40 flex items-center justify-center shrink-0">
