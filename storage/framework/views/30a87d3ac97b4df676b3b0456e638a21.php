...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Production Gantt Chart')); ?> <?php $__env->endSlot(); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $schedule['work_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="mb-4">
                                ...
                                <div class="flex items-center gap-3 mb-2">
                                    <span
                                        class="text-sm font-medium text-gray-900 w-32"><?php echo e($wo['number']); ?></span>
                                    <span
                                        class="text-xs text-gray-600 flex-1"><?php echo e($wo['product_name']); ?></span>

                                    
                                    <span
                                        class="px-2 py-1 text-xs font-semibold rounded 
                            <?php echo e($wo['priority'] == 1 ? 'bg-red-100 text-red-700' : ''); ?>

                            <?php echo e($wo['priority'] == 2 ? 'bg-orange-100 text-orange-700' : ''); ?>

                            <?php echo e($wo['priority'] == 3 ? 'bg-blue-100 text-blue-700' : ''); ?>

                            <?php echo e($wo['priority'] == 4 ? 'bg-gray-100 text-gray-700' : ''); ?>">
                                    ...
                                    <span
                                        class="text-xs text-gray-600 w-16 text-right"><?php echo e($wo['progress']); ?>%</span>
                                </div>
                                ...
                                <div class="relative h-8 bg-gray-100 rounded-lg overflow-hidden ml-32">
                                    ...
                                    <?php echo e($wo['is_overdue'] ? 'bg-red-500' : 'bg-green-500'); ?>"
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="font-semibold text-gray-900"><?php echo e($analytics['priority_distribution']['urgent']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600"><i
                                    class="fas fa-circle text-orange-600 mr-2"></i>High</span>
                            <span
                                class="font-semibold text-gray-900"><?php echo e($analytics['priority_distribution']['high']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600"><i
                                    class="fas fa-circle text-blue-600 mr-2"></i>Normal</span>
                            <span
                                class="font-semibold text-gray-900"><?php echo e($analytics['priority_distribution']['normal']); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-600"><i
                                    class="fas fa-circle text-gray-600 mr-2"></i>Low</span>
                            <span
                                class="font-semibold text-gray-900"><?php echo e($analytics['priority_distribution']['low']); ?></span>
                        </div>
                    </div>
                </div>
