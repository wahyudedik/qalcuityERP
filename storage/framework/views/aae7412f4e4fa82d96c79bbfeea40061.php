        ...
        <?php if(session('error')): ?>
            <div class="flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 rounded-2xl px-5 py-4 text-sm">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-0.5 text-red-700"><?php echo e(session('error')); ?></p>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <label
                        ...
                        <?php echo e(old('cleanup_strategy', 'keep') === 'keep' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?>"
                    ...
                    <label
                        class="relative flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition
                        <?php echo e(old('cleanup_strategy') === 'archive' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?>"
                    ...
                    <label
                        class="relative flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition
                        <?php echo e(old('cleanup_strategy') === 'soft_delete' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?>"
                        ...
                        <?php $__currentLoopData = $keys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <label
                                ...
                                <input type="checkbox" name="modules[]" value="<?php echo e($key); ?>"
                                    class="sr-only module-checkbox" <?php echo e($isEnabled && !$isLocked ? 'checked' : ''); ?>

                                    <?php echo e($isLocked ? 'disabled' : ''); ?> onchange="updateCard(this)">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="text-xs text-gray-500 mt-0.5"><?php echo e($m['desc']); ?></div>
                                </div>
                                <div class="shrink-0">
                                    <?php if($isLocked): ?>
                                    ...
                                    <?php else: ?>
                                        <div
                                            class="w-10 h-5 rounded-full transition-colors <?php echo e($isEnabled ? 'bg-blue-600' : 'bg-gray-300'); ?> relative toggle-track">
                                            <div
