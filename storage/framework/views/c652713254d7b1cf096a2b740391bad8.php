...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-wrap items-center justify-end gap-2 mb-4">
        <a href="<?php echo e(route('supplier-performance.dashboard')); ?>" class="text-gray-400 hover:text-blue-500 transition-colors">
                ...
                <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-0.5 flex-wrap">
                        <?php if($supplier->company): ?>
                            <span class="text-sm text-gray-500"><?php echo e($supplier->company); ?></span>
                        <?php endif; ?>
                        <?php if($supplier->email): ?>
                            <span class="text-gray-300">·</span>
                            <span class="text-sm text-gray-400"><?php echo e($supplier->email); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
