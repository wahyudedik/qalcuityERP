            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo e($nights); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500 mb-1">Adults</p>
                        <p class="font-medium text-gray-700"><?php echo e($reservation->adults ?? 1); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500 mb-1">Children</p>
                        <p class="font-medium text-gray-700"><?php echo e($reservation->children ?? 0); ?></p>
                    </div>
                </div>
            </div>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $reservation->checkInOuts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-3 py-2">
                                            <span
                                                class="px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($cio->type === 'check_in' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'); ?>">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-900"><?php echo e($nights); ?></span>
                    </div>
                    <div class="flex justify-between">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <span
                            class="text-gray-700"><?php echo e($reservation->createdBy?->name ?? 'System'); ?></span>
                    </div>
                    <div class="flex items-center justify-between text-sm">
                        <span class="text-gray-500">Created at</span>
                        <span
                            class="text-gray-700"><?php echo e($reservation->created_at->format('d M Y, H:i')); ?></span>
                    </div>
                    <?php if($reservation->updated_at != $reservation->created_at): ?>
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-500">Last updated</span>
                            <span
                                class="text-gray-700"><?php echo e($reservation->updated_at->format('d M Y, H:i')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
