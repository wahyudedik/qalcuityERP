                ...
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white"><?php echo e($info['name']); ?></h3>
                                <?php if($isConnected): ?>
                                    <span
                    ...
                    <?php if($config): ?>
                        <div class="space-y-2 mb-4 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="text-gray-900 dark:text-white font-mono"><?php echo e($config->property_id ?? '-'); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-500 dark:text-slate-400">Last Synced</span>
                                <span
                                    class="text-gray-900 dark:text-white"><?php echo e($config->last_synced_at?->diffForHumans() ?? 'Never'); ?></span>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        <?php $__empty_1 = true; $__currentLoopData = $recentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                <td class="px-4 py-3">
                                    <span
                                        class="font-medium text-gray-900 dark:text-white"><?php echo e($channelInfo[$log->channel]['name'] ?? ucfirst($log->channel)); ?></span>
                                </td>
