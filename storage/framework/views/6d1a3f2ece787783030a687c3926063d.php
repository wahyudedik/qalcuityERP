    ...
    <form method="POST" action="<?php echo e(route('price-lists.store')); ?>" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="2" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('description')); ?></textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                ...
                <label class="flex items-center gap-2 p-2 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50">
                    ...
                    <span class="text-sm text-gray-700 truncate"><?php echo e($c->name); ?></span>
                </label>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="<?php echo e(route('price-lists.index')); ?>" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</a>
