<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalRequests) }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-blue-600 mt-1">{{ $approvedRequests }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Fulfilled Hari Ini</p>
            <p class="text-2xl font-bold text-green-600 mt-1">{{ $fulfilledToday }}</p>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($requests ?? [] as $request)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <span
                                    class="font-mono text-sm font-bold text-blue-600">{{ $request->request_number ?? '-' }}</span>
                            </td>
                            <td class="px-4 py-3">
                                <span
                            ...
                            <td class="px-4 py-3 hidden md:table-cell">
                                <p class="text-gray-900">{{ count($request->items ?? []) }} items</p>
