...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Create Ward')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('healthcare.wards.store')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="ward_code" id="ward_code" required
                                    ...
                                    value="WARD-<?php echo e(date('Ymd')); ?>-<?php echo e(str_pad(rand(1, 999), 4, '0', STR_PAD_LEFT)); ?>"
                                    readonly>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\wards\create.blade.php ENDPATH**/ ?>