            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-700 text-xs"><?php echo e($lc->purchaseOrder->number ?? '-'); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell text-gray-500"><?php echo e(Str::limit($lc->description, 40)); ?></td>
                        <td class="px-4 py-3 text-right font-medium text-gray-900">Rp <?php echo e(number_format($lc->total_additional_cost, 0, ',', '.')); ?></td>
                        <td class="px-4 py-3 text-center text-xs text-gray-500"><?php echo e($ml); ?></td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="<?php echo e(route('landed-cost.show', $lc)); ?>" class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50">Detail</a>
                    ...
                    <tr><td colspan="7" class="px-4 py-12 text-center text-gray-400">Belum ada landed cost.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        <?php if($landedCosts->hasPages()): ?><div class="px-4 py-3 border-t border-gray-100"><?php echo e($landedCosts->links()); ?></div><?php endif; ?>
    </div>
