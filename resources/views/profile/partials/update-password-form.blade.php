<form method="post" action="{{ route('password.update') }}" class="space-y-4">
    ...
    <div>
        <label for="update_password_current_password" class="block text-sm font-medium text-gray-500 mb-1.5">Password Saat
            Ini</label>
        <input id="update_password_current_password" name="current_password" type="password" autocomplete="current-password"
            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition
    ...
    <div>
        <label for="update_password_password" class="block text-sm font-medium text-gray-500 mb-1.5">Password
            Baru</label>
    ...
    <div>
        <label for="update_password_password_confirmation"
            class="block text-sm font-medium text-gray-500 mb-1.5">Konfirmasi Password Baru</label>
