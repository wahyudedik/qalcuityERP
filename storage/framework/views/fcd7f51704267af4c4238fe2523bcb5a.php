        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div x-data="{ expanded: false }"
                    class="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition <?php echo e($notif->isRead() ? 'opacity-50' : ''); ?>">
                    ...
                    <div x-show="expanded" x-collapse class="px-6 pb-4 pl-[4.5rem]">
                        <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                            <?php if($notif->data && is_array($notif->data)): ?>
                                <?php $__currentLoopData = $notif->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!in_array($key, ['url', 'action'])): ?>
                                        <div class="flex gap-2">
                                            <span
                                                class="text-xs font-medium text-gray-600 min-w-[100px]"><?php echo e(ucfirst(str_replace('_', ' ', $key))); ?>:</span>
                                            <span
                                                class="text-xs text-gray-900"><?php echo e(is_array($value) ? json_encode($value) : $value); ?></span>
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>

                            <?php if($notif->data && isset($notif->data['url'])): ?>
                                <div class="pt-2 border-t border-gray-200">
                                    <a href="<?php echo e($notif->data['url']); ?>"
