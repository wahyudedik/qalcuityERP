            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 {{ $expired ? 'opacity-60' : '' }}">
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell text-xs {{ $expired ? 'text-red-500' : 'text-gray-500' }}">
                            {{ $qt->valid_until?->format('d M Y') ?? '-' }}
                        </td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="{{ route('quotations.show', $qt) }}" class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50">
                                    Detail
                                </a>
