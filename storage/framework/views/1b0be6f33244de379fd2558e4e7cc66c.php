...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Disetujui (<?php echo e(now()->year); ?>)</p>
            <p class="text-2xl font-bold text-green-500 mt-1"><?php echo e($stats['approved']); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Ditolak (<?php echo e(now()->year); ?>)</p>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-4">
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="<?php echo e(route('hrm.leave')); ?>" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Reset</a>
        </form>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900"><?php echo e($leave->employee->name); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($leave->employee->position ?? '-'); ?></p>
                        </td>
                        <td class="px-4 py-3 text-gray-700"><?php echo e($leave->typeLabel()); ?></td>
                        <td class="px-4 py-3 text-gray-500 text-xs">
                            <?php echo e($leave->start_date->format('d M Y')); ?> — <?php echo e($leave->end_date->format('d M Y')); ?>

                        </td>
                        <td class="px-4 py-3 text-center font-semibold text-gray-900"><?php echo e($leave->days); ?></td>
        ...
        <div class="px-4 py-3 border-t border-gray-100"><?php echo e($leaves->links()); ?></div>
        <?php endif; ?>
    </div>
