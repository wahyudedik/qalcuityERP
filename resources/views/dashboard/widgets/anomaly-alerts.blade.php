                ...
                <div class="rounded-xl border {{ $aBorder }} p-3.5 flex items-start gap-3"
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 mb-0.5">
                            <p class="text-sm font-semibold text-gray-900 truncate">{{ $aTitle }}</p>
                            <span class="text-xs font-medium px-1.5 py-0.5 rounded-full shrink-0 {{ $aBadge }}">
                                {{ $aBadgeLabel }}
                            </span>
                        </div>
                        <p class="text-xs text-gray-500 leading-relaxed">{{ $aDesc }}</p>
                        <p class="text-xs text-gray-400 mt-1">{{ $aTimeAgo }}</p>
                    </div>
                    <button onclick="acknowledgeAnomaly({{ $aId }}, this)"
