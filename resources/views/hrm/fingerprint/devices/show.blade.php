...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">{{ $device->name }}</h1>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-2xl font-bold text-gray-900 dark:text-white">{{ $status['today_scans'] ?? 0 }}</div>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white font-medium">{{ $device->device_id }}</p>
                </div>
                <div>
                    <label class="text-sm text-gray-600 dark:text-gray-400">Vendor</label>
                    <p class="text-gray-900 dark:text-white font-medium">{{ ucfirst($device->vendor) }}</p>
                </div>
                <div>
                    <label class="text-sm text-gray-600 dark:text-gray-400">Model</label>
                    <p class="text-gray-900 dark:text-white font-medium">{{ $device->model ?? '-' }}</p>
                </div>
                <div>
                    <label class="text-sm text-gray-600 dark:text-gray-400">Protokol</label>
                    <p class="text-gray-900 dark:text-white font-medium">{{ strtoupper($device->protocol) }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white font-medium">{{ $device->port }}</p>
                </div>
                <div>
            ...
            @if ($device->notes)
                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-gray-900 dark:text-white mt-1">{{ $device->notes }}</p>
                </div>
            @endif
        </div>
