...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-12 text-center">
        ...
        <p class="text-gray-500 text-sm font-medium">Akun Anda belum terhubung ke data karyawan.</p>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-5 flex items-center gap-5">
        <img src="<?php echo e(auth()->user()->avatarUrl()); ?>" alt="avatar"
            class="w-16 h-16 rounded-full object-cover ring-2 ring-blue-500/30">
        <div class="flex-1 min-w-0">
            <h2 class="text-xl font-bold text-gray-900"><?php echo e($employee->name); ?></h2>
        ...
        <a href="<?php echo e(route('self-service.profile')); ?>"
            class="shrink-0 px-4 py-2 text-sm bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition">
            Edit Profil
        </a>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <p class="text-xs text-gray-500 mb-1">Sisa Cuti Tahunan</p>
            <p class="text-3xl font-black text-blue-500"><?php echo e($leaveQuota - $leaveUsed); ?></p>
            <p class="text-xs text-gray-400 mt-1">dari <?php echo e($leaveQuota); ?> hari</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <p class="text-xs text-gray-500 mb-1">Hadir Bulan Ini</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <p class="text-xs text-gray-500 mb-1">Gaji Terakhir</p>
            <?php if($latestPayslip): ?>
            <p class="text-lg font-black text-gray-900">Rp <?php echo e(number_format($latestPayslip->net_salary, 0, ',', '.')); ?></p>
            <p class="text-xs text-gray-400 mt-1"><?php echo e($latestPayslip->payrollRun?->period ?? '-'); ?></p>
            <?php else: ?>
            <p class="text-sm text-gray-400 mt-2">Belum ada</p>
            <?php endif; ?>
        </div>
        
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <p class="text-xs text-gray-500 mb-1">Status Hari Ini</p>
            ...
            <?php else: ?>
                <p class="text-xl font-black text-gray-400">Belum Absen</p>
                <p class="text-xs text-gray-400 mt-1"><?php echo e(today()->format('d M Y')); ?></p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <p class="text-3xl font-mono font-bold text-gray-900 mb-1" id="ess-clock">--:--:--</p>
            <p class="text-xs text-gray-400 mb-5"><?php echo e(today()->translatedFormat('l, d F Y')); ?></p>
            ...
            <div class="text-xs text-gray-500 mb-3">
                Masuk pukul <span class="font-semibold text-gray-900"><?php echo e($todayAttendance->check_in); ?></span>
            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('self-service.leave.index')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-50 text-blue-700 hover:bg-blue-100 transition text-sm font-medium">
                ...
                <a href="<?php echo e(route('payroll.slip.index')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl bg-purple-50 text-purple-700 hover:bg-purple-100 transition text-sm font-medium">
                ...
                <a href="<?php echo e(route('self-service.attendance.index')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl bg-green-50 text-green-700 hover:bg-green-100 transition text-sm font-medium">
                ...
                <a href="<?php echo e(route('self-service.profile')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 text-gray-700 hover:bg-gray-100 transition text-sm font-medium">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <h3 class="font-semibold text-gray-900 mb-4">Kinerja Terakhir</h3>
            <?php if($latestReview): ?>
            <?php
            ...
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900"><?php echo e($latestReview->overallLabel()); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e($latestReview->period); ?> · <?php echo e(ucfirst($latestReview->period_type)); ?></p>
                </div>
            </div>
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-xs text-gray-500 w-28 shrink-0"><?php echo e($label); ?></span>
                    <div class="flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full bg-blue-500 rounded-full" style="width: <?php echo e(($latestReview->$field / 5) * 100); ?>%"></div>
                    </div>
                    <span class="text-xs font-medium text-gray-700 w-4"><?php echo e($latestReview->$field); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php if($latestReview->recommendation): ?>
            <p class="text-xs text-gray-400 mt-3">Rekomendasi: <span class="font-medium text-gray-700"><?php echo e($latestReview->recommendationLabel()); ?></span></p>
            <?php endif; ?>
            <?php else: ?>
            <div class="text-center py-6">
                <p class="text-sm text-gray-400">Belum ada penilaian kinerja.</p>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        <div class="flex items-center justify-between mb-4">
            <h3 class="font-semibold text-gray-900">Slip Gaji Terakhir — <?php echo e($latestPayslip->payrollRun?->period); ?></h3>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
                ...
                <p class="text-sm font-semibold text-gray-900 mt-0.5">Rp <?php echo e(number_format($latestPayslip->base_salary, 0, ',', '.')); ?></p>
            </div>
            <div>
