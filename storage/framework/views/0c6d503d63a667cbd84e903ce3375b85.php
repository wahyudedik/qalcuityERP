     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Telemedicine Feedback')); ?>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-sm text-gray-600">Date: <span
                                class="font-medium"><?php echo e($consultation->scheduled_time->format('l, F j, Y')); ?></span></p>
                        <p class="text-sm text-gray-600">Duration: <span
                                class="font-medium"><?php echo e($consultation->scheduled_duration); ?> minutes</span></p>
                    </div>
                </div>
                            ...
                            <select name="doctor_rating" required
                                ...
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <option value="<?php echo e($i); ?>"><?php echo e($i); ?> -
                                        <?php echo e(['Poor', 'Fair', 'Good', 'Very Good', 'Excellent'][$i - 1]); ?></option>
                                <?php endfor; ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="feedback" rows="4"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="Share your experience with this consultation..."><?php echo e(old('feedback')); ?></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <textarea name="positive_feedback" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Positive aspects..."><?php echo e(old('positive_feedback')); ?></textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="negative_feedback" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Areas for improvement..."><?php echo e(old('negative_feedback')); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="suggestions" rows="3"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="Any suggestions for improvement..."><?php echo e(old('suggestions')); ?></textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="followup_notes" rows="3"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="Additional notes for follow-up..."><?php echo e(old('followup_notes')); ?></textarea>
                    </div>
