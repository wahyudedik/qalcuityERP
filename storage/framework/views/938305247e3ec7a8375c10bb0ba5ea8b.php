...
<?php $__env->startSection('title', 'F&B Inventory Management'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <div class="text-2xl font-bold"><?php echo e($stats['total_supplies']); ?></div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="text-sm text-gray-600">Low Stock Items</div>
                <div class="text-2xl font-bold <?php echo e($stats['low_stock_count'] > 0 ? 'text-yellow-600' : 'text-green-600'); ?>">
            ...
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <div class="text-2xl font-bold <?php echo e($stats['out_of_stock'] > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                    <?php echo e($stats['out_of_stock']); ?>

                </div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="text-sm text-gray-600">Inventory Value</div>
                <div class="text-2xl font-bold">Rp <?php echo e(number_format($stats['total_inventory_value'], 0, ',', '.')); ?></div>
            </div>
        </div>
                        ...
                        <div class="mt-2 text-sm text-yellow-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <?php $__currentLoopData = $lowStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($item->name); ?> - Current: <?php echo e($item->current_stock); ?> <?php echo e($item->unit); ?> (Min:
                                        <?php echo e($item->minimum_stock); ?>)</li>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $supplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if($supply->supplier_name): ?>
                                    <div class="text-xs text-gray-500"><?php echo e($supply->supplier_name); ?></div>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($supply->unit); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <?php echo e(number_format($supply->current_stock, 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e(number_format($supply->minimum_stock, 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                Rp <?php echo e(number_format($supply->cost_per_unit, 0, ',', '.')); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($supply->stock_status == 'out_of_stock'): ?>
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">
                                        Out of Stock
                                    </span>
                                <?php elseif($supply->stock_status == 'low_stock'): ?>
                                    <span
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <button onclick="openRestockModal(<?php echo e($supply->id); ?>, '<?php echo e($supply->name); ?>')"
                                    class="text-indigo-600 hover:text-indigo-900">Restock</button>
                                <a href="<?php echo e(route('hotel.fb.supplies.transactions', $supply)); ?>"
                                    class="text-blue-600 hover:text-blue-900">History</a>
                                <button onclick="openUsageModal(<?php echo e($supply->id); ?>, '<?php echo e($supply->name); ?>')"
    ...
    <div id="addSupplyModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            ...
            <form action="<?php echo e(route('hotel.fb.supplies.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\fb\supplies\index.blade.php ENDPATH**/ ?>