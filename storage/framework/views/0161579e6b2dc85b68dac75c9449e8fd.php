        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    <td class="px-4 py-3 font-mono font-medium text-slate-800"><?php echo e($do->number); ?></td>
                    <td class="px-4 py-3 font-mono text-xs text-slate-500"><?php echo e($do->salesOrder->number ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-600"><?php echo e($do->salesOrder?->customer?->name ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-500"><?php echo e($do->warehouse->name ?? '-'); ?></td>
                    <td class="px-4 py-3 text-slate-500"><?php echo e($do->delivery_date->format('d/m/Y')); ?></td>
                    <td class="px-4 py-3 text-slate-500"><?php echo e($do->courier ?? '-'); ?></td>
                    <td class="px-4 py-3">
