...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> ❄️ Cold Storage Detail - <?php echo e($unit->unit_code); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-900"><?php echo e($unit->unit_code); ?></h2>
                <p class="text-sm text-gray-500 mt-1"><?php echo e($unit->name); ?></p>
                <?php if($unit->location): ?>
                    <p class="text-xs text-gray-400 mt-1">📍 <?php echo e($unit->location); ?></p>
                <?php endif; ?>
            </div>
            <div class="text-right">
                <span
                    class="inline-block px-3 py-1 text-sm rounded-full <?php echo e($unit->isTemperatureSafe() ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
        ...
        <div
            ...
            <div class="text-center">
                ...
                <p class="text-xs text-gray-500 mt-1"><?php echo e($temperatureLogs->total()); ?> readings
                    recorded</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $temperatureLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-2 py-1 text-xs rounded-full <?php echo e($log->is_within_range ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'); ?>">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <span
                                        class="px-2 py-0.5 text-xs rounded-full <?php echo e($alert->status === 'active' ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'); ?>">
                                        <?php echo e(ucfirst($alert->status)); ?>

                                    </span>
                                </div>
                                <p class="text-sm text-gray-900 font-medium"><?php echo e($alert->message); ?></p>
