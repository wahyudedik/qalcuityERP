<x-guest-layout>
    <div class="mb-7">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white leading-tight">Buat akun perusahaan</h2>
        <p class="mt-1.5 text-sm text-gray-500 dark:text-gray-400">Coba gratis 14 hari, tanpa kartu kredit</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            <label for="company_name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Nama Perusahaan</label>
            <input id="company_name" type="text" name="company_name" value="{{ old('company_name') }}" required autofocus
                class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm placeholder-gray-400 dark:placeholder-gray-500
                       ...
                       @error('company_name') border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-900/20 @enderror"
        ...
        <div>
            <label for="business_type" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Jenis Bisnis</label>
            <select id="business_type" name="business_type"
                class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm
                       focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
                <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Nama Admin</label>
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name"
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm placeholder-gray-400 dark:placeholder-gray-500
                           focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition
                           @error('name') border-red-400 dark:border-red-500 bg-red-50 dark:bg-red-900/20 @enderror"
            ...
            <div>
                <label for="phone" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                    Telepon <span class="text-gray-400 dark:text-gray-500 font-normal">(opsional)</span>
                </label>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Konfirmasi</label>
        ...
        <button type="submit"
            class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700
                   text-white font-semibold py-2.5 rounded-xl text-sm transition-all shadow-md shadow-blue-200/60 dark:shadow-blue-900/40 active:scale-[.98] mt-1">
            Buat Akun Gratis
        </button>
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline">Masuk</a>
        </p>
    </form>
</x-guest-layout>
