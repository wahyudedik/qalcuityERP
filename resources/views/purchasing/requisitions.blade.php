<x-app-layout>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-4">
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('purchasing.requisitions') }}" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Reset</a>
        </form>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        <div class="px-4 py-3 border-t border-gray-100">{{ $requisitions->links() }}</div>
        @endif
    </div>
