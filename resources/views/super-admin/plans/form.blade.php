<x-app-layout>
    ...
    <div class="sm:hidden mb-4">
        <a href="{{ route('super-admin.plans.index') }}" class="text-sm text-gray-500 dark:text-slate-400">← Kembali ke daftar paket</a>
    </div>
    ...
    <div class="max-w-2xl">
        <form method="POST"
            ...
            @php $cls = 'w-full px-3.5 py-2.5 text-sm border border-gray-200 dark:border-white/10 rounded-xl bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition'; @endphp
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-1 max-h-64 overflow-y-auto border border-gray-200 dark:border-white/10 rounded-xl p-3 bg-gray-50 dark:bg-[#0f172a]">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer py-1 px-1 rounded hover:bg-gray-100 dark:hover:bg-white/5">
                        ...
                        <span class="text-xs text-gray-700 dark:text-slate-300">{{ $feat }}</span>
                    </label>
                    @endforeach
                </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-end gap-3 pt-2 border-t border-gray-200 dark:border-white/10">
                <a href="{{ route('super-admin.plans.index') }}" class="w-full sm:w-auto text-center text-sm text-gray-600 dark:text-slate-400 px-4 py-2.5 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition">Batal</a>
