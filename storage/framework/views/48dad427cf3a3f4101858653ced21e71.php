...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        <div class="bg-white rounded-2xl border border-gray-200 shadow-xl p-10">
            <?php $status = request('status', 'expired'); ?>

            <div class="w-16 h-16 rounded-2xl mx-auto mb-6 flex items-center justify-center
                <?php echo e(in_array($status, ['trial_expired', 'expired']) ? 'bg-amber-500/20' : 'bg-red-500/20'); ?>">
...
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\subscription\expired.blade.php ENDPATH**/ ?>