...
class FleetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        foreach ($expiring as $v) {
            if ($v->isExpiringSoon('registration_expiry')) $alerts[] = "STNK {$v->plate_number} expired " . $v->registration_expiry->format('d/m/Y');
            if ($v->isExpiringSoon('insurance_expiry'))    $alerts[] = "Asuransi {$v->plate_number} expired " . $v->insurance_expiry->format('d/m/Y');
        }
