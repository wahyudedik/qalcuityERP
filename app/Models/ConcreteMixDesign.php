...
class ConcreteMixDesign extends Model
{
     ...
     */
    public function createVersion(string $changeReason): MixDesignVersion
    {
        return MixDesignVersion::createVersion($this, $changeReason);
    }

    /**
     * Update with versioning
     */
    public function updateWithVersion(array $data, string $changeReason): bool
    {
        // Create version snapshot
        $this->createVersion($changeReason);
     ...
     */
    public function approveLatestVersion(int $userId): ?MixDesignVersion
    {
