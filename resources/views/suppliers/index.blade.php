        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 {{ !$sup->is_active ? 'opacity-60' : '' }}">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900 dark:text-white">{{ $sup->name }}</p>
                            @if($sup->npwp)
                            <p class="text-xs text-gray-400 dark:text-slate-500">NPWP: {{ $sup->npwp }}</p>
                            @endif
                        </td>
                        ...
                        <td class="px-4 py-3 hidden lg:table-cell text-gray-500 dark:text-slate-400">{{ $sup->email ?? '-' }}</td>
                        <td class="px-4 py-3 hidden lg:table-cell text-gray-500 dark:text-slate-400">
                            @if($sup->bank_name)
                                <p class="text-xs">{{ $sup->bank_name }}</p>
                                <p class="text-xs text-gray-400 dark:text-slate-500">{{ $sup->bank_account }}</p>
                            @else
                                -
                            @endif
                        </td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <form method="POST" action="{{ route('suppliers.destroy', $sup) }}"
                                    onsubmit="return confirm('Hapus supplier {{ addslashes($sup->name) }}?')">
                                    @csrf @method('DELETE')
