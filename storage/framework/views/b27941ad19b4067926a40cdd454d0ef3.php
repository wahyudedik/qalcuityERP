...
<div class="mb-4 px-4 py-3 rounded-xl bg-green-500/10 border border-green-500/30 text-green-400 text-sm"><?php echo e(session('success')); ?></div>
<?php endif; ?>
<?php if(session('error')): ?>
<div class="mb-4 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/30 text-red-400 text-sm"><?php echo e(session('error')); ?></div>
<?php endif; ?>
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10">
                    <div>
                        ...
                        <p class="text-xs text-amber-400 mt-0.5">Ditutup oleh <?php echo e($fy->closedBy->name); ?> · <?php echo e($fy->closed_at->format('d M Y H:i')); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="text-xs font-medium px-2 py-0.5 rounded-full <?php echo e($statusColor); ?>"><?php echo e($statusLabel); ?></span>
                        <?php if($fy->isOpen()): ?>
                        <form method="POST" action="<?php echo e(route('accounting.period-lock.fiscal-years.close', $fy)); ?>" class="inline"
                              onsubmit="return confirm('Tutup tahun fiskal <?php echo e($fy->name); ?>? Semua periode di dalamnya akan ikut ditutup.')">
                        ...
                        <form method="POST" action="<?php echo e(route('accounting.period-lock.fiscal-years.lock', $fy)); ?>" class="inline"
                              onsubmit="return confirm('KUNCI PERMANEN tahun fiskal <?php echo e($fy->name); ?>? Tindakan ini tidak dapat dibatalkan!')">
                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                        ...
                        <?php elseif($fy->isClosed()): ?>
                        <form method="POST" action="<?php echo e(route('accounting.period-lock.fiscal-years.lock', $fy)); ?>" class="inline"
                              onsubmit="return confirm('KUNCI PERMANEN tahun fiskal <?php echo e($fy->name); ?>? Tindakan ini tidak dapat dibatalkan!')">
                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                            <button class="text-xs px-2.5 py-1 rounded-lg bg-red-500/20 hover:bg-red-500/30 text-red-400 font-medium transition">Kunci</button>
                        </form>
                        <form method="POST" action="<?php echo e(route('accounting.period-lock.fiscal-years.reopen', $fy)); ?>" class="inline"
                              onsubmit="return confirm('Buka kembali tahun fiskal <?php echo e($fy->name); ?>?')">
                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr>
                        ...
                        <td class="py-2.5 text-right">
                            ...
                            <form method="POST" action="<?php echo e(route('accounting.period-lock.periods.lock', $period)); ?>" class="inline"
                                  onsubmit="return confirm('Kunci periode <?php echo e($period->name); ?>?')">
                                <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                ...
                <div class="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">
                            ...
                            · <?php echo e($backup->fileSizeHuman()); ?>

                            <?php if($backup->summary): ?>
                            · <?php echo e(collect($backup->summary)->sum()); ?> records
                            <?php endif; ?>
                            <?php endif; ?>
                        </p>
                        <?php if($backup->isFailed()): ?>
                        <p class="text-xs text-red-400 mt-0.5"><?php echo e($backup->error_message); ?></p>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\accounting\period-lock.blade.php ENDPATH**/ ?>