...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($totalWarehouses); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Gudang Aktif</p>
            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1"><?php echo e($activeWarehouses); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Gudang Nonaktif</p>
            <p class="text-2xl font-bold text-gray-500 dark:text-slate-400 mt-1"><?php echo e($totalWarehouses - $activeWarehouses); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($wh->name); ?></p>
                        </td>
                        <td class="px-4 py-3 hidden sm:table-cell font-mono text-xs text-gray-500 dark:text-slate-400"><?php echo e($wh->code); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500 dark:text-slate-400 text-xs max-w-xs truncate"><?php echo e($wh->address ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right hidden lg:table-cell text-gray-700 dark:text-slate-300"><?php echo e(number_format($wh->product_stocks_count ?? 0)); ?></td>
                        <td class="px-4 py-3 text-right font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($wh->product_stocks_sum_quantity ?? 0)); ?></td>
                        <td class="px-4 py-3 text-center hidden sm:table-cell">
                            <span class="px-2 py-0.5 rounded-full text-xs <?php echo e($wh->is_active ? 'bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400' : 'bg-gray-100 text-gray-500 dark:bg-white/10 dark:text-slate-400'); ?>">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <form method="POST" action="<?php echo e(route('warehouses.toggle', $wh)); ?>">
                                    ...
                                    <button type="submit" class="p-1.5 rounded-lg <?php echo e($wh->is_active ? 'text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-500/10' : 'text-green-500 hover:bg-green-50 dark:hover:bg-green-500/10'); ?>" title="<?php echo e($wh->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>">
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($warehouses->links()); ?></div>
        <?php endif; ?>
    </div>
