                    ...
                    <div class="border-l-4 {{ $severityClass }} rounded-r-xl p-4 flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-semibold text-gray-800 dark:text-gray-100 text-sm">{{ $anomaly->title }}</span>
                                <span class="text-xs px-2 py-0.5 rounded-full
                                    {{ $anomaly->status === 'open' ? 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300' :
