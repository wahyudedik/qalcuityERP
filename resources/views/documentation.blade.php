    ...
    <div class="pt-16 flex min-h-screen">
        ...
        <aside class="fixed left-0 top-16 w-72 h-[calc(100vh-4rem)] bg-white border-r border-gray-200 overflow-y-auto">
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <a href="#overview"
                            class="sidebar-link active block px-4 py-2.5 rounded-lg text-sm font-medium">
                            📋 Overview Sistem
                        </a>
                        <a href="#quick-start"
                            class="sidebar-link block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:text-white">
                            🚀 Quick Start
                        </a>
                        <a href="#first-login"
                            class="sidebar-link block px-4 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:text-white">
        ...
        <main class="ml-72 flex-1 max-w-5xl px-8 py-12">
            ...
            <section id="overview" class="mb-16">
                ...
                <p class="text-xl text-gray-600 mb-8">Panduan lengkap untuk menggunakan semua modul dan fitur Qalcuity
                    ERP</p>

                <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                    <h2 class="text-2xl font-bold mb-4">Apa itu Qalcuity ERP?</h2>
                    <p class="text-gray-700 leading-relaxed mb-4">
                        Qalcuity ERP adalah platform ERP (Enterprise Resource Planning) berbasis AI yang dirancang
                        khusus untuk berbagai industri di Indonesia.
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm space-y-6">
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Klik tombol "Coba Gratis" di halaman beranda dan isi formulir
                                pendaftaran. Anda akan mendapatkan akses 14 hari gratis.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Cek email Anda dan klik link verifikasi untuk mengaktifkan akun.
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Lengkapi informasi perusahaan, logo, dan pengaturan awal setelah
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700">Jelajahi dashboard dan mulai tambahkan data bisnis Anda. Gunakan
                                panduan modul di bawah untuk detail setiap fitur.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mt-6">
                        <p class="text-sm text-yellow-800">
                            <strong>Tips:</strong> Untuk keamanan, aktifkan Two-Factor Authentication (2FA) di menu
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm space-y-6">
                    <div>
                        ...
                        <ul class="list-disc list-inside space-y-2 text-gray-700">
                            ...
                            <li><strong>Filter:</strong> Klik tombol "Filters" di list page, pilih kriteria, klik
                                "Apply"</li>
                            <li><strong>Advanced Search:</strong> Klik icon 🔍 > "Advanced Search" > pilih field &
                                kondisi</li>
                        </ul>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between"><span>Global Search</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">Ctrl + K</kbd></div>
                                <div class="flex justify-between"><span>Dashboard</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">G + D</kbd></div>
                                <div class="flex justify-between"><span>Sales</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">G + S</kbd></div>
                                <div class="flex justify-between"><span>Finance</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">G + F</kbd></div>
                            </div>
                        </div>
                        <div>
                            <h3 class="font-semibold mb-3">Actions:</h3>
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between"><span>New Record</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">Ctrl + N</kbd></div>
                                <div class="flex justify-between"><span>Save</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">Ctrl + S</kbd></div>
                                <div class="flex justify-between"><span>Export</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">Ctrl + E</kbd></div>
                                <div class="flex justify-between"><span>Print</span> <kbd
                                        class="px-2 py-1 bg-gray-100 rounded">Ctrl + P</kbd></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm space-y-6">
                    <div x-data="{ open: false }" class="border-b pb-4">
                        <button @click="open = !open"
                            ...
                            <svg class="w-5 h-5 transform transition-transform" :class="open ? 'rotate-180' : ''"
                        ...
                        <div x-show="open" class="mt-3 text-gray-700">
                            Klik "Forgot Password?" di halaman login, masukkan email Anda, lalu ikuti link reset yang
                            dikirim ke email.
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="border-b pb-4">
                        ...
                        <div x-show="open" class="mt-3 text-gray-700">
                            Mode offline terbatas tersedia untuk POS dan attendance. Data akan otomatis sync saat
                            koneksi pulih.
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="border-b pb-4">
                        ...
                        <div x-show="open" class="mt-3 text-gray-700">
                            Chrome 90+, Firefox 88+, Edge 90+, Safari 14+. Direkomendasikan menggunakan browser versi
                            terbaru.
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" class="mt-3 text-gray-700">
                            Backup dilakukan otomatis setiap hari oleh sistem. Anda juga bisa export data manual melalui
                            menu Export di setiap modul.
                        </div>
                    </div>
                </div>
            </section>
