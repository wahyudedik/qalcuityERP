    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('Pendapatan per Paket')); ?></h1>
                    <p class="mt-1 text-sm text-gray-600"><?php echo e(__('Analisis distribusi pendapatan dari paket internet')); ?></p>
                </div>
            ...
            <?php if(isset($report['summary'])): ?>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-white shadow-sm sm:rounded-lg p-4 border-l-4 border-green-500">
                        <p class="text-sm text-gray-600"><?php echo e(__('Total Pendapatan')); ?></p>
                        <p class="text-2xl font-bold text-gray-900">Rp <?php echo e(number_format($report['summary']['total_revenue'] ?? 0, 0, ',', '.')); ?></p>
                    </div>
                    <div class="bg-white shadow-sm sm:rounded-lg p-4 border-l-4 border-blue-500">
                        <p class="text-sm text-gray-600"><?php echo e(__('Total Subscription Aktif')); ?></p>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($report['summary']['total_subscriptions'] ?? 0)); ?></p>
                    </div>
                    <div class="bg-white shadow-sm sm:rounded-lg p-4 border-l-4 border-purple-500">
                        <p class="text-sm text-gray-600"><?php echo e(__('Jumlah Paket')); ?></p>
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(count($report['packages'] ?? [])); ?></p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('Detail per Paket')); ?></h2>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Kecepatan')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Harga')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Subscription Aktif')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Total Pendapatan')); ?></th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><?php echo e(__('% Kontribusi')); ?></th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $report['packages'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pkg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($pkg['name'] ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($pkg['speed'] ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-900">Rp <?php echo e(number_format($pkg['price'] ?? 0, 0, ',', '.')); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format($pkg['active_subscriptions'] ?? 0)); ?></td>
                                    <td class="px-6 py-4 text-sm font-semibold text-green-600">Rp <?php echo e(number_format($pkg['total_revenue'] ?? 0, 0, ',', '.')); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(number_format($pkg['revenue_percentage'] ?? 0, 1)); ?>%</td>
                                </tr>
