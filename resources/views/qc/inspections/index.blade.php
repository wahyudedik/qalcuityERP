                            ...
                            @forelse($inspections as $inspection)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-medium text-blue-600 dark:text-blue-400">{{ $inspection->inspection_number }}</span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($inspection->grade)
                                            ...
                                            {{ $inspection->grade == 'A' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : '' }}
                                            {{ $inspection->grade == 'B' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' : '' }}
                                            {{ $inspection->grade == 'C' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300' : '' }}
                                            {{ $inspection->grade == 'D' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300' : '' }}
                                            {{ $inspection->grade == 'F' ? 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300' : '' }}">
                                                {{ $inspection->grade }}
                                            </span>
                                        @else
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        {{ $inspection->status_color == 'gray' ? 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300' : '' }}">
