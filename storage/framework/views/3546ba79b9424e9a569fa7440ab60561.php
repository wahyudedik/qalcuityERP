...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('production.recipes')); ?>" class="px-3 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">
                Resep/BOM
            </a>
            <a href="<?php echo e(route('manufacturing.bom')); ?>" class="px-3 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">
                BOM Multi-Level
            </a>
            <a href="<?php echo e(route('manufacturing.mrp')); ?>" class="px-3 py-2 text-sm border border-purple-200 dark:border-purple-500/30 rounded-xl text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-500/10">
                MRP
            </a>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3 font-mono text-xs font-medium text-gray-900 dark:text-white">
                            <a href="<?php echo e(route('production.show', $wo)); ?>" class="hover:text-blue-500"><?php echo e($wo->number); ?></a>
                        </td>
                        <td class="px-4 py-3 text-gray-700 dark:text-slate-300">
                            <?php echo e($wo->product->name ?? '-'); ?>

                            <?php if($wo->recipe): ?> <span class="text-xs text-gray-400 dark:text-slate-500">(<?php echo e($wo->recipe->name); ?>)</span> <?php endif; ?>
                        </td>
                        ...
                        <td class="px-4 py-3 text-right hidden md:table-cell">
                            <?php $good = $wo->totalGoodQty(); $reject = $wo->totalRejectQty(); ?>
                            <span class="text-green-500"><?php echo e($good); ?></span>
                            <?php if($reject > 0): ?> <span class="text-red-400 text-xs">/ <?php echo e($reject); ?> reject</span> <?php endif; ?>
                        </td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="<?php echo e(route('production.show', $wo)); ?>" class="text-xs px-2 py-1 border border-gray-200 dark:border-white/10 rounded-lg text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">
                                    Detail
                                </a>
                                <?php if($wo->status === 'pending'): ?>
                                <form method="POST" action="<?php echo e(route('production.status', $wo)); ?>" class="inline">
                                ...
                                <form method="POST" action="<?php echo e(url('manufacturing')); ?>/<?php echo e($wo->id); ?>/consume" class="inline" onsubmit="return confirm('Konsumsi material dari stok?')">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="recipe_id" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <?php $__currentLoopData = $recipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($r->id); ?>"><?php echo e($r->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="bom_id" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <?php $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($b->id); ?>"><?php echo e($b->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
