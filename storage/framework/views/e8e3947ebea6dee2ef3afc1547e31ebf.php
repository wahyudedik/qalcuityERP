...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            ...
            <p class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($stats['total_sales'], 0, ',', '.')); ?></p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-gray-900"><?php echo e($c->user->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-500"><?php echo e($target ? 'Rp ' . number_format($target->target_amount, 0, ',', '.') : '-'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-900">Rp <?php echo e(number_format($c->total_sales, 0, ',', '.')); ?></td>
                        ...
                        <td class="px-4 py-3 text-right text-gray-900">Rp <?php echo e(number_format($c->commission_amount, 0, ',', '.')); ?></td>
                        ...
                        <td class="px-4 py-3 text-right font-semibold text-gray-900">Rp <?php echo e(number_format($c->total_payout, 0, ',', '.')); ?></td>
                        <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($cc); ?>-100 text-<?php echo e($cc); ?>-700 $cc }}-500/20 $cc }}-400"><?php echo e($cl); ?></span></td>
