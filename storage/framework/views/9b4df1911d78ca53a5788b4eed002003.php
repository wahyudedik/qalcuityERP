...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Edit QC Test Template')); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="<?php echo e(route('qc.templates.update', $template)); ?>" method="POST" x-data="templateForm()">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="product_type"
                            value="<?php echo e(old('product_type', $template->product_type)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="incoming"
                                <?php echo e(old('stage', $template->stage) == 'incoming' ? 'selected' : ''); ?>>Incoming Material
                            </option>
                            <option value="in-process"
                                <?php echo e(old('stage', $template->stage) == 'in-process' ? 'selected' : ''); ?>>In-Process
                            </option>
                            <option value="final" <?php echo e(old('stage', $template->stage) == 'final' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="1"
                                <?php echo e(old('sample_size_formula', $template->sample_size_formula) == 1 ? 'selected' : ''); ?>>
                                √n (Square Root of Lot Size)</option>
                            <option value="2"
                                <?php echo e(old('sample_size_formula', $template->sample_size_formula) == 2 ? 'selected' : ''); ?>>
                                10% of Lot Size</option>
                            <option value="3"
                                <?php echo e(old('sample_size_formula', $template->sample_size_formula) == 3 ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="acceptance_quality_limit" step="0.01" min="0"
                            max="100"
                            value="<?php echo e(old('acceptance_quality_limit', $template->acceptance_quality_limit)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="instructions" rows="3"
                            class="w-full rounded-md border-gray-300"
                            placeholder="Step-by-step inspection instructions (optional)"><?php echo e(old('instructions', $template->instructions)); ?></textarea>
                    </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            function templateForm() {
                return {
                    parameters: <?php echo json_encode($template->test_parameters ?? [['name' => '', 'unit' => '', 'min' => '') ?>,
                    addParameter() {
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\qc\templates\edit.blade.php ENDPATH**/ ?>