    ...
    <section class="bg-white border-b border-gray-100 py-14">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                @foreach ([['value' => '40+', 'label' => 'Modul ERP Terintegrasi'], ['value' => '8+', 'label' => 'Industri Didukung'], ['value' => 'AI', 'label' => 'Powered by Qalcuity AI'], ['value' => '4.9★', 'label' => 'Rating Pengguna']] as $s)
                    <div>
