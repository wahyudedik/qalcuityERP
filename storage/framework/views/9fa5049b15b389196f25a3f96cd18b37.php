                ...
                <div class="space-y-1.5" id="shift-palette">
                    ...
                    <div draggable="true"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm text-gray-900 truncate"><?php echo e($shift->name); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($shift->timeLabel()); ?></p>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm border-collapse" id="scheduler-table">
                        <thead>
                            <tr class="bg-gray-50">
                                ...
                                <th class="px-2 py-3 text-center text-xs font-semibold border-b border-gray-100 min-w-[90px]
                                    <?php echo e($day->isToday() ? 'text-blue-600' : 'text-gray-500'); ?>">
                                    <p><?php echo e($days[$i]); ?></p>
                                    <p class="text-base font-bold <?php echo e($day->isToday() ? 'text-blue-600' : 'text-gray-900'); ?>">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50/50 group" data-emp-id="<?php echo e($emp->id); ?>">
                                <td class="px-4 py-2 border-r border-gray-100 sticky left-0 bg-white group-hover:bg-gray-50/50 z-10">
                                    <p class="font-medium text-gray-900 text-xs truncate max-w-[140px]"><?php echo e($emp->name); ?></p>
                                    <p class="text-xs text-gray-400 truncate"><?php echo e($emp->department ?? $emp->position ?? '-'); ?></p>
                                </td>
                                ...
                                ?>
                                <td class="px-1 py-1 text-center <?php echo e($isWeekend ? 'bg-gray-50/50' : ''); ?>"
                                    ...
                                    <button
                                        ...
                                        class="shift-cell w-full min-h-[52px] rounded-lg text-xs transition flex flex-col items-center justify-center gap-0.5 px-1 relative
                                            <?php echo e($schedule ? 'cursor-grab active:cursor-grabbing' : ($isWeekend ? 'cursor-default' : 'hover:bg-gray-100 cursor-pointer')); ?>"
                                        <?php if($schedule): ?>
                                    ...
                                    >
                                        ...
                                        <?php else: ?>
                                        <span class="text-lg leading-none text-gray-300"><?php echo e($isWeekend ? '—' : '+'); ?></span>
                                        <?php endif; ?>
                                    </button>
                                </td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 w-full max-w-sm shadow-2xl">
            ...
            <div class="p-4 space-y-2">
                ...
                <button onclick="assignShift(pickerEmpId, pickerDate, <?php echo e($shift->id); ?>)"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-900"><?php echo e($shift->name); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($shift->timeLabel()); ?> · <?php echo e(round($shift->workMinutes()/60,1)); ?> jam</p>
                    </div>
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
