    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mt-2">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900"><?php echo e($workflow->name); ?></h1>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                <dd class="mt-1 text-lg font-semibold text-gray-900 capitalize">
                    <?php echo e($workflow->trigger_type); ?></dd>
            </div>
            <div class="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                <dd class="mt-1">
                    <span
                        ...
                        <?php echo e($workflow->is_active ? 'Aktif' : 'Nonaktif'); ?>
            ...
            <div class="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                <dd class="mt-1 text-lg font-semibold text-gray-900">
                    <?php echo e(number_format($workflow->execution_count)); ?></dd>
            </div>
        </div>
        ...
        <div class="bg-white shadow sm:rounded-lg mb-8">
            <div
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900">Aksi (<?php echo e($actions->count()); ?>)
                </h3>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2">
                                    <span
                                        class="text-sm font-medium text-gray-900">#<?php echo e($action->order); ?></span>
                                    <span
                                ...
                                <?php if($action->condition): ?>
                                    <p class="mt-1 text-xs text-gray-500">
                                        Kondisi: <?php echo e($action->condition['field'] ?? ''); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-red-600 hidden md:table-cell">
                                    <?php echo e(Str::limit($log->error_message, 50)); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
