...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('farm.plots.show', $cropCycle->plot)); ?>" class="text-sm text-gray-500 hover:text-gray-700">Lahan <?php echo e($cropCycle->plot->code); ?> →</a>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                <span class="text-lg font-bold text-gray-900"><?php echo e($cropCycle->crop_name); ?></span>
                <?php if($cropCycle->crop_variety): ?> <span class="text-sm text-gray-400 ml-2">var. <?php echo e($cropCycle->crop_variety); ?></span> <?php endif; ?>
                <?php if($cropCycle->season): ?> <span class="text-xs ml-2 px-2 py-0.5 rounded bg-blue-100 text-blue-600"><?php echo e($cropCycle->season); ?></span> <?php endif; ?>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('farm.cycles.phase', $cropCycle)); ?>" class="flex items-center gap-2">
                ...
                <select name="phase" class="text-xs rounded-lg border border-gray-200 bg-gray-50 text-gray-900 py-1.5 px-2">
        ...
        <div class="flex gap-1 mb-1">
            ...
            <?php
                ...
                $color = $isCurrent ? 'bg-emerald-500' : ($done ? 'bg-emerald-400' : 'bg-gray-200');
            ?>
        ...
        <div class="flex justify-between text-[9px] text-gray-400 mt-1 px-0.5">
            <?php $__currentLoopData = $phases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="<?php echo e($cropCycle->phase === $p ? 'text-emerald-600 font-bold' : ''); ?>">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    ...
                    <p class="text-lg font-bold text-gray-900"><?php echo e($cropCycle->durationDays() ?? 0); ?> hari</p>
                </div>
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    <p class="text-xs text-gray-500">Hasil Panen</p>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    ...
                    <p class="text-lg font-bold <?php echo e($cropCycle->budgetUsedPercent() > 100 ? 'text-red-500' : 'text-gray-900'); ?>">Rp <?php echo e(number_format($cropCycle->actual_cost, 0, ',', '.')); ?></p>
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-4">
                    <p class="text-xs text-gray-500">HPP / <?php echo e($cropCycle->target_yield_unit); ?></p>
                    <p class="text-lg font-bold text-gray-900"><?php echo e($cropCycle->costPerUnit() ? 'Rp '.number_format($cropCycle->costPerUnit(), 0, ',', '.') : '-'); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="font-semibold text-gray-900">Aktivitas (<?php echo e($cropCycle->activities->count()); ?>)</h3>
                    <?php if(!in_array($cropCycle->phase, ['completed', 'cancelled'])): ?>
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="px-5 py-3 flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex flex-wrap gap-x-3 gap-y-1 mt-0.5 text-xs text-gray-500">
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between"><span class="text-gray-500">Lahan</span><span class="text-gray-900 font-medium"><?php echo e($cropCycle->plot->code); ?> — <?php echo e($cropCycle->plot->name); ?></span></div>
                    <div class="flex justify-between"><span class="text-gray-500">Luas</span><span><?php echo e($cropCycle->plot->area_size); ?> <?php echo e($cropCycle->plot->area_unit); ?></span></div>
                    <?php if($cropCycle->plan_prep_start): ?>
                    <div class="flex justify-between"><span class="text-gray-500">Renc. Olah Tanah</span><span><?php echo e($cropCycle->plan_prep_start->format('d M Y')); ?></span></div>
                    <?php endif; ?>
                    <?php if($cropCycle->plan_plant_date): ?>
                    <div class="flex justify-between"><span class="text-gray-500">Renc. Tanam</span><span><?php echo e($cropCycle->plan_plant_date->format('d M Y')); ?></span></div>
                    <?php endif; ?>
                    <?php if($cropCycle->plan_harvest_date): ?>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Renc. Panen</span>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        <span class="text-gray-600"><?php echo e(\App\Models\FarmPlotActivity::ACTIVITY_TYPES[$ct->activity_type] ?? $ct->activity_type); ?></span>
                        <span class="font-mono text-gray-900">Rp <?php echo e(number_format($ct->total_cost, 0, ',', '.')); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
    ...
    <div id="actModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
        <div class="bg-white rounded-2xl border border-gray-200 w-full max-w-md p-6 max-h-[90vh] overflow-y-auto">
            <div class="flex items-center justify-between mb-5">
                ...
                <button onclick="document.getElementById('actModal').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">✕</button>
            </div>
            <form method="POST" action="<?php echo e(route('farm.cycles.activities.store', $cropCycle)); ?>" class="space-y-4">
                ...
                <div id="cyc-harvest" class="hidden space-y-3 border-t border-gray-100 pt-3">
                    <div class="grid grid-cols-3 gap-3">
                ...
                <div class="flex gap-3 pt-2">
                    <button type="button" onclick="document.getElementById('actModal').classList.add('hidden')" class="flex-1 px-4 py-2 rounded-lg text-sm border border-gray-200 text-gray-700">Batal</button>
