@if(!empty($data['openAnomalies']) && $data['openAnomalies']->isNotEmpty())
<div class="h-full" id="anomaly-section">
    <div class="flex items-center justify-between gap-2 mb-3">
        <div class="flex items-center gap-2">
            ...
            <span class="text-xs bg-red-500/20 text-red-400 font-medium px-2 py-0.5 rounded-full">{{ $data['openAnomalies']->count() }} open</span>
        </div>
    ...
    <div class="space-y-2" id="anomaly-list">
        @foreach($data['openAnomalies'] as $anomaly)
        @php
