...
<form
    <?php echo e($attributes->merge(['class' => 'offline-form'])); ?>

    action="<?php echo e($action); ?>"
    method="<?php echo e(strtoupper($method) === 'GET' ? 'GET' : 'POST'); ?>"
    data-offline-module="<?php echo e($module); ?>"
    data-offline-redirect="<?php echo e($redirect); ?>"
    data-offline-message="<?php echo e($offlineMessage); ?>"
...
<?php if (! $__env->hasRenderedOnce('f3dfa087-d83f-468f-bbfa-e9dd2bfb70a3')): $__env->markAsRenderedOnce('f3dfa087-d83f-468f-bbfa-e9dd2bfb70a3'); ?>
