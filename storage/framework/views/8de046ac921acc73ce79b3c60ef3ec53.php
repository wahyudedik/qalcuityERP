        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td class="px-4 py-3 text-gray-900"><?php echo e($r->warehouse->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-gray-700"><?php echo e($r->product->name ?? $r->product_category ?? 'Semua'); ?></td>
                        <td class="px-4 py-3 text-gray-500"><?php echo e($r->zone->name ?? '-'); ?></td>
                        <td class="px-4 py-3 font-mono text-xs text-gray-500"><?php echo e($r->bin->code ?? 'Auto'); ?></td>
                        <td class="px-4 py-3 text-center text-gray-900"><?php echo e($r->priority); ?></td>
    ...
    <div id="modal-rule" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-sm shadow-xl">
            ...
            <form method="POST" action="<?php echo e(route('wms.putaway-rules.store')); ?>" class="p-6 space-y-3">
                ...
                <div><label class="block text-xs text-gray-600 mb-1">Kategori Produk (opsional)</label><input type="text" name="product_category" placeholder="elektronik, makanan..." class="<?php echo e($cls); ?>"></div>
                <div><label class="block text-xs text-gray-600 mb-1">Prioritas</label><input type="number" name="priority" min="0" value="0" class="<?php echo e($cls); ?>"></div>
