...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">SOAP Note - <?php echo e($visit->patient->full_name); ?>

                </h2>
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">
                    Visit Date:
                    <?php echo e($visit->visit_date ? \Carbon\Carbon::parse($visit->visit_date)->format('d M Y') : 'N/A'); ?>
