...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($totalERPatients); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border-2 border-red-200 dark:border-red-800">
            ...
            <p class="text-2xl font-bold text-red-600 dark:text-red-400 mt-1"><?php echo e($redPriority); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border-2 border-amber-200 dark:border-amber-800">
            ...
            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1"><?php echo e($yellowPriority); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border-2 border-green-200 dark:border-green-800">
            ...
            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1"><?php echo e($greenPriority); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Non-Urgent</p>
            <p class="text-2xl font-bold text-gray-600 dark:text-gray-400 mt-1"><?php echo e($blackPriority); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Rata-rata Lama (mnt)</p>
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1"><?php echo e(round($avgStayTime)); ?></p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            <p class="text-xs text-gray-500 dark:text-slate-400">Throughput Hari Ini</p>
            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1"><?php echo e($todayThroughput); ?></p>
        </div>
    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentCases ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-4 py-3 text-center hidden lg:table-cell">
                                <span
                                    class="font-bold text-gray-900 dark:text-white"><?php echo e($case->stay_duration_minutes ?? '-'); ?></span>
                            </td>
