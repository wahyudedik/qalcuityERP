            ...
            <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition">
                    <td class="px-4 sm:px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-xs text-gray-500 dark:text-slate-400 truncate"><?php echo e($user->email); ?></p>
                    ...
                    <td class="px-4 sm:px-6 py-4 hidden sm:table-cell">
                        ...
                        $roleLabel = ['admin' => 'Admin', 'manager' => 'Manager', 'staff' => 'Staff'];
                        ?>
                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium <?php echo e($roleStyle[$user->role] ?? 'bg-[#f8f8f8] dark:bg-white/10 text-slate-300'); ?>">
...
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/tenant/users/index.blade.php ENDPATH**/ ?>