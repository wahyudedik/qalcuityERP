    ...
    <nav x-data="{ open: false }"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="https://wa.me/6281529211963" target="_blank" rel="noopener"
                ...
                <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-hover bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
                        <div class="w-10 h-10 rounded-xl <?php echo e($c['bg']); ?> flex items-center justify-center mb-4">
                            <svg class="w-5 h-5 <?php echo e($c['ic']); ?>" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                ...
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-hover bg-white border <?php echo e($c['b']); ?> rounded-2xl p-4">
                        ...
                        <h3 class="font-bold <?php echo e($c['t']); ?> mb-2.5 text-xs uppercase tracking-wide">
                            <?php echo e($m['title']); ?></h3>
                        <ul class="space-y-1.5">
                            <?php $__currentLoopData = $m['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center gap-1.5 text-xs text-gray-500">
                                    <span
                                        class="w-1 h-1 rounded-full <?php echo e($c['d']); ?> shrink-0"></span><?php echo e($item); ?>
            ...
            <div class="grid md:grid-cols-3 gap-5">
                ...
                <div class="card-hover bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                    ...
                    <div class="space-y-2.5">
                        <?php $chartData = [['m'=>'Jan','p'=>'60%','v'=>'Rp 28jt'],['m'=>'Feb','p'=>'75%','v'=>'Rp 35jt'],['m'=>'Mar','p'=>'55%','v'=>'Rp 26jt'],['m'=>'Apr','p'=>'90%','v'=>'Rp 42jt'],['m'=>'Mei','p'=>'80%','v'=>'Rp 38jt']]; ?>
                        <?php $__currentLoopData = $chartData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2">
                                <span class="text-xs text-gray-400 w-6 shrink-0"><?php echo e($cd['m']); ?></span>
                                <div class="flex-1 bg-gray-100 rounded-full h-1.5">
                                    <div class="bg-gradient-to-r from-blue-500 to-indigo-500 h-1.5 rounded-full"
                                        style="width:<?php echo e($cd['p']); ?>"></div>
                                </div>
                                <span
                                    class="text-xs text-gray-500 w-12 text-right shrink-0"><?php echo e($cd['v']); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-hover bg-white border <?php echo e($ind['color']); ?> rounded-2xl p-5">
                        <span class="text-3xl"><?php echo e($ind['emoji']); ?></span>
                        <h3 class="font-bold text-gray-900 mt-3 mb-1.5 text-sm"><?php echo e($ind['title']); ?></h3>
                        <p class="text-xs text-gray-500 leading-relaxed"><?php echo e($ind['desc']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <?php $__currentLoopData = [['num' => '01', 'title' => 'Daftar & Setup', 'desc' => 'Buat akun perusahaan dalam 2 menit. Masukkan nama perusahaan, email, dan password. Langsung aktif.', 'icon' => 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z'], ['num' => '02', 'title' => 'Input Data Bisnis', 'desc' => 'Tambahkan produk, pelanggan, supplier, dan karyawan. Atau minta AI untuk membantu setup awal bisnis Anda.', 'icon' => 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4'], ['num' => '03', 'title' => 'Kelola Lewat AI', 'desc' => 'Tanyakan apa saja ke Qalcuity AI. Cek stok, buat order, lihat laporan — semua lewat chat natural.', 'icon' => 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative text-center">
                        <div
                            ...
                            <span
                                class="absolute -top-2 -right-2 w-5 h-5 bg-white border-2 border-blue-200 rounded-full text-xs font-black text-blue-600 flex items-center justify-center"><?php echo e($i + 1); ?></span>
                        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-4 gap-5">
                ...
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="relative flex flex-col rounded-3xl border <?php echo e($plan['highlight'] ? 'border-blue-500 shadow-2xl shadow-blue-100 scale-[1.02]' : 'border-gray-200 shadow-sm'); ?> bg-white p-7">
                        <?php if($plan['badge']): ?>
                            <div
                        ...
                        <div class="mb-6">
                            <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">
                                <?php echo e($plan['name']); ?></p>
                            <div class="flex items-end gap-1 mb-1">
                                <span
                                    class="text-3xl font-black text-gray-900 tracking-tight"><?php echo e($plan['price']); ?></span>
                        ...
                        <ul class="space-y-2.5 flex-1 mb-7">
                            <?php $__currentLoopData = $plan['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li
                                    class="flex items-center gap-2.5 text-sm <?php echo e($feat['ok'] ? 'text-gray-700' : 'text-gray-300'); ?>">
                                    <?php if($feat['ok']): ?>
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
                        <button @click="active = active === <?php echo e($i); ?> ? null : <?php echo e($i); ?>"
                            ...
                            <svg class="w-4 h-4 text-gray-400 shrink-0 transition-transform duration-200"
                                :class="active === <?php echo e($i); ?> ? 'rotate-180' : ''" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
    ...
    <section id="affiliate" class="py-20 bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid sm:grid-cols-3 gap-5 mb-10 text-left">
                <?php $__currentLoopData = [['icon' => '🔗', 'title' => 'Dapatkan Link Referral', 'desc' => 'Daftar sebagai affiliate dan dapatkan link unik Anda.'], ['icon' => '📢', 'title' => 'Bagikan ke Jaringan', 'desc' => 'Share link ke teman, komunitas, atau media sosial Anda.'], ['icon' => '💰', 'title' => 'Terima Komisi', 'desc' => 'Setiap kali referral Anda berlangganan, Anda dapat 10% komisi.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white/10 border border-white/10 rounded-2xl p-5 backdrop-blur">
                        <span class="text-2xl"><?php echo e($step['icon']); ?></span>
                        <h3 class="font-bold text-white mt-3 mb-1 text-sm"><?php echo e($step['title']); ?></h3>
                        <p class="text-xs text-purple-200 leading-relaxed"><?php echo e($step['desc']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="https://wa.me/6281529211963?text=Halo%2C%20saya%20tertarik%20menjadi%20affiliate%20Qalcuity%20ERP"
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                ...
                <div class="relative bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur">
                    ...
                    <ul class="space-y-2.5 mb-8">
                        <?php $__currentLoopData = ['Custom AI training sesuai bisnis kamu', 'Integrasi dengan sistem existing', 'Setup & konfigurasi lengkap', 'Training team (2 sesi)', 'Maintenance & update GRATIS', '24/7 technical support']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="https://wa.me/6281529211963?text=Halo%2C%20saya%20tertarik%20dengan%20Paket%20Instalasi%20Open%20Clow%20Agent"
                        target="_blank" rel="noopener"
                ...
                <div class="relative bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur">
                    ...
                    <ul class="space-y-2.5 mb-8">
                        <?php $__currentLoopData = ['100.000 AI tokens per bulan', '~3.000 interaksi AI per bulan', 'Unlimited users dalam tim', 'Real-time analytics & reporting', 'Auto-scaling sesuai kebutuhan', 'Priority support']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center gap-2.5 text-sm text-slate-300">
                    ...
                    <a href="https://wa.me/6281529211963?text=Halo%2C%20saya%20tertarik%20dengan%20Biaya%20Operasional%20Open%20Clow%20Agent"
                        target="_blank" rel="noopener"
            ...
            <div class="mt-16 text-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $clowFuncs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white/5 border border-white/10 rounded-2xl p-5 text-left">
                            <span class="text-2xl"><?php echo e($cf['emoji']); ?></span>
                            <h4 class="font-bold text-white text-sm mt-3 mb-1"><?php echo e($cf['title']); ?></h4>
                            <p class="text-xs text-slate-400 leading-relaxed"><?php echo e($cf['desc']); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li><a href="<?php echo e(route('documentation')); ?>"
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li>
                            <a href="<?php echo e(route('resources.blog')); ?>"
                                class="text-gray-600 hover:text-blue-600 transition">Blog</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('about.partners')); ?>"
        ...
        <div class="border-t border-gray-200 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-4 text-sm">
                    <a href="<?php echo e(route('legal.privacy')); ?>" class="text-gray-600 hover:text-blue-600 transition">
                        Privacy Policy
                    </a>
                    <span class="text-gray-300">|</span>
                    <a href="<?php echo e(route('legal.terms')); ?>" class="text-gray-600 hover:text-blue-600 transition">
                        Terms of Service
                    </a>
                    <span class="text-gray-300">|</span>
                    <a href="<?php echo e(route('legal.cookies')); ?>" class="text-gray-600 hover:text-blue-600 transition">
                        Cookie Policy
                    </a>
                    <span class="text-gray-300">|</span>
                    <a href="<?php echo e(route('legal.security')); ?>" class="text-gray-600 hover:text-blue-600 transition">
                        Security
                    </a>
                    <span class="text-gray-300">|</span>
                    <a href="<?php echo e(route('legal.gdpr')); ?>" class="text-gray-600 hover:text-blue-600 transition">
                        GDPR
                    </a>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
                    <p>© <?php echo e(date('Y')); ?> <a href="<?php echo e(url('/')); ?>"
