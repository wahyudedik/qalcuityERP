...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('cost-centers.report') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/10 transition">
    ...
    <form method="GET" class="flex gap-3 flex-wrap">
        ...
        <a href="{{ route('cost-centers.index') }}" class="px-4 py-2 rounded-xl text-sm bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-slate-400 hover:bg-gray-50 dark:hover:bg-white/10 transition">Reset</a>
        @endif
    </form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition">
                    <td class="px-4 py-3 font-mono text-blue-600 dark:text-blue-400 font-medium">{{ $cc->code }}</td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <span class="inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-medium bg-{{ $c }}-100 text-{{ $c }}-700 dark:bg-{{ $c }}-500/20 dark:text-{{ $c }}-300">
                            {{ $cc->typeLabel() }}
                        </span>
                    </td>
                    <td class="px-4 py-3 text-slate-500 dark:text-slate-400">{{ $cc->parent?->name ?? '—' }}</td>
                    <td class="px-4 py-3">
                        @if($cc->is_active)
