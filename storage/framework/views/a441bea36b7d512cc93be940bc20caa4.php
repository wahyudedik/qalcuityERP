                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $maintenances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($m->asset->name ?? '-'); ?>
                            ...
                            <td class="px-4 py-3 text-right hidden md:table-cell text-gray-700">
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($mc); ?>-100 text-<?php echo e($mc); ?>-700 $mc }}-500/20 $mc }}-400">
    ...
    <div id="modal-add-maintenance" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Jadwalkan Maintenance</h3>
            ...
            <form method="POST" action="<?php echo e(route('assets.maintenance.store')); ?>" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">Aset *</label>
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-600 mb-1">Deskripsi Pekerjaan
                        *</label>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label
                            class="block text-xs font-medium text-gray-600 mb-1">Vendor/Bengkel</label>
