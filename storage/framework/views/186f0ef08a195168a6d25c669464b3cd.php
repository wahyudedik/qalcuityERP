...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-4 mb-4">
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="<?php echo e(route('hrm.performance')); ?>" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">Reset</a>
        </form>
    </div>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 cursor-pointer" onclick="openDetail(<?php echo e($review->id); ?>)">
                        <td class="px-4 py-3">
                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($review->employee->name); ?></p>
                            <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e($review->employee->department ?? '-'); ?></p>
                        </td>
                        ...
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500 dark:text-slate-400"><?php echo e($review->reviewer->name); ?></td>
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($reviews->links()); ?></div>
        <?php endif; ?>
    </div>
            ...
            <form method="POST" action="<?php echo e(route('hrm.performance.store')); ?>" class="p-6 space-y-5">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-4">
                        <label class="w-36 text-sm text-gray-700 dark:text-slate-300 shrink-0"><?php echo e($label); ?></label>
                        <div class="flex gap-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                            <label class="cursor-pointer">
                                <input type="radio" name="<?php echo e($field); ?>" value="<?php echo e($i); ?>" <?php echo e($i === 3 ? 'checked' : ''); ?> class="sr-only peer">
                                <span class="w-9 h-9 flex items-center justify-center rounded-xl border-2 border-gray-200 dark:border-white/10 text-sm font-semibold text-gray-500 dark:text-slate-400 peer-checked:border-blue-500 peer-checked:bg-blue-500 peer-checked:text-white transition cursor-pointer hover:border-blue-400"><?php echo e($i); ?></span>
                            </label>
                            <?php endfor; ?>
                        </div>
                    </div>
