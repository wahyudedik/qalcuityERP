...
<?php $__env->startSection('title', 'Dynamic Pricing Rules'); ?>
                    ...
                    <tbody class="divide-y">
                        <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div class="font-medium"><?php echo e($rule->name); ?></div>
                                    <?php if($rule->ratePlan): ?>
                                        <div class="text-sm text-gray-500">Applies to: <?php echo e($rule->ratePlan->name); ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span class="px-2 py-1 text-xs rounded bg-gray-100">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $rule->rule_type))); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="font-medium <?php echo e($rule->adjustment_value > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                                        <?php echo e($rule->adjustment_value > 0 ? '+' : ''); ?><?php echo e(number_format($rule->adjustment_value, 1)); ?><?php echo e($rule->adjustment_type === 'percentage' ? '%' : '$'); ?>
                                ...
                                <?php echo e($rule->priority === 'high' ? 'bg-red-100 text-red-700' : ''); ?>

                                <?php echo e($rule->priority === 'medium' ? 'bg-yellow-100 text-yellow-700' : ''); ?>

                                <?php echo e($rule->priority === 'low' ? 'bg-green-100 text-green-700' : ''); ?>">
                                        <?php echo e(ucfirst($rule->priority)); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="px-2 py-1 text-xs rounded <?php echo e($rule->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'); ?>">
                                        <?php echo e($rule->is_active ? 'Active' : 'Inactive'); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center text-sm">
                                    <?php if($rule->valid_from && $rule->valid_to): ?>
                                        <?php echo e($rule->valid_from->format('M d')); ?> - <?php echo e($rule->valid_to->format('M d, Y')); ?>

                                    <?php elseif($rule->valid_from): ?>
                                        From <?php echo e($rule->valid_from->format('M d, Y')); ?>

                                    <?php elseif($rule->valid_to): ?>
                                        Until <?php echo e($rule->valid_to->format('M d, Y')); ?>
    ...
    <div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded-lg shadow-lg max-w-2xl w-full max-h-screen overflow-y-auto">
                ...
                <form action="<?php echo e(route('revenue.pricing-rules.store')); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="rate_plan_id" class="w-full border rounded px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $ratePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\revenue\pricing-rules.blade.php ENDPATH**/ ?>