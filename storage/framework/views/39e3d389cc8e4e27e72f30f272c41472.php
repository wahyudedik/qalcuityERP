                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__currentLoopData = $activeRecalls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <?php if($recall->severity == 'critical'): ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300
                                        <?php elseif($recall->severity == 'major'): ?> bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300
                                        <?php else: ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 <?php endif; ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded-full
                                        <?php if($recall->recall_type == 'mandatory'): ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300
                                        <?php else: ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 <?php endif; ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded-full
                                        <?php if($recall->status == 'initiated'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300
                                        <?php else: ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 <?php endif; ?>">
