        ...
        <aside id="sidebar-rail"
            ...
            <?php else: ?>
                ...
                <?php if(!$user?->isKasir() && !$user?->isGudang()): ?>
                    ...
                    <?php if($navTenant?->isModuleEnabled('hotel') ?? true): ?>
                        <?php echo $__env->make('layouts._rail_btn', [
                            'group' => 'hotel',
                            'icon' => 'hotel',
                            'label' => 'Hotel PMS',
            ...
            <header
                ...
                <div class="flex-1 flex items-center gap-2 min-w-0">
                    ...
                    <?php elseif(View::hasSection('header')): ?>
                        <h1 class="text-base font-semibold text-gray-900 dark:text-white truncate"><?php echo $__env->yieldContent('header'); ?>
                        </h1>
                    <?php endif; ?>
                </div>
                ...
                superadmin: {
                    ...
                    items: [{
                        ...
                        },
                        {
                            ...
                            badge: <?php echo e(\App\Models\ErrorLog::where('is_resolved', false)->count() ?: 'null'); ?>,
                        ...
                        },
                        {
                            ...
                            badge: <?php echo e(\App\Models\AffiliateCommission::where('status', 'pending')->count() ?: 'null'); ?>,
                        ...
                        },
                        {
                            ...
                            badge: <?php echo e(\App\Models\AffiliateAuditLog::where('severity', 'fraud')->where('created_at', '>=', now()->subDays(7))->count() ?:'null'); ?>,
                            badgeClass: 'badge-red'
                        },
                        {
                            section: 'Platform'
                        ...
                        <?php if($canView('suppliers')): ?>
                            {
                                ...
                                active: <?php echo e(request()->routeIs('suppliers*') && !request()->routeIs('suppliers.scorecards*') && !request()->routeIs('suppliers.sourcing*') ? 'true' : 'false'); ?>
                        ...
                        <?php if($canView('suppliers')): ?>
                            {
                                ...
                                href: '<?php echo e(route('suppliers.sourcing')); ?>',
                                active: <?php echo e(request()->routeIs('suppliers.sourcing*') ? 'true' : 'false'); ?>
                ...
                <?php if(!$user?->isKasir() && !$user?->isGudang()): ?>
                    ops: {
                        ...
                        items: [
                            ...
                            <?php if(($navTenant?->isModuleEnabled('production') ?? true) && $canView('production')): ?>
                                {
                                    ...
                                    active: <?php echo e(request()->routeIs('production*') ? 'true' : 'false'); ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()?->tenant_id && $canView('cosmetic')): ?>
                                {
                            ...
                            <?php endif; ?>
                            <?php if(($navTenant?->isModuleEnabled('tour_travel') ?? true) && $canView('tour_travel')): ?>
                                {
                                    section: 'Tour & Travel'
                                }, {
                                    label: 'Tour Packages',
                            ...
                            <?php endif; ?>
                            <?php if($navTenant?->isModuleEnabled('livestock_enhancement') ?? true): ?>
                                {
                            ...
                            <?php endif; ?>
                            <?php if($navTenant?->isModuleEnabled('fisheries') ?? true): ?>
                                {
                            ...
                            <?php if($canView('approvals')): ?>
                                {
                                    ...
                                    badge: <?php echo e(\App\Models\ApprovalRequest::where('tenant_id', $user?->tenant_id ?? 0)->where('status', 'pending')->count() ?:'null'); ?>
                            ...
                            <?php if(($navTenant?->isModuleEnabled('hrm') ?? true) && $canView('hrm')): ?>
                                {
                                    ...
                                    badge: <?php echo e(\App\Models\OvertimeRequest::where('tenant_id', $user?->tenant_id ?? 0)->where('status', 'pending')->count() ?:'null'); ?>
                                    ...
                                    badge: <?php echo e(\App\Models\EmployeeCertification::where('tenant_id', $user?->tenant_id ?? 0)->where('status', 'active')->whereNotNull('expiry_date')->where('expiry_date', '<=', now()->addDays(90))->count() ?:'null'); ?>,
                                    badgeClass: 'badge-red'
                                }, {
                                    label: 'Surat Peringatan',
                                    href: '<?php echo e(route('hrm.disciplinary.index')); ?>',
                                    active: <?php echo e(request()->routeIs('hrm.disciplinary*') ? 'true' : 'false'); ?>,
                                    badge: <?php echo e(\App\Models\DisciplinaryLetter::where('tenant_id', $user?->tenant_id ?? 0)->whereIn('status', ['issued', 'acknowledged'])->count() ?:'null'); ?>
