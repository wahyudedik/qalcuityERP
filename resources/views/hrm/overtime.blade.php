<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-4 border border-gray-200 dark:border-white/10">
            ...
            <p class="text-xl font-bold text-blue-500 mt-1">Rp {{ number_format($summary['total_pay'], 0, ',', '.') }}</p>
        </div>
    </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                <td class="px-4 py-3">
                                    <p class="font-medium text-gray-900 dark:text-white">{{ $ot->employee->name ?? '-' }}</p>
                                    <p class="text-xs text-gray-400 dark:text-slate-500">{{ $ot->employee->department ?? $ot->employee->position ?? '' }}</p>
                                </td>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $ot->durationLabel() }}</span>
                                </td>
                                <td class="px-4 py-3 text-right hidden sm:table-cell">
                                    @if($ot->status === 'approved')
                                    <span class="text-green-600 dark:text-green-400 font-medium">Rp {{ number_format($ot->overtime_pay, 0, ',', '.') }}</span>
                                    @else
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">Payroll {{ $ot->payroll_period }}</p>
                                        @else
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-0.5 max-w-[120px] truncate" title="{{ $ot->rejection_reason }}">{{ $ot->rejection_reason }}</p>
                                        @endif
                                    </div>
                                    @endif
                                </td>
