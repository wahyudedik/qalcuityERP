<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalSurgeries) }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Terjadwal Hari Ini</p>
            <p class="text-2xl font-bold text-blue-600 mt-1">{{ $scheduledToday }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Berlangsung</p>
            <p class="text-2xl font-bold text-amber-600 mt-1">{{ $inProgressSurgeries }}</p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-purple-600 mt-1">{{ $pendingSurgeries }}</p>
        </div>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($schedules ?? [] as $schedule)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <span
                                    class="font-mono text-sm font-bold text-blue-600">{{ $schedule->schedule_number ?? '-' }}</span>
                            </td>
                            <td class="px-4 py-3">
