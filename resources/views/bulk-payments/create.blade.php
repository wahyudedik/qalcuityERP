...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-3">
        <a href="{{ route('bulk-payments.index') }}" class="text-slate-400 hover:text-slate-600">
                ...
                <div id="invoiceList" class="space-y-2">
                    @if($pendingInvoices->isNotEmpty())
                        ...
                        <div class="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-mono font-medium text-slate-800">{{ $inv->number }}</p>
                                <p class="text-xs text-slate-500">Jatuh tempo: {{ $inv->due_date->format('d/m/Y') }}</p>
                            </div>
                            <div class="text-right">
                                <p class="text-xs text-slate-500">Sisa tagihan</p>
                                <p class="text-sm font-medium text-slate-800">Rp {{ number_format($inv->remaining_amount, 0, ',', '.') }}</p>
                            </div>
                            <div class="w-36">
