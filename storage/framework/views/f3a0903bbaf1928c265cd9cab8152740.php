                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-5 flex flex-col gap-3">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mt-1"><?php echo e($sim->name); ?></h3>
                            ...
                            <span class="text-xs px-2 py-1 rounded-full
                                <?php echo e($sim->status === 'calculated' ? 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300'); ?>">
                        ...
                        <?php if($sim->ai_narrative): ?>
                            <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2"><?php echo e($sim->ai_narrative); ?></p>
                        <?php endif; ?>
