        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-slate-400 mt-1">
                    MRN: <?php echo e($patient->medical_record_number); ?> |
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-200 dark:border-white/10 p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($statistics['total_visits']); ?>
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $active_medications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="p-3 bg-gray-50 dark:bg-white/5 rounded-lg">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($med->medication_name); ?>
