...
class ProactiveInsightEnginePropertyTest extends TestCase
{
    ...
    #[DataProvider('lowStockScenarios')]
    public function test_low_stock_trigger_generates_insight(int $productCount, int $stockMin): void
    {
    ...
    #[DataProvider('overdueArScenarios')]
    public function test_overdue_ar_trigger_generates_insight(int $invoiceCount, int $daysOverdue): void
    {
        $tenant = $this->createTenant();
    ...
    #[DataProvider('budgetExceededScenarios')]
    public function test_budget_exceeded_trigger_generates_insight(int $budgetCount, int $usagePercent): void
    {
        $tenant = $this->createTenant();
    ...
    #[DataProvider('contractExpiryScenarios')]
    public function test_contract_expiry_trigger_generates_insight(int $employeeCount, int $daysRemaining): void
    {
        $tenant = $this->createTenant();
    ...
    #[DataProvider('unpaidInvoiceScenarios')]
    public function test_unpaid_invoice_trigger_generates_insight(int $invoiceCount, int $invoiceAmount): void
    {
        $tenant = $this->createTenant();
        $customer = $this->createCustomer($tenant->id);
    ...
    #[DataProvider('allConditionTypes')]
    public function test_insight_structure_completeness_for_all_condition_types(string $conditionType): void
    {
        $tenant = $this->createTenant();
    ...
    #[DataProvider('dismissReasons')]
    public function test_insight_suppression_after_dismiss(string $dismissReason): void
    {
        $tenant = $this->createTenant();
    ...
    public function test_insight_with_same_hash_not_duplicated_within_suppression_window(): void
    {
        $tenant = $this->createTenant();
        $warehouse = $this->createWarehouse($tenant->id);
