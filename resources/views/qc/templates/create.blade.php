<x-app-layout>
    <x-slot name="header">{{ __('Create QC Test Template') }}</x-slot>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('qc.templates.store') }}" method="POST" x-data="templateForm()">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="sample_size_formula" required
                            ...
                            <option value="1" {{ old('sample_size_formula', 1) == 1 ? 'selected' : '' }}>√n
                                (Square Root of Lot Size)</option>
                            <option value="2" {{ old('sample_size_formula') == 2 ? 'selected' : '' }}>10% of Lot
                                Size</option>
                            <option value="3" {{ old('sample_size_formula') == 3 ? 'selected' : '' }}>5% of Lot
                                Size (min 3)</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="acceptance_quality_limit" step="0.01" min="0"
                            max="100" value="{{ old('acceptance_quality_limit', '2.50') }}" required
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="instructions" rows="3"
                            class="w-full rounded-md border-gray-300"
                            placeholder="Step-by-step inspection instructions (optional)">{{ old('instructions') }}</textarea>
                    </div>
