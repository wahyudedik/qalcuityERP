...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('Aging Report')); ?></h2>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp
                                <?php echo e(number_format($aging['current'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp
                                <?php echo e(number_format($aging['1_30_days'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp
                                <?php echo e(number_format($aging['31_60_days'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp
                                <?php echo e(number_format($aging['61_90_days'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">Rp
                                <?php echo e(number_format($aging['over_90_days'], 0, ',', '.')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-semibold text-gray-900">Rp
                                <?php echo e(number_format($aging['current'], 0, ',', '.')); ?>

                                (<?php echo e($total > 0 ? number_format(($aging['current'] / $total) * 100, 1) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-green-600 h-4 rounded-full"
                                style="width: <?php echo e($total > 0 ? ($aging['current'] / $total) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-semibold text-gray-900">Rp
                                <?php echo e(number_format($aging['1_30_days'], 0, ',', '.')); ?>

                                (<?php echo e($total > 0 ? number_format(($aging['1_30_days'] / $total) * 100, 1) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-blue-600 h-4 rounded-full"
                                style="width: <?php echo e($total > 0 ? ($aging['1_30_days'] / $total) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-semibold text-gray-900">Rp
                                <?php echo e(number_format($aging['31_60_days'], 0, ',', '.')); ?>

                                (<?php echo e($total > 0 ? number_format(($aging['31_60_days'] / $total) * 100, 1) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-yellow-600 h-4 rounded-full"
                                style="width: <?php echo e($total > 0 ? ($aging['31_60_days'] / $total) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-semibold text-gray-900">Rp
                                <?php echo e(number_format($aging['61_90_days'], 0, ',', '.')); ?>

                                (<?php echo e($total > 0 ? number_format(($aging['61_90_days'] / $total) * 100, 1) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-orange-600 h-4 rounded-full"
                                style="width: <?php echo e($total > 0 ? ($aging['61_90_days'] / $total) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-semibold text-gray-900">Rp
                                <?php echo e(number_format($aging['over_90_days'], 0, ',', '.')); ?>

                                (<?php echo e($total > 0 ? number_format(($aging['over_90_days'] / $total) * 100, 1) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-red-600 h-4 rounded-full"
                                style="width: <?php echo e($total > 0 ? ($aging['over_90_days'] / $total) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="p-4 bg-red-50 border-l-4 border-red-500 rounded">
                        ...
                        <p class="text-xs text-red-700 mt-1">Over 60 days: Rp
                            <?php echo e(number_format($aging['61_90_days'] + $aging['over_90_days'], 0, ',', '.')); ?></p>
                    ...
                    <div class="p-4 bg-green-50 border-l-4 border-green-500 rounded">
                        ...
                        <p class="text-xs text-green-700 mt-1">0-30 days: Rp
                            <?php echo e(number_format($aging['current'] + $aging['1_30_days'], 0, ',', '.')); ?></p>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\financial-reports\aging.blade.php ENDPATH**/ ?>