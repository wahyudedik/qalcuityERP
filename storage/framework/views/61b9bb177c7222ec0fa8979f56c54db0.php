...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-4 px-4 py-3 bg-red-50 border border-red-200 rounded-xl text-sm text-red-700"><?php echo e(session('error')); ?></div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-200 p-6">
            <div class="flex items-start justify-between mb-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e($deferredItem->description); ?></h2>
                    <p class="text-sm text-gray-500 mt-1"><?php echo e($deferredItem->start_date->format('d M Y')); ?> – <?php echo e($deferredItem->end_date->format('d M Y')); ?> · <?php echo e($deferredItem->total_periods); ?> bulan</p>
                </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
                <div class="bg-gray-50 rounded-xl p-3">
                    ...
                    <p class="font-semibold text-gray-900 mt-0.5">Rp <?php echo e(number_format($deferredItem->total_amount,0,',','.')); ?></p>
                </div>
                <div class="bg-green-50 rounded-xl p-3">
                    <p class="text-xs text-gray-500">Diakui</p>
                    <p class="font-semibold text-green-700 mt-0.5">Rp <?php echo e(number_format($deferredItem->recognized_amount,0,',','.')); ?></p>
                </div>
                <div class="bg-blue-50 rounded-xl p-3">
                    <p class="text-xs text-gray-500">Sisa</p>
                    <p class="font-semibold text-blue-700 mt-0.5">Rp <?php echo e(number_format($deferredItem->remaining_amount,0,',','.')); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl p-3">
                    <p class="text-xs text-gray-500">Progress</p>
                    <p class="font-semibold text-gray-900 mt-0.5"><?php echo e($deferredItem->recognized_periods); ?>/<?php echo e($deferredItem->total_periods); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div>
                    ...
                    <span class="ml-1 text-gray-900"><?php echo e($deferredItem->deferredAccount->code); ?> - <?php echo e($deferredItem->deferredAccount->name); ?></span>
                </div>
                <div>
                    <span class="text-gray-500">Akun Pengakuan:</span>
                    <span class="ml-1 text-gray-900"><?php echo e($deferredItem->recognitionAccount->code); ?> - <?php echo e($deferredItem->recognitionAccount->name); ?></span>
                </div>
                <?php if($deferredItem->reference_number): ?>
                <div>
                    <span class="text-gray-500">Referensi:</span>
                    <span class="ml-1 text-gray-900"><?php echo e($deferredItem->reference_number); ?></span>
                </div>
                <?php endif; ?>
                <div>
                    <span class="text-gray-500">Dibuat oleh:</span>
                    <span class="ml-1 text-gray-900"><?php echo e($deferredItem->user->name); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <div class="mt-4 p-3 bg-amber-50 rounded-xl border border-amber-200">
                ...
                <p class="text-sm font-semibold text-amber-800 mt-1"><?php echo e($nextPending->recognition_date->format('d M Y')); ?></p>
                <p class="text-xs text-amber-600">Rp <?php echo e(number_format($nextPending->amount,0,',','.')); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    ?>
                    <tr class="hover:bg-gray-50 <?php echo e($isDue ? 'bg-amber-50/50' : ''); ?>">
                        <td class="px-4 py-3 text-center font-medium text-gray-900"><?php echo e($schedule->period_number); ?></td>
                        <td class="px-4 py-3 text-gray-700"><?php echo e($schedule->recognition_date->format('d M Y')); ?></td>
                        <td class="px-4 py-3 text-right font-medium text-gray-900">Rp <?php echo e(number_format($schedule->amount,0,',','.')); ?></td>
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            <a href="<?php echo e(route('journals.show', $schedule->journalEntry)); ?>" class="text-xs text-blue-600 hover:underline"><?php echo e($schedule->journalEntry->number); ?></a>
                            <?php else: ?>
