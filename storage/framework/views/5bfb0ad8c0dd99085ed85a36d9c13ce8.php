            ...
            <div class="card-hover bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                ...
                <div class="space-y-2.5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex-1 bg-gray-100 rounded-full h-1.5"><div class="bg-gradient-to-r from-blue-500 to-indigo-500 h-1.5 rounded-full" style="width:<?php echo e($cd['p']); ?>"></div></div>
                        <span class="text-xs text-gray-500 w-12 text-right shrink-0"><?php echo e($cd['v']); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
