...
<?php $__env->startSection('title', 'Quality Control Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($statistics['quality_checks']['total']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <span
                        class="text-green-600 text-sm font-semibold"><?php echo e(number_format($statistics['quality_checks']['pass_rate'], 1)); ?>%
                        Pass Rate</span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600"><?php echo e($statistics['quality_checks']['passed']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600"><?php echo e($statistics['quality_checks']['failed']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600"><?php echo e($statistics['defects']['open']); ?></p>
                    </div>
                ...
                <div class="mt-4">
                    <span class="text-red-600 text-sm font-semibold"><?php echo e($statistics['defects']['critical']); ?>
        ...
        <div class="mb-6 flex gap-3">
            ...
            <a href="<?php echo e(route('manufacturing.quality.standards')); ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <?php if($recentChecks->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $recentChecks->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                                    <div class="flex-1">
                                        <p class="font-semibold text-gray-900"><?php echo e($check->check_number); ?></p>
                                        <p class="text-sm text-gray-600">
                                            <?php echo e($check->workOrder?->number ?? 'N/A'); ?> | <?php echo e($check->stage); ?>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">
                                            <?php echo e($check->inspected_at?->format('d/m/Y H:i') ?? 'Not inspected'); ?></p>
                                    </div>
                                </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <?php if($openDefects->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $openDefects->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $defect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                                    <div class="flex-1">
                                        <p class="font-semibold text-gray-900"><?php echo e($defect->defect_code); ?></p>
                                        <p class="text-sm text-gray-600">
                                            <?php echo e($defect->product?->name ?? 'N/A'); ?> | <?php echo e($defect->defect_type); ?>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <?php endif; ?>
                                        <p class="text-xs text-gray-500 mt-1">Qty: <?php echo e($defect->quantity_defected); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\manufacturing\quality\dashboard.blade.php ENDPATH**/ ?>