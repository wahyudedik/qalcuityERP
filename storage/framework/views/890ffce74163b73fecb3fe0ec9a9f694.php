    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            ...
            <div class="flex items-end gap-2">
                <p class="text-3xl font-black text-gray-900"><?php echo e($quota - $usedDays); ?></p>
                <p class="text-sm text-gray-400 mb-1">/ <?php echo e($quota); ?> hari tersisa</p>
            </div>
            <div class="mt-3 h-2 bg-gray-100 rounded-full overflow-hidden">
                <div class="h-full bg-blue-500 rounded-full transition-all"
                    style="width: <?php echo e($quota > 0 ? min(100, ($usedDays / $quota) * 100) : 0); ?>%"></div>
            </div>
            <p class="text-xs text-gray-400 mt-1"><?php echo e($usedDays); ?> hari terpakai tahun <?php echo e(now()->year); ?></p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1">
            <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-5 py-4 flex items-start gap-4">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 flex-wrap">
                                <p class="text-sm font-medium text-gray-900"><?php echo e($leave->typeLabel()); ?></p>
                            ...
                            <?php if($leave->reason): ?>
                            <p class="text-xs text-gray-400 mt-0.5 italic"><?php echo e($leave->reason); ?></p>
                            <?php endif; ?>
                            <?php if($leave->status === 'rejected' && $leave->rejection_reason): ?>
                            <p class="text-xs text-red-500 mt-1">Alasan penolakan: <?php echo e($leave->rejection_reason); ?></p>
                            <?php endif; ?>
                            <?php if($leave->status === 'approved' && $leave->approver): ?>
                            <p class="text-xs text-gray-400 mt-0.5">Disetujui oleh: <?php echo e($leave->approver->name); ?></p>
                            <?php endif; ?>
                        </div>
                        <div class="shrink-0 text-right">
                            <p class="text-xs text-gray-400"><?php echo e($leave->created_at->format('d M Y')); ?></p>
                ...
                <div class="px-5 py-3 border-t border-gray-100"><?php echo e($leaves->links()); ?></div>
                <?php endif; ?>
                <?php endif; ?>
            </div>
        </div>
