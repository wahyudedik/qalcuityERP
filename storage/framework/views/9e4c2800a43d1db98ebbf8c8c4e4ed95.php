        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <?php endif; ?>
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($doctor->name); ?></h2>
                        <p class="text-sm text-gray-500 dark:text-slate-400">
                            <?php echo e($doctor->specialization ?? 'Dokter Umum'); ?>

                        </p>
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">STR: <?php echo e($doctor->str_number ?? '-'); ?>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t border-gray-200 dark:border-white/10">
                <div>
                    ...
                    <p class="text-sm font-medium text-gray-900 dark:text-white mt-1"><?php echo e($doctor->email ?? '-'); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500 dark:text-slate-400">Telepon</p>
                    <p class="text-sm font-medium text-gray-900 dark:text-white mt-1"><?php echo e($doctor->phone ?? '-'); ?></p>
                </div>
                <div>
