...
<?php $__env->startSection('title', 'QC Trend Analysis'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" class="flex gap-4">
                ...
                <select name="category" class="px-3 py-2 border border-gray-300 rounded-lg">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($cat); ?>" <?php echo e($category == $cat ? 'selected' : ''); ?>><?php echo e($cat); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-gray-900"><?php echo e(number_format($qcStats['total_tests'])); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Passed</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e(number_format($qcStats['pass_count'])); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Failed</div>
                <div class="mt-2 text-3xl font-bold text-red-600"><?php echo e(number_format($qcStats['fail_count'])); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Pass Rate</div>
                <div
                    class="mt-2 text-3xl font-bold <?php echo e($qcStats['pass_rate'] >= 95 ? 'text-green-600' : 'text-yellow-600'); ?>">
                    <?php echo e(number_format($qcStats['pass_rate'], 1)); ?>%</div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $failurePoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($failure->test_name); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600 font-semibold">
                                <?php echo e($failure->fail_count); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            const trendData = <?php echo json_encode($trendByDate, 15, 512) ?>;
            ...
            const catData = <?php echo json_encode($byCategory, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\analytics\qc-trend.blade.php ENDPATH**/ ?>