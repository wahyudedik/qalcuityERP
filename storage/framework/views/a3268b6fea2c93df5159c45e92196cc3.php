...
<div class="w-full max-w-2xl">
    ...
    <div id="ai-mode" class="hidden">
        ...
        <div class="flex items-center justify-center gap-2 mb-5" id="ai-step-indicator">
            <?php $__currentLoopData = [1 => 'Jenis Bisnis', 2 => 'Chat AI', 3 => 'Modul', 4 => 'Selesai!']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-2">
                <div class="ai-step-dot w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold transition-all
                    <?php echo e($n === 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-500'); ?>" data-step="<?php echo e($n); ?>">
                    <?php echo e($n); ?>

                </div>
                <span class="text-xs hidden sm:block <?php echo e($n === 1 ? 'text-blue-600 font-medium' : 'text-gray-400'); ?>" data-ai-step-label="<?php echo e($n); ?>"><?php echo e($label); ?></span>
                <?php if($n < 4): ?><div class="w-8 h-px bg-gray-200 mx-1"></div><?php endif; ?>
            </div>
        ...
        <div id="ai-step-1" class="ai-step-panel">
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ind): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button onclick="selectIndustry('<?php echo e($key); ?>', '<?php echo e($ind['label']); ?>')"
                        ...
                        data-industry="<?php echo e($key); ?>">
                        <span class="text-2xl"><?php echo e($ind['icon']); ?></span>
                        <div class="font-medium text-gray-900 text-sm"><?php echo e($ind['label']); ?></div>
                        <div class="text-xs text-gray-400"><?php echo e($ind['desc']); ?></div>
                    </button>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <div class="flex justify-between mt-4">
                ...
                <a href="<?php echo e(route('onboarding.skip')); ?>" class="text-sm text-gray-400 hover:text-gray-600 transition py-2">Lewati setup</a>
            </div>
        </div>
        ...
        <div id="ai-step-4" class="ai-step-panel hidden">
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center space-y-4">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" id="finish-btn" class="inline-block px-8 py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white text-sm font-semibold transition mt-2">
                    Mulai Gunakan ERP 🚀
                </a>
            </div>
        </div>
    ...
    <div id="manual-mode" class="hidden">
        ...
        <div class="flex items-center justify-center gap-2 mb-5" id="manual-step-indicator">
            <?php $__currentLoopData = [1 => 'Bisnis', 2 => 'Gudang & Produk', 3 => 'Modul', 4 => 'Siap!']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs hidden sm:block <?php echo e($n === 1 ? 'text-blue-600 font-medium' : 'text-gray-400'); ?>" data-step-label="<?php echo e($n); ?>"><?php echo e($label); ?></span>
                <?php if($n < 4): ?><div class="manual-connector w-8 h-px bg-gray-200 mx-1"></div><?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <form method="POST" action="<?php echo e(route('onboarding.complete')); ?>" id="onboarding-form">
            <?php echo csrf_field(); ?>
            ...
            <div class="step-panel" data-panel="1">
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="business_name" value="<?php echo e(old('business_name', $tenant->name)); ?>" required
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            ...
                            ?>
                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="business-type-card cursor-pointer">
                                <input type="radio" name="business_type" value="<?php echo e($value); ?>" class="sr-only"
                                    <?php echo e(old('business_type', $tenant->business_type) === $value ? 'checked' : ''); ?>>
                                <div class="flex items-center gap-2 px-3 py-2.5 rounded-xl border-2 border-gray-200 hover:border-blue-300 transition text-sm font-medium text-gray-700 select-none">
                                    <span class="text-lg"><?php echo e($type['icon']); ?></span><?php echo e($type['label']); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="address" value="<?php echo e(old('address', $tenant->address)); ?>"
                                class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <textarea name="business_description" rows="2"
                            ...
                            placeholder="Contoh: Toko kelontong kebutuhan sehari-hari"><?php echo e(old('business_description', $tenant->business_description)); ?></textarea>
                    </div>
                </div>
                <div class="flex justify-between mt-4">
            ...
            <div class="step-panel hidden" data-panel="2">
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="warehouse_name" value="<?php echo e(old('warehouse_name', 'Gudang Utama')); ?>" required
                            class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="expense_categories" value="<?php echo e(old('expense_categories', 'Bahan Baku, Operasional, Gaji Karyawan')); ?>"
                            class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="bg-blue-50 rounded-xl p-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <button type="button" onclick="applyPreset('<?php echo e($key); ?>')"
            ...
            <div class="step-panel hidden" data-panel="3">
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-2" id="manual-module-grid">
                        <?php $__currentLoopData = \App\Services\ModuleRecommendationService::MODULE_META; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $isOn = true; ?>
                        <label class="manual-module-card flex items-center gap-2 p-2.5 rounded-xl border-2 cursor-pointer transition text-sm border-blue-500 bg-blue-50">
                            <input type="checkbox" name="modules[]" value="<?php echo e($key); ?>" checked class="sr-only" onchange="toggleManualModule(this)">
                            <span class="text-lg shrink-0"><?php echo e($m['icon']); ?></span>
                            <span class="font-medium text-gray-800 leading-tight"><?php echo e($m['label']); ?></span>
...
<script>
const presets = <?php echo $jsPresets; ?>;
const aiChatEndpoint = "<?php echo e(route('onboarding.ai-chat')); ?>";
...
const moduleRecommendEndpoint = "<?php echo e(route('settings.modules.recommend')); ?>";
const moduleSaveEndpoint = "<?php echo e(route('settings.modules.update')); ?>";
const allModuleMeta = <?php echo json_encode(\App\Services\ModuleRecommendationService::MODULE_META, 15, 512) ?>;
let selectedModules = [];
...
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\onboarding\wizard.blade.php ENDPATH**/ ?>