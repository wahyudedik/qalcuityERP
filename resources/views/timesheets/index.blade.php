    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900">{{ number_format($totalHours, 1) }} <span class="text-sm font-normal text-gray-400">jam</span></p>
            </div>
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
        ...
        <form method="GET" class="flex flex-wrap gap-3">
            ...
            <a href="{{ route('timesheets.index') }}" class="px-4 py-2 border border-gray-200 text-gray-600 text-sm font-medium rounded-xl hover:bg-gray-100 transition">Reset</a>
            @endif
        </form>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-gray-500 hidden sm:table-cell">{{ $ts->user?->name ?? '-' }}</td>
                            <td class="px-6 py-3 text-gray-600 max-w-xs truncate">{{ $ts->description }}</td>
                            <td class="px-6 py-3 text-right font-medium text-gray-900">{{ number_format($ts->hours, 1) }}</td>
