                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                @if ($sp->habitat)
                                    <div>
                                        ...
                                        <span class="text-gray-700 ml-1">{{ $sp->habitat }}</span>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-5 hover:shadow-lg transition">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    <div
                                        class="w-16 h-16 rounded-xl bg-gradient-to-br from-{{ $grade->color ?? 'purple' }}-100 to-{{ $grade->color ?? 'purple' }}-200 $grade->color ?? 'purple' }}-500/20 $grade->color ?? 'purple' }}-500/30 flex items-center justify-center">
                                        <span
                                            class="text-2xl font-bold text-{{ $grade->color ?? 'purple' }}-600 $grade->color ?? 'purple' }}-400">{{ $grade->grade_code }}</span>
                                    </div>
                                    <div>
                                        <h4 class="text-base font-bold text-gray-900">
                                            {{ $grade->name }}</h4>
                                        <p class="text-sm text-gray-500">{{ $grade->description }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 pt-3 border-t border-gray-100 grid grid-cols-3 gap-4 text-xs">
                                    @if ($grade->min_weight_kg)
                                        <div>
                                            ...
                                            <span
                                                class="text-gray-700 ml-1">{{ number_format($grade->min_weight_kg, 2) }}
                                                kg</span>
                                        </div>
                                    @endif
                                    @if ($grade->max_weight_kg)
                                        <div>
                                            ...
                                            <span
                                                class="text-gray-700 ml-1">{{ number_format($grade->max_weight_kg, 2) }}
                                                kg</span>
                                        </div>
                                    @endif
