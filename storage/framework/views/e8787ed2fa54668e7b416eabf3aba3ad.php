...
<?php $__env->startSection('title', 'Radiology Orders'); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <i class="fas <?php echo e($icons[$order->exam_type] ?? 'fa-x-ray'); ?> me-1"></i>
                                            <?php echo e($order->exam_type ?? '-'); ?>

                                        </td>
                                        <td><?php echo e($order->body_part ?? '-'); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo e(route('healthcare.emr.radiology-orders.show', $order)); ?>"
    ...
    <div class="modal fade" id="addOrderModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="<?php echo e(route('healthcare.emr.radiology-orders.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\emr\radiology-orders.blade.php ENDPATH**/ ?>