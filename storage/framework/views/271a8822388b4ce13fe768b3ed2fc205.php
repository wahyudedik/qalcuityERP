...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 font-medium text-gray-900"><?php echo e($bom->name); ?></td>
                            <td class="px-4 py-3 text-gray-700"><?php echo e($bom->product->name ?? '-'); ?>
        ...
        <?php if($boms->hasPages()): ?>
            <div class="px-4 py-3 border-t border-gray-100"><?php echo e($boms->links()); ?></div>
        <?php endif; ?>
    </div>
        ...
        <div id="modal-detail-<?php echo e($bom->id); ?>"
            ...
            <div class="bg-white rounded-2xl w-full max-w-lg shadow-xl max-h-[80vh] overflow-y-auto">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h3 class="font-semibold text-gray-900"><?php echo e($bom->name); ?></h3>
                    <button
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-3 mb-4 text-sm">
                        <div><span class="text-gray-500">Produk:</span> <span
                                class="text-gray-900"><?php echo e($bom->product->name ?? '-'); ?></span></div>
                        <div><span class="text-gray-500">Batch:</span> <span
                                class="text-gray-900"><?php echo e($bom->batch_size); ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $bom->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="py-1.5 text-gray-900"><?php echo e($line->product->name ?? '-'); ?>

                                    </td>
                                    <td class="py-1.5 text-right text-gray-900">
                                        <?php echo e(number_format($line->quantity_per_batch, 3)); ?></td>
                                    <td class="py-1.5 text-gray-500"><?php echo e($line->unit); ?></td>
                                    <td class="py-1.5">
                                        <?php if($line->childBom): ?>
                                            <span
                                                class="px-1.5 py-0.5 rounded text-xs bg-purple-100 text-purple-700"><?php echo e($line->childBom->name); ?></span>
                                        <?php else: ?>
