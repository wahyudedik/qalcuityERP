    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <div class="flex items-start justify-between mb-3">
                <div>
                    <h3 class="font-semibold text-gray-900"><?php echo e($pl->name); ?></h3>
                    <?php if($pl->code): ?><p class="text-xs text-gray-400"><?php echo e($pl->code); ?></p><?php endif; ?>
                </div>
                <div class="flex items-center gap-2">
                    <span class="px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($typeColor); ?>"><?php echo e($pl->typeLabel()); ?></span>
                    <span class="w-2 h-2 rounded-full <?php echo e($isValid ? 'bg-green-500' : 'bg-gray-300'); ?>"></span>
                </div>
            </div>

            <?php if($pl->description): ?>
            <p class="text-xs text-gray-500 mb-3"><?php echo e($pl->description); ?></p>
            <?php endif; ?>
            ...
            <div class="flex items-center gap-2 pt-3 border-t border-gray-100">
                <a href="<?php echo e(route('price-lists.show', $pl)); ?>" class="flex-1 text-center px-3 py-1.5 text-xs border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50">Detail</a>
        ...
        <div class="col-span-3 py-12 text-center text-gray-400">Belum ada price list. <a href="<?php echo e(route('price-lists.create')); ?>" class="text-blue-600 hover:underline">Buat sekarang</a>.</div>
        <?php endif; ?>
    </div>
