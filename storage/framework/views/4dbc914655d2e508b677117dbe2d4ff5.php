...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p
                class="text-lg font-bold <?php echo e($summary['total_actual'] > $summary['total_rab'] ? 'text-red-500' : 'text-emerald-600'); ?>">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p
                class="text-lg font-bold <?php echo e($variance < 0 ? 'text-red-500' : 'text-emerald-600'); ?>">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-lg font-bold text-gray-900"><?php echo e($summary['item_count']); ?> <span
            ...
            <div class="flex flex-wrap gap-3">
                <?php $__currentLoopData = $byCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 text-xs">
                        <span
                            class="font-medium text-gray-700 capitalize"><?php echo e($cat->cat); ?></span>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <?php if($tree->isNotEmpty()): ?>
                        <tr class="bg-gray-50 font-bold">
                            ...
                            <td
                                class="px-4 py-3 text-right <?php echo e($summary['total_actual'] > $summary['total_rab'] ? 'text-red-500' : 'text-emerald-600'); ?>">
                                Rp <?php echo e(number_format($summary['total_actual'], 0, ',', '.')); ?>
