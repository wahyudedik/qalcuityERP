    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(__('Utilisasi Bandwidth')); ?></h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Tren konsumsi bandwidth dan penggunaan per perangkat')); ?></p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 mb-6">
                <form method="GET" action="<?php echo e(route('telecom.reports.bandwidth-utilization')); ?>" class="flex flex-wrap gap-4 items-end">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Kelompokkan')); ?></label>
            ...
            <?php if(isset($report['summary'])): ?>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 border-l-4 border-blue-500">
                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Total Download')); ?></p>
                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e(number_format(($report['summary']['total_download'] ?? 0) / 1073741824, 2)); ?> GB</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 border-l-4 border-green-500">
                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Total Upload')); ?></p>
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e(number_format(($report['summary']['total_upload'] ?? 0) / 1073741824, 2)); ?> GB</p>
                    </div>
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-4 border-l-4 border-purple-500">
                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(__('Total Penggunaan')); ?></p>
                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e(number_format((($report['summary']['total_download'] ?? 0) + ($report['summary']['total_upload'] ?? 0)) / 1073741824, 2)); ?> GB</p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e(__('Data Penggunaan Bandwidth')); ?></h2>
                </div>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $report['data'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-white"><?php echo e($row['period'] ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-blue-600 dark:text-blue-400"><?php echo e(number_format(($row['total_download'] ?? 0) / 1073741824, 2)); ?> GB</td>
                                    <td class="px-6 py-4 text-sm text-green-600 dark:text-green-400"><?php echo e(number_format(($row['total_upload'] ?? 0) / 1073741824, 2)); ?> GB</td>
                                    <td class="px-6 py-4 text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(number_format((($row['total_download'] ?? 0) + ($row['total_upload'] ?? 0)) / 1073741824, 2)); ?> GB</td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400"><?php echo e(__('Tidak ada data untuk periode ini')); ?></td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
