<x-app-layout>
    <x-slot name="header">{{ __('Create QC Inspection') }}</x-slot>
                ...
                <form action="{{ route('qc.inspections.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="work_order_id" required
                            class="w-full rounded-md border-gray-300 @error('work_order_id') border-red-500 @enderror">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="sample_size" value="{{ old('sample_size', 10) }}" min="1"
                            required
                            class="w-full rounded-md border-gray-300 @error('sample_size') border-red-500 @enderror">
                        @error('sample_size')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
