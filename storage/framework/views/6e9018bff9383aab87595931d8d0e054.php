...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('New Radiology Order')); ?></h2>
     <?php $__env->endSlot(); ?>

    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('healthcare.radiology.exams.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            ...
                            <select name="exam_type" required
                                ...
                                <option value="xray" <?php echo e(old('exam_type') === 'xray' ? 'selected' : ''); ?>>X-Ray
                                </option>
                                <option value="ct_scan" <?php echo e(old('exam_type') === 'ct_scan' ? 'selected' : ''); ?>>CT Scan
                                </option>
                                <option value="mri" <?php echo e(old('exam_type') === 'mri' ? 'selected' : ''); ?>>MRI</option>
                                <option value="ultrasound" <?php echo e(old('exam_type') === 'ultrasound' ? 'selected' : ''); ?>>
                                    Ultrasound</option>
                                <option value="mammography" <?php echo e(old('exam_type') === 'mammography' ? 'selected' : ''); ?>>
                                    Mammography</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="body_part" required value="<?php echo e(old('body_part')); ?>"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        ...
                        <div>
                            ...
                            <textarea name="clinical_indication" rows="3"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Reason for exam..."><?php echo e(old('clinical_indication')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="priority"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="routine" <?php echo e(old('priority') === 'routine' ? 'selected' : ''); ?>>Routine
                                </option>
                                <option value="urgent" <?php echo e(old('priority') === 'urgent' ? 'selected' : ''); ?>>Urgent
                                </option>
                                <option value="stat" <?php echo e(old('priority') === 'stat' ? 'selected' : ''); ?>>STAT
                                    (Emergency)</option>
                            </select>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views/healthcare/radiology/create.blade.php ENDPATH**/ ?>