        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        <span class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($farmPlot->code); ?></span>
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 dark:bg-<?php echo e($sc); ?>-500/20 dark:text-<?php echo e($sc); ?>-400"><?php echo e($farmPlot->statusLabel()); ?></span>
                    </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e(number_format($farmPlot->area_size, 1)); ?> <?php echo e($farmPlot->area_unit); ?></p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white"><?php echo e($farmPlot->costPerUnit() ? 'Rp '.number_format($farmPlot->costPerUnit(), 0, ',', '.') : '-'); ?></p>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <div class="px-3 py-2 rounded-lg bg-gray-50 dark:bg-white/5 text-xs">
                        <span class="font-medium text-gray-700 dark:text-slate-300"><?php echo e(\App\Models\FarmPlotActivity::ACTIVITY_TYPES[$ct->activity_type] ?? $ct->activity_type); ?></span>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
                <div class="px-5 py-4 border-b border-gray-100 dark:border-white/10 flex items-center justify-between">
                    <h3 class="font-semibold text-gray-900 dark:text-white">Riwayat Aktivitas (<?php echo e($farmPlot->activities->count()); ?>)</h3>
