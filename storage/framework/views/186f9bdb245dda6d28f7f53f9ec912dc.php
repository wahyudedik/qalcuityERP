        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('Edit Paket Internet')); ?></h1>
                        <p class="mt-1 text-sm text-gray-600"><?php echo e(__('Perbarui informasi paket internet')); ?></p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="download_speed_mbps" id="download_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-16 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?php $__errorArgs = ['download_speed_mbps'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="upload_speed_mbps" id="upload_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-16 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?php $__errorArgs = ['upload_speed_mbps'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500"><?php echo e(__('Contoh: 107374182400 = 100 GB')); ?></p>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('description', $package->description)); ?></textarea>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_active" class="font-medium text-gray-700"><?php echo e(__('Aktifkan Paket')); ?></label>
                            <p class="text-gray-500"><?php echo e(__('Jadikan paket ini tersedia untuk subscription baru')); ?></p>
                        </div>
                    </div>
