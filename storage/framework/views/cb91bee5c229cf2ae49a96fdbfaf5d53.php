...
<?php $__env->startSection('title', 'Special Events'); ?>
                    ...
                    <tbody class="divide-y">
                        <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div class="font-medium"><?php echo e($event->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($event->description, 50)); ?></div>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <div><?php echo e($event->start_date->format('M d, Y')); ?></div>
                                    <div class="text-sm text-gray-500">to <?php echo e($event->end_date->format('M d, Y')); ?></div>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <span
                                        class="px-2 py-1 text-xs rounded
                                <?php echo e($event->impact_level === 'very_high' ? 'bg-red-100 text-red-700' : ''); ?>

                                <?php echo e($event->impact_level === 'high' ? 'bg-orange-100 text-orange-700' : ''); ?>

                                <?php echo e($event->impact_level === 'medium' ? 'bg-yellow-100 text-yellow-700' : ''); ?>

                                <?php echo e($event->impact_level === 'low' ? 'bg-green-100 text-green-700' : ''); ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $event->impact_level))); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <?php if($event->expected_demand_increase > 0): ?>
                                        <span
                                            class="font-medium text-blue-600">+<?php echo e(number_format($event->expected_demand_increase, 0)); ?>%</span>
                                    <?php else: ?>
                                        <span class="text-gray-400">-</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3 text-center">
                                    <?php if($event->affects_pricing): ?>
    ...
    <div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen px-4">
            <div class="bg-white rounded-lg shadow-lg max-w-lg w-full">
                ...
                <form action="<?php echo e(route('revenue.special-events.store')); ?>" method="POST" class="p-6">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\revenue\special-events.blade.php ENDPATH**/ ?>