...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(session('status') == 'verification-link-failed'): ?>
    <div class="mb-4 flex items-center gap-2 bg-amber-50 border border-amber-200 text-amber-700 text-sm px-4 py-3 rounded-xl">
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
        </svg>
        Gagal mengirim email verifikasi. Coba lagi nanti atau hubungi admin.
    </div>
    <?php endif; ?>
