<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <span>🎫 Tour & Travel - Bookings</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-yellow-200 dark:border-yellow-500/30 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Pending</p>
            <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ $stats['pending_bookings'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-blue-200 dark:border-blue-500/30 p-4">
            ...
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ $stats['confirmed_bookings'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-purple-200 dark:border-purple-500/30 p-4">
            <p class="text-xs text-gray-500 dark:text-slate-400">Upcoming Departures</p>
            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1">{{ $stats['upcoming_departures'] }}
            </p>
        </div>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-white/10 flex items-center justify-between">
            <h3 class="text-base font-semibold text-gray-900 dark:text-white">📋 All Bookings</h3>
        ...
        @if ($bookings->count() === 0)
            <div class="p-12 text-center">
                ...
                <p class="text-sm text-gray-500 dark:text-slate-400">No bookings yet.</p>
                <a href="{{ route('tour-travel.bookings.create') }}"
