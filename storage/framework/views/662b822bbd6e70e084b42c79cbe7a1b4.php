    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e($customer->name); ?></h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Subscription Aktif')); ?></h2>
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Paket')); ?></p>
                                <p class="mt-1 font-medium text-gray-900"><?php echo e($subscription->package?->name ?? '-'); ?></p>
                            </div>
                            <div>
                                ...
                                <span class="mt-1 px-2 py-0.5 inline-flex text-xs font-semibold rounded-full
                                    <?php echo e($subscription->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                    <?php echo e(ucfirst($subscription->status)); ?>

                                </span>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Kecepatan')); ?></p>
                            ...
                            <div>
                                ...
                                <p class="mt-1 font-medium text-gray-900"><?php echo e($subscription->device?->name ?? '-'); ?></p>
                            </div>
                            <?php if($subscription->hotspot_username): ?>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Username')); ?></p>
                                    <p class="mt-1 font-mono text-gray-900"><?php echo e($subscription->hotspot_username); ?></p>
                                </div>
                            <?php endif; ?>
                            <div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('Ringkasan Penggunaan')); ?></h2>
                            <div class="flex gap-2">
                                <?php $__currentLoopData = ['daily' => __('Harian'), 'weekly' => __('Mingguan'), 'monthly' => __('Bulanan')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('telecom.customers.show-usage', $customer)); ?>?period=<?php echo e($p); ?>"
                                        class="px-3 py-1 text-xs rounded-full <?php echo e($period === $p ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?>">
                                        <?php echo e($label); ?>
                        ...
                        <?php if($quotaBytes > 0): ?>
                            <div class="mb-6">
                                <div class="flex justify-between text-sm mb-2">
                                    <span class="text-gray-600"><?php echo e(round($usedBytes / 1073741824, 2)); ?> GB <?php echo e(__('terpakai')); ?></span>
                                    <span class="text-gray-600"><?php echo e(round($quotaBytes / 1073741824, 2)); ?> GB <?php echo e(__('total')); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-4">
                                    <div class="bg-<?php echo e($color); ?>-500 h-4 rounded-full" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                                <p class="text-sm text-gray-500 mt-1"><?php echo e($percentage); ?>% <?php echo e(__('terpakai')); ?></p>
                            </div>
                        <?php else: ?>
                            <p class="text-sm text-blue-600 font-semibold mb-4">∞ <?php echo e(__('Kuota Unlimited')); ?></p>
                        <?php endif; ?>

                        <?php if(isset($usageSummary)): ?>
                            <div class="grid grid-cols-3 gap-4">
                                <div class="text-center p-4 bg-blue-50 rounded-lg">
                                    <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Download')); ?></p>
                                    <p class="text-xl font-bold text-blue-600">
                                        <?php echo e(round(($usageSummary['total_download'] ?? 0) / 1073741824, 2)); ?> GB
                                    </p>
                                </div>
                                <div class="text-center p-4 bg-green-50 rounded-lg">
                                    <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Upload')); ?></p>
                                    <p class="text-xl font-bold text-green-600">
                                        <?php echo e(round(($usageSummary['total_upload'] ?? 0) / 1073741824, 2)); ?> GB
                                    </p>
                                </div>
                                <div class="text-center p-4 bg-purple-50 rounded-lg">
                                    <p class="text-xs text-gray-500 mb-1"><?php echo e(__('Total')); ?></p>
                    ...
                    <?php if(isset($chartData) && count($chartData['labels']) > 0): ?>
                        <div class="bg-white shadow-sm sm:rounded-lg p-6">
                            <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Tren Penggunaan (7 Hari Terakhir)')); ?></h2>
                    ...
                    <?php if(isset($usageHistory) && $usageHistory->count() > 0): ?>
                        <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                            <div class="px-6 py-4 border-b border-gray-200">
                                <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('Riwayat Penggunaan')); ?></h2>
                            </div>
                ...
                <div class="space-y-4">
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Aksi')); ?></h2>
                        <div class="space-y-3">
                    ...
                    <!-- Customer Info -->
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Info Pelanggan')); ?></h2>
                        <div class="space-y-3 text-sm">
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Nama')); ?></p>
                                <p class="mt-1 font-medium text-gray-900"><?php echo e($customer->name); ?></p>
                            </div>
                            <?php if($customer->email): ?>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Email')); ?></p>
                                    <p class="mt-1 text-gray-900"><?php echo e($customer->email); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($customer->phone): ?>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Telepon')); ?></p>
                                    <p class="mt-1 text-gray-900"><?php echo e($customer->phone); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
