...
<?php $__env->startSection('title', 'QC Test Templates'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-lg transition">
                    <div class="p-6">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900"><?php echo e($template->template_name); ?></h3>
                                <p class="text-sm text-gray-500"><?php echo e($template->template_code); ?></p>
                            </div>
                            <span
                                class="px-2 py-1 text-xs font-medium rounded-full
                        <?php if($template->is_active): ?> bg-green-100 text-green-800
                        ...
                        <div class="mb-4">
                            <span class="px-3 py-1 text-sm font-medium rounded-full bg-blue-100 text-blue-800">
                                <?php echo e($template->category_label); ?>
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="text-sm">
                                ...
                                <span class="text-gray-900"><?php echo e(count($template->test_parameters ?? [])); ?></span>
                            </div>
                            <div class="text-sm">
                                <strong class="text-gray-700">Tests Using:</strong>
                                <span class="text-gray-900"><?php echo e($template->testResults->count()); ?></span>
                            </div>
                        </div>

                        <?php if($template->procedure): ?>
                            <div class="p-3 bg-gray-50 rounded text-sm text-gray-700 mb-4">
                                <strong>Procedure:</strong>
                                <p class="mt-1 line-clamp-3"><?php echo e(Str::limit($template->procedure, 150)); ?></p>
                            </div>
                        <?php endif; ?>

                        <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                            <span class="text-xs text-gray-500">
                                Created: <?php echo e($template->created_at->format('d M Y')); ?>
    ...
    <div id="add-template-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div
            ...
            <form method="POST" action="<?php echo e(route('cosmetic.qc.templates.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\qc\templates.blade.php ENDPATH**/ ?>