...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <a href="<?php echo e(route('payables.index')); ?>" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5 text-center">
            Hutang (Payables) →
        </a>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e($overdue ? 'bg-red-50/50 dark:bg-red-900/10' : ''); ?>">
                        <td class="px-4 py-3 font-mono text-xs font-medium text-gray-900 dark:text-white"><?php echo e($inv->number); ?></td>
                        <td class="px-4 py-3 text-gray-700 dark:text-slate-300"><?php echo e($inv->customer->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right text-gray-900 dark:text-white">Rp <?php echo e(number_format($inv->total_amount, 0, ',', '.')); ?></td>
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($invoices->links()); ?></div>
        <?php endif; ?>
    </div>
