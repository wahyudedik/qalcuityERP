        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['total']); ?></div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(ucfirst($reg->product_category)); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-medium rounded-full
                                        <?php if($reg->status == 'pending'): ?> bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300
                                        <?php elseif($reg->status == 'submitted'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300
                                        <?php elseif($reg->status == 'approved'): ?> bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300
                                        <?php elseif($reg->status == 'rejected'): ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300
                                        <?php else: ?> bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300 <?php endif; ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            class="text-sm
                                        <?php if($reg->expiry_date && $reg->expiry_date->lt(now())): ?> text-red-600 dark:text-red-400 font-bold
                                        <?php elseif($reg->expiry_date && $reg->expiry_date->lt(now()->addDays(90))): ?> text-yellow-600 dark:text-yellow-400
                                        <?php else: ?> text-gray-600 dark:text-gray-400 <?php endif; ?>">
