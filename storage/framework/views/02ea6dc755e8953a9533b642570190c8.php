...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-[#1e293b] border border-white/10 rounded-2xl overflow-hidden">
                        ...
                        <tr class="hover:bg-white/5 transition">
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <?php endif; ?>
                                    <div class="min-w-0">
                                        <p class="text-sm font-medium text-slate-100 truncate"><?php echo e($ad->title); ?></p>
                                        <?php if($ad->button_label): ?>
                                            <p class="text-xs text-slate-500 truncate">CTA: <?php echo e($ad->button_label); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-5 py-4 hidden md:table-cell">
                                ...
                                <?php else: ?>
                                    <span class="text-xs text-blue-400"><?php echo e(count($ad->tenant_ids ?? [])); ?> tenant</span>
                                <?php endif; ?>
                            </td>
                            <td class="px-5 py-4 hidden md:table-cell">
                            ...
                            <td class="px-5 py-4 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <form method="POST" action="<?php echo e(route('super-admin.popup-ads.toggle', $ad)); ?>"
                                        ...
                                        <button type="submit"
                                            class="p-1.5 rounded-lg transition <?php echo e($ad->is_active ? 'text-green-400 hover:text-slate-400 hover:bg-white/10' : 'text-slate-400 hover:text-green-400 hover:bg-green-500/10'); ?>"
        ...
        <?php if($ads->hasPages()): ?>
            <div class="px-6 py-4 border-t border-white/10"><?php echo e($ads->links()); ?></div>
        <?php endif; ?>
    </div>
