...
<?php $__env->startSection('title', 'Batch Performance Report'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('cosmetic.analytics.dashboard')); ?>" class="text-blue-600 hover:text-blue-800">
                    ← Back to Analytics
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-gray-900"><?php echo e(number_format($metrics['total_batches'])); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Average Yield</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e(number_format($metrics['avg_yield'], 1)); ?>%</div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">QC Pass Rate</div>
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e(number_format($metrics['qc_pass_rate'], 1)); ?>%</div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Avg Rework Count</div>
                <div class="mt-2 text-3xl font-bold text-orange-600"><?php echo e(number_format($metrics['avg_rework_count'], 1)); ?>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__currentLoopData = $byFormula; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($item->formula?->formula_name ?? 'Unknown'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($item->batch_count); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-green-600">
                                <?php echo e(number_format($item->avg_yield, 1)); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600">
                                <?php echo e(number_format($item->min_yield, 1)); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">
                                <?php echo e(number_format($item->max_yield, 1)); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <span
                                    ...
                                    <?php echo e($consistency === 'Excellent' ? 'bg-green-100 text-green-800' : ($consistency === 'Good' ? 'bg-blue-100 text-blue-800' : 'bg-yellow-100 text-yellow-800')); ?>">
                                    <?php echo e($consistency); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\analytics\batch-performance.blade.php ENDPATH**/ ?>