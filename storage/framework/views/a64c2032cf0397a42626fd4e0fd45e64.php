...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-2xl mx-auto space-y-5">
        ...
        <form method="POST" action="<?php echo e(route('self-service.profile.update')); ?>" enctype="multipart/form-data">
                ...
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <label for="avatar-input"
                            class="cursor-pointer px-4 py-2 text-sm bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition">
                            Ganti Foto
                        </label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-5">
                <h2 class="font-semibold text-gray-900 mb-4">Data Pribadi</h2>
                <div class="space-y-4">
                    <div>
                        <label class="block text-xs text-gray-500 mb-1">Nama Lengkap <span class="text-red-400">*</span></label>
                    ...
                    <div>
                        ...
                        <input type="email" value="<?php echo e(auth()->user()->email); ?>" disabled
                            class="w-full bg-gray-100 border border-gray-200 rounded-xl px-3 py-2 text-sm text-gray-400 cursor-not-allowed">
                        <p class="text-xs text-gray-400 mt-1">Email tidak dapat diubah sendiri. Hubungi admin.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="3" placeholder="Alamat lengkap"
                            class="w-full bg-gray-50 border border-gray-200 rounded-xl px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"><?php echo e(old('address', $employee->address)); ?></textarea>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if($employee): ?>
            <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-5">
                <h2 class="font-semibold text-gray-900 mb-4">Informasi Kepegawaian</h2>
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <p class="text-xs text-gray-500">ID Karyawan</p>
                        <p class="font-medium text-gray-900 mt-0.5"><?php echo e($employee->employee_id); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500">Jabatan</p>
                        <p class="font-medium text-gray-900 mt-0.5"><?php echo e($employee->position ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500">Departemen</p>
                        <p class="font-medium text-gray-900 mt-0.5"><?php echo e($employee->department ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500">Tanggal Bergabung</p>
                        <p class="font-medium text-gray-900 mt-0.5"><?php echo e($employee->join_date?->format('d M Y') ?? '-'); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500">Status</p>
                        <p class="font-medium text-gray-900 mt-0.5 capitalize"><?php echo e($employee->status); ?></p>
                    </div>
                    <div>
                ...
                <p class="text-xs text-gray-400 mt-4">Data kepegawaian hanya dapat diubah oleh HRD.</p>
            </div>
            <?php endif; ?>

            
            <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-5">
                <h2 class="font-semibold text-gray-900 mb-1">Ganti Password</h2>
