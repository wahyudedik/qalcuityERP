...
<?php $component->withAttributes([]); ?>
        ...
        <div
            ...
            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-500 dark:text-slate-400">
                ...
                <span class="px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-400 font-medium">Retensi:
                    <?php echo e($retentionDays); ?> hari</span>
            </div>
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('audit.export', request()->only(['date_from', 'date_to', 'module']))); ?>"
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e($log->is_ai_action ? 'bg-purple-50/30 dark:bg-purple-900/5' : ''); ?> <?php echo e($log->rolled_back_at ? 'opacity-60' : ''); ?>"
                                ...
                                <td class="px-4 py-3">
                                    <?php if($log->rolled_back_at): ?>
                                        <span
                                            class="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-500/20 text-amber-400">↩
                                            rolled back</span>
                                    <?php elseif($log->action === 'rollback'): ?>
                                        <span
                                            class="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-500/20 text-amber-400">↩
                                            rollback</span>
                                    <?php else: ?>
                                        <span
                                            class="px-2 py-0.5 rounded-full text-xs font-medium <?php echo e($log->is_ai_action ? 'bg-purple-500/20 text-purple-400' : 'bg-blue-500/20 text-blue-400'); ?>">
    ...
    <div id="modal-compliance"
        ...
        <div
            ...
            <form id="form-compliance" action="<?php echo e(route('audit.compliance-report')); ?>" method="GET"
                class="p-6 space-y-4">
