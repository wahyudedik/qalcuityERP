...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Komponen Gaji <?php $__env->endSlot(); ?>
            ...
            <?php $__currentLoopData = ['allowance' => 'Tunjangan', 'deduction' => 'Potongan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div
                    ...
                    <div
                        ...
                        <p class="font-semibold text-gray-900"><?php echo e($label); ?></p>
                        <span class="text-xs text-gray-400"><?php echo e($group->count()); ?> komponen</span>
                    </div>
                    <?php if($group->isEmpty()): ?>
                        <div class="px-5 py-8 text-center text-sm text-gray-400">Belum ada komponen
                            <?php echo e(strtolower($label)); ?>.</div>
                    <?php else: ?>
                            ...
                            <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="px-5 py-3 flex items-center gap-3">
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2">
                                            <p class="text-sm font-medium text-gray-900">
                                                <?php echo e($comp->name); ?></p>
                                            <?php if($comp->code): ?>
                                                <span
                                                    class="text-xs text-gray-400 font-mono"><?php echo e($comp->code); ?></span>
                                            <?php endif; ?>
                                    ...
                                    <div class="flex items-center gap-2 shrink-0">
                                        <button
                                            onclick="editComp(<?php echo e($comp->id); ?>, '<?php echo e(addslashes($comp->name)); ?>', '<?php echo e($comp->code); ?>', '<?php echo e($comp->type); ?>', '<?php echo e($comp->calc_type); ?>', <?php echo e($comp->default_amount); ?>, <?php echo e($comp->taxable ? 1 : 0); ?>, '<?php echo e(addslashes($comp->description ?? '')); ?>')"
                                        ...
                                        <form method="POST"
                                            action="<?php echo e(route('payroll.components.destroy', $comp)); ?>"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="px-5 py-3 flex items-center gap-3">
                            <div
                                ...
                                <span
                                    class="text-blue-600 text-xs font-bold"><?php echo e(strtoupper(substr($emp->name, 0, 1))); ?></span>
                            </div>
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-gray-900"><?php echo e($emp->name); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($emp->position ?? '-'); ?> ·
                                    <?php echo e($emp->department ?? '-'); ?></p>
                            </div>
