        ...
        <div class="flex gap-2">
            <?php $__currentLoopData = ['' => 'Semua', 'pending' => 'Pending', 'in_progress' => 'Progress', 'completed' => 'Selesai']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="?status=<?php echo e($v); ?>"
                    class="px-3 py-1.5 text-xs rounded-xl <?php echo e(request('status') === $v ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600'); ?>"><?php echo e($l); ?></a>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-5">
                <div class="flex items-center justify-between mb-3">
                    <div>
                        <span
                            class="font-mono text-sm font-bold text-gray-900"><?php echo e($list->number); ?></span>
                        <span
                            class="text-xs text-gray-500 ml-2"><?php echo e($list->warehouse->name ?? '-'); ?></span>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <?php endif; ?>
                        <span
                            class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 $sc }}-500/20 $sc }}-400"><?php echo e(ucfirst(str_replace('_', ' ', $list->status))); ?></span>
                    </div>
                </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $list->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <td class="py-1.5 text-gray-900"><?php echo e($item->product->name ?? '-'); ?>
                                    ...
                                    <td class="py-1.5 text-center"><span
                                            class="px-1.5 py-0.5 rounded text-[10px] bg-<?php echo e($ic); ?>-100 text-<?php echo e($ic); ?>-700 $ic }}-500/20 $ic }}-400"><?php echo e(ucfirst($item->status)); ?></span>
                                    </td>
