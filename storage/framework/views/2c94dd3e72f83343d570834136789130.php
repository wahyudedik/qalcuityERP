    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(__('Edit Device')); ?></h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1"><?php echo e($device->name); ?></p>
            </div>
            ...
            <form action="<?php echo e(route('telecom.devices.update', $device)); ?>" method="POST"
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="password"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"><?php echo e(__('Password')); ?></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"><?php echo e(old('description', $device->description)); ?></textarea>
                        </div>
                    </div>
                </div>
