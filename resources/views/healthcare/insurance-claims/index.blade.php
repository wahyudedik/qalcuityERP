        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-2xl p-4 border border-gray-200">
                    ...
                    <p class="text-2xl font-bold text-red-600 mt-1">{{ $statistics['rejected'] ?? 0 }}
                    </p>
                </div>
            </div>
                            ...
                            @forelse($claims as $claim)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <span
                                            class="inline-flex items-center px-2 py-1 text-xs font-medium rounded-lg {{ $claim->status === 'pending' ? 'bg-amber-100 text-amber-700' : ($claim->status === 'processing' ? 'bg-blue-100 text-blue-700' : ($claim->status === 'approved' ? 'bg-green-100 text-green-700' : ($claim->status === 'rejected' ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-700'))) }}">
