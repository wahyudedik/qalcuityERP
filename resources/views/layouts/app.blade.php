                        ...
                        <div id="notif-dropdown"
                            ...
                            <div class="max-h-72 overflow-y-auto divide-y divide-gray-100 dark:divide-white/5">
                                ...
                                @forelse($topbarNotifs as $notif)
                                    <div
                                        class="px-4 py-3 hover:bg-[#f0f0f0] dark:hover:bg-white/5 {{ $notif->isRead() ? 'opacity-60' : '' }}">
                        ...
                        @if ($canView('suppliers'))
                            {
                                ...
                                active: {{ request()->routeIs('suppliers*') && !request()->routeIs('suppliers.scorecards*') && !request()->routeIs('suppliers.strategic-sourcing*') ? 'true' : 'false' }}
                            },
                        @endif
                        @if ($canView('suppliers'))
                            {
