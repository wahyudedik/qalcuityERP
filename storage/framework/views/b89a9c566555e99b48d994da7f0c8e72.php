                    ...
                    <div class="border-l-4 <?php echo e($severityClass); ?> rounded-r-xl p-4 flex items-start justify-between gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                <span class="font-semibold text-gray-800 text-sm"><?php echo e($anomaly->title); ?></span>
                                <span class="text-xs px-2 py-0.5 rounded-full
                                    <?php echo e($anomaly->status === 'open' ? 'bg-red-100 text-red-700' :
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($anomaly->description); ?></p>
