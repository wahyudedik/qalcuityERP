...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-4">
        ...
        <div class="flex gap-2">
            ...
            <?php endif; ?>
            <button id="btn-print-batch" onclick="printSelectedBarcodes()" disabled
                class="px-4 py-2 text-sm bg-purple-600 text-white rounded-xl hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                </svg>
                <span id="batch-count">0</span> Label Terpilih
            </button>
        </div>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5" data-asset-id="<?php echo e($asset->id); ?>">
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <input type="checkbox"
                                        class="asset-checkbox w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
    ...
    <form id="form-batch-print" method="POST" action="<?php echo e(route('assets.barcode.print')); ?>" class="hidden">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="asset_ids" id="batch-asset-ids">
    </form>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function printSelectedBarcodes() {
                ...
                document.getElementById('batch-asset-ids').value = JSON.stringify(assetIds);
                document.getElementById('form-batch-print').submit();
            }
        </script>
    <?php $__env->stopPush(); ?>
