...
<?php $__env->startSection('title', 'Cosmetic Analytics Dashboard'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e(number_format($stats['batch_yield_avg'], 1)); ?>%</div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div
                    class="mt-2 text-3xl font-bold <?php echo e($stats['qc_pass_rate'] >= 95 ? 'text-green-600' : ($stats['qc_pass_rate'] >= 85 ? 'text-yellow-600' : 'text-red-600')); ?>">
                    <?php echo e(number_format($stats['qc_pass_rate'], 1)); ?>%</div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e($stats['active_registrations']); ?></div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="mt-2 text-3xl font-bold <?php echo e($stats['open_recalls'] > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                    <?php echo e($stats['open_recalls']); ?></div>
                <div class="text-xs text-gray-500 mt-1">Product safety</div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-sm font-medium text-gray-500">Expiry Alerts (30d)</div>
                <div
                    class="mt-2 text-3xl font-bold <?php echo e($stats['expiry_alerts_30d'] > 0 ? 'text-orange-600' : 'text-green-600'); ?>">
                    <?php echo e($stats['expiry_alerts_30d']); ?></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <a href="<?php echo e(route('cosmetic.analytics.batch-performance')); ?>"
            ...
            <a href="<?php echo e(route('cosmetic.analytics.qc-trend')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.regulatory')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.cost-analysis')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.supplier-quality')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.product-lifecycle')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.recall-report')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
            ...
            <a href="<?php echo e(route('cosmetic.analytics.expiry-forecast')); ?>"
                class="bg-white rounded-lg shadow hover:shadow-lg transition p-6">
                <div class="flex items-center mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\cosmetic\analytics\dashboard.blade.php ENDPATH**/ ?>