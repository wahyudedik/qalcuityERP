<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Clinical Quality Metrics') }}</h2>
    </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        {{ number_format($qualityMetrics['readmission_rate'], 2) }}%</p>
                    <p class="text-xs text-gray-500 mt-2">Target: < 5%</p>
                            @if ($qualityMetrics['readmission_rate'] < 5)
                                <span
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        {{ number_format($qualityMetrics['average_length_of_stay'], 2) }} days</p>
                    <p class="text-xs text-gray-500 mt-2">Target: < 5 days</p>
                            @if ($qualityMetrics['average_length_of_stay'] < 5)
                                <span
                                    class="inline-block mt-2 px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Good</span>
                            @else
                                <span
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        {{ number_format($qualityMetrics['mortality_rate'], 2) }}%</p>
                    <p class="text-xs text-gray-500 mt-2">Target: < 3%</p>
                            @if ($qualityMetrics['mortality_rate'] < 3)
                                <span
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        {{ number_format($qualityMetrics['infection_rate'], 2) }}%</p>
                    <p class="text-xs text-gray-500 mt-2">Target: < 2%</p>
                            @if ($qualityMetrics['infection_rate'] < 2)
                                <span
                                    class="inline-block mt-2 px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Good</span>
                            @else
                                <span
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-900">
                        {{ number_format($qualityMetrics['patient_satisfaction'], 1) }}/5.0</p>
                    <p class="text-xs text-gray-500 mt-2">Target: > 4.0</p>
                    @if ($qualityMetrics['patient_satisfaction'] >= 4)
                        <span
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded">
                            ...
                            <span
                                class="text-lg font-bold text-blue-900">{{ number_format($qualityMetrics['readmission_rate'], 2) }}%</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-green-50 rounded">
                            <span class="text-sm font-medium text-gray-700">Average Length of Stay</span>
                            <span
                                class="text-lg font-bold text-green-900">{{ number_format($qualityMetrics['average_length_of_stay'], 2) }}
                                days</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-red-50 rounded">
                            ...
                            <span
                                class="text-lg font-bold text-red-900">{{ number_format($qualityMetrics['mortality_rate'], 4) }}%</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-orange-50 rounded">
                            ...
                            <span
                                class="text-lg font-bold text-orange-900">{{ number_format($qualityMetrics['infection_rate'], 2) }}%</span>
                        </div>
                    </div>
                </div>
