    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-6 gap-4">
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                <p class="text-xs text-gray-500 mb-1">Tipe Billing</p>
                <p class="font-semibold text-gray-900"><?php echo e(['time_material'=>'T&M','milestone'=>'Milestone','retainer'=>'Retainer','fixed_price'=>'Fixed','termin'=>'Termin'][$config->billing_type ?? ''] ?? 'Belum diset'); ?></p>
            </div>
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                <p class="text-xs text-gray-500 mb-1">Unbilled Hours</p>
                <p class="text-xl font-bold text-amber-500"><?php echo e(number_format($unbilledHours, 1)); ?>h</p>
            </div>
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                <p class="text-xs text-gray-500 mb-1">Unbilled Amount</p>
            ...
            <div class="bg-white rounded-2xl border border-amber-200 p-4">
                <p class="text-xs text-amber-600 mb-1">Retensi Ditahan</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <h3 class="font-semibold text-gray-900 mb-4">Konfigurasi Billing</h3>
                <form method="POST" action="<?php echo e(route('project-billing.config', $project)); ?>" class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div><label class="block text-xs font-medium text-gray-600 mb-1">Retensi (%)</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <h3 class="font-semibold text-gray-900 mb-4">Generate Invoice</h3>
                ...
                <form method="POST" action="<?php echo e(route('project-billing.time-material', $project)); ?>" class="space-y-3 mb-4">
                    <?php echo csrf_field(); ?>
                    <?php $cls = 'w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900'; ?>
                    <p class="text-sm text-gray-500">Time & Material — <?php echo e(number_format($unbilledHours, 1)); ?>h unbilled</p>
                    <div class="grid grid-cols-2 gap-3">
                        <div><label class="block text-xs text-gray-600 mb-1">Dari</label><input type="date" name="period_start" required class="<?php echo e($cls); ?>"></div>
                        <div><label class="block text-xs text-gray-600 mb-1">Sampai</label><input type="date" name="period_end" required value="<?php echo e(date('Y-m-d')); ?>" class="<?php echo e($cls); ?>"></div>
                    </div>
                ...
                <form method="POST" action="<?php echo e(route('project-billing.retainer', $project)); ?>">
                    <?php echo csrf_field(); ?>
                    <p class="text-sm text-gray-500 mb-2">Retainer: Rp <?php echo e(number_format($config->retainer_amount ?? 0, 0, ',', '.')); ?> / <?php echo e($config->retainer_cycle ?? 'monthly'); ?></p>
        ...
        ?>
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <h3 class="font-semibold text-gray-900 mb-4">Termin / Progress Payment</h3>

            
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                <div class="p-3 rounded-xl bg-gray-50">
                    <p class="text-[10px] text-gray-500 uppercase">Nilai Kontrak</p>
                    <p class="text-sm font-bold text-gray-900">Rp <?php echo e(number_format($contractVal, 0, ',', '.')); ?></p>
                </div>
                <div class="p-3 rounded-xl bg-gray-50">
                    <p class="text-[10px] text-gray-500 uppercase">Sudah Billed</p>
                ...
                <div class="p-3 rounded-xl bg-gray-50">
                    <p class="text-[10px] text-gray-500 uppercase">Retensi Ditahan</p>
                    <p class="text-sm font-bold text-amber-500">Rp <?php echo e(number_format(max(0, $totalRetentionHeld), 0, ',', '.')); ?></p>
                </div>
                <div class="p-3 rounded-xl bg-gray-50">
                    <p class="text-[10px] text-gray-500 uppercase">Termin Ke-</p>
                    <p class="text-sm font-bold text-gray-900"><?php echo e($terminCount + 1); ?></p>
                </div>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('project-billing.termin', $project)); ?>" class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Progress Kumulatif (%)</label>
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 flex items-center justify-between">
                    ...
                    <form method="POST" action="<?php echo e(route('project-billing.release-retention', $ri)); ?>" class="flex items-center gap-2">
                        <?php echo csrf_field(); ?>
                        <input type="number" name="amount" step="1" min="1" max="<?php echo e($ri->retentionOutstanding()); ?>" value="<?php echo e($ri->retentionOutstanding()); ?>" class="w-32 px-2 py-1.5 text-xs rounded-lg border border-gray-200 bg-gray-50 text-gray-900">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td class="px-4 py-3 text-gray-900"><?php echo e($ms->name); ?></td>
                            <td class="px-4 py-3 text-right text-gray-900">Rp <?php echo e(number_format($ms->amount, 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 text-center text-xs text-gray-500"><?php echo e($ms->due_date?->format('d/m/Y') ?? '-'); ?></td>
                            <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($mc); ?>-100 text-<?php echo e($mc); ?>-700 $mc }}-500/20 $mc }}-400"><?php echo e(ucfirst($ms->status)); ?></span></td>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Timesheet Unbilled</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 text-xs text-gray-500 uppercase">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-gray-900"><?php echo e($ts->user->name ?? '-'); ?></td>
                            <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e(Str::limit($ts->description, 40)); ?></td>
                            <td class="px-4 py-3 text-right text-gray-900"><?php echo e($ts->hours); ?>h</td>
                            <td class="px-4 py-3 text-right text-gray-500">Rp <?php echo e(number_format($ts->hourly_rate ?: ($config->hourly_rate ?? 0), 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 text-right font-medium text-gray-900">Rp <?php echo e(number_format($ts->laborCost(), 0, ',', '.')); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <span class="text-gray-900 font-mono text-xs"><?php echo e($pi->invoice->number ?? '-'); ?></span>
                            ...
                            <td class="px-4 py-3 text-right font-medium text-gray-900">Rp <?php echo e(number_format($pi->total_amount, 0, ',', '.')); ?></td>
                            <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($ic); ?>-100 text-<?php echo e($ic); ?>-700 $ic }}-500/20 $ic }}-400"><?php echo e(ucfirst($pi->status)); ?></span></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
    ...
    <div id="modal-ms" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-md shadow-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                <h3 class="font-semibold text-gray-900">Tambah Milestone</h3>
                <button onclick="document.getElementById('modal-ms').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">✕</button>
            </div>
            <form method="POST" action="<?php echo e(route('project-billing.milestones.store', $project)); ?>" class="p-6 space-y-4">
                <?php echo csrf_field(); ?>
                <?php $cls = 'w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900'; ?>
                <div><label class="block text-xs font-medium text-gray-600 mb-1">Nama *</label><input type="text" name="name" required class="<?php echo e($cls); ?>"></div>
                <div class="grid grid-cols-2 gap-3">
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Nilai (Rp) *</label><input type="number" name="amount" required min="0" step="1000" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Due Date</label><input type="date" name="due_date" class="<?php echo e($cls); ?>"></div>
                </div>
                <div class="flex justify-end gap-3">
                    <button type="button" onclick="document.getElementById('modal-ms').classList.add('hidden')" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</button>
