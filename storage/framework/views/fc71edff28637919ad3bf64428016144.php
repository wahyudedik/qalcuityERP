    ...
    <div class="h-screen flex flex-col" style="height: calc(100vh - 64px);">
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(__('Network Maps')); ?></h1>
                    <p class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($stats['devices_with_location']); ?>
            ...
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2 text-sm">
                    <span class="flex items-center gap-1">
                        ...
                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Online')); ?></span>
                    </span>
                    <span class="flex items-center gap-1">
                        <span class="w-3 h-3 rounded-full bg-red-500"></span>
                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Offline')); ?></span>
                    </span>
                    <span class="flex items-center gap-1">
                        <span class="w-3 h-3 rounded-full bg-yellow-500"></span>
                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Maintenance')); ?></span>
                    </span>
                </div>
            ...
            <div class="flex-1 relative">
                ...
                <div id="mapLoading"
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 font-medium"><?php echo e(__('Loading map...')); ?></p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="p-2" style="min-width: 250px;">
                                ...
                                <div class="space-y-1 text-sm">
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Status')); ?>:</span>
                                    ...
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Type')); ?>:</span>
                                        <span>${device.device_type.replace('_', ' ').toUpperCase()}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Brand')); ?>:</span>
                                        <span>${device.brand.toUpperCase()}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('IP')); ?>:</span>
                                        <span class="font-mono">${device.ip_address}</span>
                                    </div>
                                    ${device.location ? `
                                                <div class="flex justify-between">
                                                    <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Location')); ?>:</span>
                                                    <span>${device.location}</span>
                                                </div>
                                            ` : ''}
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Subscriptions')); ?>:</span>
                                        <span class="font-semibold">${device.subscriptions_count}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Users')); ?>:</span>
                                        <span class="font-semibold">${device.hotspot_users_count}</span>
                                    </div>
                                    ${device.last_seen_at ? `
                                                <div class="flex justify-between">
                                                    <span class="text-gray-600 dark:text-gray-400"><?php echo e(__('Last Seen')); ?>:</span>
