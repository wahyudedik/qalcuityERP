            ...
            <div id="slip-print"
                ...
                <div class="flex items-start justify-between border-b-2 border-gray-800 pb-5 mb-6 print:border-gray-800">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 print:text-gray-600 mt-0.5"><?php echo e($profile->address); ?></p>
                        <?php endif; ?>
                    </div>
                    <div class="text-right">
                        ...
                        ?>
                        <p class="text-xl font-black text-blue-600 print:text-blue-700 capitalize"><?php echo e($monthName); ?></p>
                ...
                <div class="grid grid-cols-2 gap-x-8 gap-y-1.5 mb-6 text-sm">
                    ...
                    <div class="flex gap-2">
                        <span class="w-28 shrink-0 text-gray-500 print:text-gray-500"><?php echo e($label); ?></span>
                        <span class="text-gray-900 print:text-black font-medium">: <?php echo e($value); ?></span>
                    </div>
                        ...
                        <table class="w-full text-sm">
                            <tbody class="divide-y divide-gray-100 print:divide-gray-200">
                                <tr>
                                    ...
                                    <td class="py-1.5 text-right font-medium text-gray-900 print:text-black">Rp <?php echo e(number_format($item->base_salary, 0, ',', '.')); ?></td>
                                </tr>
                                ...
                                <?php if($compAllowances->count()): ?>
                                    ...
                                    <tr>
                                        <td class="py-1.5 text-gray-600 print:text-gray-700"><?php echo e($c->name); ?></td>
                                        <td class="py-1.5 text-right font-medium text-gray-900 print:text-black">Rp <?php echo e(number_format($c->amount, 0, ',', '.')); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php elseif(($item->allowances ?? 0) > 0): ?>
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">Tunjangan</td>
                                    <td class="py-1.5 text-right font-medium text-gray-900 print:text-black">Rp <?php echo e(number_format($item->allowances, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="py-1.5 text-right font-medium text-green-600 print:text-green-700">+Rp <?php echo e(number_format($item->overtime_pay, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                    ...
                    <div>
                        ...
                        <table class="w-full text-sm">
                            <tbody class="divide-y divide-gray-100 print:divide-gray-200">
                                ...
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">Potongan Absen (<?php echo e($item->absent_days); ?>h)</td>
                                    <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($item->deduction_absent, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if(($item->deduction_late ?? 0) > 0): ?>
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">Potongan Terlambat (<?php echo e($item->late_days); ?>h)</td>
                                    <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($item->deduction_late, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if(($item->bpjs_employee ?? 0) > 0): ?>
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">BPJS (Kesehatan + Ketenagakerjaan)</td>
                                    <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($item->bpjs_employee, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if(($item->tax_pph21 ?? 0) > 0): ?>
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">PPh 21</td>
                                    <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($item->tax_pph21, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                ...
                                <?php if($compDeductions->count()): ?>
                                    ...
                                    <tr>
                                        <td class="py-1.5 text-gray-600 print:text-gray-700"><?php echo e($c->name); ?></td>
                                        <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($c->amount, 0, ',', '.')); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                <tr>
                                    <td class="py-1.5 text-gray-600 print:text-gray-700">Potongan Lain</td>
                                    <td class="py-1.5 text-right font-medium text-red-600 print:text-red-700">-Rp <?php echo e(number_format($item->deduction_other, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <tr class="border-t-2 border-gray-300 print:border-gray-400">
                                    ...
                                    <td class="py-2 text-right font-bold text-red-600 print:text-red-700">-Rp <?php echo e(number_format($totalDeduct, 0, ',', '.')); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <table class="w-full text-xs border border-gray-100 print:border-gray-200 rounded-xl overflow-hidden">
                        ...
                        <tbody class="divide-y divide-gray-100 print:divide-gray-200">
                            ...
                            <tr>
                                <td class="px-3 py-1.5 text-gray-700 print:text-gray-700"><?php echo e($ot->date->format('d M Y')); ?></td>
                                <td class="px-3 py-1.5 text-center text-gray-600 print:text-gray-600"><?php echo e(substr($ot->start_time, 0, 5)); ?> – <?php echo e(substr($ot->end_time, 0, 5)); ?></td>
                                <td class="px-3 py-1.5 text-center text-gray-700 print:text-gray-700"><?php echo e($ot->durationLabel()); ?></td>
                                <td class="px-3 py-1.5 text-right text-green-600 print:text-green-700">Rp <?php echo e(number_format($ot->overtime_pay, 0, ',', '.')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
