...
class PickingListItem extends Model
{
    ...
    protected function casts(): array { return ['quantity_requested'=>'decimal:3','quantity_picked'=>'decimal:3']; }
    public function pickingList(): BelongsTo { return $this->belongsTo(PickingList::class); }
