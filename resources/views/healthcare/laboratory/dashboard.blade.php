<x-app-layout>
    <x-slot name="header">Dashboard Laboratorium</x-slot>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['samples_collected'] ?? 0 }}</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['in_analysis'] ?? 0 }}</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $statistics['completed_today'] ?? 0 }}</p>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $statistics['avg_turnaround_time'] ? round($statistics['avg_turnaround_time'], 1) . ' jam' : '-' }}
                    </p>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <a href="{{ route('healthcare.laboratory.index') }}"
