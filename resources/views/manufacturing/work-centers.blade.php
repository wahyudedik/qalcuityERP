<x-app-layout>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                        <td class="px-4 py-3 font-mono text-xs font-medium text-gray-900 dark:text-white">{{ $wc->code }}</td>
                        <td class="px-4 py-3 text-gray-700 dark:text-slate-300">{{ $wc->name }}</td>
                        <td class="px-4 py-3 text-right text-gray-900 dark:text-white">Rp {{ number_format($wc->cost_per_hour, 0, ',', '.') }}</td>
                        <td class="px-4 py-3 text-center text-gray-900 dark:text-white">{{ $wc->capacity_per_day }} jam</td>
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5">{{ $workCenters->links() }}</div>
        @endif
    </div>
