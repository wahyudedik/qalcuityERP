            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2"
                              class="w-full rounded-xl border border-gray-300 bg-white text-gray-900 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo e(old('address', $tenant->address)); ?></textarea>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="invoice_footer_notes" rows="2" placeholder="Terima kasih atas kepercayaan Anda..."
                              class="w-full rounded-xl border border-gray-300 bg-white text-gray-900 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo e(old('invoice_footer_notes', $tenant->invoice_footer_notes)); ?></textarea>
                </div>
                <div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="border border-gray-200 rounded-xl p-4">
                    <p class="text-sm font-medium text-gray-700 mb-1"><?php echo e($img['label']); ?></p>
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                <div>
                    <div class="flex items-center gap-2">
                        <span class="text-sm font-medium text-gray-900"><?php echo e($tpl->name); ?></span>
                        <?php if($tpl->is_default): ?>
                        <span class="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full">Default</span>
                        <?php endif; ?>
                    </div>
                    <span class="text-xs text-gray-500"><?php echo e(\App\Models\DocumentTemplate::docTypeLabel($tpl->doc_type)); ?></span>
                </div>
                <div class="flex items-center gap-2">
