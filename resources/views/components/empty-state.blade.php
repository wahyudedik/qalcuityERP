...
<div class="flex flex-col items-center justify-center py-16 px-4">
    ...
    {{-- Title --}}
    <h3 class="text-lg font-semibold text-gray-700 dark:text-slate-200 mb-2">{{ $title }}</h3>

    {{-- Message --}}
    <p class="text-sm text-gray-500 dark:text-slate-400 text-center max-w-sm mb-6">{{ $message }}</p>
