    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-6">
            ...
            <div class="flex items-center justify-between mb-5">
                <div>
                    <h1 class="text-lg font-bold text-gray-900"><?php echo e($asset->name); ?></h1>
            ...
            <div class="space-y-2 text-sm mb-6">
                <?php if($asset->serial_number): ?>
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-900"><?php echo e($asset->serial_number); ?></span>
                    </div>
                <?php endif; ?>
                <?php if($asset->brand): ?>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Brand</span>
                        <span class="font-medium text-gray-900"><?php echo e($asset->brand); ?></span>
                    </div>
                <?php endif; ?>
                <?php if($asset->model): ?>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Model</span>
                        <span class="font-medium text-gray-900"><?php echo e($asset->model); ?></span>
                    </div>
                <?php endif; ?>
                <?php if($asset->location): ?>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Location</span>
                        <span class="font-medium text-gray-900"><?php echo e($asset->location); ?></span>
                    </div>
                <?php endif; ?>
