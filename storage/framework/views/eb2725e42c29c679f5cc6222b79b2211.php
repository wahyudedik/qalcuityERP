...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-2xl">
        ...
        <form method="POST" action="<?php echo e(route('deferred.store')); ?>" class="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex justify-end gap-3 pt-2">
                <a href="<?php echo e(route('deferred.index')); ?>" class="px-4 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Batal</a>
