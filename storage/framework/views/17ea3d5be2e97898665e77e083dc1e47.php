    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-2 text-3xl font-bold text-blue-600"><?php echo e(number_format($stats['today_eggs'])); ?></div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Avg Laying Rate</div>
                <div class="mt-2 text-3xl font-bold text-green-600"><?php echo e(number_format($stats['avg_laying_rate'], 1)); ?>%</div>
            </div>
            <div class="bg-white rounded-lg shadow p-6">
                <div class="text-sm font-medium text-gray-500">Avg Breakage</div>
                <div class="mt-2 text-3xl font-bold text-red-600"><?php echo e(number_format($stats['avg_breakage_rate'], 1)); ?>%</div>
            </div>
        </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    <?php echo e(number_format($record->eggs_collected)); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600">
                                    <?php echo e(number_format($record->eggs_broken)); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($record->laying_rate_percentage, 1)); ?>%</td>
                            </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\livestock\poultry\egg-production.blade.php ENDPATH**/ ?>