...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Cold Chain Management <?php $__env->endSlot(); ?>
                    ...
                    <div
                        ...
                        <div>
                            <div class="flex items-center gap-2">
                                <span
                                    class="text-lg font-bold text-gray-900"><?php echo e($unit->unit_code); ?></span>
                                <span
                                    class="text-xs px-2 py-0.5 rounded-full bg-<?php echo e($tempClass); ?>-100 text-<?php echo e($tempClass); ?>-700 $tempClass }}-500/20 $tempClass }}-400">
                                    <?php echo e($unit->isTemperatureSafe() ? 'Normal' : 'Warning'); ?>

                                </span>
                            </div>
                            <p class="text-sm text-gray-500 mt-0.5"><?php echo e($unit->name); ?></p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs mt-3">
                            <?php if($unit->capacity_kg): ?>
                                <div>
                                    ...
                                    <span
                                        class="text-gray-700"><?php echo e(number_format($unit->capacity_kg, 0)); ?>
                            ...
                            <?php if($unit->utilization_percentage): ?>
                                <div>
                                    ...
                                    <span
                                        class="text-gray-700"><?php echo e(number_format($unit->utilization_percentage, 1)); ?>%</span>
                                </div>
                            <?php endif; ?>
                            <?php if($unit->location): ?>
                                <div class="col-span-2">
                                    <span class="text-gray-400">Lokasi:</span>
                                    <span class="text-gray-700"><?php echo e($unit->location); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <?php $__currentLoopData = $alerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900"><?php echo e($alert['title']); ?></p>
                            <p class="text-xs text-gray-600"><?php echo e($alert['description']); ?></p>
                            <p class="text-xs text-gray-400 mt-1"><?php echo e($alert['time']); ?></p>
                        </div>
                        <span
                            class="text-xs px-2 py-1 rounded-full bg-<?php echo e($alert['severity_color']); ?>-100 text-<?php echo e($alert['severity_color']); ?>-700 $alert['severity_color'] }}-500/20 $alert['severity_color'] }}-400">
