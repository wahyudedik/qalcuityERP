<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Buat Grup Perusahaan</h2>
        </div>
    </x-slot>
    ...
    <div class="py-6 max-w-lg mx-auto px-4">
        <form method="POST" action="{{ route('company-groups.store') }}"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mata Uang Konsolidasi</label>
                <select name="currency_code" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-slate-800 dark:text-white text-sm">
