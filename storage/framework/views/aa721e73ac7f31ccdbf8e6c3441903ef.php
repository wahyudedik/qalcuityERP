...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5 text-center">
            ...
            <p class="text-xs text-gray-400 mt-1"><?php echo e($sc['label']); ?></p>
        </div>
    ...
    <form method="GET" action="<?php echo e(route('super-admin.tenants.index')); ?>" class="flex flex-wrap gap-3 mb-4">
        ...
        <a href="<?php echo e(route('super-admin.tenants.index')); ?>" class="px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium transition">Reset</a>
        <?php endif; ?>
    </form>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-4 sm:px-6 py-4">
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($tenant->name); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($tenant->slug); ?></p>
                    </td>
                    <td class="px-4 sm:px-6 py-4 text-sm text-gray-500 hidden md:table-cell"><?php echo e($tenant->admins->first()?->email ?? '�'); ?></td>
                    <td class="px-4 sm:px-6 py-4">
                    ...
                    <td class="px-4 sm:px-6 py-4 hidden lg:table-cell">
                        <?php if($expiryDate): ?>
                        <span class="text-sm <?php echo e($isExpiringSoon ? 'text-red-400 font-semibold' : 'text-gray-500'); ?>">
                    ...
                    <td class="px-4 sm:px-6 py-4 text-center hidden sm:table-cell">
                        <span class="text-sm font-semibold text-gray-900"><?php echo e($tenant->users_count); ?></span>
                    </td>
                    <td class="px-4 sm:px-6 py-4">
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\super-admin\tenants\index.blade.php ENDPATH**/ ?>