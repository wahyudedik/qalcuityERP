                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($device->name); ?>

                                        </div>
                                        <div class="text-sm text-gray-500"><?php echo e($device->device_id); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e(ucfirst($device->vendor)); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($device->model ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($device->ip_address ?? '-'); ?></div>
                                <div class="text-sm text-gray-500">Port: <?php echo e($device->port); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                            <?php echo e($device->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
