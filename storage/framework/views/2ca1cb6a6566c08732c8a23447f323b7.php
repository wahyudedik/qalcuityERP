    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($invoice->number); ?></p>
                    </div>
                    <?php
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($invoice->customer?->name ?? '-'); ?></p>
                        <?php if($invoice->customer?->company): ?><p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e($invoice->customer->company); ?></p><?php endif; ?>
                        <?php if($invoice->customer?->email): ?><p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e($invoice->customer->email); ?></p><?php endif; ?>
                        <?php if($invoice->customer?->phone): ?><p class="text-gray-500 dark:text-slate-400 text-xs"><?php echo e($invoice->customer->phone); ?></p><?php endif; ?>
                    </div>
                    <div>
                        <p class="text-xs text-gray-400 mb-0.5">Tanggal Invoice</p>
                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($invoice->created_at->format('d M Y')); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-400 mb-0.5">Jatuh Tempo</p>
                        <p class="font-medium <?php echo e($isOverdue ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'); ?>">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($invoice->salesOrder->number); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="font-medium text-green-600 dark:text-green-400">Rp <?php echo e(number_format($invoice->total_amount * $invoice->currency_rate, 0, ',', '.')); ?></p>
                    </div>
                    <?php endif; ?>
                    <?php endif; ?>
                </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3 text-center text-gray-600 dark:text-slate-400 hidden sm:table-cell"><?php echo e($item->quantity); ?></td>
                                <td class="px-4 py-3 text-right text-gray-600 dark:text-slate-400 hidden sm:table-cell">Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></td>
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                ...
                <p class="text-sm text-gray-700 dark:text-slate-300"><?php echo e($invoice->notes); ?></p>
            </div>
            <?php endif; ?>
        </div>
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6 space-y-3">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white">Rp <?php echo e(number_format($invoice->total_amount, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-slate-400">Terbayar</span>
                        <span class="font-semibold text-green-600 dark:text-green-400">Rp <?php echo e(number_format($invoice->paid_amount, 0, ',', '.')); ?></span>
                    </div>
                    <div class="flex justify-between border-t border-gray-100 dark:border-white/10 pt-2">
                        ...
                        <span class="font-bold text-lg <?php echo e($invoice->remaining_amount > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'); ?>">
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e($sig->signature_data); ?>" alt="TTD" class="h-10 border border-gray-200 dark:border-white/10 rounded-lg bg-white">
                        <div>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($sig->user?->name); ?></p>
                            <p class="text-xs text-gray-400 dark:text-slate-500"><?php echo e($sig->signed_at?->format('d M Y H:i')); ?> · <?php echo e($sig->ip_address); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-3 rounded-xl bg-green-50 dark:bg-green-900/20 text-sm">
                        <div>
                            <p class="font-medium text-green-700 dark:text-green-400">Rp <?php echo e(number_format($pay->amount, 0, ',', '.')); ?></p>
                            <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e($pay->payment_date?->format('d M Y')); ?> · <?php echo e(strtoupper($pay->payment_method ?? '-')); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <a href="<?php echo e(route('invoices.index')); ?>" class="flex items-center gap-2 text-sm text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-white transition">
