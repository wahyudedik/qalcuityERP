...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Hutang (Payables) <?php $__env->endSlot(); ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($overdue ? 'bg-red-50/50' : ''); ?>">
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            <button onclick="openPayModal('<?php echo e($pay->id); ?>','<?php echo e($pay->number); ?>','<?php echo e($pay->remaining_amount); ?>')"
    ...
    function openPayModal(id, number, remaining) {
        ...
        document.getElementById('form-pay').action = '<?php echo e(url("payables")); ?>/' + id + '/payment';
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\receivables\payables.blade.php ENDPATH**/ ?>