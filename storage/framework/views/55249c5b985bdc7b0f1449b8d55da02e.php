    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e($landedCost->number); ?></h2>
                ...
                <div class="flex items-center gap-2">
                    ...
                    ?>
                    <span
                        class="px-3 py-1 rounded-full text-sm font-medium bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 $sc }}-500/20 $sc }}-400"><?php echo e($sl); ?></span>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                <div>
                    ...
                    <p class="text-gray-900"><?php echo e($landedCost->date->format('d/m/Y')); ?></p>
                </div>
                <div>
                        ...
                        <?php $__currentLoopData = $landedCost->components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-4 py-3 text-xs">
                                    <span
                                        class="px-2 py-0.5 rounded-full <?php echo e(['freight' => 'bg-blue-100 text-blue-700', 'customs' => 'bg-red-100 text-red-700', 'insurance' => 'bg-green-100 text-green-700', 'handling' => 'bg-amber-100 text-amber-700'][$comp->type] ?? 'bg-gray-100 text-gray-500'); ?>">
                                        <?php echo e(['freight' => 'Freight', 'customs' => 'Bea Masuk', 'insurance' => 'Asuransi', 'handling' => 'Handling', 'other' => 'Lainnya'][$comp->type] ?? $comp->type); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 text-gray-900"><?php echo e($comp->name); ?></td>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__currentLoopData = $landedCost->allocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alloc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-4 py-3 text-gray-900"><?php echo e($alloc->product->name ?? '-'); ?>
