...
<div class="h-full">
    <div class="flex items-center justify-between gap-2 mb-3">
        <div class="flex items-center gap-2">
            ...
            <p class="text-sm font-semibold text-gray-900">Insight AI</p>
            <span class="text-xs text-gray-400" id="insights-updated-at">— diperbarui otomatis setiap jam</span>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3" id="insights-grid">
        ...
        <div class="rounded-xl border <?php echo e($borderColor); ?> p-4 flex flex-col gap-2">
            <div class="flex items-start justify-between gap-2">
                <p class="text-sm font-semibold text-gray-900 leading-snug"><?php echo e($insight['title']); ?></p>
                <span class="text-xs font-medium px-2 py-0.5 rounded-full shrink-0 <?php echo e($badgeColor); ?>"><?php echo e($badgeLabel); ?></span>
            </div>
            <p class="text-xs text-gray-500 leading-relaxed"><?php echo e($insight['body']); ?></p>
