...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> <?php echo e(__('Create QC Inspection')); ?> <?php $__env->endSlot(); ?>
                ...
                <form action="<?php echo e(route('qc.inspections.store')); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="work_order_id" required
                            class="w-full rounded-md border-gray-300 <?php $__errorArgs = ['work_order_id'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="sample_size" value="<?php echo e(old('sample_size', 10)); ?>" min="1"
                            required
                            class="w-full rounded-md border-gray-300 <?php $__errorArgs = ['sample_size'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
