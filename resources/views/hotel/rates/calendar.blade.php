    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <span
                    class="px-4 py-2 font-medium text-gray-900 dark:text-white min-w-[160px] text-center">{{ $monthName }}</span>
                    ...
                    <thead>
                        <tr class="bg-gray-50 dark:bg-white/5">
                            ...
                            @for ($day = 1; $day <= $daysInMonth; $day++)
                                ...
                                @endphp
                                <th
                                    class="px-2 py-3 text-center text-xs font-medium {{ $isWeekend ? 'bg-blue-50 dark:bg-blue-500/10' : '' }} {{ $isToday ? 'bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-slate-400' }}">
                        ...
                        @forelse($roomTypes as $roomType)
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                ...
                                @for ($day = 1; $day <= $daysInMonth; $day++)
                                    ...
                                    @endphp
                                    <td
                                        class="px-1 py-2 text-center {{ $isWeekend ? 'bg-blue-50/50 dark:bg-blue-500/5' : '' }} {{ $isToday ? 'bg-green-50/50 dark:bg-green-500/5' : '' }}">
                                        <div
                                            class="px-1 py-1 rounded-lg {{ $hasCustomRate ? 'bg-blue-100 dark:bg-blue-500/20 font-medium text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-slate-400' }}">
