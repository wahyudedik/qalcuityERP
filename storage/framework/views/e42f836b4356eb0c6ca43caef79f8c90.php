...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                    ...
                    ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-white/5 <?php echo e($expired ? 'opacity-60' : ''); ?>">
                        ...
                        <td class="px-4 py-3 text-gray-700 dark:text-slate-300"><?php echo e($qt->customer->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right font-medium text-gray-900 dark:text-white">Rp <?php echo e(number_format($qt->total, 0, ',', '.')); ?></td>
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell text-xs <?php echo e($expired ? 'text-red-500' : 'text-gray-500 dark:text-slate-400'); ?>">
                            <?php echo e($qt->valid_until?->format('d M Y') ?? '-'); ?>

                        </td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <a href="<?php echo e(route('quotations.show', $qt)); ?>" class="text-xs px-2 py-1 border border-gray-200 dark:border-white/10 rounded-lg text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">
                                    Detail
                                </a>
        ...
        <div class="px-4 py-3 border-t border-gray-100 dark:border-white/5"><?php echo e($quotations->links()); ?></div>
        <?php endif; ?>
    </div>
