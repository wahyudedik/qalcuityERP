    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                ...
                <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($summary['total']); ?></p>
            </div>
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
        ...
        <?php if($unmatchedCount > 0): ?>
            <div id="ai-banner"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-purple-700"><?php echo e($unmatchedCount); ?>
        ...
        <?php if($processableCount > 0): ?>
            <div id="auto-generate-banner"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-indigo-700"><?php echo e($processableCount); ?>
