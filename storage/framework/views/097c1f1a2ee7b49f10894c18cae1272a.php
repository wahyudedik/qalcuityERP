        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Total Events</h3>
                    <p class="text-3xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($stats['total_events'] ?? 0); ?></p>
                </div>

                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Upcoming Events</h3>
                    <p class="text-3xl font-bold text-orange-600 dark:text-orange-400">
                        <?php echo e($stats['upcoming_events'] ?? 0); ?></p>
                </div>

                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">This Month Revenue</h3>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <?php if($event->status === 'confirmed'): ?>
                                            <form action="<?php echo e(route('hotel.fb.banquet.complete', $event->id)); ?>"
                                                ...
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
                                                    class="text-green-600 hover:text-green-900 dark:text-green-400">Complete</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
                                </tr>
