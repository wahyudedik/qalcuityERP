<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <span>✈️ Tour & Travel - Packages</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-green-200 dark:border-green-500/30 p-4">
            ...
            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $stats['active_packages'] }}</p>
        </div>
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-blue-200 dark:border-blue-500/30 p-4">
            ...
            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ $stats['total_bookings'] }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-xl border border-orange-200 dark:border-orange-500/30 p-4">
            ...
            <p class="text-2xl font-bold text-orange-600 dark:text-orange-400 mt-1">{{ $stats['pending_visas'] }}</p>
        </div>
    </div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-[#0f172a] transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        ...
                                        <form action="{{ route('tour-travel.packages.toggle-status', $package) }}"
