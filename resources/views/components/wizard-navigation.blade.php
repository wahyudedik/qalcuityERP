...
<div class="flex items-center justify-between gap-3">
    <div class="flex gap-2">
        @if ($showDraft)
            <button type="button" data-wizard-save-draft
                class="px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-700 hover:bg-gray-50 transition font-medium">
    ...
    <div class="flex gap-3">
        <button type="button" data-wizard-prev
            class="px-6 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-700 hover:bg-gray-50 transition font-medium"
            style="display: none;">
            <svg class="w-4 h-4 inline-block mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
