<div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-5 h-full">
    <div class="flex items-start justify-between mb-4">
        <p class="text-xs font-medium text-gray-500 dark:text-slate-400 leading-tight">Order Bulan Ini</p>
    ...
    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($data['this_month_orders'] ?? 0) }}</p>
