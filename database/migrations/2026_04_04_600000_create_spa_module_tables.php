...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('spa_bookings', function (Blueprint $table) {
            ...
            $table->foreignId('guest_id')->nullable()->constrained('hotel_guests')->nullOnDelete();
            $table->foreignId('room_number')->nullable()->constrained('hotel_rooms', 'room_number')->nullOnDelete();
        ...
        Schema::create('therapist_schedules', function (Blueprint $table) {
            ...
            $table->unique(['therapist_id', 'schedule_date', 'start_time', 'end_time']);
