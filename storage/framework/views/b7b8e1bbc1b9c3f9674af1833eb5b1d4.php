    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6">
                <div class="flex items-start justify-between gap-4 mb-4">
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900"><?php echo e($t->subject); ?></h2>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($t->ticket_number); ?> · <?php echo e($t->created_at->format('d/m/Y H:i')); ?> · oleh <?php echo e($t->creator->name ?? '-'); ?></p>
                    </div>
                    <?php
                    ...
                    <div class="flex gap-2">
                        <span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($pc); ?>-100 text-<?php echo e($pc); ?>-700 $pc }}-500/20 $pc }}-400"><?php echo e(ucfirst($t->priority)); ?></span>
                        <span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 $sc }}-500/20 $sc }}-400"><?php echo e(ucfirst(str_replace('_', ' ', $t->status))); ?></span>
                    </div>
                </div>
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white rounded-2xl border <?php echo e($reply->is_internal ? 'border-amber-200' : 'border-gray-200'); ?> p-4">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-gray-900"><?php echo e($reply->user->name ?? 'System'); ?></span>
                    ...
                    <div class="text-sm text-gray-700"><?php echo nl2br(e($reply->body)); ?></div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-4 space-y-2 text-sm">
                ...
                <div><span class="text-gray-500">Customer:</span> <span class="text-gray-900"><?php echo e($t->customer->name ?? $t->contact_name ?? '-'); ?></span></div>
                <div><span class="text-gray-500">Email:</span> <span class="text-gray-900"><?php echo e($t->contact_email ?? $t->customer->email ?? '-'); ?></span></div>
                <div><span class="text-gray-500">Kategori:</span> <span class="text-gray-900"><?php echo e(ucfirst($t->category)); ?></span></div>
                <?php if($t->contract): ?><div><span class="text-gray-500">Kontrak:</span> <a href="<?php echo e(route('contracts.show', $t->contract)); ?>" class="text-blue-500 hover:underline"><?php echo e($t->contract->contract_number); ?></a></div><?php endif; ?>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-4 space-y-2 text-sm">
                ...
                <div class="flex justify-between"><span class="text-gray-500">Response Due:</span>
                    <span class="<?php echo e($t->sla_response_due && $t->sla_response_due->isPast() && !$t->first_responded_at ? 'text-red-500' : 'text-gray-900'); ?>"><?php echo e($t->sla_response_due?->format('d/m H:i') ?? '-'); ?></span>
                </div>
                <div class="flex justify-between"><span class="text-gray-500">First Response:</span>
                    <span class="text-gray-900"><?php echo e($t->first_responded_at?->format('d/m H:i') ?? '-'); ?>
                ...
                <div class="flex justify-between"><span class="text-gray-500">Resolve Due:</span>
                    <span class="<?php echo e($t->isOverdue() ? 'text-red-500 font-semibold' : 'text-gray-900'); ?>"><?php echo e($t->sla_resolve_due?->format('d/m H:i') ?? '-'); ?></span>
                </div>
                <div class="flex justify-between"><span class="text-gray-500">Resolved:</span>
                    <span class="text-gray-900"><?php echo e($t->resolved_at?->format('d/m H:i') ?? '-'); ?>
