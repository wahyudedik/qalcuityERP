...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
            ...
            <p class="text-lg font-bold text-gray-900">Rp <?php echo e(number_format($stats['value'], 0, ',', '.')); ?></p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-4">
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('contracts.templates')); ?>" class="px-3 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Template</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-700"><?php echo e(Str::limit($c->title, 40)); ?></td>
                        ...
                        <td class="px-4 py-3 text-right hidden md:table-cell text-gray-900">Rp <?php echo e(number_format($c->value, 0, ',', '.')); ?></td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="<?php echo e(route('contracts.show', $c)); ?>" class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50">Detail</a>
                        </td>
                    </tr>
        ...
        <?php if($contracts->hasPages()): ?><div class="px-4 py-3 border-t border-gray-100"><?php echo e($contracts->links()); ?></div><?php endif; ?>
    </div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-2xl shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" action="<?php echo e(route('contracts.store')); ?>" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2"><label class="block text-xs font-medium text-gray-600 mb-1">Judul Kontrak *</label><input type="text" name="title" required placeholder="Kontrak Sewa Gudang 2026" class="<?php echo e($cls); ?>"></div>
                    ...
                    <?php endif; ?>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Mulai *</label><input type="date" name="start_date" required class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Berakhir *</label><input type="date" name="end_date" required class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Nilai Kontrak (Rp) *</label><input type="number" name="value" required min="0" step="1000" class="<?php echo e($cls); ?>"></div>
                    ...
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Billing per Siklus (Rp)</label><input type="number" name="billing_amount" min="0" step="1000" class="<?php echo e($cls); ?>"></div>
                ...
                <details class="text-sm">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
                        <div><label class="block text-xs font-medium text-gray-600 mb-1">Response Time (jam)</label><input type="number" name="sla_response_hours" min="1" class="<?php echo e($cls); ?>"></div>
                        <div><label class="block text-xs font-medium text-gray-600 mb-1">Resolution Time (jam)</label><input type="number" name="sla_resolution_hours" min="1" class="<?php echo e($cls); ?>"></div>
                        <div><label class="block text-xs font-medium text-gray-600 mb-1">Uptime (%)</label><input type="number" name="sla_uptime_pct" min="0" max="100" step="0.01" placeholder="99.90" class="<?php echo e($cls); ?>"></div>
                        <div class="sm:col-span-3"><label class="block text-xs font-medium text-gray-600 mb-1">Ketentuan SLA</label><textarea name="sla_terms" rows="2" class="<?php echo e($cls); ?>"></textarea></div>
                        <div class="sm:col-span-3"><label class="block text-xs font-medium text-gray-600 mb-1">Terms & Conditions</label><textarea name="terms" rows="2" class="<?php echo e($cls); ?>"></textarea></div>
                    </div>
                </details>
