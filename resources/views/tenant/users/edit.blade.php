        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <form method="POST" action="{{ route('tenant.users.update', $user) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1.5">Role menentukan menu dan AI tools yang bisa diakses
                        pengguna.</p>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 mb-1.5">Password
                                Baru</label>
