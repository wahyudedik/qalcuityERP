...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row gap-2 mb-4">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('helpdesk.kb')); ?>" class="px-3 py-2 text-sm border border-gray-200 rounded-xl text-gray-600">Knowledge Base</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    ?>
                    <tr class="hover:bg-gray-50 <?php echo e($t->isOverdue() ? 'bg-red-50/50' : ''); ?>">
                        ...
                        <td class="px-4 py-3 text-gray-700"><?php echo e(Str::limit($t->subject, 35)); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell text-xs text-gray-500"><?php echo e($t->customer->name ?? $t->contact_name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($pc); ?>-100 text-<?php echo e($pc); ?>-700 $pc }}-500/20 $pc }}-400"><?php echo e(ucfirst($t->priority)); ?></span></td>
                        <td class="px-4 py-3 text-center hidden sm:table-cell text-xs text-gray-500"><?php echo e($t->assignee->name ?? '-'); ?></td>
                        <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 rounded-full text-xs bg-<?php echo e($sc); ?>-100 text-<?php echo e($sc); ?>-700 $sc }}-500/20 $sc }}-400"><?php echo e($sl); ?></span></td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="<?php echo e(route('helpdesk.show', $t)); ?>" class="text-xs px-2 py-1 border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50">Detail</a>
                        </td>
                    </tr>
        ...
        <?php if($tickets->hasPages()): ?><div class="px-4 py-3 border-t border-gray-100"><?php echo e($tickets->links()); ?></div><?php endif; ?>
    </div>
    ...
    <div id="modal-add" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-xl max-h-[90vh] overflow-y-auto">
            ...
            <form method="POST" action="<?php echo e(route('helpdesk.store')); ?>" class="p-6 space-y-4">
                ...
                <div><label class="block text-xs font-medium text-gray-600 mb-1">Subjek *</label><input type="text" name="subject" required class="<?php echo e($cls); ?>"></div>
                <div><label class="block text-xs font-medium text-gray-600 mb-1">Deskripsi *</label><textarea name="description" required rows="3" class="<?php echo e($cls); ?>"></textarea></div>
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Nama Kontak</label><input type="text" name="contact_name" class="<?php echo e($cls); ?>"></div>
                    <div><label class="block text-xs font-medium text-gray-600 mb-1">Email Kontak</label><input type="email" name="contact_email" class="<?php echo e($cls); ?>"></div>
                </div>
