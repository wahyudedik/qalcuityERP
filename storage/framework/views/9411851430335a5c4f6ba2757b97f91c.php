...
<?php $__env->startSection('title', 'F&B Reports & Analytics'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('hotel.fb.reports.export', ['start_date' => $startDate, 'end_date' => $endDate])); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <div class="text-2xl font-bold text-green-600">Rp <?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?>

                </div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="text-sm text-gray-600">Total Orders</div>
                <div class="text-2xl font-bold"><?php echo e(number_format($stats['total_orders'])); ?></div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="text-sm text-gray-600">Avg Order Value</div>
                <div class="text-2xl font-bold">Rp <?php echo e(number_format($stats['avg_order_value'], 0, ',', '.')); ?></div>
            </div>
            <div class="bg-white p-4 rounded-lg shadow">
                <div class="text-sm text-gray-600">Gross Profit</div>
                <div class="text-2xl font-bold <?php echo e($stats['gross_profit'] >= 0 ? 'text-blue-600' : 'text-red-600'); ?>">
                    Rp <?php echo e(number_format($stats['gross_profit'], 0, ',', '.')); ?>
            ...
            <div class="bg-white p-4 rounded-lg shadow">
                ...
                <div
                    class="text-2xl font-bold <?php echo e($stats['profit_margin'] >= 30 ? 'text-green-600' : ($stats['profit_margin'] >= 20 ? 'text-yellow-600' : 'text-red-600')); ?>">
                    <?php echo e(number_format($stats['profit_margin'], 1)); ?>%
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="space-y-3">
                    <?php $__empty_1 = true; $__currentLoopData = $revenueByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="w-3 h-3 rounded-full bg-indigo-500 mr-2"></div>
                                <span
                                    class="text-sm font-medium capitalize"><?php echo e(str_replace('_', ' ', $type->order_type)); ?></span>
                            </div>
                            <div class="text-right">
                                <div class="text-sm font-bold">Rp <?php echo e(number_format($type->total, 0, ',', '.')); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($type->count); ?> orders</div>
                            </div>
                        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $topItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm"><?php echo e($item->name); ?></span>
                            </div>
                            <div class="text-right">
                                <div class="text-sm font-bold"><?php echo e(number_format($item->total_quantity)); ?> sold</div>
                                <div class="text-xs text-gray-500">Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $categoryStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-2 text-sm font-medium"><?php echo e($cat->category_name ?? 'Uncategorized'); ?>

                                    </td>
                                    <td class="px-4 py-2 text-sm text-right"><?php echo e($cat->order_count); ?></td>
                                    <td class="px-4 py-2 text-sm text-right"><?php echo e(number_format($cat->total_items_sold)); ?>

                                    </td>
                                    <td class="px-4 py-2 text-sm text-right font-medium">Rp
                                        <?php echo e(number_format($cat->revenue, 0, ',', '.')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $supplyUsage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-2 text-sm font-medium"><?php echo e($supply->supply_name); ?></td>
                                    <td class="px-4 py-2 text-sm text-right"><?php echo e(number_format($supply->usage_qty, 2)); ?>

                                        <?php echo e($supply->unit); ?></td>
                                    <td
                                        class="px-4 py-2 text-sm text-right <?php echo e($supply->waste_qty > 0 ? 'text-red-600' : ''); ?>">
                                        <?php echo e(number_format($supply->waste_qty, 2)); ?> <?php echo e($supply->unit); ?>

                                    </td>
                                    <td class="px-4 py-2 text-sm text-right font-medium">Rp
                                        <?php echo e(number_format($supply->total_cost, 0, ',', '.')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\hotel\fb\reports\index.blade.php ENDPATH**/ ?>