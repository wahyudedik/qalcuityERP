                    ...
                    @forelse($workOrders as $wo)
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-4 py-3 text-gray-700 dark:text-slate-300">
                                ...
                                @if ($wo->recipe)
                                    <span
                                        class="text-xs text-gray-400 dark:text-slate-500">({{ $wo->recipe->name }})</span>
                                @endif
                            </td>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                @endphp
                                <span
                                    class="px-2 py-0.5 rounded-full text-xs bg-{{ $c }}-100 text-{{ $c }}-700 dark:bg-{{ $c }}-500/20 dark:text-{{ $c }}-400">
