            ...
            <div class="flex items-start justify-between flex-wrap gap-4">
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(ucfirst($tenant?->plan ?? 'Trial')); ?></h2>
                    ...
                    <?php if($tenant?->subscriptionPlan): ?>
                        <p class="text-sm text-gray-500 dark:text-slate-400 mt-1"><?php echo e($tenant->subscriptionPlan->name); ?> —
                ...
                <div class="text-right">
                    <?php if($tenant?->plan === 'trial' && $tenant?->trial_ends_at): ?>
                        ...
                        <?php if(!$tenant->isTrialExpired()): ?>
                            <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5"><?php echo e($tenant->trial_ends_at->diffForHumans()); ?></p>
                        <?php endif; ?>
                    <?php elseif($tenant?->plan_expires_at): ?>
                        ...
                        <?php if(!$tenant->isPlanExpired()): ?>
                            <p class="text-xs text-gray-500 dark:text-slate-400 mt-0.5"><?php echo e($tenant->plan_expires_at->diffForHumans()); ?></p>
                        <?php endif; ?>
                    <?php else: ?>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6 pt-5 border-t border-gray-200 dark:border-white/10">
                <div>
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white">
                        ...
                        <span class="font-normal text-gray-500 dark:text-slate-400">/ <?php echo e($maxUsers === -1 ? '∞' : $maxUsers); ?></span>
                    </p>
                    <?php if($maxUsers !== -1): ?>
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold text-gray-900 dark:text-white">
                        ...
                        <span class="font-normal text-gray-500 dark:text-slate-400">/ <?php echo e($maxAi === -1 ? '∞' : $maxAi); ?></span>
                    </p>
                    <?php if($maxAi !== -1): ?>
                    <div class="mt-1.5 h-1.5 bg-[#f8f8f8] dark:bg-white/10 rounded-full overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white">
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div>
                   ...
                   <a href="https://wa.me/6281654932383?text=Halo,%20saya%20ingin%20upgrade%20paket%20untuk%20<?php echo e(urlencode($tenant?->name ?? 'tenant saya')); ?>"
                   target="_blank"
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl border shadow-sm p-5 flex flex-col relative
                    <?php echo e($isCurrent ? 'border-blue-500 ring-2 ring-blue-500/20' : 'border-gray-200 dark:border-white/10'); ?>">
                    <?php if($isCurrent): ?>
                    ...
                    <p class="text-xs text-gray-400 dark:text-slate-500 mb-4">Rp <?php echo e(number_format($plan->price_yearly, 0, ',', '.')); ?>/tahun</p>
                    ...
                    <?php else: ?>
                    <a href="https://wa.me/6281654932383?text=Halo,%20saya%20ingin%20upgrade%20ke%20paket%20<?php echo e(urlencode($plan->name)); ?>"
                       target="_blank"
