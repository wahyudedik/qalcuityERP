<x-app-layout>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-xl font-bold text-gray-900">{{ $stats['total_harvests'] }}</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-xl font-bold text-gray-900">Rp {{ number_format($stats['total_cost'], 0, ',', '.') }}</p>
        </div>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 font-medium text-gray-900">{{ $log->plot?->code }}</td>
                        <td class="px-4 py-3 text-gray-600">{{ $log->crop_name }}</td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <span class="inline-block text-[10px] px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-700 mr-1">{{ $g->grade }}: {{ number_format($g->quantity, 0) }}</span>
                            @endforeach
                        </td>
