            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="px-6 py-4 flex flex-col sm:flex-row sm:items-center gap-4 {{ $isOverdue ? 'bg-amber-50' : '' }}">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-900 text-sm {{ $reminder->status === 'done' ? 'line-through opacity-60' : '' }}">
                            {{ $reminder->title }}
                        </p>
                        @if($reminder->notes)
                        ...
                        <div class="flex items-center gap-3 mt-1">
                            <span class="text-xs {{ $isOverdue ? 'text-amber-500 font-medium' : 'text-gray-400' }}">
