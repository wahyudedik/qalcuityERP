        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">{{ __('Edit Paket Internet') }}</h1>
                        <p class="mt-1 text-sm text-gray-600">{{ __('Perbarui informasi paket internet') }}</p>
                    </div>
                ...
                <form action="{{ route('telecom.packages.update', $package) }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required value="{{ old('name', $package->name) }}"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('name') border-red-300 @enderror">
                        @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="download_speed_mbps" id="download_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-16 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('download_speed_mbps') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="upload_speed_mbps" id="upload_speed_mbps" required
                                    ...
                                    class="block w-full rounded-md border-gray-300 bg-white text-gray-900 pr-16 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('upload_speed_mbps') border-red-300 @enderror">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 sm:text-sm">Mbps</span>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="quota_bytes" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <p class="mt-1 text-xs text-gray-500">{{ __('Contoh: 107374182400 = 100 GB') }}</p>
                        </div>

                        <div>
                            <label for="quota_period" class="block text-sm font-medium text-gray-700 mb-1">
                                {{ __('Periode Kuota') }}
                            </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                ...
                                <input type="number" name="price" id="price" required min="0" step="1000"
                                    ...
                                    class="block w-full pl-12 rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('price') border-red-300 @enderror">
                            </div>
                            @error('price')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="billing_cycle" id="billing_cycle" required
                                class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('billing_cycle') border-red-300 @enderror">
                    ...
                    <!-- Setup Fee -->
                    <div>
                        <label for="setup_fee" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div class="relative mt-1 rounded-md shadow-sm max-w-xs">
                            ...
                            <input type="number" name="setup_fee" id="setup_fee" min="0" step="1000"
                                ...
                                class="block w-full pl-12 rounded-md border-gray-300 bg-white text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            ...
                            class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('description', $package->description) }}</textarea>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_active" class="font-medium text-gray-700">{{ __('Aktifkan Paket') }}</label>
                            <p class="text-gray-500">{{ __('Jadikan paket ini tersedia untuk subscription baru') }}</p>
                        </div>
                    </div>
