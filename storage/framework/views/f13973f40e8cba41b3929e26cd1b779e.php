...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Bulk Document Generation')); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('documents.bulk-generate')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Template
                                *</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Output Format
                                *</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Data (JSON)
                                *</label>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
                <div class="p-6">
                    ...
                    <div class="text-center py-8">
                        ...
                        <p class="mt-2 text-sm text-gray-500">No recent bulk generations</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\documents\bulk-generate.blade.php ENDPATH**/ ?>