...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Detail Rawat Inap - <?php echo e($admission->patient?->full_name ?? 'Pasien'); ?> <?php $__env->endSlot(); ?>
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 mb-6 text-white">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-bold"><?php echo e($admission->patient?->full_name ?? '-'); ?></h2>
                    <p class="text-sm text-white/80">
                        RM: <?php echo e($admission->patient?->medical_record_number ?? '-'); ?> |
                        Kamar: <?php echo e($admission->bed?->bed_number ?? '-'); ?> (<?php echo e($admission->bed?->ward?->name ?? '-'); ?>)
                    </p>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\healthcare\inpatient\admissions\show.blade.php ENDPATH**/ ?>