...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            ...
            <?php echo e($groupBooking->group_name); ?>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="font-medium text-gray-900 dark:text-white"><?php echo e($groupBooking->organizer->name); ?></p>
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-900 dark:text-white"><?php echo e(ucfirst($groupBooking->type)); ?></p>
                </div>
                <div>
            ...
            <?php if($groupBooking->notes): ?>
                <div class="mt-4 pt-4 border-t border-gray-200 dark:border-white/10">
                    ...
                    <p class="text-sm text-gray-700 dark:text-slate-300"><?php echo e($groupBooking->notes); ?></p>
                </div>
            <?php endif; ?>
        </div>
                            ...
                            <tr class="border-b border-gray-100 dark:border-white/5">
                                ...
                                <td class="py-3 px-2">
                                    <span
                                        ...
                                        <?php if($reservation->status === 'confirmed'): ?> bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400
                                        <?php elseif($reservation->status === 'checked_in'): ?> bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400
                                        <?php else: ?> bg-gray-100 text-gray-700 dark:bg-white/10 dark:text-slate-400 <?php endif; ?>">
