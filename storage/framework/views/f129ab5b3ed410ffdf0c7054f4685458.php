    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('Detail Subscription')); ?></h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Informasi Subscription')); ?></h2>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Status')); ?></p>
                                <span class="mt-1 px-3 py-1 inline-flex text-sm font-semibold rounded-full
                                    <?php echo e($subscription->status === 'active' ? 'bg-green-100 text-green-800' : ($subscription->status === 'suspended' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800')); ?>">
                                    <?php echo e(ucfirst($subscription->status)); ?>

                                </span>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Pelanggan')); ?></p>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($subscription->customer?->name ?? '-'); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Paket')); ?></p>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($subscription->package?->name ?? '-'); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Perangkat')); ?></p>
                                <p class="mt-1 text-sm font-medium text-gray-900"><?php echo e($subscription->device?->name ?? '-'); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Tanggal Mulai')); ?></p>
                            ...
                            <div>
                                <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Tagihan Berikutnya')); ?></p>
                                <p class="mt-1 text-sm text-gray-900">
                            ...
                            <?php if($subscription->hotspot_username): ?>
                                <div>
                                    <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Username Hotspot')); ?></p>
                                    <p class="mt-1 text-sm font-mono text-gray-900"><?php echo e($subscription->hotspot_username); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($subscription->notes): ?>
                                <div class="col-span-2">
                                    <p class="text-xs text-gray-500 uppercase"><?php echo e(__('Catatan')); ?></p>
                                    <p class="mt-1 text-sm text-gray-900"><?php echo e($subscription->notes); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <!-- Usage Summary -->
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Ringkasan Penggunaan')); ?></h2>
                        <?php
                        ...
                        <?php if($quotaBytes > 0): ?>
                            <div class="mb-4">
                                <div class="flex justify-between text-sm mb-2">
                                    <span class="text-gray-600"><?php echo e(__('Terpakai')); ?>: <?php echo e(round($usedBytes / 1073741824, 2)); ?> GB</span>
                                    <span class="text-gray-600"><?php echo e(__('Total')); ?>: <?php echo e(round($quotaBytes / 1073741824, 2)); ?> GB</span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-4">
                                    <div class="bg-<?php echo e($color); ?>-500 h-4 rounded-full transition-all" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                                <p class="text-sm text-gray-600 mt-1"><?php echo e($percentage); ?>% <?php echo e(__('terpakai')); ?></p>
                            </div>
                        <?php else: ?>
                            <p class="text-sm text-blue-600 font-semibold">∞ <?php echo e(__('Kuota Unlimited')); ?></p>
                        <?php endif; ?>

                        <?php if(isset($usageSummary)): ?>
                            <div class="grid grid-cols-3 gap-4 mt-4">
                                <div class="text-center p-3 bg-blue-50 rounded-lg">
                                    <p class="text-xs text-gray-500"><?php echo e(__('Download')); ?></p>
                                    <p class="text-lg font-bold text-blue-600">
                                        <?php echo e(round(($usageSummary['total_download'] ?? 0) / 1073741824, 2)); ?> GB
                                    </p>
                                </div>
                                <div class="text-center p-3 bg-green-50 rounded-lg">
                                    <p class="text-xs text-gray-500"><?php echo e(__('Upload')); ?></p>
                                    <p class="text-lg font-bold text-green-600">
                                        <?php echo e(round(($usageSummary['total_upload'] ?? 0) / 1073741824, 2)); ?> GB
                                    </p>
                                </div>
                                <div class="text-center p-3 bg-purple-50 rounded-lg">
                                    <p class="text-xs text-gray-500"><?php echo e(__('Total')); ?></p>
                ...
                <div class="space-y-4">
                    <!-- Quick Actions -->
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Aksi Cepat')); ?></h2>
                        <div class="space-y-3">
                    ...
                    <?php if($subscription->package): ?>
                        <div class="bg-white shadow-sm sm:rounded-lg p-6">
                            <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('Info Paket')); ?></h2>
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    <span class="text-gray-500"><?php echo e(__('Download')); ?></span>
                                    <span class="font-medium text-gray-900"><?php echo e($subscription->package->download_speed_mbps); ?> Mbps</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-500"><?php echo e(__('Upload')); ?></span>
                                    <span class="font-medium text-gray-900"><?php echo e($subscription->package->upload_speed_mbps); ?> Mbps</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-500"><?php echo e(__('Harga')); ?></span>
                                    <span class="font-medium text-gray-900">Rp <?php echo e(number_format($subscription->package->price, 0, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
