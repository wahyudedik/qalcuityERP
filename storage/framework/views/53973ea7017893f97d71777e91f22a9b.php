<?php
    $icons = [
        ...
        'database' =>
            '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 7c0-1.657 3.582-3 8-3s8 1.343 8 3M4 7v5c0 1.657 3.582 3 8 3s8-1.343 8-3V7M4 7c0 1.657 3.582 3 8 3s8-1.343 8-3M4 17v-5m16 0v5c0 1.657-3.582 3-8 3s-8-1.343-8-3"/>',
        'mobile' =>
...
?>
<button onclick="toggleGroup('<?php echo e($group); ?>')" data-group="<?php echo e($group); ?>" data-color="<?php echo e($gc['color']); ?>"
    data-rgb="<?php echo e($gc['rgb']); ?>" title="<?php echo e($label); ?>"
