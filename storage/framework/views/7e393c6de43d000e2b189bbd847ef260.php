...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 mb-6">
        ...
        <div class="flex gap-2 ml-auto">
            ...
            <a href="<?php echo e(route('hrm.index')); ?>" class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5">← Karyawan</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-3 border border-gray-200 dark:border-white/10 text-center">
            ...
            <p class="text-xl font-bold text-<?php echo e($color); ?>-600 dark:text-<?php echo e($color); ?>-400 mt-1"><?php echo e($summary[$key] ?? 0); ?></p>
        </div>
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-gray-200 dark:border-white/10 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 dark:border-white/10">
            <h3 class="font-semibold text-gray-900 dark:text-white">Absensi <?php echo e($date->format('d F Y')); ?></h3>
        </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                            ...
                            <td class="px-4 py-3 hidden sm:table-cell text-gray-500 dark:text-slate-400"><?php echo e($emp->position ?? '-'); ?></td>
                            <td class="px-4 py-3 hidden lg:table-cell">
                                <span class="shift-badge-<?php echo e($emp->id); ?> text-xs text-gray-400 dark:text-slate-500">—</span>
                            </td>
                            <td class="px-4 py-3">
                                <select name="records[<?php echo e($i); ?>][status]" class="w-full px-2 py-1.5 text-sm rounded-lg border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
