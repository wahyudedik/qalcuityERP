...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Printing Job Dashboard <?php $__env->endSlot(); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['total_jobs']); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500">Active Jobs</p>
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($stats['active_jobs']); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <p class="text-xs text-gray-500">Completed Today</p>
            <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($stats['completed_today']); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-red-200 p-4">
            <p class="text-xs text-gray-500">Overdue Jobs</p>
            <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e($stats['overdue_jobs']); ?></p>
        </div>
        <div class="bg-white rounded-xl border border-orange-200 p-4">
            <p class="text-xs text-gray-500">Urgent Jobs</p>
            <p class="text-2xl font-bold text-orange-600 mt-1"><?php echo e($stats['urgent_jobs']); ?></p>
        </div>
    </div>
    ...
    <?php if($overdue->count() > 0): ?>
        <div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
            <h3 class="text-sm font-semibold text-red-800 mb-2">Overdue Jobs
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $overdue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between text-sm">
                        <span class="text-red-700"><?php echo e($job->job_number); ?> -
                            <?php echo e($job->job_name); ?></span>
                        <span class="text-red-600">Due: <?php echo e($job->due_date->format('d M Y')); ?></span>
                    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h3 class="text-base font-semibold text-gray-900">Active Print Jobs</h3>
                        ...
                        <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    ?>
                                    <span
                                        class="px-2 py-1 text-xs rounded-full bg-<?php echo e($pColor); ?>-100 text-<?php echo e($pColor); ?>-700 $pColor }}-500/20 $pColor }}-400">
                                ...
                                <td class="px-6 py-4">
                                    <?php if($job->due_date): ?>
                                        <?php if($job->due_date->isPast()): ?>
                                            <span
                                                class="text-red-600 font-medium"><?php echo e($job->due_date->format('d M Y')); ?></span>
                                        <?php else: ?>
                                            <span
                                                class="text-gray-700"><?php echo e($job->due_date->format('d M Y')); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <?php if($job->status === 'queued'): ?>
                                            <form action="<?php echo e(route('printing.status', $job)); ?>" method="POST"
                                                ...
                                                <button type="submit"
                                                    class="text-blue-600 hover:underline text-xs">Start</button>
                                            </form>
                                        <?php endif; ?>
                                    </div>
                                </td>
