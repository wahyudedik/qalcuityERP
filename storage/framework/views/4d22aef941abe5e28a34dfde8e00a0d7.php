...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($summary['active']); ?></p>
        </div>
                    ...
                    <div class="space-y-2">
                        <?php $__currentLoopData = $atRisk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-xs text-gray-700 truncate"><?php echo e($sp->employee->name ?? '-'); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
        ...
        <div class="flex-1 min-w-0">
            ...
            <div
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $letters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-3">
                                        ...
                                        <p class="text-xs text-gray-400"><?php echo e($sp->letter_number); ?>
                                    ...
                                    <td
                                        ...
                                        <?php if($sp->valid_until): ?>
                                            <p
                                                class="text-xs <?php echo e($sp->valid_until->isPast() ? 'text-red-400' : 'text-gray-400'); ?>">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <?php $sc = ['draft'=>'bg-gray-100 text-gray-500','issued'=>'bg-amber-100 text-amber-700','acknowledged'=>'bg-green-100 text-green-700','expired'=>'bg-gray-100 text-gray-400'][$sp->status] ?? ''; ?>
                ...
                <?php if($letters->hasPages()): ?>
                    <div class="px-4 py-3 border-t border-gray-100"><?php echo e($letters->links()); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
