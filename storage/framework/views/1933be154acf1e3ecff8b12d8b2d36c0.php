...
<div class="p-4 sm:p-6 max-w-lg mx-auto space-y-6">
    ...
    <div>
        ...
        <h1 class="text-xl font-semibold text-gray-900">Buka Sesi Kasir</h1>
        <p class="text-sm text-gray-500 mt-0.5">Masukkan modal awal dan informasi kasir</p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('pos.sessions.store')); ?>"
        ...
        <div>
            ...
            <input type="text" value="<?php echo e(auth()->user()->name); ?>" readonly
                class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm text-gray-700 cursor-not-allowed">
        </div>

        
        <div>
            <label for="register_name" class="block text-sm font-medium text-gray-700 mb-1.5">
            ...
            <input type="text" id="register_name" name="register_name"
                ...
                class="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label for="warehouse_id" class="block text-sm font-medium text-gray-700 mb-1.5">
                Gudang / Lokasi
            </label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            <label for="opening_balance" class="block text-sm font-medium text-gray-700 mb-1.5">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea id="notes" name="notes" rows="2"
                ...
                class="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"><?php echo e(old('notes')); ?></textarea>
