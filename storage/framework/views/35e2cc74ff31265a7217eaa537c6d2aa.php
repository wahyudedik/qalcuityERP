            ...
            <div>
                <div class="flex items-center gap-3">
                    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        <?php echo e($formula->formula_code); ?>

                    </h2>
                    <span
                        class="px-3 py-1 text-sm font-medium rounded-full
                        <?php if($formula->status == 'draft'): ?> bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300
                        <?php elseif($formula->status == 'testing'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300
                        <?php elseif($formula->status == 'approved'): ?> bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300
                        <?php elseif($formula->status == 'production'): ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300
                        <?php else: ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 <?php endif; ?>">
                        <i class="fas fa-circle text-xs mr-1"></i><?php echo e($formula->status_label); ?>

                    </span>
                </div>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($formula->formula_name); ?></p>
                <?php if($formula->brand): ?>
                    <p class="text-xs text-gray-500 dark:text-gray-500">Brand: <?php echo e($formula->brand); ?></p>
                <?php endif; ?>
            </div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                    ...
                    <div class="mt-2 text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($ingredients->count()); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3">
                                                <span
                                                    ...
                                                    <?php if($ingredient->function == 'active'): ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300
                                                    <?php elseif($ingredient->function == 'preservative'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300
                                                    <?php else: ?> bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 <?php endif; ?>">
                                ...
                                <?php $__currentLoopData = $versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $version): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="flex justify-between items-start mb-2">
                                            ...
                                            <span
                                                class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($version->created_at->format('d M Y H:i')); ?></span>
                                        </div>
                                ...
                                <?php $__currentLoopData = $stabilityTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="flex justify-between items-start mb-2">
                                            <div>
                                                <span
                                                    class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($test->test_code); ?></span>
                                                <span
                                                    class="ml-2 px-2 py-1 text-xs font-medium rounded-full
                                                    <?php if($test->test_type == 'accelerated'): ?> bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-300
                                                    <?php elseif($test->test_type == 'real_time'): ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300
                                                    <?php else: ?> bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 <?php endif; ?>">
                                            ...
                                            <span
                                                class="px-2 py-1 text-xs font-medium rounded-full
                                                <?php if($test->status == 'in_progress'): ?> bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300
                                                <?php elseif($test->status == 'completed'): ?> bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300
                                                <?php else: ?> bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 <?php endif; ?>">
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm mt-3">
                                            <div>
                                                ...
                                                <span
                                                    class="text-gray-900 dark:text-white"><?php echo e($test->start_date->format('d M Y')); ?></span>
                                            </div>
                                            <?php if($test->expected_end_date): ?>
                                                <div>
                                                    <span class="text-gray-500 dark:text-gray-400">Expected End:</span>
                                                    <span
                                                        class="text-gray-900 dark:text-white"><?php echo e($test->expected_end_date->format('d M Y')); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            <?php if($test->initial_ph): ?>
                                                <div>
                                                    ...
                                                    <span
                                                        class="text-gray-900 dark:text-white"><?php echo e($test->initial_ph); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            <?php if($test->overall_result): ?>
                                                <div>
                                                    ...
                                                    <span
                                                        class="font-medium
                                                        <?php if($test->overall_result == 'Pass'): ?> text-green-600 dark:text-green-400
                    ...
                    <div x-show="activeTab === 'info'" class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-gray-900 dark:text-white"><?php echo e(ucfirst($formula->product_type)); ?></p>
                            </div>
                            <?php if($formula->target_ph): ?>
                                <div>
                                    <strong class="text-sm text-gray-700 dark:text-gray-300">Target pH:</strong>
                                    <p class="text-gray-900 dark:text-white"><?php echo e($formula->target_ph); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if($formula->actual_ph): ?>
                                <div>
                                    ...
                                    <p
                                        class="text-gray-900 dark:text-white <?php echo e($formula->isPhWithinRange() ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                            ...
                            <?php if($formula->shelf_life_months): ?>
                                <div>
                                    ...
                                    <p class="text-gray-900 dark:text-white"><?php echo e($formula->shelf_life_months); ?> months
                                    </p>
                                </div>
                            <?php endif; ?>
                            <div>
                                <strong class="text-sm text-gray-700 dark:text-gray-300">Created By:</strong>
                                <p class="text-gray-900 dark:text-white"><?php echo e($formula->creator->name ?? 'Unknown'); ?>
                        ...
                        <?php if($formula->notes): ?>
                            <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                ...
                                <p class="text-gray-900 dark:text-white mt-1"><?php echo e($formula->notes); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
