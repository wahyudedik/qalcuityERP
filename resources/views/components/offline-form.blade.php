...
<form {{ $attributes->merge(['class' => 'offline-form']) }} action="{{ $action }}"
    method="{{ strtoupper($method) === 'GET' ? 'GET' : 'POST' }}" data-offline-module="{{ $module }}"
    data-offline-redirect="{{ $redirect }}" data-offline-message="{{ $offlineMessage }}"
