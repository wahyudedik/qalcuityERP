                                ...
                                @foreach ([1 => 'S', 2 => 'M', 4 => 'L'] as $sz => $label)
                                    @if ($defaultCols <= $sz || $sz === 1)
                                        <button
                                            ...
                                            {{ $activeCols === $sz ? 'bg-blue-500 text-white' : 'bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-slate-400 hover:bg-gray-200 dark:hover:bg-white/20' }}">
                                            {{ $label }}
                                        </button>
                                    @endif
                                @endforeach
                        ...
                        <div class="flex gap-2">
                            @foreach ([1 => 'Kecil (1 kolom)', 2 => 'Sedang (2 kolom)', 4 => 'Lebar (4 kolom)'] as $sz => $lbl)
                                <label
                                    ...
                                    <span class="text-xs text-gray-700 dark:text-slate-300">{{ $lbl }}</span>
                                </label>
                            @endforeach
                        </div>
                    </div>
