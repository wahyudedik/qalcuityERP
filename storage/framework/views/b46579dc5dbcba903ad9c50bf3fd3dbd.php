                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div class="flex items-center space-x-2">
                                            <?php if(in_array($reservation->status, ['confirmed'])): ?>
                                                <form action="<?php echo e(route('fnb.tables.reservations.update-status', $reservation)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if(in_array($reservation->status, ['confirmed', 'seated'])): ?>
                                                <form action="<?php echo e(route('fnb.tables.reservations.cancel', $reservation)); ?>" method="POST" class="inline"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\fnb\tables\reservations.blade.php ENDPATH**/ ?>