...
<?php $__env->startSection('content'); ?>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2"><?php echo e($recipe->name); ?></h1>
            <?php if($recipe->description): ?>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400"><?php echo e($recipe->description); ?></p>
            <?php endif; ?>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            ?>
            <div class="<?php echo e($marginGood ? 'bg-purple-50 dark:bg-purple-900/20 border-purple-500' : 'bg-red-50 dark:bg-red-900/20 border-red-500'); ?> rounded-lg shadow p-4 border-l-4">
                <div class="text-sm <?php echo e($marginGood ? 'text-purple-600 dark:text-purple-400' : 'text-red-600 dark:text-red-400'); ?>">
                    Margin Keuntungan
                </div>
                <div class="text-2xl font-bold <?php echo e($marginGood ? 'text-purple-700 dark:text-purple-300' : 'text-red-700 dark:text-red-300'); ?>">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($ingredient['percentage'] ?? 0); ?>%</span>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center p-3 <?php echo e($isProfitable ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'); ?> rounded">
                    <span class="font-medium text-gray-700 dark:text-gray-300">Keuntungan per Porsi</span>
                    <span class="font-bold <?php echo e($isProfitable ? 'text-green-700 dark:text-green-300' : 'text-red-700 dark:text-red-300'); ?>">
                        Rp <?php echo e(number_format($costData['profit_margin']['profit_per_serving'] ?? 0, 0, ',', '.')); ?>

                    </span>
                </div>
                <div class="flex justify-between items-center p-3 <?php echo e($marginGood ? 'bg-green-50 dark:bg-green-900/20' : 'bg-yellow-50 dark:bg-yellow-900/20'); ?> rounded">
                    <span class="font-medium text-gray-700 dark:text-gray-300">Persentase Margin</span>
                    <span class="font-bold <?php echo e($marginGood ? 'text-green-700 dark:text-green-300' : 'text-yellow-700 dark:text-yellow-300'); ?>">
                        <?php echo e($marginPct); ?>%
                    </span>
                </div>
            </div>
