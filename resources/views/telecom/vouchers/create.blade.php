    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ __('Generate Vouchers') }}</h1>
                    <p class="text-gray-600 mt-1">{{ __('Create new voucher codes for customers') }}
                    </p>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('telecom.vouchers.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="number" name="code_length" id="code_length" min="6" max="16"
                                ...
                                class="w-full border-gray-300 bg-white text-gray-900 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <p class="mt-1 text-xs text-gray-500">{{ __('6-16 characters') }}</p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="number" name="validity_hours" id="validity_hours" min="1"
                                ...
                                class="w-full border-gray-300 bg-white text-gray-900 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <p class="mt-1 text-xs text-gray-500">{{ __('Default: 24 hours') }}</p>
                        </div>
                    ...
                    <div
                        ...
                        <h3 class="text-sm font-semibold text-blue-900 mb-2">{{ __('Preview:') }}
                        </h3>
