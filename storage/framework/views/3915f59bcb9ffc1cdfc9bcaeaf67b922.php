                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1 min-w-0">
                            ...
                            <p class="text-2xl font-bold text-gray-900">
                                <?php echo e(number_format($bookingStats['total_bookings'])); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1 min-w-0">
                            ...
                            <p class="text-2xl font-bold text-green-600">
                                <?php echo e(number_format($bookingStats['completed_bookings'])); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1 min-w-0">
                            ...
                            <p class="text-2xl font-bold text-purple-600">
                                Rp <?php echo e(number_format($bookingStats['total_revenue'], 0, ',', '.')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 flex-1 min-w-0">
                            ...
                            <p class="text-2xl font-bold text-yellow-600">
                                Rp <?php echo e(number_format($bookingStats['pending_revenue'], 0, ',', '.')); ?>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $topPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4">
                                        <span
                                            class="font-medium text-gray-900"><?php echo e($package->name); ?></span>
                                    </td>
                                    <td class="px-6 py-4 text-gray-700">
                                        <?php echo e($package->bookings_count); ?>

                                    </td>
                                    <td class="px-6 py-4 text-gray-700">
                                        Rp <?php echo e(number_format($package->bookings_sum_total_amount ?? 0, 0, ',', '.')); ?>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        ?>
                                        <span
                                            class="px-2 py-1 text-xs rounded-full bg-<?php echo e($statusColor); ?>-100 text-<?php echo e($statusColor); ?>-700 $statusColor }}-500/20 $statusColor }}-400">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php $__currentLoopData = $popularDestinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-6 py-4">
                                            <span
                                                class="font-medium text-gray-900"><?php echo e($destination->destination ?? 'N/A'); ?></span>
                                        </td>
                                        <td class="px-6 py-4 text-gray-700">
                                            <?php echo e($destination->bookings); ?>

                                        </td>
                                        <td class="px-6 py-4 text-gray-700">
                                            Rp <?php echo e(number_format($destination->revenue ?? 0, 0, ',', '.')); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\tour-travel\analytics\index.blade.php ENDPATH**/ ?>