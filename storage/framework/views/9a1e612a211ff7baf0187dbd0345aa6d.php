...
<?php $__env->startSection('title', 'Custom Report Builder'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="<?php echo e(route('analytics.generate-report')); ?>" method="POST" id="reportForm">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="date" name="start_date" value="<?php echo e(now()->subDays(30)->format('Y-m-d')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\qalcuityERP\resources\views\analytics\report-builder.blade.php ENDPATH**/ ?>