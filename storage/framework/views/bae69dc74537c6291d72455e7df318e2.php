...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            ...
            <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($totalEmp); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Aktif</p>
            <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($totalActive); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Hadir Hari Ini</p>
            <p class="text-2xl font-bold text-blue-600 mt-1"><?php echo e($todayPresent); ?></p>
        </div>
        <div class="bg-white rounded-2xl p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Tidak Hadir</p>
            <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e($todayAbsent); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 mb-4">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('hrm.attendance')); ?>" class="px-3 py-2 text-sm border border-gray-200 rounded-xl text-gray-600 hover:bg-gray-50">Absensi</a>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 hidden sm:table-cell font-mono text-xs text-gray-500"><?php echo e($emp->employee_id); ?></td>
                        <td class="px-4 py-3 hidden md:table-cell text-gray-500"><?php echo e($emp->department ?? '-'); ?></td>
                        ...
                        <td class="px-4 py-3 text-center hidden sm:table-cell">
                            <span class="px-2 py-0.5 rounded-full text-xs
                                <?php echo e($emp->status === 'active' ? 'bg-green-100 text-green-700' :
                                   ($emp->status === 'resigned' ? 'bg-red-100 text-red-700' : 'bg-gray-100 text-gray-500')); ?>">
                                <?php echo e(ucfirst($emp->status)); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3 hidden lg:table-cell text-xs text-gray-500"><?php echo e($emp->join_date?->format('d M Y') ?? '-'); ?></td>
        ...
        <div class="px-4 py-3 border-t border-gray-100"><?php echo e($employees->links()); ?></div>
        <?php endif; ?>
    </div>
            ...
            <form method="POST" action="<?php echo e(route('hrm.store')); ?>" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="join_date" value="<?php echo e(today()->format('Y-m-d')); ?>" class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
