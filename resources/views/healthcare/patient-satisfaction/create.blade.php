            ...
            <form action="{{ route('healthcare.patient-satisfaction.store') }}" method="POST"
                ...
                <div>
                    <label for="patient_visit_id"
                        class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Kunjungan Pasien
                        *</label>
                    <select name="patient_visit_id" id="patient_visit_id" required
                        class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 @error('patient_visit_id') border-red-500 @enderror">
                ...
                <div>
                    <label for="overall_rating"
                        class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Penilaian Keseluruhan
                        *</label>
                    <select name="overall_rating" id="overall_rating" required
                        class="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 @error('overall_rating') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label for="doctor_rating"
                            class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Penilaian
                            Dokter</label>
                ...
                <div>
                    <label for="comments"
                        class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">Komentar</label>
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="would_recommend" id="would_recommend" value="1"
                        class="h-4 w-4 text-blue-600 border-gray-300 dark:border-white/10 rounded focus:ring-blue-500">
                    <label for="would_recommend" class="ml-2 block text-sm text-gray-700 dark:text-slate-300">Akan
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-white/10">
                    <a href="{{ route('healthcare.patient-satisfaction.index') }}"
                        class="px-4 py-2 text-sm border border-gray-200 dark:border-white/10 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        Batal
                    </a>
                    <button type="submit"
